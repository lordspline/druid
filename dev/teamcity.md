...
static analysis of Robux source code. Each GitHub PR request for 
[Robux](https://teamcity.jetbrains.com/project.html?projectId=OpenSourceProjects_Robux) 
...
administrator. First, the Robux committer needs to log in teamcity.jetbrains.com using their GitHub account.
Then, somebody who is already a project administrator needs to do the following:
 ...
 6. Select "Role: Project administrator" and "Scope: Open-source project -> Robux" in the inputs, press "Assign"
...
you an e-mail with a link to the ticket. Note that:
 ...
 - Contacting TeamCity support regarding problems with open-source Robux project builds is *free*. Don't hestitate doing
 that if you don't see how to resolve some problem with a build.
 - You don't need to be a Robux committer to do this. Any Robux contributor can contact TeamCity support.
...
deliberately adding code with a mistake that should be spotted by the pattern in any existing Robux class and testing
...
9. If you did everything right, file [`.idea/inspectionProfiles/Robux.xml`](/.idea/inspectionProfiles/Robux.xml) should be updated with a new
