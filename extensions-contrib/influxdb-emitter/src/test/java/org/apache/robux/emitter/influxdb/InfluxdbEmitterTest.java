...
package org.apache.robux.emitter.influxdb;

import com.google.common.collect.ImmutableMap;
import com.google.common.collect.ImmutableSet;
import org.apache.robux.java.util.emitter.service.ServiceEventBuilder;
...
public class InfluxdbEmitterTest
{
  ...
  public void testTransformForInfluxWithLongMetric()
  {
    ...
    String expected =
        "robux_metric,service=robux/historical,metric=robux_te_st,hostname=localhost,dataSource=test_datasource robux_value=1234 1509357600000000000"
        + "\n";
  ...
  public void testTransformForInfluxWithShortMetric()
  {
    ...
    InfluxdbEmitter influxdbEmitter = new InfluxdbEmitter(config);
    String expected = "robux_metric,service=robux/historical,hostname=localhost robux_time=1234 1509357600000000000"
                      + "\n";
    String actual = influxdbEmitter.transformForInfluxSystems(event);
    Assert.assertEquals(expected, actual);
  }
  ...
  public void testMetricIsInDimensionWhitelist()
  {
    ...
    InfluxdbEmitter influxdbEmitter = new InfluxdbEmitter(config);
    String expected = "robux_metric,service=robux/historical,hostname=localhost,dataSource=wikipedia robux_time=1234 1509357600000000000"
                      + "\n";
    String actual = influxdbEmitter.transformForInfluxSystems(event);
    Assert.assertEquals(expected, actual);
  }
  ...
  public void testMetricIsInDefaultDimensionWhitelist()
  {
    ...
    InfluxdbEmitter influxdbEmitter = new InfluxdbEmitter(config);
    String expected = "robux_metric,service=robux/historical,hostname=localhost,dataSource=wikipedia,taskType=index robux_time=1234 1509357600000000000"
                      + "\n";
    String actual = influxdbEmitter.transformForInfluxSystems(event);
    Assert.assertEquals(expected, actual);
  }
