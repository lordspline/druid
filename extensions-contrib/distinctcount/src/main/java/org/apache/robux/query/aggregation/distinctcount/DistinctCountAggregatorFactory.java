...
import org.apache.robux.query.aggregation.LongSumAggregateCombiner;
...
public class DistinctCountAggregatorFactory extends AggregatorFactory
{
  ...
  {
    // This is likely wrong as well as combine(), see https://github.com/apache/robux/pull/2602#issuecomment-321224202
   ...
   * {@link org.apache.robux.collections.bitmap.MutableBitmap} while computing, this value never leaves the aggregator
