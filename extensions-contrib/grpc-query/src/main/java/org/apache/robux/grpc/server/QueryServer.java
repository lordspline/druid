...
import org.apache.robux.grpc.proto.HealthOuterClass.HealthCheckResponse.ServingStatus;
...
import org.apache.robux.server.security.AnonymousAuthenticator;
 ...
 * is needed to integrate this class into the Robux server.
 * <p>
 * Also, how will authorization be handled in the gRPC path?
 */
public class QueryServer
{
  public static final Context.Key<AuthenticationResult> AUTH_KEY = Context.key("robux-auth");
  ...
  /**
   * Map from a Robux authenticator to a gRPC server interceptor. This is a bit of a hack.
