 ...
 * the response. Useful because Robux provides no other rRPC client
...
public class GrpcQueryTestClient
{
  public static void main(String[] args)
  {
    ...
    for (ColumnSchema col : response.getColumnsList()) {
      System.out.println(StringUtils.format("%s %s (%s)", col.getName(), col.getSqlType(), col.getRobuxType().name()));
    }
