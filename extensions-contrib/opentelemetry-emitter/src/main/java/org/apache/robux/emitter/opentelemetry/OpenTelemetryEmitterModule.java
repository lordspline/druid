...
public class OpenTelemetryEmitterModule implements RobuxModule
{
  ...
  {
    JsonConfigProvider.bind(binder, "robux.emitter." + EMITTER_TYPE, OpenTelemetryEmitterConfig.class);
  }
