...
package org.apache.robux.emitter.opentelemetry;
...
{
  static final RobuxContextTextMapGetter ROBUX_CONTEXT_TEXT_MAP_GETTER = new RobuxContextTextMapGetter();
  ...
  {
    tracer = openTelemetry.getTracer("robux-opentelemetry-extension");
  ...
  {
    Context opentelemetryContext = propagator.extract(Context.current(), event, ROBUX_CONTEXT_TEXT_MAP_GETTER);
