...
package org.apache.robux.query.aggregation.tdigestsketch.sql;
...
import org.apache.robux.query.aggregation.tdigestsketch.TDigestSketchAggregatorFactory;
import org.apache.robux.query.aggregation.tdigestsketch.TDigestSketchModule;
import org.apache.robux.query.aggregation.tdigestsketch.TDigestSketchToQuantilePostAggregator;
...
public class TDigestSketchSqlAggregatorTest extends BaseCalciteQueryTest
{
  protected static class TDigestComponentSupplier extends StandardComponentSupplier
  {
    ...
    {
      return RobuxModuleCollection.of(super.getCoreModule(), new TDigestSketchModule());
    }
