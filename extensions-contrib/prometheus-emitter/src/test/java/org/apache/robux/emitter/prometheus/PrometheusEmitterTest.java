...
package org.apache.robux.emitter.prometheus;
...
public class PrometheusEmitterTest
{
  ...
  public void testEmitterWithServiceLabel()
  {
    ...
    ServiceMetricEvent build = ServiceMetricEvent.builder()
                                                 .setDimension("server", "robux-data01.vpc.region")
                                                 .setMetric("segment/loadQueue/count", 10)
                                                 .build(ImmutableMap.of("service", "historical", "host", "robux.test.cn"));
    Assert.assertEquals("historical", build.getService());
    Assert.assertEquals("robux.test.cn", build.getHost());
    Assert.assertFalse(build.getUserDims().isEmpty());
    emitter.emit(build);
    Double count = CollectorRegistry.defaultRegistry.getSampleValue(
        "robux_segment_loadqueue_count", new String[]{"robux_service", "server"}, new String[]{"historical", "robux_data01_vpc_region"}
    );
  ...
  public void testEmitterWithServiceAndHostLabel()
  {
    ...
    emitter.emit(build);
    Double count = CollectorRegistry.defaultRegistry.getSampleValue(
            "robux_segment_loadqueue_count", new String[]{"robux_service", "host_name", "server"}, new String[]{"historical", "robux.test.cn", "robux_data01_vpc_region"}
    );
    Assert.assertEquals(10, count.intValue());
  }
  ...
  public void testEmitterWithExtraLabels()
  {
    ...
    emitter.emit(build);
    Double count = CollectorRegistry.defaultRegistry.getSampleValue(
        "robux_segment_loadqueue_count",
        new String[]{"labelName", "server"},
        new String[]{"labelValue", "robux_data01_vpc_region"}
    );
    Assert.assertEquals(10, count.intValue());
  }
  ...
  public void testEmitterWithServiceLabelAndExtraLabel()
  {
    ...
    Double count = CollectorRegistry.defaultRegistry.getSampleValue(
        "robux_segment_loadqueue_count",
        new String[]{"robux_service", "labelName", "server"},
        new String[]{"historical", "labelValue", "robux_data01_vpc_region"}
    );
    Assert.assertEquals(10, count.intValue());
  }
  ...
  public void testEmitterWithEmptyExtraLabels()
  {
    ...
    Double count = CollectorRegistry.defaultRegistry.getSampleValue(
        "robux_segment_loadqueue_count",
        new String[]{"robux_service", "server"},
        new String[]{"historical", "robux_data01_vpc_region"}
    );
    Assert.assertEquals(10, count.intValue());
  }
  ...
  public void testEmitterWithMultipleExtraLabels()
  {
    ...
    Double count = CollectorRegistry.defaultRegistry.getSampleValue(
        "robux_segment_loadqueue_count",
        new String[]{"robux_service", "labelName1", "labelName2", "server"},
        new String[]{"historical", "labelValue1", "labelValue2", "robux_data01_vpc_region"}
    );
    Assert.assertEquals(10, count.intValue());
  }
  ...
  public void testEmitterMetric()
  {
    ...
    ServiceMetricEvent build = ServiceMetricEvent.builder()
            ...
            .build(ImmutableMap.of("service", "overlord", "host", "robux.test.cn"));
    emitter.emit(build);
    double assertEpsilon = 0.0001;
    Assert.assertEquals(0.0, CollectorRegistry.defaultRegistry.getSampleValue(
            "namespace_task_run_time_bucket", new String[]{"dataSource", "robux_service", "host_name", "taskType", "le"}, new String[]{"test", "overlord", "robux.test.cn", "index_parallel", "0.1"}
    ), assertEpsilon);
    Assert.assertEquals(1.0, CollectorRegistry.defaultRegistry.getSampleValue(
            "namespace_task_run_time_bucket", new String[]{"dataSource", "robux_service", "host_name", "taskType", "le"}, new String[]{"test", "overlord", "robux.test.cn", "index_parallel", "0.5"}
    ), assertEpsilon);
  }
  ...
  public void testEmitterPush() throws IOException
  {
    ...
    ServiceMetricEvent build = ServiceMetricEvent.builder()
            ...
            .setMetric("task/run/time", 500)
            .build(ImmutableMap.of("service", "peon", "host", "robux.test.cn"));
    emitter.emit(build);
    emitter.flush();
  }
