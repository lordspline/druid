...
package org.apache.robux.indexing.overlord.autoscaling.gce;
...
import org.apache.robux.indexing.overlord.autoscaling.AutoScaler;
import org.apache.robux.indexing.overlord.autoscaling.AutoScalingData;
...
public class GceAutoScalerTest
{
  ...
  private static void verifyAutoScaler(final GceAutoScaler autoScaler)
  {
    ...
    Assert.assertEquals("robux-mig", autoScaler.getEnvConfig().getManagedInstanceGroupName());
  }
  ...
  public void testConfig()
  {
    final String json = "{\n"
            ...
            + "      \"managedInstanceGroupName\" : \"robux-mig\"\n"
            + "   },\n"
            + "   \"maxNumWorkers\" : 4,\n"
            + "   \"minNumWorkers\" : 2,\n"
            + "   \"type\" : \"gce\"\n"
      ...
      throws IOException, GeneralSecurityException, GceServiceException
  {
    GceAutoScaler autoScaler = EasyMock.createMockBuilder(GceAutoScaler.class).withConstructor(
        ...
        2,
        4,
        new GceEnvironmentConfig(1, "proj-x", "us-central-1", "robux-mig")
    ).addMockedMethod(
