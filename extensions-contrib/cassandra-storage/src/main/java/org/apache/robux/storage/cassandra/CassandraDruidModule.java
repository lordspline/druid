...
package org.apache.robux.storage.cassandra;
...
/**
 */
public class CassandraRobuxModule implements RobuxModule
{
  ...
  public void configure(Binder binder)
  {
    ...
    JsonConfigProvider.bind(binder, "robux.storage", CassandraDataSegmentConfig.class);
  }
  ...
  public List<? extends Module> getJacksonModules()
  {
    return ImmutableList.of(
        new Module()
        {
          ...
          {
            return "RobuxCassandraStorage-" + System.identityHashCode(this);
          }
