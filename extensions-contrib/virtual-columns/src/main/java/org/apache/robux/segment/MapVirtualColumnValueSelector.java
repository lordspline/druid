...
abstract class MapVirtualColumnValueSelector<T> implements ColumnValueSelector<T>
{
  ...
  {
    throw RobuxException.defensive("getDouble called on MapVirtualColumnValueSelector, but this is unsupported");
  }

  @Override
  public float getFloat()
  {
    throw RobuxException.defensive("getFloat called on MapVirtualColumnValueSelector, but this is unsupported");
  }

  @Override
  public long getLong()
  {
    throw RobuxException.defensive("getLong called on MapVirtualColumnValueSelector, but this is unsupported");
  }
