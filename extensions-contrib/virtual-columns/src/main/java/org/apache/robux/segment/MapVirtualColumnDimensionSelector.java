...
abstract class MapVirtualColumnDimensionSelector implements DimensionSelector
{
  ...
  {
    throw RobuxException.defensive("getDouble called on MapVirtualColumnDimensionSelector, but this is unsupported");
  }

  @Override
  public float getFloat()
  {
    throw RobuxException.defensive("getFloat called on MapVirtualColumnDimensionSelector, but this is unsupported");
  }

  @Override
  public long getLong()
  {
    throw RobuxException.defensive("getLong called on MapVirtualColumnDimensionSelector, but this is unsupported");
  }
