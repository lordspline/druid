...
package org.apache.robux.emitter.graphite;
...
public class GraphiteEmitterConfig
{
  ...
  private final RobuxToGraphiteEventConverter robuxToGraphiteEventConverter;
  @JsonProperty
  ...
  public boolean equals(Object o)
  {
    ...
    if (!getRobuxToGraphiteEventConverter().equals(that.getRobuxToGraphiteEventConverter())) {
      return false;
    }
  ...
  public int hashCode()
  {
    ...
    result = 31 * result + getRobuxToGraphiteEventConverter().hashCode();
  ...
  public GraphiteEmitterConfig(
      ...
      @JsonProperty("eventConverter") RobuxToGraphiteEventConverter robuxToGraphiteEventConverter,
  ...
  )
  {
    ...
    this.robuxToGraphiteEventConverter = Preconditions.checkNotNull(
        robuxToGraphiteEventConverter,
  ...
  @JsonProperty
  public RobuxToGraphiteEventConverter getRobuxToGraphiteEventConverter()
  {
    return robuxToGraphiteEventConverter;
  }
