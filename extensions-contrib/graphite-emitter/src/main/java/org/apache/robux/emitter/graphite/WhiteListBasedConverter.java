...
public class WhiteListBasedConverter implements RobuxToGraphiteEventConverter
{
   ...
   * <namespacePrefix>.[<robux service name>].[<robux hostname>].<white-listed dimensions>.<metric>
   * <p/>
  ...
  @Override
  public GraphiteEvent robuxEventToGraphite(ServiceMetricEvent serviceMetricEvent)
  {
