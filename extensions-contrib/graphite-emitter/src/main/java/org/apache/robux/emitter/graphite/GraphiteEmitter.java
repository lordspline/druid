...
public class GraphiteEmitter implements Emitter
{
  ...
  private final RobuxToGraphiteEventConverter graphiteEventConverter;
  ...
  )
  {
    ...
    this.graphiteEventConverter = graphiteEmitterConfig.getRobuxToGraphiteEventConverter();
  ...
  public void emit(Event event)
  {
    ...
    if (event instanceof ServiceMetricEvent) {
      final GraphiteEvent graphiteEvent = graphiteEventConverter.robuxEventToGraphite((ServiceMetricEvent) event);
