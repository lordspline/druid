...
public class WhiteListBasedConverterTest
{
  ...
  public void testDefaultIsInWhiteList(String key, boolean expectedValue)
  {
    ...
    boolean isIn = defaultWhiteListBasedConverter.robuxEventToGraphite(event) != null;
  ...
  {
    GraphiteEvent graphiteEvent = defaultWhiteListBasedConverter.robuxEventToGraphite(serviceMetricEvent);
    String path = null;
  ...
  public void testWhiteListedStringArrayDimension() throws IOException
  {
    ...
    GraphiteEvent graphiteEvent = converter.robuxEventToGraphite(event);
