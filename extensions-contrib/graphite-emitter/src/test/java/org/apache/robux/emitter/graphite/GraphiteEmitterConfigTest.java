...
public class GraphiteEmitterConfigTest
{
  ...
  @Test
  public void testSerDeserRobuxToGraphiteEventConverter() throws IOException
  {
    ...
    RobuxToGraphiteEventConverter robuxToGraphiteEventConverter = mapper.readerFor(RobuxToGraphiteEventConverter.class)
                                                                        .readValue(noopGraphiteEventConverterString);
    Assert.assertEquals(robuxToGraphiteEventConverter, sendAllGraphiteEventConverter);
    ...
    robuxToGraphiteEventConverter = mapper.readerFor(RobuxToGraphiteEventConverter.class)
                                          .readValue(whiteListBasedConverterString);
    Assert.assertEquals(robuxToGraphiteEventConverter, whiteListBasedConverter);
  }
