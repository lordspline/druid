 ...
 * This is necessary purely to allow existing common robux code that only knows
...
public class AveragerFactoryWrapper<T, R> extends AggregatorFactory
{
  ...
  /* (non-Javadoc)
   * @see org.apache.robux.query.aggregation.AggregatorFactory#getComparator()
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see org.apache.robux.query.aggregation.AggregatorFactory#getName()
   */
  @Override
