...
public class KafkaEmitterConfigTest
{
  ...
  public void testNullBootstrapServers()
  {
    MatcherAssert.assertThat(
        ...
        operatorExceptionMatcher()
            .expectMessageIs("robux.emitter.kafka.bootstrap.servers must be specified.")
    );
  }
  ...
  public void testNullMetricTopic()
  {
    MatcherAssert.assertThat(
        ...
        operatorExceptionMatcher()
            .expectMessageIs("robux.emitter.kafka.metric.topic must be specified if robux.emitter.kafka.event.types contains metrics.")
    );
  }
  ...
  public void testNullAlertTopic()
  {
    MatcherAssert.assertThat(
        ...
        operatorExceptionMatcher()
            .expectMessageIs(
                "robux.emitter.kafka.alert.topic must be specified if robux.emitter.kafka.event.types contains alerts."
            )
    );
  }
  ...
  public void testNullRequestTopic()
  {
    MatcherAssert.assertThat(
        ...
        operatorExceptionMatcher()
            .expectMessageIs(
                "robux.emitter.kafka.request.topic must be specified if robux.emitter.kafka.event.types contains requests."
            )
    );
  }
  ...
  public void testNullSegmentMetadataTopic()
  {
    MatcherAssert.assertThat(
        ...
        operatorExceptionMatcher()
            .expectMessageIs(
                "robux.emitter.kafka.segmentMetadata.topic must be specified if robux.emitter.kafka.event.types contains segment_metadata."
            )
    );
  }

  private RobuxExceptionMatcher operatorExceptionMatcher()
  {
