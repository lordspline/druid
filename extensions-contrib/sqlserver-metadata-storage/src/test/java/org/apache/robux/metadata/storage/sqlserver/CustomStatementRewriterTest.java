...
import org.apache.robux.metadata.storage.sqlserver.SQLServerConnector.CustomStatementRewriter;
...
public class CustomStatementRewriterTest
{
  ...
  /**
   *
   * @see org.apache.robux.metadata.SQLMetadataConnector#createTable(String, Iterable)
   *
   */
  @Test
  ...
  /**
   *
   * @see org.apache.robux.metadata.SQLMetadataStorageActionHandler#setStatus(String,
   *      boolean, Object)
   *
   */
  @Test
