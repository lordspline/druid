...
public class CompressedBigDecimalObjectStrategy implements ObjectStrategy<CompressedBigDecimal>
{
   ...
   * (non-Javadoc)
   *
   * @see org.apache.robux.segment.data.ObjectStrategy#getClazz()
   */
   ...
   * (non-Javadoc)
   *
   * @see org.apache.robux.segment.data.ObjectStrategy#fromByteBuffer(java.nio.ByteBuffer, int)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.apache.robux.segment.data.ObjectStrategy#toBytes(java.lang.Object)
   */
  @Override
