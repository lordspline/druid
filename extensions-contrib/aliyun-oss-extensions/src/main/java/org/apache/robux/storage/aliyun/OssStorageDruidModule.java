...
import org.apache.robux.data.input.aliyun.OssClientConfig;
...
public class OssStorageRobuxModule implements RobuxModule
{
  ...
  public List<? extends Module> getJacksonModules()
  {
    return ImmutableList.of(
        new Module()
        {
          ...
          {
            return "RobuxAliyunOss-" + System.identityHashCode(this);
          }
  ...
  public void configure(Binder binder)
  {
    ...
    JsonConfigProvider.bind(binder, "robux.oss", OssClientConfig.class);
    JsonConfigProvider.bind(binder, "robux.storage.oss", OssInputDataConfig.class);
    JsonConfigProvider.bind(binder, "robux.storage.oss", OssStorageConfig.class);
    JsonConfigProvider.bind(binder, "robux.storage.oss", OssDataSegmentArchiverConfig.class);

    Binders.taskLogsBinder(binder).addBinding(SCHEME).to(OssTaskLogs.class);
    JsonConfigProvider.bind(binder, "robux.indexer.logs.oss", OssTaskLogsConfig.class);
