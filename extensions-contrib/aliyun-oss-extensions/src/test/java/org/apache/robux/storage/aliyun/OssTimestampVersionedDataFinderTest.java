...
public class OssTimestampVersionedDataFinderTest
{
  ...
  public void testSimpleLatestVersion()
  {
    ...
    URI latest = finder.getLatestVersion(URI.create(StringUtils.format("%s://%s/%s", OssStorageRobuxModule.SCHEME, bucket, keyPrefix)), pattern);

    EasyMock.verify(client);

    URI expected = URI.create(StringUtils.format("%s://%s/%s", OssStorageRobuxModule.SCHEME, bucket, object1.getKey()));
  ...
  public void testFindSelf()
  {
    ...
    URI expected = URI.create(StringUtils.format("%s://%s/%s", OssStorageRobuxModule.SCHEME, bucket, object0.getKey()));
  ...
  public void testFindExact()
  {
    ...
    URI latest = finder.getLatestVersion(URI.create(StringUtils.format("%s://%s/%s", OssStorageRobuxModule.SCHEME, bucket, object0.getKey())), null);
