...
public class OssObjectSummaryIteratorTest
{
  ...
  {
    test(
        ImmutableList.of(OssStorageRobuxModule.SCHEME + "://b/foo/baz"),
        ImmutableList.of(OssStorageRobuxModule.SCHEME + "://b/foo/baz"),
        5
    );
  }
  ...
  public void testMultiObjectOneKeyAtATime()
  {
    test(
        ImmutableList.of(
            OssStorageRobuxModule.SCHEME + "://b/foo/bar1",
            OssStorageRobuxModule.SCHEME + "://b/foo/bar2",
            OssStorageRobuxModule.SCHEME + "://b/foo/bar3",
            OssStorageRobuxModule.SCHEME + "://b/foo/bar4",
            OssStorageRobuxModule.SCHEME + "://b/foo/baz"
        ),
        ImmutableList.of(OssStorageRobuxModule.SCHEME + "://b/foo/"),
        1
    );
  }
  ...
  {
    test(
        ImmutableList.of(OssStorageRobuxModule.SCHEME + "://b/foo/bar1", OssStorageRobuxModule.SCHEME + "://b/foo/bar2", OssStorageRobuxModule.SCHEME + "://b/foo/bar3", OssStorageRobuxModule.SCHEME + "://b/foo/bar4"),
        ImmutableList.of(OssStorageRobuxModule.SCHEME + "://b/foo/bar"),
        10
    );
  }
  ...
  public void testNoPath()
  {
    test(
        ImmutableList.of(
            OssStorageRobuxModule.SCHEME + "://b/foo",
            OssStorageRobuxModule.SCHEME + "://b/foo/bar1",
            OssStorageRobuxModule.SCHEME + "://b/foo/bar2",
            OssStorageRobuxModule.SCHEME + "://b/foo/bar3",
            OssStorageRobuxModule.SCHEME + "://b/foo/bar4",
        ...
        ImmutableList.of(OssStorageRobuxModule.SCHEME + "://b"),
        10
    );
  }
  ...
  public void testDifferentBucket()
  {
    test(
        ImmutableList.of(),
        ImmutableList.of(OssStorageRobuxModule.SCHEME + "://bx/foo/"),
        10
    );
  }
  ...
  public void testWithMultiplePrefixesReturningAllNonEmptyObjectsStartingWithOneOfPrefixes()
  {
    test(
        ...
        ImmutableList.of(OssStorageRobuxModule.SCHEME + "://b/foo/bar", OssStorageRobuxModule.SCHEME + "://b/foo/baz"),
        10
    );
  }
