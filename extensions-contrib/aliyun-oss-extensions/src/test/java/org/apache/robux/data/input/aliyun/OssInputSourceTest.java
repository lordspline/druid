...
package org.apache.robux.data.input.aliyun;
...
import org.apache.robux.storage.aliyun.OssInputDataConfig;
import org.apache.robux.storage.aliyun.OssStorageRobuxModule;
import org.apache.robux.storage.aliyun.OssUtils;
...
public class OssInputSourceTest extends InitializedNullHandlingTest
{
  ...
  public void testGetTypes()
  {
    ...
    Assert.assertEquals(ImmutableSet.of(OssStorageRobuxModule.SCHEME), inputSource.getTypes());
  }
  ...
  {
    RobuxModule baseModule = new TestOssModule();
  ...
  public static class TestOssModule implements RobuxModule
  {
    @Override
