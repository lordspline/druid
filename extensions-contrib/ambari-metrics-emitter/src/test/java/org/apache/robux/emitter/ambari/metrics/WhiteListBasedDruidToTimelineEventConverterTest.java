...
package org.apache.robux.emitter.ambari.metrics;

import junitparams.JUnitParamsRunner;
import junitparams.Parameters;
import org.apache.commons.io.IOUtils;
import org.apache.robux.annotations.UsedByJUnitParamsRunner;
...
public class WhiteListBasedRobuxToTimelineEventConverterTest
{
  private final String prefix = "robux";
  private final WhiteListBasedRobuxToTimelineEventConverter defaultWhiteListBasedRobuxToTimelineEventConverter =
      new WhiteListBasedRobuxToTimelineEventConverter(prefix, "robux", null, new DefaultObjectMapper());
  ...
  public void testDefaultIsInWhiteList(String key, boolean expectedValue)
  {
    ...
    boolean isIn = defaultWhiteListBasedRobuxToTimelineEventConverter.robuxEventToTimelineMetric(event) != null;
  ...
  {
    TimelineMetric metric = defaultWhiteListBasedRobuxToTimelineEventConverter.robuxEventToTimelineMetric(serviceMetricEvent);
    String path = null;
    if (metric != null) {
  ...
  public void testWhiteListedStringArrayDimension() throws IOException
  {
    ...
    WhiteListBasedRobuxToTimelineEventConverter converter = new WhiteListBasedRobuxToTimelineEventConverter(
        prefix,
        "robux",
    ...
    TimelineMetric metric = converter.robuxEventToTimelineMetric(event);
