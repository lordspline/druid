...
public class WhiteListBasedRobuxToTimelineEventConverter implements RobuxToTimelineMetricConverter
{
  private static final Logger LOGGER = new Logger(WhiteListBasedRobuxToTimelineEventConverter.class);
  /**
   * @code whiteListDimsMapper is a white list of metric->dimensions mappings.
   * Key is the robux metric name or the metric's prefix.
  ...
  @JsonCreator
  public WhiteListBasedRobuxToTimelineEventConverter(
  ...
  /**
   * @param serviceMetricEvent robux metric event to convert
   *
   ...
   * <namespacePrefix>.<robux service name>.<white-listed dimensions>.<metric>
   * <p/>
  ...
  @Override
  public TimelineMetric robuxEventToTimelineMetric(ServiceMetricEvent serviceMetricEvent)
  {
  ...
  public boolean equals(Object o)
  {
    ...
    WhiteListBasedRobuxToTimelineEventConverter that = (WhiteListBasedRobuxToTimelineEventConverter) o;
