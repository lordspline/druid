...
public class AmbariMetricsEmitterModule implements RobuxModule
{
  ...
  {
    JsonConfigProvider.bind(binder, "robux.emitter." + EMITTER_TYPE, AmbariMetricsEmitterConfig.class);
  }
