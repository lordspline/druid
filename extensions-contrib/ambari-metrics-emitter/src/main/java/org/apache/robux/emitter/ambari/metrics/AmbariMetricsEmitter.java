...
public class AmbariMetricsEmitter extends AbstractTimelineMetricsSink implements Emitter
{
  ...
  private final RobuxToTimelineMetricConverter timelineMetricConverter;
  ...
  )
  {
    ...
    this.timelineMetricConverter = config.getRobuxToTimelineEventConverter();
  ...
  public void emit(Event event)
  {
    ...
    if (event instanceof ServiceMetricEvent) {
      final TimelineMetric timelineEvent = timelineMetricConverter.robuxEventToTimelineMetric((ServiceMetricEvent) event);
