 ...
 * <namespacePrefix>.<robux service name>.<dimensions values ordered by dimension's name>.<metric>
 * <p>
 * Note that this name will be sanitized by replacing all the `.` or `space` to `_` {@link AmbariMetricsEmitter#sanitize(String)}
 */

@JsonTypeName("all")
public class SendAllTimelineEventConverter implements RobuxToTimelineMetricConverter
{
  public static final String DEFAULT_APP_NAME = "robux";
