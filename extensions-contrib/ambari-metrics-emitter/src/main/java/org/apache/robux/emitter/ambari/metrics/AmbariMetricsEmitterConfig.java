...
public class AmbariMetricsEmitterConfig
{
  ...
  private final RobuxToTimelineMetricConverter robuxToTimelineEventConverter;
  ...
  public AmbariMetricsEmitterConfig(
      ...
      @JsonProperty("eventConverter") RobuxToTimelineMetricConverter robuxToTimelineEventConverter,
  ...
  )
  {
    ...
    this.robuxToTimelineEventConverter = Preconditions.checkNotNull(
        robuxToTimelineEventConverter,
  ...
  @JsonProperty
  public RobuxToTimelineMetricConverter getRobuxToTimelineEventConverter()
  {
    return robuxToTimelineEventConverter;
  }
  ...
  public boolean equals(Object o)
  {
    ...
    if (!robuxToTimelineEventConverter.equals(that.robuxToTimelineEventConverter)) {
      return false;
    }
  ...
  public int hashCode()
  {
    ...
    result = 31 * result + robuxToTimelineEventConverter.hashCode();
