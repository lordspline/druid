...
/**
 * Refer to extensions-contrib/robux-deltalake-extensions/src/test/resources/README.md to generate the
...
public class NonPartitionedDeltaTable
{
  ...
  /**
   * The Robux schema used for ingestion of {@link #DELTA_TABLE_PATH}.
   */
