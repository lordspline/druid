...
package org.apache.robux.delta.filter;
...
/**
 * Robux filters that translate to the underlying Delta Kernel {@link Predicate}s. Implementations should
 * provide an expression tree syntax to provide more flexibility to users.
 *
 * <p>
 * A user-facing Robux {@link DeltaFilter} should be translated to a canonical Delta Kernel {@link Predicate}.
