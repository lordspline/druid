...
public class MaterializedViewMaintenanceRobuxModule implements RobuxModule 
{
  @Override
  ...
  {
    JsonConfigProvider.bind(binder, "robux.materialized.view.task", MaterializedViewTaskConfig.class);
  }
}
