...
package org.apache.robux.security.ranger.authorizer;
...
import org.apache.robux.security.ranger.authorizer.guice.Ranger;
...
public class RangerAuthorizer implements Authorizer
{
  ...
  public static final String RANGER_ROBUX_SERVICETYPE = "robux";
  public static final String RANGER_ROBUX_APPID = "robux";
      ...
      @JacksonInject @Ranger Configuration conf)
  {
    ...
    rangerPlugin = new RangerBasePlugin(RANGER_ROBUX_SERVICETYPE, RANGER_ROBUX_APPID);
    rangerPlugin.init();
  ...
  public Access authorize(AuthenticationResult authenticationResult, Resource resource, Action action)
  {
    ...
    RangerRobuxResource rangerRobuxResource = new RangerRobuxResource(resource);
    RangerRobuxAccessRequest request = new RangerRobuxAccessRequest(
        rangerRobuxResource,
...
class RangerRobuxResource extends RangerAccessResourceImpl
{
  public RangerRobuxResource(Resource resource)
  {
    setValue(resource.getType().toLowerCase(Locale.ENGLISH), resource.getName());
  }
}

class RangerRobuxAccessRequest extends RangerAccessRequestImpl
{
  public RangerRobuxAccessRequest(RangerRobuxResource resource, String user, Set<String> userGroups, Action action)
  {
