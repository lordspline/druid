...
public class StatsDEmitterTest
{
  ...
  public void testServiceAsTagOption()
  {
    ...
    emitter.emit(new ServiceMetricEvent.Builder()
            ...
            .setDimension("type", "groupBy")
            .setMetric("query/time", 10)
            .build("robux/broker", "brokerHost1")
    );
    verify(client).time("robux.query.time", 10,
                        "robux_service:robux/broker", "dataSource:data-source", "type:groupBy", "hostname:brokerHost1");
  }
  ...
  public void testAlertEvent()
  {
    ...
    verify(client).recordEvent(
        ...
        eq("feed:alerts"), eq("robux_service:robux/broker"),
