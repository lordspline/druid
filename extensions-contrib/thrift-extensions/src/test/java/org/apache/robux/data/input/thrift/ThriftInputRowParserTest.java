...
package org.apache.robux.data.input.thrift;
...
import org.apache.robux.data.input.impl.JavaScriptParseSpec;
...
public class ThriftInputRowParserTest
{
  ...
  public void testGetThriftClass() throws Exception
  {
    ThriftInputRowParser parser1 = new ThriftInputRowParser(
        parseSpec,
        "example/book.jar",
        "org.apache.robux.data.input.thrift.Book"
    );
    Assert.assertEquals("org.apache.robux.data.input.thrift.Book", parser1.getThriftClass().getName());

    ThriftInputRowParser parser2 = new ThriftInputRowParser(parseSpec, null, "org.apache.robux.data.input.thrift.Book");
    Assert.assertEquals("org.apache.robux.data.input.thrift.Book", parser2.getThriftClass().getName());
  }
