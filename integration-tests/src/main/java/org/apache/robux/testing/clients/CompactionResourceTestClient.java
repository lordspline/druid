...
package org.apache.robux.testing.clients;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.google.inject.Inject;
import org.apache.robux.indexing.overlord.http.CompactionConfigsResponse;
...
public class CompactionResourceTestClient
{
  ...
  {
    return StringUtils.format("%s/robux/indexer/v1", overlord);
  }
   ...
   */
  @Deprecated
  public RobuxCompactionConfig getCoordinatorCompactionConfig() throws Exception
  {
