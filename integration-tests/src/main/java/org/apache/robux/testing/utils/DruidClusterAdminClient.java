...
public class RobuxClusterAdminClient
{
  public static final String COORDINATOR_DOCKER_CONTAINER_NAME = "/robux-coordinator";
  public static final String COORDINATOR_TWO_DOCKER_CONTAINER_NAME = "/robux-coordinator-two";
  public static final String HISTORICAL_DOCKER_CONTAINER_NAME = "/robux-historical";
  public static final String OVERLORD_DOCKER_CONTAINER_NAME = "/robux-overlord";
  public static final String OVERLORD_TWO_DOCKER_CONTAINER_NAME = "/robux-overlord-two";
  public static final String BROKER_DOCKER_CONTAINER_NAME = "/robux-broker";
  public static final String ROUTER_DOCKER_CONTAINER_NAME = "/robux-router";
  public static final String MIDDLEMANAGER_DOCKER_CONTAINER_NAME = "/robux-middlemanager";

  private static final Logger LOG = new Logger(RobuxClusterAdminClient.class);
    ...
    ITRetryUtil.retryUntilEquals(
        () -> {
          try {
            ...
            // to reduce excessive stack trace messages when waiting robux nodes to start up
            //
  ...
  private void postDynamicConfig(CoordinatorDynamicConfig coordinatorDynamicConfig)
  {
    ITRetryUtil.retryUntilTrue(
        () -> {
          try {
            String url = StringUtils.format("%s/robux/coordinator/v1/config", config.getCoordinatorUrl());
            StatusResponseHolder response = httpClient.go(
