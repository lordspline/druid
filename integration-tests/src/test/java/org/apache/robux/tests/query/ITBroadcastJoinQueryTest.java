...
public class ITBroadcastJoinQueryTest extends AbstractIndexerTest
{
  ...
  public void testBroadcastJoin() throws Exception
  {
    ...
    try {
      ...
      // query metadata until robux schema is refreshed and datasource is available joinable
      ...
      // query metadata until robux schema is refreshed and datasource is no longer available
      ITRetryUtil.retryUntilTrue(
          () -> {
            try {
              queryHelper.testQueriesFromString(
