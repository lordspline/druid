 ...
 * 1) Set the bucket and path for your data. This can be done by setting -Drobux.test.config.cloudBucket and
 *    -Drobux.test.config.cloudPath or setting "cloud_bucket" and "cloud_path" in the config file.
 ...
 *    Note that robux_s3_accessKey and robux_s3_secretKey should be unset or set to credentials that does not have
 ...
 *    -Drobux.test.config.s3AssumeRoleWithExternalId or setting "s3_assume_role_with_external_id" in the config file.
 *    -Drobux.test.config.s3AssumeRoleExternalId or setting "s3_assume_role_external_id" in the config file.
 *    -Drobux.test.config.s3AssumeRoleWithoutExternalId or setting "s3_assume_role_without_external_id" in the config file.
