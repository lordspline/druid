 ...
 *    This can be done by setting -Drobux.test.config.cloudBucket, -Drobux.test.config.cloudPath
 *    and -Drobux.test.config.cloudRegion or setting "cloud_bucket","cloud_path", and "cloud_region" in the config file.
 * 2) Set -Drobux.s3.accessKey and -Drobux.s3.secretKey when running the tests to your access/secret keys.
