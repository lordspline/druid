...
package org.apache.robux.tests;
...
public class TestNGGroup
{
   ...
   * against a quickstart deployment of Robux using the instructions in this project's README.
   ...
   * {@link org.apache.robux.tests.indexer.ITIndexerTest}) and add any additional instructions that were needed to
   ...
   * Kinesis stream endpoint for a region must also be pass to mvn with -Drobux.test.config.streamEndpoint=<ENDPOINT>
   */
