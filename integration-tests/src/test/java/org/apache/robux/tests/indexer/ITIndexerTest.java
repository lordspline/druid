...
package org.apache.robux.tests.indexer;
...
public class ITIndexerTest extends AbstractITBatchIndexTest
{
  ...
  // TODO: https://github.com/apache/robux/issues/9565
  ...
  private static final String REINDEX_TASK_WITH_ROBUX_INPUT_SOURCE = "/indexer/wikipedia_reindex_robux_input_source_task.json";
  ...
  private static final String MERGE_REINDEX_TASK_WITH_ROBUX_INPUT_SOURCE = "/indexer/wikipedia_merge_reindex_robux_input_source_task.json";
  ...
  public void testIndexData() throws Exception
  {
    ...
    final String reindexDatasourceWithRobuxInputSource = REINDEX_DATASOURCE + "-testIndexData-robuxInputSource";
    try (
        final Closeable ignored1 = unloader(INDEX_DATASOURCE + config.getExtraDatasourceNameSuffix());
        final Closeable ignored2 = unloader(reindexDatasource + config.getExtraDatasourceNameSuffix());
        final Closeable ignored3 = unloader(reindexDatasourceWithRobuxInputSource + config.getExtraDatasourceNameSuffix())
    ) {
      ...
      doReindexTest(
          INDEX_DATASOURCE,
          reindexDatasourceWithRobuxInputSource,
          REINDEX_TASK_WITH_ROBUX_INPUT_SOURCE,
          REINDEX_QUERIES_RESOURCE,
          new Pair<>(false, false)
      );
    }
  ...
  public void testReIndexDataWithTimestamp() throws Exception
  {
    ...
    final String reindexDatasourceWithRobuxInputSource = REINDEX_DATASOURCE + "-testReIndexDataWithTimestamp-robuxInputSource";
    try (
  ...
  public void testReIndexWithNonExistingDatasource() throws Exception
  {
    ...
    String taskSpec = StringUtils.replace(
        getResourceAsString(REINDEX_TASK_WITH_ROBUX_INPUT_SOURCE),
        "%%DATASOURCE%%",
  ...
  public void testMERGEIndexData() throws Exception
  {
    ...
    final String reindexDatasourceWithRobuxInputSource = MERGE_REINDEX_DATASOURCE + "-testMergeReIndexData-robuxInputSource";
    try (
      ...
      doReindexTest(
          MERGE_INDEX_DATASOURCE,
          reindexDatasourceWithRobuxInputSource,
          MERGE_REINDEX_TASK_WITH_ROBUX_INPUT_SOURCE,
          MERGE_INDEX_QUERIES_RESOURCE,
          new Pair<>(false, false)
      );
    }
