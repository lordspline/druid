...
public class ITS3OverrideCredentialsIndexTest extends AbstractITBatchIndexTest
{
  ...
  public void testS3WithoutOverrideCredentialsIndexDataShouldFailed() throws Exception
  {
    ...
    try {
      ...
      // Index task is expected to fail as the default S3 Credentials in Robux's config (robux.s3.accessKey and
      // robux.s3.secretKey should not have access to the bucket and path for our data. (Refer to the setup instruction
