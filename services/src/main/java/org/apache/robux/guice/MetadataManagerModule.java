...
import org.apache.robux.metadata.MetadataRuleManagerConfig;
import org.apache.robux.metadata.MetadataRuleManagerProvider;
import org.apache.robux.metadata.MetadataSupervisorManager;
import org.apache.robux.metadata.SQLMetadataRuleManagerProvider;
import org.apache.robux.metadata.SQLMetadataSupervisorManager;
import org.apache.robux.metadata.SegmentsMetadataManager;
import org.apache.robux.metadata.SegmentsMetadataManagerConfig;
import org.apache.robux.metadata.SegmentsMetadataManagerProvider;
import org.apache.robux.metadata.SqlSegmentsMetadataManagerProvider;
import org.apache.robux.metadata.segment.SegmentMetadataTransactionFactory;
import org.apache.robux.metadata.segment.SqlSegmentMetadataReadOnlyTransactionFactory;
...
import org.apache.robux.segment.metadata.SegmentSchemaCache;
...
public class MetadataManagerModule implements Module
{
  ...
  public void configure(Binder binder)
  {
    ...
    JsonConfigProvider.bind(binder, "robux.manager.segments", SegmentsMetadataManagerConfig.class);
    ...
    if (nodeRoles.contains(NodeRole.COORDINATOR)) {
      JsonConfigProvider.bind(binder, "robux.manager.rules", MetadataRuleManagerConfig.class);
