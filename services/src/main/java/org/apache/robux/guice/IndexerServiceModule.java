...
public class IndexerServiceModule extends AbstractRobuxServiceModule
{
  @ProvidesIntoSet
  ...
  @ProvidesIntoSet
  @Named(NodeRole.INDEXER_JSON_NAME)
  public Class<? extends RobuxService> getWorkerNodeService()
  {
  ...
  @ProvidesIntoSet
  @Named(NodeRole.INDEXER_JSON_NAME)
  public Class<? extends RobuxService> getLookupNodeService()
  {
