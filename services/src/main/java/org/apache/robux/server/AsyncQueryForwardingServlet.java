...
import org.apache.robux.server.initialization.jetty.HttpException;
import org.apache.robux.server.initialization.jetty.StandardResponseHeaderFilterHolder;
...
public class AsyncQueryForwardingServlet extends AsyncProxyServlet implements QueryCountStatsProvider
{
  ...
  private static final String HOST_ATTRIBUTE = "org.apache.robux.proxy.to.host";
  private static final String SCHEME_ATTRIBUTE = "org.apache.robux.proxy.to.host.scheme";
  private static final String QUERY_ATTRIBUTE = "org.apache.robux.proxy.query";
  private static final String AVATICA_QUERY_ATTRIBUTE = "org.apache.robux.proxy.avaticaQuery";
  private static final String SQL_QUERY_ATTRIBUTE = "org.apache.robux.proxy.sqlQuery";
  private static final String OBJECTMAPPER_ATTRIBUTE = "org.apache.robux.proxy.objectMapper";

  private static final String PROPERTY_SQL_ENABLE = "robux.router.sql.enable";
  ...
  public AsyncQueryForwardingServlet(
      ...
      @Router RobuxHttpClientConfig httpClientConfig,
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
  {
    ...
    final boolean isNativeQueryEndpoint = requestURI.startsWith("/robux/v2") && !requestURI.startsWith("/robux/v2/sql");
    final boolean isSqlQueryEndpoint = requestURI.startsWith("/robux/v2/sql");

    final boolean isAvaticaJson = requestURI.startsWith("/robux/v2/sql/avatica");
    final boolean isAvaticaPb = requestURI.startsWith("/robux/v2/sql/avatica-protobuf");
  ...
  )
  {
    ...
    clientRequest.setAttribute(AuthConfig.ROBUX_AUTHORIZATION_CHECKED, true);
  ...
  private class MetricsEmittingProxyResponseListener<T> extends ProxyResponseListener
  {
    ...
    )
    {
      ...
      if (sqlQueryId != null) {
        ...
        queryMetrics = RobuxMetrics.makeRequestMetrics(
            queryMetricsFactory,
