...
{
  public static final String DEFAULT_COORDINATOR_SERVICE_NAME = "robux/coordinator";
  public static final String DEFAULT_BROKER_SERVICE_NAME = "robux/broker";
  ...
  public LinkedHashMap<String, String> getTierToBrokerMap()
  {
    return tierToBrokerMap == null ? new LinkedHashMap<>(
        ImmutableMap.of(
            RobuxServer.DEFAULT_TIER, defaultBrokerServiceName
        )
    ) : tierToBrokerMap;
  }
