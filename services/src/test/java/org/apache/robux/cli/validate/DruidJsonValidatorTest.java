...
public class RobuxJsonValidatorTest
{
  ...
  private Runnable parseCommand(String... args)
  {
    Cli<?> parser = Cli.builder("validator")
                       .withCommand(RobuxJsonValidator.class)
                       .build();
  ...
  public void testParseValidator()
  {
    ...
    RobuxJsonValidator robuxJsonValidator = (RobuxJsonValidator) command;
    robuxJsonValidator.setLogWriter(writer);
    robuxJsonValidator.run();
