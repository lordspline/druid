...
public class ManualTieredBrokerSelectorStrategyTest
{
  ...
  {
    static final String BROKER_SVC_HOT = "robux/hotBroker";
    static final String BROKER_SVC_MEDIUM = "robux/mediumBroker";
    static final String BROKER_SVC_COLD = "robux/coldBroker";
