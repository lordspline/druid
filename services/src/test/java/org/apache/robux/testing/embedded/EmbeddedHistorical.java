...
import org.apache.robux.cli.CliHistorical;
 ...
 * Add this to your {@link EmbeddedRobuxCluster} if you want to load segments on
 * a historical and query them.
 */
public class EmbeddedHistorical extends EmbeddedRobuxServer<EmbeddedHistorical>
{
  public EmbeddedHistorical()
  {
    addBeforeStartHook((cluster, self) -> {
      self.addProperty(
          "robux.segmentCache.locations",
          StringUtils.format(
              "[{\"path\":\"%s\",\"maxSize\":\"%s\"}]",
