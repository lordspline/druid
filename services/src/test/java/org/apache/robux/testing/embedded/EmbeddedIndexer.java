...
import org.apache.robux.cli.CliIndexer;
...
/**
 * Embeddded mode of {@link CliIndexer} used in embedded tests.
 * Add this to your {@link EmbeddedRobuxCluster} if you want to run ingestion
 * tasks.
 */
public class EmbeddedIndexer extends EmbeddedRobuxServer<EmbeddedIndexer>
{
  public EmbeddedIndexer()
  {
    // Don't sync lookups as cluster might not have a Coordinator
    addProperty("robux.lookup.enableLookupSyncOnStartup", "false");
  }
