...
package org.apache.robux.testing.embedded.junit5;
...
/**
 * Base class for Junit5 tests that use an {@link EmbeddedRobuxCluster}.
 * <p>
 * Steps to write a test:
 * <ul>
 * <li>Write an {@code Embedded*Test} class that extends this class.</li>
 * <li>Create an {@link EmbeddedRobuxCluster} containing all servers, resources,
...
public abstract class EmbeddedClusterTestBase
{
   ...
   */
  protected EmbeddedRobuxCluster cluster;
   ...
   * {@link #setup()}.
   */
  protected abstract EmbeddedRobuxCluster createCluster();
