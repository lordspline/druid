...
/**
 * Represents any resource outside Robux used by an {@link EmbeddedRobuxCluster}.
...
public interface EmbeddedResource
{
   ...
   * final initialization of {@link EmbeddedRobuxServer} that need to configure themselves based on some
   * shared resources which have already been started, such as {@link TestFolder}.
   */
  default void beforeStart(EmbeddedRobuxCluster cluster)
  {
   ...
   * that are started before any Robux services, and that need to configure the Robux services in some way.
   */
  default void onStarted(EmbeddedRobuxCluster cluster)
  {
    // Do nothing by default.
  }
}
