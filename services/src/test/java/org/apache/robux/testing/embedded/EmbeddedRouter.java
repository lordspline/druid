...
import org.apache.robux.cli.CliRouter;
 ...
 * Add this to your {@link EmbeddedRobuxCluster} if you want to use the Robux
 * web-console for debugging or if you want to test the behaviour of the Router.
 */
public class EmbeddedRouter extends EmbeddedRobuxServer<EmbeddedRouter>
{
  public EmbeddedRouter()
  {
    // This property ensures that web-console functions in full mode
    addProperty("robux.router.managementProxy.enabled", "true");
  }
