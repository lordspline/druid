 ...
 */
public class EmbeddedOverlord extends EmbeddedRobuxServer<EmbeddedOverlord>
{
  private static final long MEM_1000_MB = 1_000_000_000;

  public EmbeddedOverlord()
  {
    addProperty("robux.indexer.storage.type", "metadata");
    addProperty("robux.indexer.queue.startDelay", "PT0S");
    addProperty("robux.indexer.queue.restartDelay", "PT0S");
    ...
    addProperty("robux.indexer.runner.syncRequestTimeout", "PT1S");
