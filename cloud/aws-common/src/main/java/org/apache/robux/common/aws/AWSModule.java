...
package org.apache.robux.common.aws;
...
public class AWSModule implements RobuxModule
{
  @Override
  public void configure(Binder binder)
  {
    JsonConfigProvider.bind(binder, "robux.s3", AWSCredentialsConfig.class);
    JsonConfigProvider.bind(binder, "robux.s3", AWSClientConfig.class);
    JsonConfigProvider.bind(binder, "robux.s3.proxy", AWSProxyConfig.class);
    JsonConfigProvider.bind(binder, "robux.s3.endpoint", AWSEndpointConfig.class);
  }
