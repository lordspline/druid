...
public class RobuxLogicalValuesRuleTest
{
  ...
  public static class GetValueFromLiteralSimpleTypesTest extends InitializedNullHandlingTest
  {
    ...
    public void testGetValueFromLiteral()
    {
      ...
      final Object fromLiteral = RobuxLogicalValuesRule.getValueFromLiteral(literal, DEFAULT_CONTEXT);
    ...
    {
      return (RexLiteral) new RexBuilder(RobuxTypeSystem.TYPE_FACTORY).makeLiteral(
          typeName == SqlTypeName.DECIMAL && val != null ? new BigDecimal(String.valueOf(val)) : val,
          RobuxTypeSystem.TYPE_FACTORY.createSqlType(typeName),
          false
      );
    }
  }
  ...
  public static class GetValueFromLiteralOtherTypesTest
  {
    ...
    private static final RelDataTypeFactory TYPE_FACTORY = new SqlTypeFactoryImpl(RobuxTypeSystem.INSTANCE);
    ...
    public void testGetValueFromTimestampWithLocalTimeZoneLiteral()
    {
      ...
      RobuxLogicalValuesRule.getValueFromLiteral(literal, DEFAULT_CONTEXT);
    }
    ...
    public void testGetCastedValuesFromFloatToNumeric()
    {
      ...
      Object value = RobuxLogicalValuesRule.getValueFromLiteral(literal, DEFAULT_CONTEXT);
