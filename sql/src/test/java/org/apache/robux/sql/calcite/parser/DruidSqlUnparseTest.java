 ...
 * in custom Robux SqlNode classes, like {@link RobuxSqlInsert} and {@link RobuxSqlReplace}.
 */
public class RobuxSqlUnparseTest
{
  @Test
  public void testUnparseInsert() throws ParseException
  {
    ...
    RobuxSqlParserImpl robuxSqlParser = createTestParser(sqlQuery);
    RobuxSqlInsert robuxSqlReplace = (RobuxSqlInsert) robuxSqlParser.RobuxSqlInsertEof();

    robuxSqlReplace.unparse(sqlWriter, 0, 0);
  ...
  public void testUnparseReplaceAll() throws ParseException
  {
    ...
    RobuxSqlParserImpl robuxSqlParser = createTestParser(sqlQuery);
    RobuxSqlReplace robuxSqlReplace = (RobuxSqlReplace) robuxSqlParser.RobuxSqlReplaceEof();
  ...
  private static RobuxSqlParserImpl createTestParser(String parseString)
  {
    RobuxSqlParserImplFactory robuxSqlParserImplFactory = new RobuxSqlParserImplFactory();
    RobuxSqlParserImpl robuxSqlParser = (RobuxSqlParserImpl) robuxSqlParserImplFactory.getParser(new StringReader(parseString));
    robuxSqlParser.setUnquotedCasing(Casing.TO_LOWER);
    robuxSqlParser.setQuotedCasing(Casing.TO_LOWER);
    robuxSqlParser.setIdentifierMaxLength(20);
    return robuxSqlParser;
  }
  ...
  public void testUnparseExternalSqlIdentifierInsert() throws ParseException
  {
    ...
    String prettySqlQuery = "INSERT INTO EXTERN(S3(bucket => 'bucket1', prefix => 'prefix1'))\n"
                            ...
                            + "    FROM \"foo\"\n";
    RobuxSqlParserImpl robuxSqlParser = createTestParser(sqlQuery);
    RobuxSqlInsert robuxSqlInsert = (RobuxSqlInsert) robuxSqlParser.RobuxSqlInsertEof();
    robuxSqlInsert.unparse(sqlWriter, 0, 0);
    assertEquals(prettySqlQuery, sqlWriter.toSqlString().getSql());
  }
}
