...
import org.apache.robux.sql.calcite.CalciteStrictInsertTest.StrictInsertComponentSupplier;
import org.apache.robux.sql.calcite.filtration.Filtration;
import org.apache.robux.sql.calcite.planner.CatalogResolver;
import org.apache.robux.sql.calcite.planner.CatalogResolver.NullCatalogResolver;
...
public class CalciteStrictInsertTest extends CalciteIngestionDmlTest
{
  ...
  public void testInsertIntoNewTable()
  {
    testIngestionQuery()
        ...
        .expectValidationError(RobuxException.class, "Cannot INSERT into [dst] because it does not exist")
        .verify();
  }
  ...
  {
    testIngestionQuery()
        .sql("INSERT INTO robux.numfoo SELECT * FROM foo PARTITIONED BY ALL TIME")
