...
import org.apache.robux.sql.calcite.CalciteScanSignatureTest.ScanSignatureComponentSupplier;
...
public class CalciteScanSignatureTest extends BaseCalciteQueryTest
{
  ...
  public void testScanSignature()
  {
    ...
    context.put(RobuxQuery.CTX_SCAN_SIGNATURE, "[{\"name\":\"v0\",\"type\":\"STRING\"}]");
