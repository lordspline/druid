...
public class RobuxSqlParserUtilsTest
{
  /**
  ...
  public static class TimeFloorToGranularityConversionTest
  {
    ...
    public void testGranularityFromTimeFloor()
    {
      ...
      Granularity actualGranularity = RobuxSqlParserUtils.convertSqlNodeToGranularity(
          timeFloorCall);
  ...
  public static class FloorToGranularityConversionTest
  {
    ...
    public void testGetGranularityFromFloor()
    {
      ...
      Granularity actualGranularity = RobuxSqlParserUtils.convertSqlNodeToGranularity(floorCall);
      Assert.assertEquals(expectedGranularity, actualGranularity);
    }
    ...
    public void testConvertSqlNodeToGranularityAsLiteral()
    {
      ...
      Granularity actualGranularity = RobuxSqlParserUtils.convertSqlNodeToGranularity(sqlNode);
      Assert.assertEquals(expectedGranularity, actualGranularity);
    }
  ...
  public static class ResolveClusteredByColumnsTest
  {
    ...
    {
      Assert.assertNull(RobuxSqlParserUtils.resolveClusteredByColumnsToOutputColumns(null, null));
    }
    ...
    public void testNullClusteredBy()
    {
      ...
      Assert.assertNull(
          RobuxSqlParserUtils.resolveClusteredByColumnsToOutputColumns(
              null,
              fields
          )
      );
    ...
    public void testSimpledClusteredByWithNullSource()
    {
      ...
      Assert.assertEquals(
          ...
          RobuxSqlParserUtils.resolveClusteredByColumnsToOutputColumns(args, null)
      );
    }
    ...
    public void testSimpleClusteredBy()
    {
      ...
      Assert.assertEquals(
          ...
          RobuxSqlParserUtils.resolveClusteredByColumnsToOutputColumns(clusteredByArgs, sourceFieldMappings)
      );
    }
  ...
  public static class ClusteredByColumnsValidationTest
  {
    ...
    public void testEmptyClusteredByColumnsValid()
    {
      ...
      RobuxSqlParserUtils.validateClusteredByColumns(clusteredByArgs);
    }
    ...
    public void testClusteredByColumnsWithDescThrowsException()
    {
      ...
      RobuxExceptionMatcher
          ...
          .assertThrowsAndMatches(() -> RobuxSqlParserUtils.validateClusteredByColumns(clusteredByArgs));
    }
  ...
  public static class FloorToGranularityConversionErrorsTest
  {
    ...
    public void testConvertSqlNodeToGranularityWithIncorrectFunctionCall()
    {
      ...
      RobuxExceptionMatcher
          ...
          .assertThrowsAndMatches(() -> RobuxSqlParserUtils.convertSqlNodeToGranularity(sqlNode));
    }
  ...
  public static class NonParameterizedTests
  {
    ...
    public void test_parseTimeStampWithTimeZone_timestamp_utc()
    {
      ...
      final String s = RobuxSqlParserUtils.parseTimeStampWithTimeZone(
    ...
    public void test_parseTimeStampWithTimeZone_unknownTimestamp_invalid()
    {
      final RobuxException e = Assert.assertThrows(
          ...
          () -> RobuxSqlParserUtils.parseTimeStampWithTimeZone(
              SqlLiteral.createUnknown(
                  SqlTypeName.TIMESTAMP.getSpaceName(),
                  "not a timestamp",
                  SqlParserPos.ZERO
