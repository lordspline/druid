...
public class ExpressionsTest extends CalciteTestBase
{
  ...
  final RobuxOperatorTable operatorTable = new RobuxOperatorTable(Collections.emptySet(), Collections.emptySet());
  ...
  public void testConcat()
  {
    testHelper.testExpression(
        ...
        RobuxExpression.ofExpression(
            ColumnType.STRING,
            RobuxExpression.functionCall("concat"),
            ImmutableList.of(
                RobuxExpression.ofColumn(ColumnType.STRING, "s"),
                RobuxExpression.ofStringLiteral("bar")
            )
        ),
        "foobar"
    );
  ...
  public void testCharacterLength()
  {
    testHelper.testExpression(
        ...
        RobuxExpression.ofExpression(
            ColumnType.LONG,
            RobuxExpression.functionCall("strlen"),
            ImmutableList.of(
                RobuxExpression.ofColumn(ColumnType.STRING, "s")
            )
        ),
  ...
  public void testParseLong()
  {
    testHelper.testExpression(
        ...
        RobuxExpression.ofExpression(
            ColumnType.LONG,
            RobuxExpression.functionCall("parse_long"),
            ImmutableList.of(
                RobuxExpression.ofColumn(ColumnType.STRING, "intstr")
            )
        ),
        -100L
    );
    ...
    testHelper.testExpressionString(
        ...
        RobuxExpression.ofExpression(
            ...
            RobuxExpression.functionCall("parse_long"),
            ImmutableList.of(
                RobuxExpression.ofColumn(ColumnType.STRING, "hexstr"),
                RobuxExpression.ofLiteral(ColumnType.LONG, RobuxExpression.longLiteral(16))
            )
        ),
        239L
    );
        ...
        RobuxExpression.ofExpression(
            ...
            ImmutableList.of(
                RobuxExpression.ofExpression(
                    ...
                    RobuxExpression.functionCall("concat"),
                    ImmutableList.of(
                        RobuxExpression.ofStringLiteral("0x"),
                        RobuxExpression.ofColumn(ColumnType.STRING, "hexstr")
                    )
                ),
                RobuxExpression.ofLiteral(ColumnType.LONG, RobuxExpression.longLiteral(16))
  ...
  public void testFloor()
  {
    testHelper.testExpression(
        ...
        RobuxExpression.ofExpression(
            ColumnType.LONG,
            RobuxExpression.functionCall("floor"),
            ImmutableList.of(
                RobuxExpression.ofColumn(ColumnType.LONG, "a")
            )
        ),
        10.0
    );
    ...
    testHelper.testExpression(
        ...
        RobuxExpression.ofExpression(
            ...
            RobuxExpression.functionCall("floor"),
            ImmutableList.of(
                RobuxExpression.ofColumn(ColumnType.FLOAT, "x")
            )
        ),
        2.0
    );
    ...
    testHelper.testExpression(
        ...
        RobuxExpression.ofExpression(
            ...
            RobuxExpression.functionCall("floor"),
            ImmutableList.of(
                RobuxExpression.ofColumn(ColumnType.LONG, "y")
            )
        ),
        3.0
    );
    ...
    testHelper.testExpression(
        ...
        RobuxExpression.ofExpression(
            ...
            RobuxExpression.functionCall("floor"),
            ImmutableList.of(
                RobuxExpression.ofColumn(ColumnType.FLOAT, "z")
            )
        ),
        -3.0
    );
  ...
  public void testCeil()
  {
    testHelper.testExpression(
        ...
        RobuxExpression.ofExpression(
            ColumnType.LONG,
            RobuxExpression.functionCall("ceil"),
            ImmutableList.of(
                RobuxExpression.ofColumn(ColumnType.LONG, "a")
            )
        ),
  ...
  public void testTruncate()
  {
    ...
    testHelper.testExpressionString(
        ...
        RobuxExpression.ofExpression(
            ...
            ImmutableList.of(
                RobuxExpression.ofColumn(ColumnType.FLOAT, "x"),
                RobuxExpression.ofLiteral(ColumnType.LONG, RobuxExpression.longLiteral(1))
            )
        ),
        2.2
    );
    ...
    testHelper.testExpressionString(
        ...
        RobuxExpression.ofExpression(
            ...
            ImmutableList.of(
                RobuxExpression.ofColumn(ColumnType.LONG, "b"),
                RobuxExpression.ofLiteral(ColumnType.LONG, RobuxExpression.longLiteral(-1))
            )
        ),
        20.0
  ...
  public void testRound()
  {
    ...
    testHelper.testExpression(
        ...
        RobuxExpression.ofExpression(
            ColumnType.LONG,
            RobuxExpression.functionCall("round"),
            ImmutableList.of(
                RobuxExpression.ofColumn(ColumnType.LONG, "a")
            )
        ),
    ...
    Throwable t = Assert.assertThrows(
        ...
        () -> testHelper.testExpressionString(
            ...
            RobuxExpression.ofExpression(
                ...
                ImmutableList.of(
                    RobuxExpression.ofColumn(ColumnType.FLOAT, "x"),
                    RobuxExpression.ofStringLiteral("foo")
                )
            ),
            "IAE Exception"
        )
  ...
  public void testRoundWithNanShouldRoundTo0()
  {
    ...
    testHelper.testExpression(
        ...
        RobuxExpression.ofExpression(
            ...
            RobuxExpression.functionCall("round"),
            ImmutableList.of(
                RobuxExpression.ofColumn(ColumnType.DOUBLE, "nan")
            )
        ),
        0D
    );
    testHelper.testExpression(
        ...
        RobuxExpression.ofExpression(
            ...
            RobuxExpression.functionCall("round"),
            ImmutableList.of(
                RobuxExpression.ofColumn(ColumnType.FLOAT, "fnan")
            )
        ),
        0D
    );
  ...
  public void testRoundWithInfinityShouldRoundTo0()
  {
    ...
    testHelper.testExpression(
        ...
        RobuxExpression.ofExpression(
            ...
            RobuxExpression.functionCall("round"),
            ImmutableList.of(
                RobuxExpression.ofColumn(ColumnType.DOUBLE, "inf")
            )
        ),
        Double.MAX_VALUE
    );
    ...
    testHelper.testExpression(
        ...
        RobuxExpression.ofExpression(
            ...
            RobuxExpression.functionCall("round"),
            ImmutableList.of(
                RobuxExpression.ofColumn(ColumnType.FLOAT, "finf")
            )
        ),
        Double.MAX_VALUE
    );
  ...
  public void testTimeMinusDayTimeInterval()
  {
    ...
    testHelper.testExpression(
        ...
        RobuxExpression.ofExpression(
            ...
            ImmutableList.of(
                RobuxExpression.ofColumn(ColumnType.LONG, "t"),
                RobuxExpression.ofLiteral(ColumnType.LONG, "90060000")
            )
        ),
  ...
  public void testTimeMinusYearMonthInterval()
  {
    ...
    testHelper.testExpression(
        ...
        RobuxExpression.ofExpression(
            ColumnType.LONG,
            RobuxExpression.functionCall("timestamp_shift"),
            ImmutableList.of(
                RobuxExpression.ofColumn(ColumnType.LONG, "t"),
                RobuxExpression.ofLiteral(ColumnType.STRING, RobuxExpression.stringLiteral("P13M")),
                RobuxExpression.ofLiteral(ColumnType.LONG, RobuxExpression.longLiteral(-1)),
                RobuxExpression.ofStringLiteral("UTC")
            )
        ),
        DateTimes.of("2000-02-03T04:05:06").minus(period).getMillis()
    );
  ...
  public void testCastAsTimestamp()
  {
    ...
    testHelper.testExpression(
        ...
        RobuxExpression.ofExpression(
            ColumnType.LONG,
            RobuxExpression.functionCall("timestamp_parse"),
            ImmutableList.of(
                RobuxExpression.ofColumn(ColumnType.STRING, "tstr"),
  ...
  public void testCastFromTimestamp()
  {
    testHelper.testExpression(
        ...
        RobuxExpression.ofExpression(
            ColumnType.STRING,
            RobuxExpression.functionCall("timestamp_format"),
            ImmutableList.of(
                RobuxExpression.ofColumn(ColumnType.LONG, "t"),
                RobuxExpression.ofStringLiteral("yyyy-MM-dd HH:mm:ss"),
                RobuxExpression.ofStringLiteral("UTC")
            )
        ),
        "2000-02-03 04:05:06"
    ...
    testHelper.testExpression(
        ...
        RobuxExpression.ofColumn(ColumnType.LONG, "t", SimpleExtraction.of("t", null)),
        DateTimes.of("2000-02-03T04:05:06").getMillis()
    );
  }
  ...
  public void testCastAsDate()
  {
    testHelper.testExpression(
        ...
        RobuxExpression.ofExpression(
            ColumnType.LONG,
            RobuxExpression.functionCall("timestamp_floor"),
            ImmutableList.of(
                RobuxExpression.ofColumn(ColumnType.LONG, "t"),
                RobuxExpression.ofStringLiteral("P1D"),
                RobuxExpression.ofLiteral(ColumnType.LONG, RobuxExpression.nullLiteral()),
                RobuxExpression.ofStringLiteral("UTC")
            )
        ),
        ...
        RobuxExpression.ofExpression(
            ...
            ImmutableList.of(
                RobuxExpression.ofExpression(
                    ...
                    RobuxExpression.functionCall("timestamp_parse"),
                    ImmutableList.of(
                        RobuxExpression.ofColumn(ColumnType.STRING, "dstr"),
                        RobuxExpression.ofLiteral(null, RobuxExpression.nullLiteral()),
                        RobuxExpression.ofStringLiteral("UTC")
                    )
                ),
    ...
    testHelper.testExpression(
        ...
        RobuxExpression.ofExpression(
            ...
            ImmutableList.of(
                ...
                RobuxExpression.ofStringLiteral("yyyy-MM-dd"),
                RobuxExpression.ofStringLiteral("UTC")
            )
        ),
        "2000-02-03"
  ...
  public void testReverse()
  {
    testHelper.testExpression(
        ...
        RobuxExpression.ofExpression(
            ColumnType.STRING,
            RobuxExpression.functionCall("reverse"),
            ImmutableList.of(
                RobuxExpression.ofColumn(ColumnType.STRING, "s")
            )
        ),
    ...
    testHelper.testExpression(
        ...
        RobuxExpression.ofExpression(
            ...
            RobuxExpression.functionCall("reverse"),
            ImmutableList.of(
                RobuxExpression.ofColumn(ColumnType.STRING, "spacey")
            )
        ),
        "  ereht yeh  "
    );
  ...
  @Test
  public void testOperatorConversionsRobuxUnaryLongFn()
  {
    testHelper.testExpressionString(
        OperatorConversions.robuxUnaryLongFn("BITWISE_COMPLEMENT", "bitwiseComplement").calciteOperator(),
        ImmutableList.of(
            testHelper.makeInputRef("a")
        ),
  ...
  @Test
  public void testOperatorConversionsRobuxUnaryDoubleFn()
  {
    testHelper.testExpressionString(
        OperatorConversions.robuxUnaryDoubleFn("BITWISE_CONVERT_LONG_BITS_TO_DOUBLE", "bitwiseConvertLongBitsToDouble")
                           .calciteOperator(),
        ImmutableList.of(
            testHelper.makeInputRef("a")
        ),
  ...
  @Test
  public void testOperatorConversionsRobuxBinaryLongFn()
  {
    testHelper.testExpressionString(
        OperatorConversions.robuxBinaryLongFn("BITWISE_AND", "bitwiseAnd").calciteOperator(),
        ImmutableList.of(
            testHelper.makeInputRef("a"),
            testHelper.makeInputRef("b")
        ),
  ...
  {
    final RexBuilder rexBuilder = new RexBuilder(RobuxTypeSystem.TYPE_FACTORY);
  ...
  @Test
  public void testCalciteLiteralToRobuxLiteral()
  {
    final RexBuilder rexBuilder = new RexBuilder(RobuxTypeSystem.TYPE_FACTORY);
    final PlannerContext plannerContext = Mockito.mock(PlannerContext.class);
    Mockito.when(plannerContext.getTimeZone()).thenReturn(DateTimeZone.UTC);
    ...
    assertRobuxLiteral(
        new RobuxLiteral(ExpressionType.STRING, null),
        Expressions.calciteLiteralToRobuxLiteral(
            plannerContext,
    ...
    assertRobuxLiteral(
        new RobuxLiteral(ExpressionType.STRING, ""),
        Expressions.calciteLiteralToRobuxLiteral(
            plannerContext,
    ...
    assertRobuxLiteral(
        new RobuxLiteral(ExpressionType.LONG, null),
        Expressions.calciteLiteralToRobuxLiteral(
            plannerContext,
    ...
    assertRobuxLiteral(
        new RobuxLiteral(ExpressionType.STRING, "abc"),
        Expressions.calciteLiteralToRobuxLiteral(plannerContext, rexBuilder.makeLiteral("abc"))
    );

    assertRobuxLiteral(
        new RobuxLiteral(ExpressionType.LONG, 1L),
        Expressions.calciteLiteralToRobuxLiteral(plannerContext, rexBuilder.makeLiteral(true))
    );

    assertRobuxLiteral(
        new RobuxLiteral(ExpressionType.LONG, 123L),
        Expressions.calciteLiteralToRobuxLiteral(
            plannerContext,
    ...
    assertRobuxLiteral(
        new RobuxLiteral(ExpressionType.DOUBLE, 123.0),
        Expressions.calciteLiteralToRobuxLiteral(
            plannerContext,
            rexBuilder.makeExactLiteral(
                BigDecimal.valueOf(123L),
    ...
    assertRobuxLiteral(
        new RobuxLiteral(ExpressionType.LONG, DateTimes.of("2000").getMillis()),
        Expressions.calciteLiteralToRobuxLiteral(
            plannerContext,
    ...
    assertRobuxLiteral(
        new RobuxLiteral(ExpressionType.LONG, 3L),
        Expressions.calciteLiteralToRobuxLiteral(
            plannerContext,
    ...
    assertRobuxLiteral(
        new RobuxLiteral(ExpressionType.LONG, 3),
        Expressions.calciteLiteralToRobuxLiteral(
            plannerContext,
            rexBuilder.makeIntervalLiteral(
                BigDecimal.valueOf(3),
    ...
    assertRobuxLiteral(
        new RobuxLiteral(ExpressionType.STRING, "123"),
        Expressions.calciteLiteralToRobuxLiteral(
            plannerContext,
            rexBuilder.makeCast(
  ...
  private void assertRobuxLiteral(
      final RobuxLiteral expected,
      final RobuxLiteral actual
  )
  {
    Assert.assertEquals(
