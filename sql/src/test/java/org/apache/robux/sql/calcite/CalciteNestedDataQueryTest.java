...
import org.apache.robux.query.NestedDataTestUtils;
...
import org.apache.robux.segment.AutoTypeColumnSchema;
...
import org.apache.robux.segment.nested.NestedPathField;
import org.apache.robux.segment.virtual.ExpressionVirtualColumn;
import org.apache.robux.segment.virtual.NestedFieldVirtualColumn;
...
import org.apache.robux.sql.calcite.CalciteNestedDataQueryTest.NestedComponentSupplier;
...
public class CalciteNestedDataQueryTest extends BaseCalciteQueryTest
{
  ...
  public void testTopNPath()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.x'), "
        + "SUM(cnt) "
        + "FROM robux.nested GROUP BY 1 LIMIT 10",
  ...
  public void testGroupByOnNestedColumn()
  {
    cannotVectorize();
    testQuery(
        "SELECT nester, SUM(strlen(string)) FROM robux.nested GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByOnNestedColumnWithOrderByAndLimit()
  {
    cannotVectorize();
    testQuery(
        "SELECT nester, SUM(strlen(string)) FROM robux.nested GROUP BY 1 ORDER BY 1 LIMIT 100",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByOnNestedColumnWithOrderByAndLimit2()
  {
    cannotVectorize();
    testQuery(
        "SELECT nester, SUM(strlen(string)) FROM robux.nested GROUP BY 1 ORDER BY 1 LIMIT 2",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByOnNestedColumnWithLimit()
  {
    cannotVectorize();
    testQuery(
        "SELECT nester, SUM(strlen(string)) FROM robux.nested GROUP BY 1 LIMIT 100",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByOnNestedColumnWithLimit2()
  {
    cannotVectorize();
    testQuery(
        "SELECT nester, SUM(strlen(string)) FROM robux.nested GROUP BY 1 LIMIT 2",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByRootSingleTypeLongMixed1()
  {
    testQuery(
        ...
        + "long, "
        + "SUM(cnt) "
        + "FROM robux.nested_mix GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
  ...
  public void testGroupByRootSingleTypeLongMixed2()
  {
    testQuery(
        ...
        + "long, "
        + "SUM(cnt) "
        + "FROM robux.nested_mix_2 GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
  ...
  {
    testBuilder()
        .sql("SELECT longs FROM robux.arrays, UNNEST(arrayLongNulls) as u(longs)")
        .queryContext(QUERY_CONTEXT_NO_STRINGIFY_ARRAY)
        .expectedQueries(
            ImmutableList.of(
                Robuxs.newScanQueryBuilder()
  ...
  {
    testBuilder()
        .sql("SELECT strings FROM robux.arrays, UNNEST(arrayStringNulls) as u(strings)")
        .queryContext(QUERY_CONTEXT_NO_STRINGIFY_ARRAY)
        .expectedQueries(
            ImmutableList.of(
                Robuxs.newScanQueryBuilder()
  ...
  {
    testBuilder()
        .sql("SELECT doubles FROM robux.arrays, UNNEST(arrayDoubleNulls) as u(doubles)")
        .queryContext(QUERY_CONTEXT_NO_STRINGIFY_ARRAY)
        .expectedQueries(
            ImmutableList.of(
                Robuxs.newScanQueryBuilder()
  ...
  public void testGroupByRootSingleTypeArrayLongFilteredArrayEquality()
  {
    ...
    testBuilder()
        .sql(
            ...
            + "arrayLong, "
            + "SUM(cnt) "
            + "FROM robux.arrays WHERE arrayLong = ARRAY[1, 2, 3] GROUP BY 1"
        )
  ...
  public void testGroupByRootSingleTypeLongJsonValueFilter()
  {
    testQuery(
        ...
        + "long, "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(long, '$.') = '1' GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByRootSingleTypeArrayLongNullsFilteredArrayEquality()
  {
    ...
    testBuilder()
        .sql(
            ...
            + "arrayLongNulls, "
            + "SUM(cnt) "
            + "FROM robux.arrays WHERE arrayLongNulls = ARRAY[null, 2, 9] OR arrayLongNulls IS NULL GROUP BY 1"
        )
        .queryContext(QUERY_CONTEXT_NO_STRINGIFY_ARRAY)
        .expectedQueries(
            ImmutableList.of(
  ...
  public void testGroupByRootSingleTypeArrayLongNullsUnnest()
  {
    ...
    testBuilder()
        .sql(
            ...
            + "longs, "
            + "SUM(cnt) "
            + "FROM robux.arrays, UNNEST(arrayLongNulls) as u (longs) GROUP BY 1"
        )
        .queryContext(QUERY_CONTEXT_NO_STRINGIFY_ARRAY)
        .expectedQuery(
            GroupByQuery.builder()
  ...
  public void testGroupByRootSingleTypeArrayLongNullsFilteredMore()
  {
    ...
    testBuilder()
        .sql(
            ...
            + "arrayLongNulls, "
            + "SUM(cnt) "
            + "FROM robux.arrays WHERE ARRAY_CONTAINS(arrayLongNulls, 1) OR ARRAY_OVERLAP(arrayLongNulls, ARRAY[2, 3]) GROUP BY 1"
        )
        .queryContext(QUERY_CONTEXT_NO_STRINGIFY_ARRAY)
        .expectedQueries(
            ImmutableList.of(
  ...
  public void testGroupByRootSingleTypeArrayStringNullsUnnest()
  {
    ...
    testBuilder()
        .sql(
            ...
            + "strings, "
            + "SUM(cnt) "
            + "FROM robux.arrays, unnest(arrayStringNulls) as u (strings) GROUP BY 1"
        )
        .queryContext(QUERY_CONTEXT_NO_STRINGIFY_ARRAY)
        .expectedQueries(
            ImmutableList.of(
  ...
  public void testGroupByRootSingleTypeArrayDoubleNullsUnnest()
  {
    ...
    testBuilder()
        .sql(
            ...
            + "doubles, "
            + "SUM(cnt) "
            + "FROM robux.arrays, UNNEST(arrayDoubleNulls) as u (doubles) GROUP BY doubles"
        )
        .queryContext(QUERY_CONTEXT_NO_STRINGIFY_ARRAY)
        .expectedQueries(
            ImmutableList.of(
  ...
  public void testGroupByJsonValues()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$[''x'']'), "
        + "SUM(cnt) "
        + "FROM robux.nested GROUP BY 1, 2",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathSelectorFilter()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.x'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nest, '$.x') = '100' GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathSelectorFilterCoalesce()
  {
    ...
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.x'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE COALESCE(JSON_VALUE(nest, '$.x'), '0') = '100' GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathSelectorFilterDouble()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.x'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nest, '$.y') = 2.02 GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathSelectorFilterString()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.x'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nest, '$.z') = '400' GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathSelectorFilterVariant()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.x'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nester, '$.n.x') = 1 GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathSelectorFilterVariant2()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.x'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nest, '$.mixed2') = '1' GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathSelectorFilterVariant2Double()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.x'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nest, '$.mixed2') = 1.1 GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathSelectorFilterVariant2BothTypesMatcher()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.x'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nest, '$.mixed2') = '1' OR JSON_VALUE(nest, '$.mixed2') = 1 GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathSelectorFilterVariant3()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.x'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nest, '$.mixed2') in ('1', '1.1') GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathSelectorFilterNonExistent()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.x'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nest, '$.missing') = 'no way' GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathSelectorFilterNull()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.x'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nest, '$.z') IS NOT NULL GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathBoundFilterLong()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.x'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nest, '$.x') >= '100' AND JSON_VALUE(nest, '$.x') <= '300' GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathNumericBoundFilterLongNoUpperNumeric()
  {
    testQuery(
        ...
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nest, '$.x' RETURNING BIGINT) >= 100 GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathBoundFilterDouble()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.y'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nest, '$.y') >= '1.01' AND JSON_VALUE(nest, '$.y') <= '3.03' GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathBoundFilterDoubleNoUpper()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.y'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nest, '$.y') >= '1.01' GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathBoundDoubleFilterNumeric()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.y'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nest, '$.y') >= 2.0 AND JSON_VALUE(nest, '$.y') <= 3.5 GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathBoundFilterDoubleNoUpperNumeric()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.y'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nest, '$.y') >= 1.0 GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathLikeFilter()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.x'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nest, '$.x') LIKE '10%' GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathLikeFilterStringPrefix()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.x'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nest, '$.z') LIKE '30%' GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathLikeFilterString()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.x'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nest, '$.z') LIKE '%00%' GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathLikeFilterVariant()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.x'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nester, '$.n.x') LIKE '%ell%' GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathInFilter()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.x'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nest, '$.x') in (100, 200) GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathInFilterDouble()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.x'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nest, '$.y') in (2.02, 3.03) GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathInFilterString()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.x'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nest, '$.z') in ('300', 'abcdef') GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathInFilterVariant()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.x'), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nester, '$.n.x') in ('hello', 1) GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT JSON_VALUE(nester, '$.array[-1]'), JSON_QUERY(nester, '$.array[-1]'), JSON_KEYS(nester, '$.array[-1]') FROM robux.nested",
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(DATA_SOURCE)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathSelectorFilterVariantNull()
  {
    testQuery(
        ...
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nester, '$.n.x' RETURNING BIGINT) IS NULL GROUP BY 1, 2",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testSelectPathSelectorFilterVariantNull()
  {
    testQuery(
        ...
        + "JSON_VALUE(nest, '$.x'), "
        + "JSON_VALUE(nester, '$.n.x' RETURNING BIGINT) "
        + "FROM robux.nested WHERE JSON_VALUE(nester, '$.n.x' RETURNING BIGINT) IS NULL",
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(DATA_SOURCE)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByPathSelectorFilterVariantNotNull()
  {
    testQuery(
        ...
        + "JSON_VALUE(nester, '$.n.x' RETURNING BIGINT), "
        + "SUM(cnt) "
        + "FROM robux.nested WHERE JSON_VALUE(nester, '$.n.x' RETURNING BIGINT) IS NOT NULL GROUP BY 1, 2",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByRegularLongLongMixed1FilterNotNull()
  {
    testQuery(
        ...
        + "SUM(cnt) "
        + "FROM robux.nested_mix WHERE JSON_VALUE(long, '$' RETURNING BIGINT) IS NOT NULL GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE_MIXED)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByRootSingleTypeStringMixed1SparseNotNull()
  {
    testQuery(
        ...
        + "SUM(cnt) "
        + "FROM robux.nested_mix_2 WHERE JSON_VALUE(string_sparse, '$' RETURNING BIGINT) IS NOT NULL GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE_MIXED_2)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    RobuxException e = Assertions.assertThrows(RobuxException.class, () -> {
      testQuery(
  ...
  public void testScanStringNotNullCast()
  {
    ...
    testQuery(
        ...
        + "FROM robux.nested_mix WHERE CAST(string_sparse as BIGINT) IS NOT NULL",
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(DATA_SOURCE_MIXED)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByRootSingleTypeStringMixed1SparseNotNullCast2()
  {
    testQuery(
        ...
        + "CAST(string_sparse as BIGINT), "
        + "SUM(cnt) "
        + "FROM robux.nested_mix WHERE CAST(string_sparse as BIGINT) IS NOT NULL GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE_MIXED)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByRootSingleTypeArrayLongNullsAsMvdFilteredMore()
  {
    ...
    testBuilder()
        .sql(
            ...
            + "ARRAY_TO_MV(arrayLongNulls), "
            + "SUM(cnt) "
            + "FROM robux.arrays WHERE MV_CONTAINS(ARRAY_TO_MV(arrayLongNulls), '1') OR MV_OVERLAP(ARRAY_TO_MV(arrayLongNulls), ARRAY['2', '3']) GROUP BY 1"
        )
        .queryContext(QUERY_CONTEXT_NO_STRINGIFY_ARRAY)
        .expectedQueries(
            ImmutableList.of(
  ...
  public void testGroupByAndFilterVariant()
  {
    testQuery(
        ...
        + "variant, "
        + "SUM(cnt) "
        + "FROM robux.all_auto WHERE variant = '1' GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
  ...
  public void testFilterJsonIsNotNull()
  {
    testQuery(
        "SELECT nest\n"
        + "FROM robux.nested WHERE nest IS NOT NULL",
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(DATA_SOURCE)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testFilterJsonIsNull()
  {
    testQuery(
        "SELECT nest, nester\n"
        + "FROM robux.nested WHERE nest IS NULL",
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(DATA_SOURCE)
                  .intervals(querySegmentSpec(Filtration.eternity()))
    ...
    testBuilder()
        .sql(
            "select c,long,coalesce(c,long) as col "
                + " from robux.all_auto, unnest(json_value(arrayNestedLong, '$[1]' returning bigint array)) as u(c) "
        )
        .expectedQueries(
            ImmutableList.of(
                Robuxs.newScanQueryBuilder()
  ...
  public void testJsonQueryArrays()
  {
    msqIncompatible();
    testBuilder()
        .sql("SELECT JSON_QUERY_ARRAY(arrayObject, '$') FROM robux.arrays")
  ...
  public void testJsonQueryArrayNullArray()
  {
    ...
    msqIncompatible();
    testBuilder()
        .sql("SELECT JSON_QUERY_ARRAY(arrayObject, '$.') FROM robux.arrays where arrayObject is null limit 1")
        .queryContext(QUERY_CONTEXT_DEFAULT)
        .expectedQueries(
            ImmutableList.of(
                Robuxs.newScanQueryBuilder()
  ...
  {
    testBuilder()
        .sql("SELECT objects FROM robux.arrays, UNNEST(JSON_QUERY_ARRAY(arrayObject, '$')) as u(objects)")
        .queryContext(QUERY_CONTEXT_NO_STRINGIFY_ARRAY)
        .expectedQueries(
            ImmutableList.of(
                Robuxs.newScanQueryBuilder()
  ...
  public void testUnnestJsonQueryArraysJsonValue()
  {
    ...
    testBuilder()
        .sql(
            ...
            + " count(*)"
            + " FROM robux.arrays, UNNEST(JSON_QUERY_ARRAY(arrayObject, '$')) as u(objects)"
            + " GROUP BY 1"
        )
        .queryContext(QUERY_CONTEXT_NO_STRINGIFY_ARRAY)
        .expectedQueries(
  ...
  public void testJsonValueNestedEmptyArray()
  {
    skipVectorize();
    testBuilder()
        .sql("SELECT json_value(cObj, '$.z.d') FROM robux.all_auto")
        .queryContext(QUERY_CONTEXT_NO_STRINGIFY_ARRAY)
        .expectedQueries(
            ImmutableList.of(
                Robuxs.newScanQueryBuilder()
  ...
  public void testJsonValueNestedEmptyArrayReturning()
  {
    skipVectorize();
    testBuilder()
        .sql("SELECT json_value(cObj, '$.z.d' returning varchar array) FROM robux.all_auto")
        .queryContext(QUERY_CONTEXT_NO_STRINGIFY_ARRAY)
        .expectedQueries(
            ImmutableList.of(
                Robuxs.newScanQueryBuilder()
  ...
  public void testApproxCountDistinctOnUnsupportedComplexColumn()
  {
    assertQueryIsUnplannable(
        "SELECT COUNT(DISTINCT nester) FROM robux.nested",
  ...
  {
    RobuxException robuxException = Assert.assertThrows(
        RobuxException.class,
        () -> testQuery(
            "SELECT APPROX_COUNT_DISTINCT(nester) FROM robux.nested",
            ImmutableList.of(),
            ImmutableList.of()
        )
    );
    Assert.assertTrue(robuxException.getMessage().contains(
  ...
  public void testGroupByAutoString()
  {
    ...
    testQuery(
        ...
        + "str, "
        + "SUM(cnt) "
        + "FROM robux.all_auto GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE_ALL)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
    ...
    testQuery(
        ...
        + "str, "
        + "SUM(cnt) "
        + "FROM robux.all_auto_realtime GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
  ...
  public void testToJsonString()
  {
    cannotVectorizeUnlessFallback();
    testQuery(
        "SELECT TO_JSON_STRING(nester) FROM robux.nested GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(DATA_SOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
