...
public class NamedRobuxSchemaTest extends CalciteTestBase
{
  ...
  private NamedRobuxSchema target;

  @BeforeEach
  public void setUp()
  {
    target = new NamedRobuxSchema(robuxSchema, SCHEMA_NAME);
  }
  ...
  {
    Assert.assertEquals(robuxSchema, target.getSchema());
  }
}
