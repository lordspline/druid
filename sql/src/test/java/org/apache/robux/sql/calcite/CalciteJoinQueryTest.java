...
import org.apache.robux.sql.calcite.SqlTestFrameworkConfig.MinTopNThreshold;
...
public class CalciteJoinQueryTest extends BaseCalciteQueryTest
{
                            ...
                            newScanQueryBuilder()
                                .dataSource(
                                    join(
                                        ...
                                        "j0.",
                                        equalsCondition(
                                            RobuxExpression.ofColumn(ColumnType.FLOAT, "m1"),
                                            RobuxExpression.ofColumn(ColumnType.FLOAT, "j0.m1")
                                        ),
                                        JoinType.INNER
                                    )
                                )
  ...
  public void testTimeColumnAggregationsOnLookups(Map<String, Object> queryContext)
  {
    try {
      ...
      assertThat(
          e,
          new RobuxExceptionMatcher(RobuxException.Persona.ADMIN, RobuxException.Category.INVALID_INPUT, "general")
              .expectMessageIs(
  ...
  {
    // Regression test for https://github.com/apache/robux/issues/9646.
                  ...
                  .dataSource(
                      join(
                          join(
                              ...
                              equalsCondition(
                                  RobuxExpression.ofColumn(ColumnType.FLOAT, "m1"),
                                  RobuxExpression.ofColumn(ColumnType.FLOAT, "j0.v0")
                              ),
                              JoinType.INNER
                          ),
                          new LookupDataSource("lookyloo"),
                  ...
                  .dataSource(
                      join(
                          ...
                          equalsCondition(
                              ...
                              RobuxExpression.ofColumn(ColumnType.DOUBLE, "_j0.m1")
                          ),
                          JoinType.INNER
                      )
                  )
  ...
  public void testInnerJoinLookupTableTable(Map<String, Object> queryContext)
  {
    ...
    testQuery(
        ...
        + "INNER JOIN robux.foo f on f.dim1 = l.k\n"
        + "INNER JOIN robux.numfoo nf on nf.dim1 = l.k\n"
  ...
  public void testInnerJoinLookupTableTableChained(Map<String, Object> queryContext)
  {
    ...
    testQuery(
        ...
        + "FROM lookup.lookyloo l\n"
        + "INNER JOIN robux.foo f on f.dim1 = l.k\n"
        + "INNER JOIN robux.numfoo nf on nf.dim1 = f.dim1\n"
        + "GROUP BY 1, 2 ORDER BY 2",
        queryContext,
        ImmutableList.of(
            GroupByQuery.builder()
  ...
  // Unfortunately, we have disabled pushing down predicates (conditions and filters) due to https://github.com/apache/robux/pull/9773
            ...
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(
                      join(
                          ...
                          "_j0.",
                          equalsCondition(
                              RobuxExpression.fromExpression("CAST(\"j0.k\", 'LONG')"),
                              RobuxExpression.ofColumn(ColumnType.LONG, "_j0.cnt")
                          ),
                          JoinType.INNER
                      )
                  )
                  ...
                  .dataSource(
                      join(
                          join(
                              ...
                              "j0.",
                              equalsCondition(
                                  RobuxExpression.ofColumn(ColumnType.LONG, "cnt"),
                                  RobuxExpression.ofColumn(ColumnType.LONG, "j0.v0")
                              ),
                              JoinType.INNER
                          ),
                          new QueryDataSource(
  ...
  public void testInAggregationSubquery(Map<String, Object> queryContext)
  {
    ...
    testQuery(
        "SELECT DISTINCT __time FROM robux.foo WHERE __time IN (SELECT MAX(__time) FROM robux.foo)",
        updatedQueryContext,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(
                            join(
                                new TableDataSource(CalciteTests.DATASOURCE1),
                                new QueryDataSource(
                                    Robuxs.newTimeBoundaryQueryBuilder()
                                          .dataSource(CalciteTests.DATASOURCE1)
                                          .intervals(querySegmentSpec(Filtration.eternity()))
                                ...
                                "j0.",
                                equalsCondition(
                                    RobuxExpression.ofColumn(ColumnType.LONG, "__time"),
                                    RobuxExpression.ofColumn(ColumnType.LONG, "j0.a0")
                                ),
                                JoinType.INNER
                            )
                        )
  ...
  public void testNotInAggregationSubquery(Map<String, Object> queryContext)
  {
    ...
    maxTimeQueryContext.put(TimeBoundaryQuery.MAX_TIME_ARRAY_OUTPUT_NAME, "a0");
    testQuery(
        "SELECT DISTINCT __time FROM robux.foo WHERE __time NOT IN (SELECT MAX(__time) FROM robux.foo)",
        updatedQueryContext,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(
  ...
  public void testUsingSubqueryWithExtractionFns(Map<String, Object> queryContext)
  {
    ...
    testQuery(
        "SELECT dim2, COUNT(*) FROM robux.foo "
        + "WHERE substring(dim2, 1, 1) IN (SELECT substring(dim1, 1, 1) FROM robux.foo WHERE dim1 <> '')"
        + "group by dim2",
        queryContext,
        ImmutableList.of(
            GroupByQuery.builder()
  ...
  {
    testQuery(
        "SELECT dim1, l.v from robux.foo f inner join lookup.lookyloo l on f.dim1 = l.k where f.dim2 is null",
        queryContext,
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(
  ...
  @MethodSource("provideQueryContexts")
  @ParameterizedTest(name = "{0}")
  @Disabled // regression test for https://github.com/apache/robux/issues/9924
  public void testInnerJoinOnMultiValueColumn(Map<String, Object> queryContext)
  {
    cannotVectorize();
    testQuery(
        "SELECT dim3, l.v, count(*) from robux.foo f inner join lookup.lookyloo l on f.dim3 = l.k "
        + "group by 1, 2",
        queryContext,
        ImmutableList.of(
            GroupByQuery.builder()
  ...
  {
    Robuxs.ScanQueryBuilder baseScanBuilder = newScanQueryBuilder()
        .dataSource(
            join(
                new QueryDataSource(
                    newScanQueryBuilder()
  ...
  // (see issue https://github.com/apache/robux/issues/9942 for more information)
  // TODO: Remove expected Exception when https://github.com/apache/robux/issues/9942 is fixed
  @MethodSource("provideQueryContexts")
  @ParameterizedTest(name = "{0}")
  ...
  {
    testQuery(
        "SELECT dim1, EXTRACT(MONTH FROM __time) FROM robux.foo\n"
        + " WHERE dim2 IN (\n"
        + "   SELECT dim2\n"
        + "   FROM robux.foo\n"
        + "   WHERE dim1 = 'def'\n"
  ...
  public void testSemiJoinWithOuterTimeExtractAggregateWithOrderBy()
  {
    ...
    testQuery(
        "SELECT COUNT(DISTINCT dim1), EXTRACT(MONTH FROM __time) FROM robux.foo\n"
        + " WHERE dim2 IN (\n"
        + "   SELECT dim2\n"
        + "   FROM robux.foo\n"
        + "   WHERE dim1 = 'def'\n"
  ...
  // (see issue https://github.com/apache/robux/issues/9924 for more information)
  // TODO: Remove expected Exception when https://github.com/apache/robux/issues/9924 is fixed
  @MethodSource("provideQueryContexts")
  @ParameterizedTest(name = "{0}")
  public void testJoinOnMultiValuedColumnShouldThrowException(Map<String, Object> queryContext)
  {
    ...
    assertThrows(QueryException.class, () -> {
      final String query = "SELECT dim3, l.v from robux.foo f inner join lookup.lookyloo l on f.dim3 = l.k\n";
  ...
  @MethodSource("provideQueryContexts")
  @ParameterizedTest(name = "{0}")
  @Disabled("Stopped working after the ability to join on subqueries was added to RobuxJoinRule")
  ...
  public void testUsingSubqueryAsPartOfAndFilter(Map<String, Object> queryContext)
  {
    ...
    testQuery(
        "SELECT dim1, dim2, COUNT(*) FROM robux.foo\n"
        + "WHERE dim2 IN (SELECT dim1 FROM robux.foo WHERE dim1 <> '')\n"
        + "AND dim1 <> 'xxx'\n"
  ...
  public void testUsingSubqueryAsPartOfOrFilter(Map<String, Object> queryContext)
  {
    ...
    testQuery(
        "SELECT dim1, dim2, COUNT(*) FROM robux.foo\n"
        + "WHERE dim1 = 'xxx' OR dim2 IN (SELECT dim1 FROM robux.foo WHERE dim1 LIKE '%bc')\n"
        + "group by dim1, dim2 ORDER BY dim2",
        queryContext,
        ImmutableList.of(
            GroupByQuery.builder()
  ...
  public void testNestedGroupByOnInlineDataSourceWithFilter(Map<String, Object> queryContext)
  {
    ...
    testQuery(
        "with abc as"
        + "("
        + "  SELECT dim1, m2 from robux.foo where \"__time\" >= '2001-01-02'"
        + ")"
        + ", def as"
        + "("
  ...
  {
    String sql = "SELECT robux.restrictedBroadcastDatasource_m1_is_6.dim4, COUNT(*)\n"
                 + "FROM robux.numfoo\n"
                 + "INNER JOIN robux.restrictedBroadcastDatasource_m1_is_6 ON numfoo.dim4 = restrictedBroadcastDatasource_m1_is_6.dim4\n"
  ...
  public void testVirtualColumnOnMVFilterJoinExpression(Map<String, Object> queryContext)
  {
    ...
    testQuery(
        "SELECT foo1.dim3, foo2.dim3 FROM robux.numfoo as foo1 INNER JOIN robux.numfoo as foo2 "
  ...
  public void testVirtualColumnOnMVFilterMultiJoinExpression(Map<String, Object> queryContext)
  {
    ...
    testQuery(
        "SELECT foo1.dim3, foo2.dim3 FROM robux.numfoo as foo1 INNER JOIN "
        + "(SELECT foo3.dim3 FROM robux.numfoo as foo3 INNER JOIN robux.numfoo as foo4 "
  ...
  public void testJoinWithAliasAndOrderByNoGroupBy()
  {
    ...
    context.put(PlannerConfig.CTX_KEY_USE_APPROXIMATE_TOPN, false);
    testQuery(
        "select t1.__time from robux.foo as t1 join\n"
        + "  robux.numfoo as t2 on t1.dim2 = t2.dim2\n"
  ...
  public void testJoinWithInputRefCondition()
  {
    ...
    Query<?> expectedQuery = Robuxs.newTimeseriesQueryBuilder()
                                   .dataSource(
                                       join(
                                           join(
