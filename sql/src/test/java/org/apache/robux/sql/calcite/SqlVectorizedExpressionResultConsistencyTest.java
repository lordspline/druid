...
public class SqlVectorizedExpressionResultConsistencyTest extends InitializedNullHandlingTest
{
  ...
  public static void testQuery(SqlEngine engine, PlannerFactory plannerFactory, String query)
  {
    ...
    try (
        final RobuxPlanner vectorPlanner = plannerFactory.createPlannerForTesting(engine, query, vector);
        final RobuxPlanner nonVectorPlanner = plannerFactory.createPlannerForTesting(engine, query, nonvector)
    ) {
