...
public class RobuxSchemaNoDataInitTest extends CalciteTestBase
{
  ...
  public void testInitializationWithNoData() throws Exception
  {
    try (final Closer closer = Closer.create()) {
      ...
      final RobuxSchema robuxSchema = new RobuxSchema(cache, null, CatalogResolver.NULL_RESOLVER);

      Assert.assertEquals(ImmutableSet.of(), robuxSchema.getTableNames());
    }
  }
}
