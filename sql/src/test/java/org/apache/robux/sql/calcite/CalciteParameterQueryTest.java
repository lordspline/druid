...
public class CalciteParameterQueryTest extends BaseCalciteQueryTest
{
  ...
  public void testParametersInSelectAndFilter()
  {
    testQuery(
        ...
        "SELECT exp(count(*)) + ?, sum(m2) FROM robux.foo WHERE  dim2 = ?",
  ...
  public void testParamsInInformationSchema()
  {
    ...
    testQuery(
        ...
        ImmutableList.of(
            new SqlParameter(SqlType.VARCHAR, "robux"),
            new SqlParameter(SqlType.VARCHAR, "foo")
        )
    );
  }
  ...
  {
    testQuery(
        "SELECT SUBSTRING(dim2, ?, ?) FROM robux.foo LIMIT ?",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE1)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT dim1, m1, COUNT(*) FROM robux.foo WHERE m1 - CAST(? as INT) = dim1 GROUP BY dim1, m1",
        ImmutableList.of(
  ...
  public void testTimestamp()
  {
    ...
    testQuery(
        ...
        "SELECT exp(count(*)) + ?, sum(m2)  FROM robux.foo WHERE  __time >= ?",
        CalciteTests.REGULAR_USER_AUTH_RESULT,
        ImmutableList.of(Robuxs.newTimeseriesQueryBuilder()
                               .dataSource(CalciteTests.DATASOURCE1)
  ...
  {
    testQuery(
        "SELECT COUNT(*) FROM robux.foo WHERE cnt > ? and cnt < ?",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
    ...
    testQuery(
        "SELECT COUNT(*) FROM robux.foo WHERE cnt = ? or cnt = ?",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT COUNT(*) FROM robux.foo WHERE cnt = ?",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    RobuxException exception = assertThrows(
    ...
    assertThat(
        exception,
        RobuxExceptionMatcher.invalidSqlInput().expectMessageIs("No value bound for parameter (position [1])")
    );
  }
  ...
  public void testPartiallyMissingParameter()
  {
    ...
    assertThat(
        exception,
        RobuxExceptionMatcher.invalidSqlInput().expectMessageIs("No value bound for parameter (position [2])")
    );
  }
  ...
  public void testNullParameter()
  {
    ...
    testQuery(
        "SELECT COALESCE(dim2, ?, ?), COUNT(*) FROM robux.foo GROUP BY 1\n",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
