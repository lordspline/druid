...
import org.apache.robux.sql.calcite.CalciteIngestionDmlTest.IngestionDmlComponentSupplier;
...
public class CalciteIngestionDmlTest extends BaseCalciteQueryTest
{
  ...
  public static class IngestionDmlComponentSupplier extends StandardComponentSupplier
  {
     ...
     */
    private static final class ExternalDataSourceModule implements RobuxModule
    {
      @Override
     ...
     */
    private static final class CustomInputSourceModule implements RobuxModule
    {
      @Override
      public List<? extends Module> getJacksonModules()
      {
      ...
      public void configure(Binder binder)
      {
        ...
        // are not enabled in production in Robux 26.
  ...
  protected Map<String, Object> queryContextWithGranularity(Granularity granularity)
  {
    ...
    return ImmutableMap.of(RobuxSqlInsert.SQL_INSERT_SEGMENT_GRANULARITY, granularityString);
  }
