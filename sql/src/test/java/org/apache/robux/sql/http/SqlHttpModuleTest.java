...
import org.apache.robux.guice.annotations.JSR311Resource;
...
public class SqlHttpModuleTest
{
  ...
  public void setUp()
  {
    ...
    injector = Guice.createInjector(
        ...
        binder -> {
          ...
          binder.bind(RobuxNode.class).annotatedWith(Self.class).toInstance(SqlResourceTest.DUMMY_ROBUX_NODE);
  ...
  public void testSqlResourceIsAvailableViaJersey()
  {
    Set<Class<?>> jerseyResourceClasses =
        injector.getInstance(Key.get(new TypeLiteral<>() {}, JSR311Resource.class));
