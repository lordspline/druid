...
import org.apache.robux.query.OperatorFactoryBuilders;
import org.apache.robux.query.Order;
...
import org.apache.robux.query.WindowOperatorQueryBuilder;
...
import org.apache.robux.query.aggregation.DoubleMaxAggregatorFactory;
import org.apache.robux.query.aggregation.DoubleMinAggregatorFactory;
...
import org.apache.robux.query.aggregation.FloatMaxAggregatorFactory;
import org.apache.robux.query.aggregation.FloatMinAggregatorFactory;
import org.apache.robux.query.aggregation.GroupingAggregatorFactory;
import org.apache.robux.query.aggregation.LongMaxAggregatorFactory;
import org.apache.robux.query.aggregation.LongMinAggregatorFactory;
import org.apache.robux.query.aggregation.LongSumAggregatorFactory;
import org.apache.robux.query.aggregation.SerializablePairLongDoubleComplexMetricSerde;
import org.apache.robux.query.aggregation.SerializablePairLongFloatComplexMetricSerde;
import org.apache.robux.query.aggregation.SerializablePairLongLongComplexMetricSerde;
import org.apache.robux.query.aggregation.SerializablePairLongStringComplexMetricSerde;
import org.apache.robux.query.aggregation.any.DoubleAnyAggregatorFactory;
import org.apache.robux.query.aggregation.any.FloatAnyAggregatorFactory;
import org.apache.robux.query.aggregation.any.LongAnyAggregatorFactory;
import org.apache.robux.query.aggregation.any.StringAnyAggregatorFactory;
import org.apache.robux.query.aggregation.cardinality.CardinalityAggregatorFactory;
import org.apache.robux.query.aggregation.firstlast.first.DoubleFirstAggregatorFactory;
import org.apache.robux.query.aggregation.firstlast.first.FloatFirstAggregatorFactory;
import org.apache.robux.query.aggregation.firstlast.first.LongFirstAggregatorFactory;
import org.apache.robux.query.aggregation.firstlast.first.StringFirstAggregatorFactory;
import org.apache.robux.query.aggregation.firstlast.last.DoubleLastAggregatorFactory;
import org.apache.robux.query.aggregation.firstlast.last.FloatLastAggregatorFactory;
import org.apache.robux.query.aggregation.firstlast.last.LongLastAggregatorFactory;
import org.apache.robux.query.aggregation.firstlast.last.StringLastAggregatorFactory;
import org.apache.robux.query.aggregation.hyperloglog.HyperUniqueFinalizingPostAggregator;
import org.apache.robux.query.aggregation.hyperloglog.HyperUniquesAggregatorFactory;
import org.apache.robux.query.aggregation.post.ArithmeticPostAggregator;
...
import org.apache.robux.query.extraction.RegexDimExtractionFn;
import org.apache.robux.query.extraction.SubstringDimExtractionFn;
import org.apache.robux.query.filter.DimFilter;
import org.apache.robux.query.filter.EqualityFilter;
...
import org.apache.robux.query.filter.RangeFilter;
...
import org.apache.robux.query.groupby.orderby.NoopLimitSpec;
import org.apache.robux.query.groupby.orderby.OrderByColumnSpec;
import org.apache.robux.query.groupby.orderby.OrderByColumnSpec.Direction;
import org.apache.robux.query.operator.ColumnWithDirection;
import org.apache.robux.query.operator.window.WindowFrame;
...
import org.apache.robux.query.topn.DimensionTopNMetricSpec;
import org.apache.robux.query.topn.InvertedTopNMetricSpec;
import org.apache.robux.query.topn.NumericTopNMetricSpec;
...
import org.apache.robux.sql.calcite.DecoupledTestConfig.IgnoreQueriesReason;
import org.apache.robux.sql.calcite.DecoupledTestConfig.QuidemTestCaseReason;
import org.apache.robux.sql.calcite.NotYetSupported.Modes;
...
import org.apache.robux.sql.calcite.rel.CannotBuildQueryException;
...
public class CalciteQueryTest extends BaseCalciteQueryTest
{
  ...
  public void testInformationSchemaTables()
  {
    ...
    testQuery(
        ...
        ImmutableList.<Object[]>builder()
                     .add(new Object[]{"robux", CalciteTests.ARRAYS_DATASOURCE, "TABLE", "NO", "NO"})
                     .add(new Object[]{"robux", CalciteTests.BROADCAST_DATASOURCE, "TABLE", "YES", "YES"})
                     .add(new Object[]{"robux", CalciteTests.DATASOURCE1, "TABLE", "NO", "NO"})
                     .add(new Object[]{"robux", CalciteTests.DATASOURCE2, "TABLE", "NO", "NO"})
                     .add(new Object[]{"robux", CalciteTests.DATASOURCE4, "TABLE", "NO", "NO"})
                     .add(new Object[]{"robux", CalciteTests.DATASOURCE5, "TABLE", "NO", "NO"})
                     .add(new Object[]{"robux", CalciteTests.DATASOURCE3, "TABLE", "NO", "NO"})
                     .add(new Object[]{"robux", CalciteTests.RESTRICTED_BROADCAST_DATASOURCE, "TABLE", "YES", "YES"})
                     .add(new Object[]{"robux", CalciteTests.RESTRICTED_DATASOURCE, "TABLE", "NO", "NO"})
                     .add(new Object[]{"robux", CalciteTests.SOME_DATASOURCE, "TABLE", "NO", "NO"})
                     .add(new Object[]{"robux", CalciteTests.SOMEXDATASOURCE, "TABLE", "NO", "NO"})
                     .add(new Object[]{"robux", CalciteTests.USERVISITDATASOURCE, "TABLE", "NO", "NO"})
                     .add(new Object[]{"robux", CalciteTests.WIKIPEDIA, "TABLE", "NO", "NO"})
                     .add(new Object[]{"robux", CalciteTests.WIKIPEDIA_FIRST_LAST, "TABLE", "NO", "NO"})
    ...
    testQuery(
        ...
        ImmutableList.<Object[]>builder()
                     ...
                     .add(new Object[]{"robux", CalciteTests.DATASOURCE2, "TABLE", "NO", "NO"})
                     .add(new Object[]{"robux", CalciteTests.DATASOURCE4, "TABLE", "NO", "NO"})
                     .add(new Object[]{"robux", CalciteTests.FORBIDDEN_DATASOURCE, "TABLE", "NO", "NO"})
                     .add(new Object[]{"robux", CalciteTests.DATASOURCE5, "TABLE", "NO", "NO"})
                     .add(new Object[]{"robux", CalciteTests.DATASOURCE3, "TABLE", "NO", "NO"})
                     .add(new Object[]{"robux", CalciteTests.RESTRICTED_BROADCAST_DATASOURCE, "TABLE", "YES", "YES"})
                     .add(new Object[]{"robux", CalciteTests.RESTRICTED_DATASOURCE, "TABLE", "NO", "NO"})
  ...
  public void testInformationSchemaColumnsOnForbiddenTable()
  {
    ...
    testQuery(
        "SELECT COLUMN_NAME, DATA_TYPE, IS_NULLABLE\n"
        + "FROM INFORMATION_SCHEMA.COLUMNS\n"
        + "WHERE TABLE_SCHEMA = 'robux' AND TABLE_NAME = 'forbiddenDatasource'",
        ImmutableList.of(),
        ImmutableList.of()
    );
  ...
  public void testTopNLimitWrapping()
  {
    ...
    testQuery(
        "SELECT dim1, COUNT(*) FROM robux.foo GROUP BY dim1 ORDER BY dim1 DESC",
        context,
        ImmutableList.of(
  ...
  {
    testQuery(
        "SELECT dim1, COUNT(*) FROM robux.foo GROUP BY 1 ORDER BY 2 DESC",
        OUTER_LIMIT_CONTEXT,
        ImmutableList.of(
            new TopNQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE1)
  ...
  public void testGroupByLimitWrapping()
  {
    ...
    testQuery(
        "SELECT dim1, dim2, COUNT(*) FROM robux.foo GROUP BY dim1, dim2 ORDER BY dim1 DESC",
        OUTER_LIMIT_CONTEXT,
        ImmutableList.of(
  ...
  public void testGroupByWithForceLimitPushDown()
  {
    ...
    testQuery(
        "SELECT dim1, dim2, COUNT(*) FROM robux.foo GROUP BY dim1, dim2 limit 1",
        context,
        ImmutableList.of(
            new GroupByQuery.Builder()
                .setDataSource(CalciteTests.DATASOURCE1)
  ...
  {
    testQuery(
        "SELECT dim1, dim2, COUNT(*) FROM robux.foo GROUP BY 1, 2 ORDER BY 3 DESC",
        OUTER_LIMIT_CONTEXT,
        ImmutableList.of(
            new GroupByQuery.Builder()
                .setDataSource(CalciteTests.DATASOURCE1)
  ...
  public void testGroupBySingleColumnDescendingNoTopN()
  {
    testQuery(
        PLANNER_CONFIG_DEFAULT,
        "SELECT dim1 FROM robux.foo GROUP BY dim1 ORDER BY dim1 DESC",
  ...
  public void testGroupingOnStringSerializablePairLongString()
  {
    cannotVectorize();
    testQuery(
        "SELECT COUNT(*) FROM (SELECT string_first_added FROM robux.wikipedia_first_last GROUP BY 1)",
        ImmutableList.of(
  ...
  public void testGroupingOnStringSerializablePairLongLong()
  {
    cannotVectorize();
    testQuery(
        "SELECT COUNT(*) FROM (SELECT long_first_added FROM robux.wikipedia_first_last GROUP BY 1)",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(new QueryDataSource(
                            GroupByQuery.builder()
  ...
  public void testGroupingOnStringSerializablePairLongDouble()
  {
    cannotVectorize();
    testQuery(
        "SELECT COUNT(*) FROM (SELECT double_first_added FROM robux.wikipedia_first_last GROUP BY 1)",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(new QueryDataSource(
                            GroupByQuery.builder()
  ...
  public void testGroupingOnStringSerializablePairLongFloat()
  {
    cannotVectorize();
    testQuery(
        "SELECT COUNT(*) FROM (SELECT float_first_added FROM robux.wikipedia_first_last GROUP BY 1)",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(new QueryDataSource(
                            GroupByQuery.builder()
  ...
  {
    testQueryThrows(
        "SELECT EARLIEST_BY(m1, l1) FROM robux.numfoo",
  ...
  {
    testQueryThrows(
        "SELECT LATEST_BY(m1, l1) FROM robux.numfoo",
  ...
  {
    testQuery(
        "SELECT ANY_VALUE(l1), ANY_VALUE(dbl1), ANY_VALUE(f1) FROM robux.numfoo",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE3)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testLatestVectorAggregatorsOnTimeExpression()
  {
    ...
    testQuery(
        ...
        + " FROM robux.foo GROUP BY TIME_FLOOR(__time, 'P1Y', null, 'America/Los_Angeles')",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT ANY_VALUE(l1), ANY_VALUE(dbl1), ANY_VALUE(f1) FROM robux.numfoo GROUP BY dim2",
        ImmutableList.of(
            GroupByQuery.builder()
  ...
  {
    testQuery(
        "SELECT dim2, LATEST(dim4,10) AS val1 FROM robux.numfoo GROUP BY dim2",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT EARLIEST(l1), EARLIEST(dbl1), EARLIEST(f1) FROM robux.numfoo",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE3)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testLatestAggregatorsNumericNull()
  {
    msqIncompatible();
    testQuery(
        "SELECT LATEST(l1), LATEST(dbl1), LATEST(f1) FROM robux.numfoo",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE3)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT ANY_VALUE(dim1, 32), ANY_VALUE(l2), ANY_VALUE(dbl2), ANY_VALUE(f2) FROM robux.numfoo",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE3)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testOrderByEarliestFloat()
  {
    ...
    testQuery(
        "SELECT dim1, EARLIEST(f1) FROM robux.numfoo GROUP BY 1 ORDER BY 2 LIMIT 10",
        ImmutableList.of(
            new TopNQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testOrderByEarliestDouble()
  {
    ...
    testQuery(
        "SELECT dim1, EARLIEST(dbl1) FROM robux.numfoo GROUP BY 1 ORDER BY 2 LIMIT 10",
        ImmutableList.of(
            new TopNQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testOrderByEarliestLong()
  {
    ...
    testQuery(
        "SELECT dim1, EARLIEST(l1) FROM robux.numfoo GROUP BY 1 ORDER BY 2 LIMIT 10",
        ImmutableList.of(
            new TopNQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testOrderByLatestFloat()
  {
    ...
    testQuery(
        "SELECT dim1, LATEST(f1) FROM robux.numfoo GROUP BY 1 ORDER BY 2 LIMIT 10",
        ImmutableList.of(
            new TopNQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testOrderByLatestDouble()
  {
    ...
    testQuery(
        "SELECT dim1, LATEST(dbl1) FROM robux.numfoo GROUP BY 1 ORDER BY 2 LIMIT 10",
        ImmutableList.of(
            new TopNQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testOrderByLatestLong()
  {
    ...
    testQuery(
        "SELECT dim1, LATEST(l1) FROM robux.numfoo GROUP BY 1 ORDER BY 2 LIMIT 10",
        ImmutableList.of(
            new TopNQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    // Disabled test in MSQ with SQL-compatible mode till https://github.com/apache/robux/issues/13951 is resolved
    msqIncompatible();
    ...
    testQuery(
        "SELECT dim1, ANY_VALUE(f1) FROM robux.numfoo GROUP BY 1 ORDER BY 2 LIMIT 10",
        ImmutableList.of(
            new TopNQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testOrderByAnyDouble()
  {
    ...
    testQuery(
        "SELECT dim1, ANY_VALUE(dbl1) FROM robux.numfoo GROUP BY 1 ORDER BY 2 LIMIT 10",
        ImmutableList.of(
            new TopNQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testOrderByAnyLong()
  {
    ...
    testQuery(
        "SELECT dim1, ANY_VALUE(l1) FROM robux.numfoo GROUP BY 1 ORDER BY 2 LIMIT 10",
        ImmutableList.of(
            new TopNQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT cnt, COUNT(*) FROM robux.foo GROUP BY cnt",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT cnt, COUNT(*) FROM robux.foo GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  @Test
  @Disabled("Disabled since GROUP BY alias can confuse the validator; see RobuxConformance::isGroupByAlias")
  public void testGroupByAndOrderByAlias()
  {
    msqIncompatible();
    testQuery(
        "SELECT cnt AS theCnt, COUNT(*) FROM robux.foo GROUP BY theCnt ORDER BY theCnt ASC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT cnt as theCnt, COUNT(*) FROM robux.foo GROUP BY 1 ORDER BY 1 ASC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT m1, COUNT(*) FROM robux.foo GROUP BY m1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT m2, COUNT(*) FROM robux.foo GROUP BY m2",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT COUNT(*) FROM robux.foo WHERE m1 = 1.0",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT DECODE_BASE64_UTF8('aGVsbG8=') FROM robux.foo limit 1",
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT COUNT(*) FROM robux.foo WHERE m2 = 1.0",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT dim1, SUM(m1) AS m1_sum FROM robux.foo GROUP BY dim1 HAVING SUM(m1) > 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT dim2, COUNT(DISTINCT m1) FROM robux.foo GROUP BY dim2 HAVING COUNT(DISTINCT m1) > 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testExactCountDistinctWithFilter()
  {
    cannotVectorizeUnlessFallback();
    msqIncompatible();
    final String sqlQuery = "SELECT COUNT(DISTINCT foo.dim1) FILTER(WHERE foo.cnt = 1), SUM(foo.cnt) FROM robux.foo";
  ...
  {
    testQuery(
        "SELECT dim1, CAST(SUM(m1) AS FLOAT) AS m1_sum FROM robux.foo GROUP BY dim1 HAVING CAST(SUM(m1) AS FLOAT) > 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT dim1, m1, COUNT(*) FROM robux.foo WHERE m1 - 1 = dim1 GROUP BY dim1, m1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    // Test for https://github.com/apache/robux/issues/4264
  ...
  public void testExactCountDistinctUsingSubqueryOnUnionAllTables()
  {
    testQuery(
        ...
        + "  FROM (SELECT * FROM robux.foo UNION ALL SELECT * FROM robux.foo)\n"
        + "  GROUP BY dim2\n"
        + ")",
        ImmutableList.of(
            GroupByQuery.builder()
  ...
  {
    // Disabled test in MSQ till https://github.com/apache/robux/issues/13951 is resolved
    msqIncompatible();
    List<Object[]> expected = ImmutableList.of(
        new Object[]{null, 3L},
        new Object[]{1.7, 1L},
    ...
    testQuery(
        "SELECT dbl1, COUNT(*) FROM robux.numfoo GROUP BY dbl1 ORDER BY dbl1 DESC LIMIT 10",
        QUERY_CONTEXT_LEXICOGRAPHIC_TOPN,
        ImmutableList.of(
            new TopNQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
  ...
  public void testNullFloatTopN()
  {
    ...
    testQuery(
        "SELECT f1, COUNT(*) FROM robux.numfoo GROUP BY f1 ORDER BY f1 DESC LIMIT 10",
        QUERY_CONTEXT_LEXICOGRAPHIC_TOPN,
        ImmutableList.of(
            new TopNQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
  ...
  public void testNullLongTopN()
  {
    ...
    testQuery(
        "SELECT l1, COUNT(*) FROM robux.numfoo GROUP BY l1 ORDER BY l1 DESC LIMIT 10",
        QUERY_CONTEXT_LEXICOGRAPHIC_TOPN,
        ImmutableList.of(
            new TopNQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
  ...
  {
    testQuery(
        "SELECT l1 is null FROM robux.numfoo",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testCoalesceColumns()
  {
    ...
    testQuery(
        "SELECT COALESCE(dim2, dim1), COUNT(*) FROM robux.foo GROUP BY COALESCE(dim2, dim1)\n",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT COALESCE(dim2, dim1), COUNT(*) FROM robux.foo WHERE COALESCE(dim2, dim1) IN ('a', 'abc') GROUP BY COALESCE(dim2, dim1)\n",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testCoalesceMoreColumns()
  {
    ...
    testQuery(
        "SELECT COALESCE(dim2, dim1), COALESCE(dim2, dim3, dim1), COUNT(*) FROM robux.foo GROUP BY COALESCE(dim2, dim1), COALESCE(dim2, dim3, dim1)\n",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testColumnIsNull()
  {
    ...
    // This example is used in the sql.md doc.
    testQuery(
        "SELECT COUNT(*) FROM robux.foo WHERE dim2 IS NULL\n",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByNothingWithLiterallyFalseFilter()
  {
    ...
    testQuery(
        "SELECT COUNT(*), MAX(cnt) FROM robux.foo WHERE 1 = 0",
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(
                      InlineDataSource.fromIterable(
  ...
  {
    // Regression test for https://github.com/apache/robux/issues/7671
  ...
  public void testGroupByWithImpossibleTimeFilter()
  {
    ...
    testQuery(
        "SELECT dim1, COUNT(*) FROM robux.foo\n"
        + "WHERE FLOOR(__time TO DAY) = TIMESTAMP '2000-01-02 01:00:00'\n"
        + "OR FLOOR(__time TO DAY) = TIMESTAMP '2000-01-02 02:00:00'\n"
        + "GROUP BY 1",
        ImmutableList.of(
  ...
  {
    testQuery(
        "SELECT COUNT(*), MAX(cnt) FROM robux.foo WHERE 1 = 0 GROUP BY dim1",
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(
                      InlineDataSource.fromIterable(
  ...
  public void testGroupByWithFilterMatchingNothing()
  {
    msqIncompatible();
    testQuery(
        "SELECT COUNT(*), MAX(cnt) FROM robux.foo WHERE dim1 = 'foobar'",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT COUNT(*), SUM(cnt), MIN(cnt) FROM robux.foo GROUP BY ()",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT COUNT(*), MAX(cnt) FROM robux.foo WHERE dim1 = 'foobar' GROUP BY 'dummy'",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT COUNT(cnt) FROM robux.foo",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT COUNT(dim2) FROM robux.foo",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT COUNT(CASE WHEN dim2 = 'abc' THEN 'yes' WHEN dim2 = 'def' THEN 'yes' END) FROM robux.foo",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    cannotVectorizeUnlessFallback();
    Robuxs.TimeseriesQueryBuilder builder =
        Robuxs.newTimeseriesQueryBuilder()
              .dataSource(CalciteTests.DATASOURCE1)
              .intervals(querySegmentSpec(Filtration.eternity()))
              .granularity(Granularities.ALL)
  ...
  public void testConfusedView()
  {
    ...
    testQuery(
        "SELECT COUNT(*) FROM view.dview as robux WHERE robux.numfoo <> 'z'",
        ImmutableList.of(builder.build()),
        ImmutableList.of(
            new Object[]{1L}
        )
  ...
  {
    testQuery(
        "SELECT COUNT(*) FROM robux.foo WHERE dim1 like 'a%' OR dim2 like '%xb%' escape 'x'",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT COUNT(*) FROM robux.foo WHERE cnt >= 3 OR cnt = 1",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT COUNT(*) FROM robux.foo WHERE cnt > 1.1 and cnt < 100000001.0",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
    ...
    testQuery(
        "SELECT COUNT(*) FROM robux.foo WHERE cnt = 1.0",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
    ...
    testQuery(
        "SELECT COUNT(*) FROM robux.foo WHERE cnt = 100000001.0",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
    ...
    testQuery(
        "SELECT COUNT(*) FROM robux.foo WHERE cnt = 1.0 or cnt = 100000001.0",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT COUNT(*) FROM robux.foo WHERE cnt = 1 OR cnt = 2",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT distinct dim1 FROM robux.foo WHERE "
        + "dim1 = 10 OR "
  ...
  {
    testQuery(
        "SELECT distinct dim1 FROM robux.foo WHERE CAST(dim1 AS float) > 9 and CAST(dim1 AS float) <= 10.5",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT  MIN(l1), MIN(cnt), MAX(l1) FROM robux.numfoo",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE3)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT  MIN(dbl1), MAX(dbl1) FROM robux.numfoo",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE3)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT  MIN(m1), MAX(m1) FROM robux.numfoo",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE3)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT COUNT(*), COUNT(cnt), COUNT(dim1), AVG(cnt), SUM(cnt), SUM(cnt) + MIN(cnt) + MAX(cnt), COUNT(dim2), COUNT(dbl1), AVG(dbl1) FROM robux.numfoo",
        ImmutableList.of(
  ...
  public void testGroupByWithSortOnPostAggregationDefault()
  {
    ...
    testQuery(
        "SELECT dim1, MIN(m1) + MAX(m1) AS x FROM robux.foo GROUP BY dim1 ORDER BY x LIMIT 3",
        ImmutableList.of(
            new TopNQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE1)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT dim1, COUNT(*) FROM robux.foo WHERE dim1 IN ('ghi', 'abc', 'def') GROUP BY dim1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT dim1, COUNT(*) FROM robux.foo WHERE dim1 NOT IN ('ghi', 'abc', 'def') GROUP BY dim1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT dim1, COUNT(*) FROM robux.foo WHERE dim1 IN ('ghi', 'abc', 'def') IS NOT TRUE GROUP BY dim1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT dim1, COUNT(*) FROM robux.foo WHERE dim1 NOT IN ('ghi', 'abc', 'def') OR dim1 IS NULL GROUP BY dim1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT dim1, COUNT(*) FROM robux.foo WHERE dim1 NOT IN ('ghi', 'abc', 'def') AND dim1 < 'zzz' GROUP BY dim1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT dim1, COUNT(*) FROM robux.foo WHERE dim1 IN ('def', 'abc', 'ghi') IS NOT TRUE "
  ...
  {
    testQuery(
        "SELECT dim1, COUNT(*) FROM robux.foo WHERE dim1 IS NULL OR dim1 = 'abc' OR dim1 = 'def' OR dim1 = 'ghi' "
        + "GROUP BY dim1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
  ...
  {
    // Regression test for https://github.com/apache/robux/issues/4203.
  ...
  {
    testQuery(
        "SELECT COUNT(*) FROM robux.foo WHERE dim2 = 'a' and (dim1 > 'a' OR dim1 < 'b' OR dim1 IS NULL)",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testCountStarWithNotOfDegenerateFilter()
  {
    msqIncompatible();
    testQuery(
        "SELECT COUNT(*) FROM robux.foo WHERE dim2 = 'a' and not (dim1 > 'a' OR dim1 < 'b')",
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(
                      InlineDataSource.fromIterable(
  ...
  {
    msqIncompatible();
    // All of these queries are unplannable because they rely on features Robux doesn't support.
    ...
    assertQueryIsUnplannable(
        "SELECT dim1 FROM robux.foo ORDER BY dim1",
  ...
  {
    testQuery(
        "SELECT COUNT(*) FROM robux.foo WHERE 2.5 < m1 AND m1 < 3.5",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT COUNT(*) FROM robux.foo WHERE (dim1 >= 'a' and dim1 < 'b') OR dim1 = 'ab'",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testUnplannableExactCountDistinctOnSketch()
  {
    ...
    assertQueryIsUnplannable(
        PLANNER_CONFIG_NO_HLL,
        "SELECT unique_dim1, COUNT(*) FROM robux.foo GROUP BY 1",
  ...
  {
    testQuery(
        "SELECT COUNT(*) FROM robux.foo WHERE (dim1 >= 'a' and dim1 < 'b') OR dim1 IS NOT DISTINCT FROM 'ab'",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  /**
   * Same query as {@link org.apache.robux.msq.test.CalciteSelectQueryMSQTest#testArrayAggQueryOnComplexDatatypes()}.
  ...
  public void testArrayAggQueryOnComplexDatatypes()
  {
    ...
    cannotVectorize();
    testQuery(
        "SELECT ARRAY_AGG(unique_dim1) FROM robux.foo",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    try {
      testQuery("SELECT STRING_AGG(unique_dim1, ',') FROM robux.foo", ImmutableList.of(), ImmutableList.of());
  ...
  {
    testQuery(
        "SELECT COUNT(*) FROM robux.foo WHERE (dim1 >= 'a' and dim1 < 'b') and dim1 = 'abc'",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT COUNT(*) FROM robux.foo WHERE CAST(dim1 AS bigint) = 2",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByNullType()
  {
    ...
    cannotVectorize();
    testQuery(
        "SELECT NULL as nullcol, COUNT(*) FROM robux.foo GROUP BY 1",
        ImmutableList.of(
            new GroupByQuery.Builder()
                .setDataSource(CalciteTests.DATASOURCE1)
                .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testOrderByNullType()
  {
    testQuery(
        ...
        // from a table.
        "SELECT dim1, NULL as nullcol FROM (SELECT DISTINCT dim1 FROM robux.foo LIMIT 1) ORDER BY 2",
        QUERY_CONTEXT_LEXICOGRAPHIC_TOPN,
        ImmutableList.of(
  ...
  public void testGroupByOrderByNullType()
  {
    ...
    testQuery(
        "SELECT NULL as nullcol, COUNT(*) FROM robux.foo GROUP BY 1 ORDER BY 1",
        ImmutableList.of(
            new GroupByQuery.Builder()
                .setDataSource(CalciteTests.DATASOURCE1)
                .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testCountStarWithTimeFilterUsingStringLiteralsInvalid_isUnplannable()
  {
    ...
    String sql = "SELECT COUNT(*) FROM robux.foo\n"
    ...
    try {
      ...
      log.error(e, "Expected RobuxException for query: %s", sql);
      Assert.fail(sql);
    }
  }
  ...
  {
    testQuery(
        "SELECT COUNT(*) FROM robux.foo WHERE __time = TIMESTAMP '2000-01-01 00:00:00'",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
  ...
  {
    testQuery(
        "SELECT COUNT(*) FROM robux.foo WHERE "
  ...
  {
    testQuery(
        "SELECT SUM(CAST(dim1 AS INTEGER)) FROM robux.foo",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testSumOfExtractionFn()
  {
    cannotVectorizeUnlessFallback();
    testQuery(
        "SELECT SUM(CAST(SUBSTRING(dim1, 1, 10) AS INTEGER)) FROM robux.foo",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testCountDistinct()
  {
    msqIncompatible();
    testQuery(
        "SELECT SUM(cnt), COUNT(distinct dim2), COUNT(distinct unique_dim1) FROM robux.foo",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testExactCountDistinct()
  {
    ...
    testQuery(
        PLANNER_CONFIG_NO_HLL,
        "SELECT COUNT(distinct dim2) FROM robux.foo",
        CalciteTests.REGULAR_USER_AUTH_RESULT,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(
  ...
  {
    // Empty string isn't counted properly; see https://github.com/apache/robux/issues/13950
    msqIncompatible();

    // When HLL is disabled, APPROX_COUNT_DISTINCT is still approximate.
    testQuery(
        PLANNER_CONFIG_NO_HLL,
        "SELECT APPROX_COUNT_DISTINCT(dim2) FROM robux.foo",
        CalciteTests.REGULAR_USER_AUTH_RESULT,
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
  ...
  public void testApproxCountDistinctBuiltin()
  {
    ...
    testQuery(
        "SELECT APPROX_COUNT_DISTINCT_BUILTIN(dim2) FROM robux.foo",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testExactCountDistinctWithGroupingAndOtherAggregators()
  {
    ...
    testQuery(
        PLANNER_CONFIG_NO_HLL,
        "SELECT dim2, SUM(cnt), COUNT(distinct dim1) FROM robux.foo GROUP BY dim2",
        CalciteTests.REGULAR_USER_AUTH_RESULT,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(
  ...
  public void testMultipleExactCountDistinctWithGroupingAndOtherAggregatorsUsingJoin()
  {
    ...
    testQuery(
        PLANNER_CONFIG_NO_HLL,
        "SELECT dim2, COUNT(*), COUNT(distinct dim1), COUNT(distinct cnt) FROM robux.foo GROUP BY dim2",
        CalciteTests.REGULAR_USER_AUTH_RESULT,
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(
  ...
  public void testMultipleExactCountDistinctWithGroupingUsingGroupingSets()
  {
    ...
    testQuery(
        ...
        "SELECT FLOOR(__time to day), COUNT(distinct city), COUNT(distinct user) FROM robux.visits GROUP BY 1",
        CalciteTests.REGULAR_USER_AUTH_RESULT,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(
  ...
  {
    testQuery(
        "SELECT APPROX_COUNT_DISTINCT(dim1 || 'hello') FROM robux.foo",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testExactCountDistinctUsingSubquery()
  {
    testQuery(
        ...
        + "  SUM(cnt),\n"
        + "  COUNT(*)\n"
        + "FROM (SELECT dim2, SUM(cnt) AS cnt FROM robux.foo GROUP BY dim2)",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(
                            new QueryDataSource(
  ...
  public void testAvgDailyCountDistinct()
  {
    ...
    testQuery(
        "SELECT\n"
        + "  AVG(u)\n"
        + "FROM (SELECT FLOOR(__time TO DAY), APPROX_COUNT_DISTINCT(cnt) AS u FROM robux.foo GROUP BY 1)",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(
                            new QueryDataSource(
  ...
  public void testCompareExactAndApproximateCountDistinctUsingSubquery()
  {
    testQuery(
        ...
        + "FROM (SELECT DISTINCT dim1 FROM robux.foo WHERE dim1 <> '')",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(
                            new QueryDataSource(
  ...
  public void testHistogramUsingSubquery()
  {
    testQuery(
        ...
        + "  COUNT(*)\n"
        + "FROM (SELECT dim2, SUM(cnt) AS thecnt FROM robux.foo GROUP BY dim2)\n"
  ...
  public void testCountDistinctOfSubstring()
  {
    ...
    testQuery(
        "SELECT COUNT(DISTINCT SUBSTRING(dim1, 1, 1)) FROM robux.foo WHERE dim1 <> ''",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testCountDistinctOfTrim()
  {
    ...
    testQuery(
        "SELECT COUNT(DISTINCT TRIM(BOTH ' ' FROM dim1)) FROM robux.foo WHERE TRIM(dim1) <> ''",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT dim2, dim1, SUM(cnt) FROM robux.foo GROUP BY dim2, dim1 ORDER BY dim1 LIMIT 4",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByLimitPushdownExtraction()
  {
    ...
    testQuery(
        "SELECT dim4, substring(dim5, 1, 1), count(*) FROM robux.numfoo WHERE dim4 = 'a' GROUP BY 1,2 LIMIT 2",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT floor(CAST(dim1 AS float)), COUNT(*) FROM robux.foo GROUP BY floor(CAST(dim1 AS float))",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT floor(CAST(dim1 AS float)) AS fl, COUNT(*) FROM robux.foo GROUP BY floor(CAST(dim1 AS float)) ORDER BY fl DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    // Not msqCompatible until https://github.com/apache/robux/pull/14046 is merged.
    testQuery(
        "SELECT dim1 = 'abc', COUNT(*) FROM robux.foo GROUP BY 1 ORDER BY 1, 2 LIMIT 2",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByStringLength()
  {
    cannotVectorizeUnlessFallback();
    testQuery(
        "SELECT CHARACTER_LENGTH(dim1), COUNT(*) FROM robux.foo GROUP BY CHARACTER_LENGTH(dim1)",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testTimeseriesDontSkipEmptyBuckets()
  {
    ...
    testQuery(
        ...
        "SELECT SUM(cnt), gran FROM (\n"
        + "  SELECT floor(__time TO HOUR) AS gran, cnt FROM robux.foo\n"
  ...
  public void testTimeseriesEmptyResultsAggregatorDefaultValues()
  {
    ...
    testQuery(
        ...
        + " avg(l1),\n"
        + " avg(dbl1)\n"
        + "FROM robux.numfoo WHERE dim2 = 0",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE3)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByAggregatorDefaultValues()
  {
    testQuery(
        ...
        + "FROM robux.numfoo WHERE dim2 = 'a' GROUP BY dim2",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testGroupByTimeAndOtherDimension()
  {
    testQuery(
        ...
        + "FROM (SELECT FLOOR(__time TO MONTH) AS gran, dim2, cnt FROM robux.foo) AS x\n"
        + "GROUP BY dim2, gran\n"
        + "ORDER BY dim2, gran",
        ImmutableList.of(
            GroupByQuery.builder()
  ...
  public void testGroupByTimeFloorAndDimOnGroupByTimeFloorAndDim()
  {
    testQuery(
        ...
        + "FROM (SELECT time_floor(__time, 'P1D') AS gran, dim2, sum(m1) as s FROM robux.foo GROUP BY 1, 2 HAVING sum(m1) > 1) AS x\n"
        + "GROUP BY 1, 2\n"
  ...
  public void testGroupingSets()
  {
    ...
    testQuery(
        ...
        + "FROM (SELECT FLOOR(__time TO MONTH) AS gran, COALESCE(dim2, '') dim2, cnt FROM robux.foo) AS x\n"
  ...
  {
    // Regression test for https://github.com/apache/robux/pull/7710.
    try {
      testQuery("SELECT TIME_EXTRACT(__time) FROM robux.foo", ImmutableList.of(), ImmutableList.of());
      Assert.fail("query execution should fail");
    }
    catch (RobuxException e) {
      assertThat(
  ...
  {
    testQuery(
        "SELECT COUNT(*) AS cnt FROM ( SELECT * FROM robux.foo ) tmpA",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "select  __time as bug, dim2  from robux.foo group by 1, 2 order by 1 limit 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "select __time as bug from robux.foo group by 1 order by 1 limit 1",
        QUERY_CONTEXT_LEXICOGRAPHIC_TOPN,
        ImmutableList.of(
            new TopNQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE1)
  ...
  {
    testQuery(
        "select dim1 from (select dim1, dim2, count(*) cnt from robux.foo group by dim1, dim2 order by cnt)",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "select s / cnt, dim1, dim2, s from (select dim1, dim2, count(*) cnt, sum(m2) s from robux.foo group by dim1, dim2 order by cnt)",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testProjectAfterSort3()
  {
    msqIncompatible();
    testQuery(
        "select dim1 from (select dim1, dim1, count(*) cnt from robux.foo group by dim1, dim1 order by cnt)",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testProjectAfterSort3WithoutAmbiguity()
  {
    ...
    testQuery(
        "select copydim1 from (select dim1, dim1 AS copydim1, count(*) cnt from robux.foo group by dim1, dim1 order by cnt)",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testRequireTimeConditionPositive2()
  {
    ...
    testQuery(
        ...
        + "  SUM(cnt),\n"
        + "  COUNT(*)\n"
        + "FROM (SELECT dim2, SUM(cnt) AS cnt FROM robux.foo WHERE __time >= '2000-01-01' GROUP BY dim2)",
        CalciteTests.REGULAR_USER_AUTH_RESULT,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(
  ...
  public void testRequireTimeConditionPositive3()
  {
    ...
    testQuery(
        ...
        + "  SELECT SUBSTRING(dim1, 1, 1) FROM robux.foo\n"
                  ...
                  .dataSource(
                      join(
                          ...
                          equalsCondition(
                              ...
                              RobuxExpression.ofColumn(ColumnType.STRING, "j0.d0")
                          ),
                          JoinType.INNER
                      )
                  )
  ...
  public void testTrigonometricFunction()
  {
    ...
    testQuery(
        ...
        "FROM robux.foo WHERE  dim2 = 0",
        CalciteTests.REGULAR_USER_AUTH_RESULT,
        ImmutableList.of(Robuxs.newTimeseriesQueryBuilder()
                               .dataSource(CalciteTests.DATASOURCE1)
                               .intervals(querySegmentSpec(Filtration.eternity()))
                               .filters(equality("dim2", 0L, ColumnType.LONG))
                               .granularity(Granularities.ALL)
  ...
  {
    testQuery(
        "SELECT NVL(dim2, dim1), COUNT(*) FROM robux.foo GROUP BY NVL(dim2, dim1)\n",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testQueryContextOuterLimit()
  {
    ...
    testQuery(
        PLANNER_CONFIG_DEFAULT,
        outerLimitContext,
        "SELECT dim1 FROM robux.foo GROUP BY dim1 ORDER BY dim1 DESC LIMIT 9",
        CalciteTests.REGULAR_USER_AUTH_RESULT,
        ImmutableList.of(
            baseBuilder.threshold(4).build()
        ),
    ...
    testQuery(
        PLANNER_CONFIG_DEFAULT,
        outerLimitContext,
        "SELECT dim1 FROM robux.foo GROUP BY dim1 ORDER BY dim1 DESC LIMIT 2",
        CalciteTests.REGULAR_USER_AUTH_RESULT,
        ImmutableList.of(
  ...
  {
    testQuery(
        "SELECT TIMESTAMPADD(DAY, 0, \"__time\") FROM robux.foo",
  ...
  {
    testQuery(
        "SELECT TIMESTAMPADD(MONTH, 0, \"__time\") FROM robux.foo",
  ...
  {
    testQuery(
        "SELECT TIMESTAMPADD(YEAR, 0, \"__time\") FROM robux.foo",
   ...
   * see https://github.com/apache/robux/issues/10530 for more information
   */
  @Test
  public void testTimeStampAddConversion()
  {
    ...
    //
    testQuery(
        "SELECT TIMESTAMPADD(MONTH, 1, \"__time\") FROM robux.foo",
    ...
    //
    testQuery(
        "SELECT TIMESTAMPADD(MONTH, \"cnt\", \"__time\") FROM robux.foo",
  ...
  {
    testQuery(
        "SELECT f1, round(f1) FROM robux.numfoo",
        ImmutableList.of(
            new Robuxs.ScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .intervals(querySegmentSpec(Filtration.eternity()))
                .virtualColumns(
  ...
  public void testCountAndAverageByConstantVirtualColumn()
  {
    ...
    testQuery(
        "SELECT dim5, COUNT(dim1), AVG(l1) FROM robux.numfoo WHERE dim1 = '10.1' AND l1 = 325323 GROUP BY dim5",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testBitwiseAggregatorsGroupBy()
  {
    ...
    testQuery(
        ...
        + " BIT_OR(l1),\n"
        + " BIT_XOR(l1)\n"
        + "FROM robux.numfoo GROUP BY 1 ORDER BY 4",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    assertThrows(RobuxException.class, () -> {
      testQuery(
  ...
  {
    RobuxException e = assertThrows(RobuxException.class, () -> testBuilder()
    ...
    RobuxException e1 = assertThrows(RobuxException.class, () -> testBuilder()
    ...
    RobuxException e2 = assertThrows(RobuxException.class, () -> testBuilder()
    ...
    testQuery(
        ...
        ImmutableList.of(
            newScanQueryBuilder()
                ...
                // so the converted Robux native query is its result intead of the raw function call
                //
                .virtualColumns(
  ...
  {
    cannotVectorizeUnlessFallback();
    String query = "SELECT dim1, MAX(GREATEST(l1, l2)) IS NULL FROM robux.numfoo GROUP BY dim1";
  ...
  public void testGreatestFunctionForStringWithIsNull()
  {
    ...
    String query = "SELECT l1, LATEST(GREATEST(dim1, dim2)) IS NULL FROM robux.numfoo GROUP BY l1";
  ...
  public void testComplexDecode()
  {
    for (String complexDecode : Arrays.asList("COMPLEX_DECODE_BASE64", "DECODE_BASE64_COMPLEX")) {
      testQuery(
          StringUtils.format(
              "SELECT %s('hyperUnique',PARSE_JSON(TO_JSON_STRING(unique_dim1))) from robux.foo LIMIT 10",
              complexDecode
          ),
          ImmutableList.of(
              Robuxs.newScanQueryBuilder()
  ...
  public void testComplexDecodeAgg()
  {
    ...
    msqIncompatible();
    testQuery(
        "SELECT APPROX_COUNT_DISTINCT_BUILTIN(COMPLEX_DECODE_BASE64('hyperUnique',PARSE_JSON(TO_JSON_STRING(unique_dim1)))) from robux.foo",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "select __time as t, m1 from robux.foo where (m1 in (select distinct m1 from robux.foo)) order by 1 limit 1",
        ImmutableList.of(
            newScanQueryBuilder()
                .intervals(querySegmentSpec(Filtration.eternity()))
                .dataSource(
  ...
  {
    testQuery(
        "select __time, m1 from robux.foo where (m1 in (select m1 from robux.foo)) order by __time DESC limit 1",
        ImmutableList.of(
            newScanQueryBuilder()
                .intervals(querySegmentSpec(Filtration.eternity()))
                .dataSource(
  ...
  {
    testQuery(
        "select __time, dim1 from robux.foo where nvl(dim1, '') NOT IN ('a' , '')",
        ImmutableList.of(
            newScanQueryBuilder()
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "select __time, dim1 from robux.foo where (nvl(dim1, '') IN ('a' , '')) IS NOT TRUE",
        ImmutableList.of(
            newScanQueryBuilder()
                .intervals(querySegmentSpec(Filtration.eternity()))
                .dataSource(new TableDataSource(CalciteTests.DATASOURCE1))
  ...
  {
    testQuery(
        "select __time, dim1 from robux.foo where CASE WHEN dim1 IS NULL THEN '' ELSE dim1 END NOT IN ('a' , '')",
        ImmutableList.of(
            newScanQueryBuilder()
                .intervals(querySegmentSpec(Filtration.eternity()))
                .dataSource(new TableDataSource(CalciteTests.DATASOURCE1))
  ...
  {
    testQuery(
        "select __time, dim1 from robux.foo where CASE WHEN dim1 IS NOT NULL THEN dim1 ELSE '' END NOT IN ('a' , '')",
        ImmutableList.of(
            newScanQueryBuilder()
                .intervals(querySegmentSpec(Filtration.eternity()))
                .dataSource(new TableDataSource(CalciteTests.DATASOURCE1))
  ...
  {
    testQuery(
        "select DATE_TRUNC('HOUR', __time), COUNT(*) from robux.foo group by DATE_TRUNC('HOUR', __time)",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                           .dataSource(CalciteTests.DATASOURCE1)
                           .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT dim2,LATEST(dim3),LATEST_BY(dim1, __time),EARLIEST(dim3),EARLIEST_BY(dim1, __time),ANY_VALUE(dim3) FROM robux.foo where dim2='abc' group by 1",
        ImmutableList.of(
            GroupByQuery.builder()
                .setDataSource(CalciteTests.DATASOURCE1)
                .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    RobuxException e = assertThrows(RobuxException.class, () -> testBuilder()
        .sql("SELECT dim1,ROW_NUMBER() OVER (ORDER BY dim1 DESC NULLS FIRST) from robux.foo")
        .run());
  ...
  {
    RobuxException e = assertThrows(RobuxException.class, () -> testBuilder()
        .sql("SELECT dim1,ROW_NUMBER() OVER (ORDER BY dim1 NULLS LAST) from robux.foo")
        .run());
  ...
  public void testUnSupportedRangeBounds()
  {
    ...
    RobuxException e = assertThrows(RobuxException.class, () -> testBuilder()
        .sql("SELECT dim1,ROW_NUMBER() OVER (ORDER BY dim1 RANGE BETWEEN 3 PRECEDING AND 2 FOLLOWING) from robux.foo")
        .run());
  ...
  public void testUnSupportedWindowBoundExpressions()
  {
    ...
    RobuxException e = assertThrows(RobuxException.class, () -> testBuilder()
        .sql("SELECT dim1,ROW_NUMBER() OVER (ORDER BY dim1 ROWS BETWEEN dim1 PRECEDING AND dim1 FOLLOWING) from robux.foo")
        .run());
  ...
  public void testNtileNotSupportedWithFrame()
  {
    ...
    RobuxException e = assertThrows(
        RobuxException.class,
        () -> testBuilder()
            .sql("SELECT ntile(4) OVER (ORDER BY dim1 ROWS BETWEEN 1 FOLLOWING AND CURRENT ROW) from robux.foo")
            .run()
    );
  ...
  public void testDistinctNotSupportedWithWindow()
  {
    ...
    RobuxException e = assertThrows(
        RobuxException.class,
        () -> testBuilder()
            .sql("SELECT count(distinct dim1) OVER () from robux.foo")
            .run()
    );
  ...
  public void testLogicalCorrelateTrimFieldsStillNeeded()
  {
    assertEquals(
        ...
        "Calcite version changed; check if RobuxRelFieldTrimmer#trimFields(LogicalCorrelate correlate,...) is still needed or not!"
    );
  }
  ...
  public void testUnSupportedAggInSelectWindow()
  {
    assertEquals(
        "1.37.0",
        RelNode.class.getPackage().getImplementationVersion(),
        "Calcite version changed; check if CALCITE-6500 is fixed and update:\n * method RobuxSqlValidator#validateWindowClause"
    );

    RobuxException e = assertThrows(RobuxException.class, () -> testBuilder()
        .sql("SELECT dim1, ROW_NUMBER() OVER W from robux.foo WINDOW W as (ORDER BY max(length(dim1)))")
        .run());
  ...
  {
    testQuery(
        "select count(*) from robux.foo where parse_long(dim1, 10) is null",
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
                  .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testLatestByAggregatorOnSecondaryTimestampGroupBy()
  {
    msqIncompatible();
    testQuery(
        "SELECT __time, m1, LATEST_BY(m1, MILLIS_TO_TIMESTAMP(CAST(m2 AS NUMERIC))) from robux.numfoo GROUP BY 1,2",
        ImmutableList.of(
            new GroupByQuery.Builder()
                .setDataSource(CalciteTests.DATASOURCE3)
                .setInterval(querySegmentSpec(Filtration.eternity()))
    ...
    testBuilder()
        .sql(
              "SELECT ICONTAINS_STRING(dim3, 'a'), REGEXP_LIKE(dim3,'x'), SUBSTRING(dim3, 1, 1) " +
                      "from robux.numfoo where dim3 is NULL LIMIT 1"
        )
