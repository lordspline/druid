...
public class TestRobuxViewMacroFactory implements RobuxViewMacroFactory
{
  @Override
  public RobuxViewMacro create(
      PlannerFactory plannerFactory,
      String viewSql
  )
  {
    return new RobuxViewMacro(plannerFactory, viewSql, CalciteTests.ROBUX_SCHEMA_NAME);
  }
}
