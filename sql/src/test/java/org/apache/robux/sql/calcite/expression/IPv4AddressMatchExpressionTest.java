...
import org.apache.robux.math.expr.ExpressionValidationException;
...
public class IPv4AddressMatchExpressionTest extends CalciteTestBase
{
  ...
  {
    testExpression("robux.apache.org", SUBNET_192_168, NO_MATCH);
  }
  ...
  private RobuxExpression buildExpectedExpression(Object... args)
  {
    return testHelper.buildExpectedExpression(target.getRobuxFunctionName(), args);
  }
}
