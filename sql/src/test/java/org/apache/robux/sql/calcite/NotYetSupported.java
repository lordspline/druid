...
public @interface NotYetSupported
{
  ...
  {
    // @formatter:off
    DISTINCT_AGGREGATE_NOT_SUPPORTED(Scope.WINDOWING, RobuxException.class, "DISTINCT is not supported"),
    NULLS_FIRST_LAST(Scope.WINDOWING, RobuxException.class, "NULLS (FIRST|LAST)"),
    BIGINT_TO_DATE(Scope.WINDOWING, RobuxException.class, "BIGINT to type (DATE|TIME)"),
    AGGREGATION_NOT_SUPPORT_TYPE(Scope.WINDOWING, RobuxException.class, "Aggregation \\[(MIN|MAX)\\] does not support type \\[STRING\\]"),
    ALLDATA_CSV(Scope.WINDOWING, RobuxException.class, "allData.csv"),
    BIGINT_TIME_COMPARE(Scope.WINDOWING, RobuxException.class, "Cannot apply '.' to arguments of type"),
    VIEWS_NOT_SUPPORTED(Scope.WINDOWING, RobuxException.class, "Incorrect syntax near the keyword 'CREATE'"),
    ...
    UNSUPPORTED_NULL_ORDERING(Scope.WINDOWING, RobuxException.class, "(A|DE)SCENDING ordering with NULLS (LAST|FIRST)"),

    EXPRESSION_NOT_GROUPED(Scope.BINDABLE, RobuxException.class, "Expression '[a-z]+' is not being grouped"),

    NOT_ENOUGH_RULES(Scope.DECOUPLED, RobuxException.class, "There are not enough rules to produce a node"),
    SORT_REMOVE_TROUBLE(Scope.DECOUPLED, RobuxException.class, "Calcite assertion violated.*Sort\\.<init>"),
    ...
    DD_RESTRICTED_DATASOURCE_SUPPORT(Scope.DECOUPLED_DART, RobuxException.class, "ForbiddenException: Unauthorized"),
    DD_INCORRECT_RESULTS_EMPTY_STRING(Scope.DECOUPLED_DART, AssertionError.class, "column content mismatch at"),
    NO_INFORMATION_SCHEMA_SUPPORT(Scope.DECOUPLED_DART, RobuxException.class, "INFORMATION_SCHEMA"),
    DD_JOIN(Scope.DECOUPLED_DART, RobuxException.class, "RobuxJoin.ROBUX_LOGICAL"),
    DD_NULL_COLUMN_ORDER(Scope.DECOUPLED_DART, RobuxException.class, "sort: \\[\\] -> \\[1\\]"),
    DD_UNION(Scope.DECOUPLED_DART, RobuxException.class, "RobuxUnion.ROBUX_LOGICAL");
    // @formatter:on
