...
import org.apache.robux.sql.calcite.SqlTestFrameworkConfig.NumMergeBuffers;
import org.apache.robux.sql.calcite.SqlTestFrameworkConfig.ResultCache;
...
public class SqlTestFrameworkConfigTest
{
  ...
  public void testURI()
  {
    ...
    URI uri = c.getRobuxTestURI();
    assertEquals("robuxtest:///?componentSupplier=DrillComponentSupplier", uri.toString());
  }
}
