...
package org.apache.robux.sql.calcite.parser;
...
public class RobuxSqlParserTest
{
  ...
  public void test_sqlLiteralToContextValue_string()
  {
    ...
    Assert.assertEquals("abc", RobuxSqlParser.sqlLiteralToContextValue(literal));
  }
  ...
  public void test_sqlLiteralToContextValue_stringWithSpecialChars()
  {
    ...
    Assert.assertEquals("hello\nworld\t\"test\"", RobuxSqlParser.sqlLiteralToContextValue(literal));
  }
  ...
  public void test_sqlLiteralToContextValue_integer()
  {
    ...
    Assert.assertEquals(42L, RobuxSqlParser.sqlLiteralToContextValue(literal));
  }
  ...
  public void test_sqlLiteralToContextValue_negativeInteger()
  {
    ...
    Assert.assertEquals(-123L, RobuxSqlParser.sqlLiteralToContextValue(literal));
  }
  ...
  public void test_sqlLiteralToContextValue_decimal()
  {
    ...
    Assert.assertEquals(3.14159, RobuxSqlParser.sqlLiteralToContextValue(literal));
  }
  ...
  public void test_sqlLiteralToContextValue_largeNumber()
  {
    ...
    Assert.assertEquals("123456789012345678901234567890", RobuxSqlParser.sqlLiteralToContextValue(literal));
  }
  ...
  public void test_sqlLiteralToContextValue_approximateNumeric()
  {
    ...
    Assert.assertEquals(1.23E10, RobuxSqlParser.sqlLiteralToContextValue(literal));
  }
  ...
  public void test_sqlLiteralToContextValue_booleanTrue()
  {
    ...
    Assert.assertEquals(true, RobuxSqlParser.sqlLiteralToContextValue(literal));
  }
  ...
  public void test_sqlLiteralToContextValue_booleanFalse()
  {
    ...
    Assert.assertEquals(false, RobuxSqlParser.sqlLiteralToContextValue(literal));
  }
  ...
  public void test_sqlLiteralToContextValue_timestamp()
  {
    ...
    Assert.assertEquals("2023-01-15T14:30:00.000Z", RobuxSqlParser.sqlLiteralToContextValue(literal));
  }
  ...
  public void test_sqlLiteralToContextValue_timestampWithFractionalSeconds()
  {
    ...
    Assert.assertEquals("2023-01-15T14:30:00.123Z", RobuxSqlParser.sqlLiteralToContextValue(literal));
  }
  ...
  public void test_sqlLiteralToContextValue_date()
  {
    ...
    Assert.assertEquals("2023-01-15T00:00:00.000Z", RobuxSqlParser.sqlLiteralToContextValue(literal));
  }
  ...
  public void test_sqlLiteralToContextValue_unsupportedType()
  {
    ...
    final RobuxException exception = Assert.assertThrows(
        RobuxException.class,
        () -> RobuxSqlParser.sqlLiteralToContextValue(literal)
    );
