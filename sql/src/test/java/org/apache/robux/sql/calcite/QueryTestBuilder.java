...
import org.apache.robux.sql.calcite.BaseCalciteQueryTest.ResultMatchMode;
import org.apache.robux.sql.calcite.BaseCalciteQueryTest.ResultsVerifier;
...
public class QueryTestBuilder
{
  ...
  public interface QueryTestConfig
  {
    ...
    default RobuxQTestInfo getQTestInfo()
    {
      return null;
    }
