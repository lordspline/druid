...
import static org.apache.robux.segment.column.ColumnType.ofComplex;
...
public class CalciteReplaceDmlTest extends CalciteIngestionDmlTest
{
  ...
  protected Map<String, Object> addReplaceTimeChunkToQueryContext(Map<String, Object> context, String replaceTimeChunks)
  {
    return ImmutableMap.<String, Object>builder()
                       .putAll(context)
                       .put(RobuxSqlReplace.SQL_REPLACE_TIME_CHUNKS, replaceTimeChunks)
                       .build();
  }
  ...
  public void testReplaceForWithInvalidInterval()
  {
    testIngestionQuery()
        ...
        .expectValidationError(RobuxException.class)
        .verify();
  }
  ...
  {
    testIngestionQuery()
        .sql("REPLACE INTO robux.dst OVERWRITE ALL SELECT * FROM foo PARTITIONED BY ALL TIME")
        .expectTarget("dst", FOO_TABLE_SIGNATURE)
        .expectResources(dataSourceRead("foo"), dataSourceWrite("dst"))
        .expectQuery(
            newScanQueryBuilder()
  ...
  public void testReplaceIntoSystemTable()
  {
    testIngestionQuery()
        ...
        .expectValidationError(invalidSqlIs(
            ...
            + " because it is not a Robux datasource"
        ))
        .verify();
  }
  ...
  public void testReplaceIntoView()
  {
    testIngestionQuery()
        ...
        .expectValidationError(invalidSqlIs(
            "Table [view.aview] does not support operation [REPLACE] because it is not a Robux datasource"
        ))
        .verify();
  }
  ...
  public void testReplaceIntoNonexistentSchema()
  {
    testIngestionQuery()
        ...
        .expectValidationError(invalidSqlIs(
            "Table [nonexistent.dst] does not support operation [REPLACE] because it is not a Robux datasource"
        ))
        .verify();
  }
  ...
  public void testReplaceWithPartitionedByAndLimitOffset()
  {
    ...
    testIngestionQuery()
        .sql(
            "REPLACE INTO robux.dst OVERWRITE ALL SELECT __time, FLOOR(m1) as floor_m1, dim1 FROM foo LIMIT 10 OFFSET 20 PARTITIONED BY DAY")
  ...
  public void testReplaceWithClusteredBy()
  {
    ...
    testIngestionQuery()
        .sql(
            "REPLACE INTO robux.dst OVERWRITE ALL SELECT __time, FLOOR(m1) as floor_m1, dim1 FROM foo PARTITIONED BY DAY CLUSTERED BY 2, dim1")
        .expectTarget("dst", targetRowSignature)
        .expectResources(dataSourceRead("foo"), dataSourceWrite("dst"))
        .expectQuery(
            newScanQueryBuilder()
    ...
    partitionedByToGranularity.forEach((partitionedByArgument, expectedGranularity) -> {
      ...
      testIngestionQuery()
          .sql(StringUtils.format(
              "REPLACE INTO robux.dst OVERWRITE ALL SELECT __time, dim1 FROM foo PARTITIONED BY '%s'",
  ...
  public void testExplainReplaceWithLimitAndClusteredByOrdinals() throws IOException
  {
    ...
    final ScanQuery expectedQuery = newScanQueryBuilder()
        ...
        .columnTypes(LONG, STRING, STRING, STRING, LONG, FLOAT, DOUBLE, ColumnType.ofComplex("hyperUnique"))
        .context(
            queryJsonMapper.readValue(
  ...
  public void testReplaceWithSqlOuterLimit()
  {
    ...
    testIngestionQuery()
        .context(context)
        .sql("REPLACE INTO dst OVERWRITE ALL SELECT * FROM foo PARTITIONED BY ALL TIME")
        .expectValidationError(RobuxExceptionMatcher.invalidInput().expectMessageIs(
