...
import org.apache.robux.catalog.model.TableDefn;
...
import org.apache.robux.sql.calcite.CalciteCatalogIngestionDmlTest.CatalogIngestionDmlComponentSupplier;
...
public abstract class CalciteCatalogIngestionDmlTest extends CalciteIngestionDmlTest
{
  ...
  public void testInsertAddNonDefinedColumnIntoSealedCatalogTable()
  {
    testIngestionQuery()
        ...
        .expectValidationError(
            RobuxException.class,
            "Column [extra2] is not defined in the target table [robux.fooSealed] strict schema"
        )
        .verify();
  }
  ...
  public void testInsertIntoExistingStrictNoDefinedSchema()
  {
    testIngestionQuery()
        ...
        .expectValidationError(
            RobuxException.class,
            "Column [__time] is not defined in the target table [robux.strictTableWithNoDefinedSchema] strict schema")
        .verify();
  }
