...
public class CalciteLookupFunctionQueryTest extends BaseCalciteQueryTest
{
  ...
  {
    // Test to verify that "maxUnapplyCountForRobuxReverseLookupRule" works properly. This ensures that the *other*
  ...
  {
    testQuery(
        "SELECT LOOKUP(dim1, 'lookyloo121'), COUNT(*) FROM robux.foo GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT LOOKUP(dim1, 'lookyloo121'), COUNT(LOOKUP(dim1, 'lookyloo121')) FROM robux.foo GROUP BY 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT dim1, LOOKUP(dim1, 'lookyloo121'), COUNT(*) FROM robux.foo GROUP BY 1, 2",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT COUNT(*), dim2, dim1, LOOKUP(dim1, 'lookyloo121') FROM robux.foo GROUP BY 2, 3",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testPullUpLookupOneInjectiveOneNot()
  {
    ...
    testQuery(
        "SELECT COUNT(*), LOOKUP(dim1, 'lookyloo'), LOOKUP(dim1, 'lookyloo121') FROM robux.foo GROUP BY 2, 3",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE1)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
