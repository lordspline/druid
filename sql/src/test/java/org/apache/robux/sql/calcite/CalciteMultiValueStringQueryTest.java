...
import org.apache.robux.query.lookup.RegisteredLookupExtractionFn;
...
public class CalciteMultiValueStringQueryTest extends BaseCalciteQueryTest
{
  ...
  public void testMultiValueStringWorksLikeStringGroupBy()
  {
    ...
    testQuery(
        "SELECT concat(dim3, 'foo'), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
    ...
    testQueryThrows(
        ...
        ThrowableMessageMatcher.hasMessage(
            CoreMatchers.containsString(
                StringUtils.format(
                    "org.apache.robux.query.groupby.epinephelinae.UnexpectedMultiValueDimensionException: "
  ...
  public void testMultiValueStringWorksLikeStringGroupByWithFilter()
  {
    ...
    testQuery(
        "SELECT concat(dim3, '', 'foo'), SUM(cnt) FROM robux.numfoo where concat(dim3, '', 'foo') = 'bfoo' GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT concat(dim3, 'foo') FROM robux.numfoo",
        ImmutableList.of(
  ...
  {
    testQuery(
        "SELECT concat(dim3, '-lol-', dim3) FROM robux.numfoo",
        ImmutableList.of(
            new Robuxs.ScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .eternityInterval()
  ...
  public void testMultiValueStringWorksLikeStringScanWithFilter()
  {
    // concat(dim3, '', 'foo') instad of concat(dim3, 'foo'), to disable the FilterDecomposeConcatRule rewrite
    testQuery(
        "SELECT concat(dim3, '', 'foo') FROM robux.numfoo where concat(dim3, '', 'foo') = 'bfoo'",
        ImmutableList.of(
            new Robuxs.ScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .eternityInterval()
  ...
  {
    testQuery(
        "SELECT dim3 FROM robux.numfoo WHERE MV_OVERLAP(dim3, ARRAY['a','b']) LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .eternityInterval()
  ...
  {
    testQuery(
        "SELECT dim3 FROM robux.numfoo WHERE MV_OVERLAP(dim3, ARRAY[NULL]) LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .eternityInterval()
  ...
  {
    testQuery(
        "SELECT dim2, dim3 FROM robux.numfoo WHERE MV_OVERLAP(dim3, ARRAY[dim2]) LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .eternityInterval()
  ...
  {
    testQuery(
        "SELECT dim3 FROM robux.numfoo WHERE MV_CONTAINS(dim3, ARRAY['a','b']) LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .eternityInterval()
  ...
  {
    testQuery(
        "SELECT dim3 FROM robux.numfoo WHERE MV_CONTAINS(dim3, ARRAY[NULL]) LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .eternityInterval()
  ...
  {
    testQuery(
        "SELECT dim3 FROM robux.numfoo WHERE MV_CONTAINS(dim3, ARRAY['a']) LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .eternityInterval()
  ...
  {
    testQuery(
        "SELECT dim2, ARRAY[dim2], dim3 FROM robux.numfoo WHERE MV_CONTAINS(dim3, ARRAY[dim2]) LIMIT 5",
  ...
  {
    testQuery(
        "SELECT MV_SLICE(dim3, 1) FROM robux.numfoo",
        ImmutableList.of(
            new Robuxs.ScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .eternityInterval()
  ...
  public void testMultiValueStringLength()
  {
    ...
    testQuery(
        "SELECT dim1, MV_LENGTH(dim3), SUM(cnt) FROM robux.numfoo GROUP BY 1, 2 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testMultiValueStringAppend()
  {
    ...
    testQuery(
        "SELECT MV_APPEND(dim3, 'foo'), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testMultiValueStringPrepend()
  {
    ...
    testQuery(
        "SELECT MV_PREPEND('foo', dim3), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testMultiValueStringPrependAppend()
  {
    ...
    testQuery(
        "SELECT MV_TO_STRING(MV_PREPEND('foo', dim3), ','), MV_TO_STRING(MV_APPEND(dim3, 'foo'), ','), SUM(cnt) FROM robux.numfoo GROUP BY 1,2 ORDER BY 3 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testMultiValueStringConcat()
  {
    ...
    testQuery(
        "SELECT MV_CONCAT(dim3, dim3), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testMultiValueStringOffset()
  {
    cannotVectorizeUnlessFallback();
    testQuery(
        "SELECT MV_OFFSET(dim3, 1), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testMultiValueStringOrdinal()
  {
    cannotVectorizeUnlessFallback();
    testQuery(
        "SELECT MV_ORDINAL(dim3, 2), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testMultiValueStringOffsetOf()
  {
    cannotVectorizeUnlessFallback();
    testQuery(
        "SELECT MV_OFFSET_OF(dim3, 'b'), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testMultiValueStringOrdinalOf()
  {
    cannotVectorizeUnlessFallback();
    testQuery(
        "SELECT MV_ORDINAL_OF(dim3, 'b'), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testMultiValueStringToString()
  {
    ...
    testQuery(
        "SELECT MV_TO_STRING(dim3, ','), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testMultiValueStringToStringToMultiValueString()
  {
    ...
    testQuery(
        "SELECT STRING_TO_MV(CONCAT(MV_TO_STRING(dim3, ','), ',d'), ','), SUM(cnt) FROM robux.numfoo WHERE MV_LENGTH(dim3) > 0 GROUP BY 1 ORDER BY 2 DESC, 1",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testBuilder()
        .sql("SELECT STRING_TO_MV(CONCAT(MV_TO_STRING(dim3, ','), ',d'), ',') FROM robux.numfoo "
  ...
  {
    testBuilder()
        .sql("SELECT m1, STRING_TO_MV('a,b', ',') AS mv FROM robux.numfoo GROUP BY 1")
        .expectedQuery(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testStringToMVOfConstantGroupedBy()
  {
    ...
    testBuilder()
        .sql("SELECT m1, STRING_TO_MV('a,b', ',') AS mv FROM robux.numfoo GROUP BY 1, 2")
        .expectedQuery(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testStringToMVOfStringAgg()
  {
    ...
    testBuilder()
        .sql("SELECT STRING_TO_MV(STRING_AGG(dim1, ','), ',') AS mv, COUNT(*) cnt FROM robux.numfoo")
        .expectedQuery(
  ...
  public void testMultiValueListFilter()
  {
    ...
    testQuery(
        "SELECT MV_FILTER_ONLY(dim3, ARRAY['b']), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT MV_FILTER_ONLY(dim3, ARRAY[dim2]) FROM robux.numfoo",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testMultiValueListFilterDeny()
  {
    ...
    testQuery(
        "SELECT MV_FILTER_NONE(dim3, ARRAY['b']), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT MV_FILTER_NONE(dim3, ARRAY[dim2]) FROM robux.numfoo",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testMultiValueListFilterComposed()
  {
    ...
    testQuery(
        "SELECT MV_LENGTH(MV_FILTER_ONLY(dim3, ARRAY['b'])), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testMultiValueListFilterComposedNested()
  {
    ...
    testQuery(
        "SELECT COALESCE(MV_FILTER_ONLY(dim3, ARRAY['b']), 'no b'), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testMultiValueListFilterComposedNested2Input()
  {
    ...
    testQuery(
        "SELECT COALESCE(MV_FILTER_ONLY(dim3, ARRAY['b']), dim1), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testMultiValueListFilterComposedNestedNullLiteral()
  {
    ...
    testQuery(
        "SELECT COALESCE(MV_FILTER_ONLY(dim3, ARRAY[NULL, 'b']), 'no b'), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testMultiValueListFilterComposedDeny()
  {
    ...
    testQuery(
        "SELECT MV_LENGTH(MV_FILTER_NONE(dim3, ARRAY['b'])), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testMultiValueListFilterComposedMultipleExpressions()
  {
    ...
    testQuery(
        "SELECT MV_LENGTH(MV_FILTER_ONLY(dim3, ARRAY['b'])), MV_LENGTH(dim3), SUM(cnt) FROM robux.numfoo GROUP BY 1,2 ORDER BY 3 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testFilterOnMultiValueListFilterNoMatch()
  {
    ...
    testQuery(
        "SELECT dim3, SUM(cnt) FROM robux.numfoo WHERE MV_FILTER_ONLY(dim3, ARRAY['b']) = 'a' GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testFilterOnMultiValueListFilterMatch()
  {
    ...
    testQuery(
        "SELECT dim3, SUM(cnt) FROM robux.numfoo WHERE MV_FILTER_ONLY(dim3, ARRAY['b']) = 'b' GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testFilterOnMultiValueListFilterMatchLike()
  {
    ...
    testQuery(
        "SELECT dim3, SUM(cnt) FROM robux.numfoo WHERE MV_FILTER_ONLY(dim3, ARRAY['b']) LIKE 'b%' GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testMultiValueToArrayGroupAsArrayWithMultiValueDimension()
  {
    ...
    cannotVectorize();
    testQuery(
        "SELECT MV_TO_ARRAY(dim3), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        QUERY_CONTEXT_NO_STRINGIFY_ARRAY,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
  ...
  public void testMultiValueToArrayGroupAsArrayWithSingleValueDim()
  {
    ...
    cannotVectorize();
    testQuery(
        "SELECT MV_TO_ARRAY(dim1), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        QUERY_CONTEXT_NO_STRINGIFY_ARRAY,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
  ...
  public void testMultiValueToArrayGroupAsArrayWithSingleValueDimIsNotConvertedToTopN()
  {
    // Cannot vectorize due to usage of expressions.
    cannotVectorize();
    // Test for method {@link org.apache.robux.sql.calcite.rel.RobuxQuery.toTopNQuery()} so that it does not convert
    // group by on array to topn
    testQuery(
        "SELECT MV_TO_ARRAY(dim1), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC limit 10",
        QUERY_CONTEXT_NO_STRINGIFY_ARRAY,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
  ...
  {
    testQueryThrows(
        "SELECT MV_TO_ARRAY(dim3,dim3) FROM robux.numfoo",
  ...
  {
    testQueryThrows(
        "SELECT MV_TO_ARRAY() FROM robux.numfoo",
        invalidSqlContains("Invalid number of arguments to function")
    );
  }
  ...
  {
    testQueryThrows(
        "SELECT MV_TO_ARRAY(concat(dim3,'c')) FROM robux.numfoo",
        RuntimeException.class,
  ...
  {
    testQueryThrows(
        "SELECT MV_TO_ARRAY(concat(dim1,'c')) FROM robux.numfoo",
        RuntimeException.class,
  ...
  {
    testQueryThrows(
        "SELECT MV_TO_ARRAY(Array[1,2]) FROM robux.numfoo",
        RuntimeException.class,
  ...
  {
    testQuery(
        "SELECT COALESCE(dim3, 'other') FROM robux.numfoo "
  ...
  {
    testQuery(
        "SELECT COALESCE(dim3, dim2) FROM robux.numfoo "
  ...
  public void testMultiValuedFilterOnlyWhenLookupPullsInDuplicates()
  {
    ...
    testBuilder()
        .sql("SELECT \n"
             ...
             + "FROM robux.foo AS t group by 1\n")
        .expectedQuery(
            GroupByQuery.builder()
  ...
  public void testMvContainsFilterWithExtractionFn()
  {
    ...
    testQuery(
        "SELECT dim3 FROM robux.numfoo WHERE MV_CONTAINS(SUBSTRING(dim3, 1, 1), ARRAY['a','b']) LIMIT 5",
  ...
  {
    testQuery(
        "SELECT MV_CONTAINS(dim3, ARRAY['a', 'b']), MV_OVERLAP(dim3, ARRAY['a', 'b']) FROM robux.numfoo LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .intervals(querySegmentSpec(Filtration.eternity()))
