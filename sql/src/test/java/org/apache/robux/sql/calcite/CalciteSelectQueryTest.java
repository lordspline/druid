...
public class CalciteSelectQueryTest extends BaseCalciteQueryTest
{
  ...
  {
    // Test with a Robux-specific function, to make sure they are hooked up correctly even when not selecting
    // from a table.
    testQuery(
  ...
  public void testTimeCeilExpressionContainingInvalidPeriod()
  {
    testQueryThrows(
        ...
        RobuxExceptionMatcher.invalidInput().expectMessageContains(
  ...
  // a table
  @Test
  public void testRobuxLogicalValuesRule()
  {
    testQuery(
  ...
  public void testSelectStarWithDimFilter()
  {
    testQuery(
        ...
        "SELECT * FROM robux.foo WHERE dim1 > 'd' OR dim2 = 'a'",
        CalciteTests.REGULAR_USER_AUTH_RESULT,
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE1)
  ...
  public void testSelectDistinctWithCascadeExtractionFilter()
  {
    ...
    testQuery(
        "SELECT distinct dim1 FROM robux.foo WHERE substring(substring(dim1, 2), 1, 1) = 'e' OR dim2 = 'a'",
        ImmutableList.of(
  ...
  public void testSelectDistinctWithStrlenFilter()
  {
    cannotVectorizeUnlessFallback();
    testQuery(
        "SELECT distinct dim1 FROM robux.foo "
  ...
  public void testSelectDistinctWithLimit()
  {
    ...
    testQuery(
        "SELECT DISTINCT dim2 FROM robux.foo LIMIT 10",
        ImmutableList.of(
            GroupByQuery.builder()
                .setDataSource(CalciteTests.DATASOURCE1)
                .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT * FROM (SELECT DISTINCT dim2 FROM robux.foo ORDER BY dim2) LIMIT 10",
        ImmutableList.of(
            GroupByQuery.builder()
                .setDataSource(CalciteTests.DATASOURCE1)
                .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT * FROM (SELECT DISTINCT dim2 FROM robux.foo ORDER BY dim2 LIMIT 5) LIMIT 10",
        ImmutableList.of(
            GroupByQuery.builder()
                .setDataSource(CalciteTests.DATASOURCE1)
                .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT * FROM (SELECT DISTINCT dim2 FROM robux.foo ORDER BY dim2 DESC LIMIT 5) LIMIT 10",
        ImmutableList.of(
            GroupByQuery.builder()
                .setDataSource(CalciteTests.DATASOURCE1)
                .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testSelectNonAggregatingWithLimitLiterallyZero()
  {
    ...
    testQuery(
        "SELECT dim2 FROM robux.foo ORDER BY dim2 LIMIT 0",
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(
                      InlineDataSource.fromIterable(
  ...
  public void testSelectNonAggregatingWithLimitReducedToZero()
  {
    ...
    testQuery(
        "SELECT * FROM (SELECT dim2 FROM robux.foo ORDER BY dim2 LIMIT 2 OFFSET 5) OFFSET 2",
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(
                      InlineDataSource.fromIterable(
  ...
  public void testSelectAggregatingWithLimitReducedToZero()
  {
    ...
    testQuery(
        "SELECT * FROM (SELECT DISTINCT dim2 FROM robux.foo ORDER BY dim2 LIMIT 2 OFFSET 5) OFFSET 2",
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(
                      InlineDataSource.fromIterable(
                      ...
                      InlineDataSource.fromIterable(
                          ImmutableList.of(
                              new Object[]{
                                  ...
                                  // See RobuxLogicalValuesRule.getValueFromLiteral()
  ...
  public void testSelectCountStar()
  {
    ...
    testQuery(
        PLANNER_CONFIG_DEFAULT,
        QUERY_CONTEXT_DEFAULT,
        "SELECT exp(count(*)) + 10, sum(m2)  FROM robux.foo WHERE  dim2 = 0",
        CalciteTests.REGULAR_USER_AUTH_RESULT,
    ...
    testQuery(
        PLANNER_CONFIG_DEFAULT,
        QUERY_CONTEXT_DEFAULT,
        "SELECT exp(count(*)) + 10, sum(m2)  FROM robux.foo WHERE  __time >= TIMESTAMP '2999-01-01 00:00:00'",
        CalciteTests.REGULAR_USER_AUTH_RESULT,
        ImmutableList.of(Robuxs.newTimeseriesQueryBuilder()
                               .dataSource(CalciteTests.DATASOURCE1)
  ...
  public void testCountRestrictedTable_shouldFilterOnPolicy()
  {
    testQuery(
        PLANNER_CONFIG_DEFAULT,
        "SELECT COUNT(*) FROM robux.restrictedDatasource_m1_is_6",
  ...
  public void testSelectStarOnForbiddenTable()
  {
    assertQueryIsForbidden(
        "SELECT * FROM robux.forbiddenDatasource",
        CalciteTests.REGULAR_USER_AUTH_RESULT
    );
  ...
  public void testExplainSelectStar()
  {
    ...
    final String query = "EXPLAIN PLAN FOR SELECT * FROM robux.foo";
  ...
  public void testSelectStarWithLimitAndOffset()
  {
    testQuery(
        PLANNER_CONFIG_DEFAULT,
        QUERY_CONTEXT_DEFAULT,
        "SELECT * FROM robux.foo LIMIT 2 OFFSET 1",
        CalciteTests.REGULAR_USER_AUTH_RESULT,
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE1)
  ...
  {
    testQuery(
        "SELECT SUBSTRING(dim2, 1, 1) FROM robux.foo LIMIT 2",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE1)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT dim1 FROM robux.foo WHERE m1 + 1 = 7",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE1)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testSelectStarWithLimitTimeDescending()
  {
    testQuery(
        PLANNER_CONFIG_DEFAULT,
        QUERY_CONTEXT_DEFAULT,
        "SELECT * FROM robux.foo ORDER BY __time DESC LIMIT 2",
        CalciteTests.REGULAR_USER_AUTH_RESULT,
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE1)
  ...
  public void testSelectStarWithoutLimitTimeAscending()
  {
    testQuery(
        PLANNER_CONFIG_DEFAULT,
        QUERY_CONTEXT_DEFAULT,
        "SELECT * FROM robux.foo ORDER BY __time",
        CalciteTests.REGULAR_USER_AUTH_RESULT,
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE1)
  ...
  {
    testQuery(
        "SELECT dim2 x, dim2 y FROM robux.foo LIMIT 2",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE1)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT dim1 FROM robux.foo ORDER BY __time DESC LIMIT 2",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE1)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testSelectStarFromSelectSingleColumnWithLimitDescending()
  {
    ...
    // set of rows.
    testQuery(
        "SELECT * FROM (SELECT dim1 FROM robux.foo ORDER BY __time DESC) LIMIT 2",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE1)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT dim1 FROM robux.foo ORDER BY __time DESC",
        OUTER_LIMIT_CONTEXT,
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE1)
  ...
  {
    testQuery(
        "SELECT dim1 FROM robux.foo ORDER BY __time DESC OFFSET 1",
        OUTER_LIMIT_CONTEXT,
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE1)
  ...
  {
    testQuery(
        "SELECT dim1 FROM robux.foo ORDER BY __time DESC LIMIT 1 OFFSET 1",
        OUTER_LIMIT_CONTEXT,
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE1)
  ...
  {
    testQuery(
        "SELECT dim1 FROM robux.foo ORDER BY __time DESC LIMIT 10 OFFSET 1",
        OUTER_LIMIT_CONTEXT,
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE1)
  ...
  {
    testQuery(
        "SELECT 'beep ' || dim1 FROM (SELECT dim1 FROM robux.foo ORDER BY __time DESC LIMIT 2)",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE1)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    // Regression test for https://github.com/apache/robux/issues/7768.

    // After upgrading to Calcite 1.21, Calcite no longer respects the ORDER BY __time DESC
    // in the inner query. This is valid, as the SQL standard considers the subquery results to be an unordered
    // set of rows. This test now validates that the inner ordering is not applied.
    testQuery(
        "SELECT 'beep ' || dim1 FROM (SELECT dim1 FROM robux.foo ORDER BY __time DESC)",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE1)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT 'beep ' || dim1 FROM (SELECT dim1 FROM robux.foo ORDER BY __time DESC LIMIT 4) LIMIT 2",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE1)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testOrderThenLimitThenFilter()
  {
    testQuery(
        "SELECT dim1 FROM "
        + "(SELECT __time, dim1 FROM robux.foo ORDER BY __time DESC LIMIT 4) "
  ...
  public void testCountDistinctNonApproximateEmptySet()
  {
    testQuery(
        ...
        "select count(distinct m1) from robux.foo where m1 < -1.0",
        CalciteTests.REGULAR_USER_AUTH_RESULT,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(
  ...
  public void testCountDistinctNonApproximateBasic()
  {
    testQuery(
        PLANNER_CONFIG_DEFAULT.withOverrides(
            ImmutableMap.of(
                PlannerConfig.CTX_KEY_USE_APPROXIMATE_COUNT_DISTINCT, false)),
        "select count(distinct m1) from robux.foo where m1 < 111.0",
        CalciteTests.REGULAR_USER_AUTH_RESULT,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(
  ...
  public void testCountDistinctNonApproximateWithFilter()
  {
    ...
    testQuery(
        PLANNER_CONFIG_DEFAULT.withOverrides(
            ImmutableMap.of(
                PlannerConfig.CTX_KEY_USE_APPROXIMATE_COUNT_DISTINCT, false)),
        "select count(distinct m1) FILTER (where m1 < -1.0) from robux.foo",
        CalciteTests.REGULAR_USER_AUTH_RESULT,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(
  ...
  public void testCountDistinctNonApproximateWithFilterHaving()
  {
    ...
    testQuery(
        PLANNER_CONFIG_DEFAULT.withOverrides(
            ImmutableMap.of(
                PlannerConfig.CTX_KEY_USE_APPROXIMATE_COUNT_DISTINCT, false)),
        "select count(distinct m1) FILTER (where m1 < -1.0) c from robux.foo HAVING c > 3",
        CalciteTests.REGULAR_USER_AUTH_RESULT,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(
  ...
  public void testCacheKeyConsistency()
  {
    ...
    // https://github.com/apache/robux/issues/16552
    testBuilder()
