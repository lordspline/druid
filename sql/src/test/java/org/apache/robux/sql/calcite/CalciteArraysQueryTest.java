...
import org.apache.robux.query.filter.ArrayContainsElementFilter;
import org.apache.robux.query.filter.ExpressionDimFilter;
...
import org.apache.robux.query.groupby.having.DimFilterHavingSpec;
...
import org.apache.robux.sql.calcite.DecoupledTestConfig.IgnoreDefaultsReson;
...
public class CalciteArraysQueryTest extends BaseCalciteQueryTest
{
  ...
  {
    testQuery(
        "SELECT dim3 FROM robux.numfoo WHERE ARRAY_OVERLAP(dim3, ARRAY['a','b']) LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT arrayStringNulls FROM robux.arrays WHERE ARRAY_OVERLAP(arrayStringNulls, ARRAY['a','b']) LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.ARRAYS_DATASOURCE)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT arrayLongNulls FROM robux.arrays WHERE ARRAY_OVERLAP(arrayLongNulls, ARRAY[1, 2]) LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.ARRAYS_DATASOURCE)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT arrayDoubleNulls FROM robux.arrays WHERE ARRAY_OVERLAP(arrayDoubleNulls, ARRAY[1.1, 2.2]) LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.ARRAYS_DATASOURCE)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT dim3 FROM robux.numfoo WHERE ARRAY_OVERLAP(SUBSTRING(dim3, 1, 1), ARRAY['a','b']) LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT dim3 FROM robux.numfoo WHERE ARRAY_OVERLAP(dim3, ARRAY[dim2]) LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT arrayStringNulls, arrayString FROM robux.arrays WHERE ARRAY_OVERLAP(arrayStringNulls, arrayString) LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.ARRAYS_DATASOURCE)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT arrayLongNulls, arrayLong FROM robux.arrays WHERE ARRAY_OVERLAP(arrayLongNulls, arrayLong) LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.ARRAYS_DATASOURCE)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT arrayDoubleNulls, arrayDouble FROM robux.arrays WHERE ARRAY_OVERLAP(arrayDoubleNulls, arrayDouble) LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.ARRAYS_DATASOURCE)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    Robuxs.ScanQueryBuilder builder = newScanQueryBuilder()
            .dataSource(CalciteTests.DATASOURCE3)
            .intervals(querySegmentSpec(Filtration.eternity()))
    ...
    testQuery(
            ...
            "SELECT dim3 FROM robux.numfoo WHERE ARRAY_OVERLAP(?, ARRAY[dbl1]) LIMIT 5",
  ...
  {
    testQuery(
        "SELECT dim3 FROM robux.numfoo WHERE ARRAY_CONTAINS(dim3, ARRAY['a','b']) LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT arrayStringNulls FROM robux.arrays WHERE ARRAY_CONTAINS(arrayStringNulls, ARRAY['a','b']) LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.ARRAYS_DATASOURCE)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT arrayLongNulls FROM robux.arrays WHERE ARRAY_CONTAINS(arrayLongNulls, ARRAY[1, null]) LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.ARRAYS_DATASOURCE)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT arrayDoubleNulls FROM robux.arrays WHERE ARRAY_CONTAINS(arrayDoubleNulls, ARRAY[1.1, null]) LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.ARRAYS_DATASOURCE)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testArrayContainsFilterWithExtractionFn()
  {
    ...
    testQuery(
        "SELECT dim3 FROM robux.numfoo WHERE ARRAY_CONTAINS(SUBSTRING(dim3, 1, 1), ARRAY['a','b']) LIMIT 5",
        ImmutableList.of(builder.build()),
        ImmutableList.of(
            new Object[]{"[\"a\",\"b\"]"}
        )
  ...
  {
    testQuery(
        "SELECT dim3 FROM robux.numfoo WHERE ARRAY_CONTAINS(dim3, ARRAY['a']) LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT dim3 FROM robux.numfoo WHERE ARRAY_CONTAINS(dim3, ARRAY[dim2]) LIMIT 5",
        QUERY_CONTEXT_NO_STRINGIFY_ARRAY,
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
  ...
  {
    testQuery(
        "SELECT arrayStringNulls, arrayString FROM robux.arrays WHERE ARRAY_CONTAINS(arrayStringNulls, arrayString) LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.ARRAYS_DATASOURCE)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT ARRAY_CONTAINS(arrayStringNulls, ARRAY['a', 'b']), ARRAY_CONTAINS(arrayStringNulls, arrayString) FROM robux.arrays LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.ARRAYS_DATASOURCE)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT arrayLong, arrayLongNulls FROM robux.arrays WHERE ARRAY_CONTAINS(arrayLong, arrayLongNulls) LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.ARRAYS_DATASOURCE)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT arrayDoubleNulls, arrayDouble FROM robux.arrays WHERE ARRAY_CONTAINS(arrayDoubleNulls, arrayDouble) LIMIT 5",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.ARRAYS_DATASOURCE)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testArrayContainsFilterWithDynamicParameter()
  {
    ...
    testQuery(
            ...
            "SELECT dim3 FROM robux.numfoo WHERE ARRAY_CONTAINS(?, ARRAY[dbl1>1]) LIMIT 5",
            CalciteTests.REGULAR_USER_AUTH_RESULT,
            ImmutableList.of(builder.build()),
            ImmutableList.of(
                    new Object[]{"[\"b\",\"c\"]"},
  ...
  {
    testQuery(
        "SELECT ARRAY_SLICE(dim3, 1) FROM robux.numfoo",
        QUERY_CONTEXT_NO_STRINGIFY_ARRAY,
        ImmutableList.of(
  ...
  {
    testQuery(
        "SELECT ARRAY_SLICE(arrayString, 1), ARRAY_SLICE(arrayLong, 2), ARRAY_SLICE(arrayDoubleNulls, 1) FROM robux.arrays",
        QUERY_CONTEXT_NO_STRINGIFY_ARRAY,
        ImmutableList.of(
            new Robuxs.ScanQueryBuilder()
                .dataSource(CalciteTests.ARRAYS_DATASOURCE)
  ...
  public void testArrayLength()
  {
    ...
    testQuery(
        "SELECT dim1, ARRAY_LENGTH(dim3), SUM(cnt) FROM robux.numfoo GROUP BY 1, 2 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testArrayLengthArrayColumn()
  {
    ...
    testQuery(
        "SELECT arrayStringNulls, ARRAY_LENGTH(arrayStringNulls), SUM(cnt) FROM robux.arrays GROUP BY 1, 2 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.ARRAYS_DATASOURCE)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testArrayAppend()
  {
    ...
    testQuery(
        "SELECT ARRAY_APPEND(dim3, 'foo'), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        QUERY_CONTEXT_NO_STRINGIFY_ARRAY,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
  ...
  public void testArrayPrepend()
  {
    ...
    testQuery(
        "SELECT ARRAY_PREPEND('foo', dim3), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        QUERY_CONTEXT_NO_STRINGIFY_ARRAY,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
  ...
  public void testArrayPrependAppend()
  {
    ...
    testQuery(
        "SELECT ARRAY_TO_STRING(ARRAY_PREPEND('foo', dim3), ','), ARRAY_TO_STRING(ARRAY_APPEND(dim3, 'foo'), ','), SUM(cnt) FROM robux.numfoo GROUP BY 1,2 ORDER BY 3 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testArrayConcat()
  {
    ...
    testQuery(
        "SELECT ARRAY_CONCAT(dim3, dim3), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        QUERY_CONTEXT_NO_STRINGIFY_ARRAY,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
  ...
  public void testArrayOffset()
  {
    cannotVectorizeUnlessFallback();
    testQuery(
        "SELECT ARRAY_OFFSET(dim3, 1), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testArrayGroupAsLongArray()
  {
    ...
    cannotVectorize();
    testQuery(
        "SELECT ARRAY[l1], SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        QUERY_CONTEXT_NO_STRINGIFY_ARRAY,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
  ...
  public void testArrayGroupAsLongArrayColumn()
  {
    ...
    cannotVectorize();
    testQuery(
        "SELECT arrayLongNulls, SUM(cnt) FROM robux.arrays GROUP BY 1 ORDER BY 2 DESC",
        QUERY_CONTEXT_NO_STRINGIFY_ARRAY,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.ARRAYS_DATASOURCE)
  ...
  public void testArrayGroupAsDoubleArray()
  {
    ...
    cannotVectorize();
    testQuery(
        "SELECT ARRAY[dbl1], SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        QUERY_CONTEXT_NO_STRINGIFY_ARRAY,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
  ...
  public void testArrayGroupAsDoubleArrayColumn()
  {
    ...
    cannotVectorize();
    testQuery(
        "SELECT arrayDoubleNulls, SUM(cnt) FROM robux.arrays GROUP BY 1 ORDER BY 2 DESC",
        QUERY_CONTEXT_NO_STRINGIFY_ARRAY,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.ARRAYS_DATASOURCE)
  ...
  public void testArrayGroupAsFloatArray()
  {
    ...
    cannotVectorize();
    testQuery(
        "SELECT ARRAY[f1], SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        QUERY_CONTEXT_NO_STRINGIFY_ARRAY,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
  ...
  public void testArrayGroupAsArrayWithFunction()
  {
    ...
    cannotVectorize();
    testQuery(
        "SELECT ARRAY[ARRAY_ORDINAL(dim3, 2)], SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        QUERY_CONTEXT_NO_STRINGIFY_ARRAY,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
  ...
  public void testArrayOrdinal()
  {
    cannotVectorizeUnlessFallback();
    testQuery(
        "SELECT ARRAY_ORDINAL(dim3, 2), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testArrayOffsetOf()
  {
    cannotVectorizeUnlessFallback();
    testQuery(
        "SELECT ARRAY_OFFSET_OF(dim3, 'b'), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testArrayOrdinalOf()
  {
    cannotVectorizeUnlessFallback();
    testQuery(
        "SELECT ARRAY_ORDINAL_OF(dim3, 'b'), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testArrayToString()
  {
    ...
    testQuery(
        "SELECT ARRAY_TO_STRING(dim3, ','), SUM(cnt) FROM robux.numfoo GROUP BY 1 ORDER BY 2 DESC",
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
                        .setInterval(querySegmentSpec(Filtration.eternity()))
  ...
  public void testArrayToStringToMultiValueString()
  {
    ...
    testQuery(
        "SELECT STRING_TO_ARRAY(CONCAT(ARRAY_TO_STRING(dim3, ','), ',d'), ','), SUM(cnt) FROM robux.numfoo WHERE ARRAY_LENGTH(dim3) > 0 GROUP BY 1 ORDER BY 2 DESC",
        QUERY_CONTEXT_NO_STRINGIFY_ARRAY,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.DATASOURCE3)
  ...
  {
    testQuery(
        "SELECT d3 FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3)",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
  ...
  {
    testQuery(
        "SELECT a FROM robux.arrays, UNNEST(arrayString) as unnested (a)",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    // Regresson test for https://github.com/apache/robux/issues/16543.
    testQuery(
        "SELECT a || '.txt' FROM robux.arrays, UNNEST(arrayString) as unnested (a)",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT a FROM robux.arrays, UNNEST(arrayStringNulls) as unnested (a)",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT a FROM robux.arrays, UNNEST(arrayLong) as unnested (a)",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT a FROM robux.arrays, UNNEST(arrayLongNulls) as unnested (a)",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT a FROM robux.arrays, UNNEST(arrayDouble) as unnested (a)",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT a FROM robux.arrays, UNNEST(arrayDoubleNulls) as unnested (a)",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  public void testUnnestWithGroupBy()
  {
    cannotVectorize();
    testQuery(
        "SELECT d3 FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3) GROUP BY d3 ",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            GroupByQuery.builder()
  ...
  public void testUnnestWithGroupByArrayColumn()
  {
    cannotVectorize();
    testQuery(
        "SELECT usn FROM robux.arrays, UNNEST(arrayStringNulls) as u (usn) GROUP BY usn ",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(UnnestDataSource.create(
  ...
  public void testUnnestWithGroupByOrderBy()
  {
    cannotVectorize();
    testQuery(
        "SELECT d3, COUNT(*) FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) AS unnested(d3) GROUP BY d3 ORDER BY d3 DESC ",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(UnnestDataSource.create(
  ...
  public void testUnnestWithGroupByOrderByWithLimit()
  {
    ...
    testQuery(
        "SELECT d3, COUNT(*) FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) AS unnested(d3) GROUP BY d3 ORDER BY d3 ASC LIMIT 4 ",
        context,
        ImmutableList.of(
            new TopNQueryBuilder()
                .dataSource(UnnestDataSource.create(
  ...
  public void testUnnestWithGroupByHaving()
  {
    cannotVectorize();
    testQuery(
        "SELECT d3, COUNT(*) FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) AS unnested(d3) GROUP BY d3 HAVING COUNT(*) = 1",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT d3 FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3) LIMIT 3",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT d3 FROM (select dim1, dim2, dim3 from robux.numfoo), UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3)",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT strings, m1 FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) as unnested (strings) where (strings='a' and (m1<=10 or strings='b'))",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(Robuxs.newScanQueryBuilder()
                               .dataSource(UnnestDataSource.create(
                                   new TableDataSource(CalciteTests.DATASOURCE3),
                                   nestedExpressionVirtualColumn("j0.unnest", "\"dim3\"", ColumnType.STRING),
  ...
  {
    testQuery(
        "SELECT strings, m1 FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) as unnested (strings) where (strings='a' or (m1=2 and strings='b'))",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(Robuxs.newScanQueryBuilder()
                               .dataSource(UnnestDataSource.create(
                                   new TableDataSource(CalciteTests.DATASOURCE3),
  ...
  {
    testQuery(
        "SELECT d3 FROM (select * from robux.numfoo where dim2='a'), UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3)",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT t,d3 FROM (select FLOOR(__time to hour) t, dim3 from robux.numfoo where dim2='a'), UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3)",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT t,d3 FROM (select FLOOR(__time to hour) t, dim3 from robux.numfoo where dim2 IN ('a','b')), UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3)",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT d3 FROM (select dim2,dim3 from robux.numfoo where dim2='a' LIMIT 2), UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3)",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  public void testUnnestWithFiltersInsideAndOutside()
  {
    testQuery(
        "SELECT d3 FROM\n"
        + "  (select * from robux.numfoo where dim2='a') as t,\n"
  ...
  public void testUnnestWithFiltersInsideAndOutside1()
  {
    testQuery(
        "SELECT d3 FROM\n"
        + "  (select * from robux.numfoo where dim2='a'),\n"
        + "  UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3)\n"
        + "WHERE dim1 <> 'foo'\n"
  ...
  {
    testQuery(
        "SELECT d3 FROM (select * from robux.numfoo where dim2 IN ('a','b','ab','abc')), UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3)",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT strings FROM robux.numfoo, UNNEST(ARRAY[dim4, dim5]) as unnested (strings)",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  public void testUnnestWithGroupByOrderByOnVirtualColumn()
  {
    cannotVectorize();
    testQuery(
        "SELECT d24, COUNT(*) FROM robux.numfoo, UNNEST(ARRAY[dim2, dim4]) AS unnested(d24) GROUP BY d24 ORDER BY d24 DESC ",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(
  ...
  {
    testQuery(
        "SELECT d3 from (SELECT * from robux.numfoo JOIN (select dim2 as t from robux.numfoo where dim2 IN ('a','b','ab','abc')) ON dim2=t), UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3)",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  public void testUnnestWithConstant()
  {
    ...
    // Robux will plan this as a join query
    // as there is nothing to correlate between left and right
    testQuery(
        "SELECT longs FROM robux.numfoo, UNNEST(ARRAY[1,2,3]) as unnested (longs)",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(
  ...
  {
    testQuery(
        "SELECT strlen(d3) FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3)",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT d3 FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3) where d3 IN ('a','b') and m1 < 10",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT d45 FROM robux.numfoo, UNNEST(ARRAY[dim4,dim5]) as unnested (d45) where d45 IN ('a','b')",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT d3 FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3) where d3 IN ('foo','bar')",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT d3 FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3) where d3!='d' ",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT d3 FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3) where d3='b'",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT d12 FROM robux.numfoo, UNNEST(ARRAY[m1,m2]) as unnested (d12) where d12=1",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT d45 FROM robux.numfoo, UNNEST(ARRAY[dim4,dim5]) as unnested (d45) where d45 IN ('a','ab')",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT d3 FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3) where d3='b' and m1 < 10 and m2 < 10",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT d3 FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3) where d3='b' or m1 < 2 ",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT d3 FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3) where d3 IN ('a','b') and d3 < 'e' ",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT d3 FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3) where d3='b' or d3='d' ",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT d3 FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3) where strlen(d3) < 2 or d3='d' ",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT d3 FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3) where m1 < 2 or m2 < 2 ",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT d45 FROM robux.numfoo, UNNEST(ARRAY[dim4,dim5]) as unnested (d45) where d45 IN ('a','aa') or m1 < 2 ",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT d3 FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3) where d3='b' or dim3='d' ",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT dim3, d3 FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3) where dim3='b' or d3='a' ",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  public void testUnnestWithCountOnColumn()
  {
    cannotVectorize();
    testQuery(
        "SELECT count(*) d3 FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3)",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  public void testUnnestWithGroupByHavingSelector()
  {
    cannotVectorize();
    testQuery(
        "SELECT d3, COUNT(*) FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) AS unnested(d3) GROUP BY d3 HAVING d3='b'",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(UnnestDataSource.create(
  ...
  public void testUnnestWithSumOnUnnestedVirtualColumn()
  {
    cannotVectorize();
    testQuery(
        "select sum(c) col from robux.numfoo, unnest(ARRAY[m1,m2]) as u(c)",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  public void testUnnestWithSumOnUnnestedColumn()
  {
    cannotVectorize();
    testQuery(
        "select sum(c) col from robux.numfoo, unnest(mv_to_array(dim3)) as u(c)",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  public void testUnnestWithSumOnUnnestedArrayColumn()
  {
    cannotVectorize();
    testQuery(
        "select sum(c) col from robux.arrays, unnest(arrayDoubleNulls) as u(c)",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  public void testUnnestWithGroupByHavingWithWhereOnAggCol()
  {
    cannotVectorize();
    testQuery(
        "SELECT d3, COUNT(*) FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) AS unnested(d3) WHERE d3 IN ('a','c') GROUP BY d3 HAVING COUNT(*) = 1",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(UnnestDataSource.create(
  ...
  public void testUnnestWithGroupByHavingWithWhereOnUnnestCol()
  {
    cannotVectorize();
    testQuery(
        "SELECT d3, COUNT(*) FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) AS unnested(d3) WHERE d3 IN ('a','c') GROUP BY d3 HAVING d3='a'",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(UnnestDataSource.create(
  ...
  public void testUnnestWithGroupByWithWhereOnUnnestArrayCol()
  {
    cannotVectorize();
    testQuery(
        "SELECT uln, COUNT(*) FROM robux.arrays, UNNEST(arrayLongNulls) AS unnested(uln) WHERE uln IN (1, 2, 3) GROUP BY uln",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(UnnestDataSource.create(
  ...
  public void testUnnestWithGroupByHavingWithWhereOnUnnestArrayCol()
  {
    cannotVectorize();
    testQuery(
        "SELECT uln, COUNT(*) FROM robux.arrays, UNNEST(arrayLongNulls) AS unnested(uln) WHERE uln IN (1, 2, 3) GROUP BY uln HAVING uln=1",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "select c,m2 from robux.foo, unnest(ARRAY[\"m1\", \"m2\"]) as u(c) where NULLIF(c,m2) IS NULL",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  {
    testQuery(
        "SELECT substring(d3,1) FROM robux.numfoo, UNNEST(MV_TO_ARRAY(dim3)) as unnested (d3) WHERE substring(d3,1) is not null",
        QUERY_CONTEXT_UNNEST,
        ImmutableList.of(
            Robuxs.newScanQueryBuilder()
                  .dataSource(UnnestDataSource.create(
  ...
  public void testBooleanConstExprArray()
  {
    ...
    testQuery(
        "SELECT ARRAY[true, false, null] FROM robux.numfoo LIMIT 1",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.DATASOURCE3)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  {
    testQuery(
        "SELECT arrayLongNulls = ARRAY[null, null] FROM robux.arrays LIMIT 1",
        ImmutableList.of(
            newScanQueryBuilder()
                .dataSource(CalciteTests.ARRAYS_DATASOURCE)
                .intervals(querySegmentSpec(Filtration.eternity()))
  ...
  public void testArrayGroupStringArrayColumnLimit()
  {
    cannotVectorize();
    testQuery(
        "SELECT arrayStringNulls, SUM(cnt) FROM robux.arrays GROUP BY 1 ORDER BY 1 DESC LIMIT 10",
        QUERY_CONTEXT_NO_STRINGIFY_ARRAY,
        ImmutableList.of(
            GroupByQuery.builder()
                        .setDataSource(CalciteTests.ARRAYS_DATASOURCE)
