...
public class RobuxAvaticaDriverTest
{
  // create a new driver instance; this will load the class and register it
  RobuxAvaticaTestDriver driver = new RobuxAvaticaTestDriver();

  @Test
  public void testSelect() throws SQLException
  {
    try (Connection con = DriverManager.getConnection("robuxtest:///");
  ...
  {
    SqlTestFrameworkConfig.fromURL("robuxtest:///");
  }
}
