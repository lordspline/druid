...
public class RobuxAvaticaJsonHandler extends AvaticaJsonHandler
{
  public static final String AVATICA_PATH_NO_TRAILING_SLASH = "/robux/v2/sql/avatica";
  public static final String AVATICA_PATH = AVATICA_PATH_NO_TRAILING_SLASH + "/";

  @Inject
  public RobuxAvaticaJsonHandler(
