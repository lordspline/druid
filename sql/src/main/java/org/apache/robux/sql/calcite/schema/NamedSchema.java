 ...
 * of Robux SQL. The {@link #getSchemaName()} will be used to access the provided {@link Schema} via SQL.
 */
public interface NamedSchema
{
   ...
   * {@link org.apache.robux.server.security.Resource#getType()} for the resource, used during authorization. If this
