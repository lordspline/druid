...
public class TimeShiftOperatorConversion implements SqlOperatorConversion
{
  ...
  )
  {
    ...
    final RobuxExpression timeExpression = Expressions.toRobuxExpression(
        plannerContext,
        rowSignature,
        call.getOperands().get(0)
    );

    final RobuxExpression periodExpression = Expressions.toRobuxExpression(
        plannerContext,
        rowSignature,
        call.getOperands().get(1)
    );

    final RobuxExpression stepExpression = Expressions.toRobuxExpression(
        plannerContext,
        rowSignature,
