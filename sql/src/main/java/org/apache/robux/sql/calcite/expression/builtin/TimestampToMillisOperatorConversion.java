...
public class TimestampToMillisOperatorConversion implements SqlOperatorConversion
{
  ...
  {
    // Nothing to do, just leave the operand unchanged. Robux treats millis and timestamps the same internally.
    final RexCall call = (RexCall) rexNode;
    return Expressions.toRobuxExpression(plannerContext, rowSignature, Iterables.getOnlyElement(call.getOperands()));
  }
}
