 ...
 */
public abstract class RobuxUserDefinedTableMacroConversion implements SqlOperatorConversion
{
  private final SqlUserDefinedTableMacro operator;

  public RobuxUserDefinedTableMacroConversion(
      final String name,
  ...
  {
    this.operator = new RobuxUserDefinedTableMacro(
        new RobuxTableMacro(name, fn, jsonMapper)
    );
  }
