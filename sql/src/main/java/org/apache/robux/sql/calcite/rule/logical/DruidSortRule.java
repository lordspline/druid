...
/**
 * {@link ConverterRule} to convert {@link Sort} to {@link RobuxSort}
 */
public class RobuxSortRule extends ConverterRule
{

  public RobuxSortRule(
  ...
  public RelNode convert(RelNode rel)
  {
    ...
    return RobuxSort.create(
        convert(
            sort.getInput(),
            sort.getInput().getTraitSet().replace(RobuxLogicalConvention.instance())
        ),
        sort.getCollation(),
        sort.offset,
        sort.fetch
