...
/**
 * Represents a specialized table used within Robux's Calcite-based planner.
 * Used in {@link org.apache.robux.sql.calcite.rule.RobuxLogicalValuesRule RobuxLogicalValuesRule}
 * to implement trivial {@code SELECT 1} style queries that return constant values represented
 * by this inline table.
 */
public class InlineTable extends RobuxTable
{
