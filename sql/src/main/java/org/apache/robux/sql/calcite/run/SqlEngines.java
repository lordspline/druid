...
public class SqlEngines
{
   ...
   */
  public static RobuxException generateUnrecognizedFeatureException(
  ...
  )
  {
    return RobuxException
        ...
        .build(
            ...
            + "its availability. Please raise an issue if you encounter this exception while using Robux.",
            engineName,
            unrecognizedFeature
        );
  }
