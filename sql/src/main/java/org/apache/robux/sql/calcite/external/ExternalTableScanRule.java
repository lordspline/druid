...
/**
 * Rule that converts an {@link ExternalTableScan} to a call to {@link RobuxQueryRel#scanExternal}.
 *
...
public class ExternalTableScanRule extends RelOptRule
{
  ...
  public void onMatch(final RelOptRuleCall call)
  {
    ...
    call.transformTo(RobuxQueryRel.scanExternal(scan, plannerContext));
  }
}
