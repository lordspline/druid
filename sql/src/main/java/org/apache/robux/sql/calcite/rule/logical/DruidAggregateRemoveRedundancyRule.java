 ...
 */
@Value.Enclosing
public class RobuxAggregateRemoveRedundancyRule
    extends RelOptRule
    implements TransformationRule
{

  /**
   * Creates a RobuxAggregateRemoveRedundancyRule.
   */
  private static final RobuxAggregateRemoveRedundancyRule INSTANCE = new RobuxAggregateRemoveRedundancyRule();

  private RobuxAggregateRemoveRedundancyRule()
  {
    super(operand(Aggregate.class, operand(Project.class, any())));
  }

  public static RobuxAggregateRemoveRedundancyRule instance()
  {
    return INSTANCE;
  }
