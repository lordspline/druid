 ...
 * HTTP, such as {@link org.apache.robux.sql.http.SqlResource}. The main use case of
 ...
 * {@link org.apache.robux.server.QueryScheduler}. As its name indicates, it
 * also performs resource scheduling for native queries based on query lanes
 * {@link org.apache.robux.server.QueryLaningStrategy}.
 *
 * @see org.apache.robux.server.QueryScheduler#cancelQuery(String)
 */
@LazySingleton
