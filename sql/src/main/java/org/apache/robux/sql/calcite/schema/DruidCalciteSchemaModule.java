 ...
 */
public class RobuxCalciteSchemaModule implements Module
{
  ...
  public void configure(Binder binder)
  {
    ...
    binder.bind(RobuxSchemaCatalog.class)
    ...
    binder.bind(RobuxSchema.class).in(LazySingleton.class);
    ...
    SqlBindings.addSchema(binder, NamedRobuxSchema.class);
  ...
  @Provides
  @LazySingleton
  private RobuxSchemaCatalog getRootSchema(@Named(INCOMPLETE_SCHEMA) RobuxSchemaCatalog rootSchema, InformationSchema informationSchema)
  {
