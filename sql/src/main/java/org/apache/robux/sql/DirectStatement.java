...
public class DirectStatement extends AbstractStatement implements Cancelable
{
   ...
   * execute the query. In Robux, prepare and plan are different: prepare provides
   ...
   * <li>Provide parameters using a <a href="https://github.com/apache/robux/pull/6974">
   * "query optimized"</a> structure.</li>
   * <li>Validate the query against the Robux catalog.</li>
  ...
  public ResultSet plan()
  {
    ...
    try (RobuxPlanner planner = createPlanner()) {
      validate(planner);
   ...
   */
  @VisibleForTesting
  protected PlannerResult createPlan(RobuxPlanner planner)
  {
    return planner.plan();
  }
