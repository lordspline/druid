 ...
 * This is the Robux version support for https://issues.apache.org/jira/browse/CALCITE-4173
 *
...
{
  private static final RexBuilder REX_BUILDER = new RexBuilder(RobuxTypeSystem.TYPE_FACTORY);
  ...
  {
    return Expressions.toRobuxExpression(
        plannerContext,
        rowSignature,
