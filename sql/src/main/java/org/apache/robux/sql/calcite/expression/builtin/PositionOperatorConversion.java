...
{
  private static final RobuxExpression ZERO = RobuxExpression.ofLiteral(ColumnType.LONG, "0");
  ...
  )
  {
    return OperatorConversions.convertCall(
        ...
        robuxExpressions -> RobuxExpression.ofExpression(
            ColumnType.LONG,
            (args) -> {
              final RobuxExpression fromIndexExpression;
              if (args.size() > 2) {
                fromIndexExpression = RobuxExpression.ofExpression(
                    ColumnType.LONG,
