...
public class PreparedStatement extends AbstractStatement
{
   ...
   * query to use the <a href="https://github.com/apache/robux/pull/6974">
  ...
  {
    try (RobuxPlanner planner = getPlanner()) {
      validate(planner);
  ...
  /**
   * Execute a prepared JDBC query. Robux uses
   * <a href="https://github.com/apache/robux/pull/6974">
