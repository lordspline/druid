...
/**
 * Container class for {@link #validateLogicalQueryForRobux}.
 */
public class QueryValidations
{
  /**
   * Validate a {@link RelNode} prior to attempting to convert it to a Robux query. Useful for generating nice error
   * messages for things we know we definitely don't support.
   */
  public static void validateLogicalQueryForRobux(
