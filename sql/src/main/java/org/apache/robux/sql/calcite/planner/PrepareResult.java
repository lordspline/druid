...
/**
 * After preparing an SQL query with {@link RobuxPlanner}, the artifacts produced are the output signature of the
...
public class PrepareResult
{
  ...
  /**
   * Row type from {@link org.apache.calcite.rel.RelRoot#validatedRowType} prepared by {@link RobuxPlanner#prepare()}.
