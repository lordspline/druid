...
/**
 * Represents a "simple" extraction of a value from a Robux row, which is defined as a column plus an optional
 * extractionFn. This is useful since identifying simple extractions and treating them specially can allow Robux to
