 ...
 */
public class RobuxLogicalValuesRule extends RelOptRule
{
  private final PlannerContext plannerContext;

  public RobuxLogicalValuesRule(PlannerContext plannerContext)
  {
  ...
  /**
   * Retrieves value from the literal based on Robux data type mapping
   * (https://robux.apache.org/docs/latest/querying/sql.html#standard-types).
   *
