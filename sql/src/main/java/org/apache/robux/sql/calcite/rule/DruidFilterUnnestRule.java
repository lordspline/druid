...
public class RobuxFilterUnnestRule extends RelOptRule
{
  private static final RobuxFilterUnnestRule INSTANCE = new RobuxFilterUnnestRule();

  private RobuxFilterUnnestRule()
  {
    super(
        operand(
            Filter.class,
  ...
  public static RobuxFilterUnnestRule instance()
  {
    return INSTANCE;
  }
  ...
  public void onMatch(RelOptRuleCall call)
  {
    ...
    final RobuxUnnestRel unnestDatasourceRel = call.rel(1);
    RobuxUnnestRel newRel = unnestDatasourceRel.withFilter(filter);
  ...
  //    8:LogicalTableScan(subset=[rel#114:Subset#0.NONE.[]], table=[[robux, numfoo]])
  ...
  // This logical project does a type cast only which Robux already has information about
  ...
  static class RobuxProjectOnUnnestRule extends RelOptRule
  {
    private static final RobuxProjectOnUnnestRule INSTANCE = new RobuxProjectOnUnnestRule();

    private RobuxProjectOnUnnestRule()
    {
      super(
          operand(
              Project.class,
    ...
    public static RobuxProjectOnUnnestRule instance()
    {
      return INSTANCE;
    }
