...
/**
 * Represents an source of data external to Robux: a CSV file, an HTTP request, etc.
 * Each such table represents one of Robux's {@link DataSource} types. Since SQL
 ...
 * from the Robux Catalog.
 */
public class ExternalTable extends RobuxTable
{
