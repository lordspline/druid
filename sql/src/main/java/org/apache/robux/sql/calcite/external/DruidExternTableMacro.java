...
/**
 * Used by {@link ExternalOperatorConversion} to generate a {@link RobuxTable}
 * that references an {@link ExternalDataSource}.
 */
public class RobuxExternTableMacro extends RobuxUserDefinedTableMacro
{
  public RobuxExternTableMacro(RobuxTableMacro macro)
  {
    super(macro);
  }
  ...
  public Set<ResourceAction> computeResources(final SqlCall call, boolean inputSourceTypeSecurityEnabled)
  {
    ...
    try {
      InputSource inputSource = ((RobuxTableMacro) macro).getJsonMapper().readValue(inputSourceStr, InputSource.class);
