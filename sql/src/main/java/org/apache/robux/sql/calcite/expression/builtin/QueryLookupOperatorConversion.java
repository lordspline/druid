...
public class QueryLookupOperatorConversion implements SqlOperatorConversion
{
  ...
  )
  {
    return OperatorConversions.convertDirectCallWithExtraction(
        ...
        inputExpressions -> {
          final RobuxExpression arg = inputExpressions.get(0);
  ...
  /**
   * For {@link org.apache.robux.sql.calcite.rule.RobuxRules} to be able to instantiate
  ...
  private String getReplaceMissingValueWith(
      final List<RobuxExpression> inputExpressions,
      final PlannerContext plannerContext
  )
  {
