...
public class RobuxLiteral
{
  ...
  RobuxLiteral(final ExpressionType type, @Nullable final Object value)
  {
    this.type = type;
    this.value = value;
  }
  ...
  public RobuxLiteral castTo(final ExpressionType toType)
  {
    ...
    return new RobuxLiteral(castEval.type(), castEval.value());
  }
}
