...
public class RobuxJoin extends Join implements RobuxLogicalNode, SourceDescProducer
{
  public RobuxJoin(RelOptCluster cluster,
  ...
  {
    return new RobuxJoin(getCluster(), traitSet, hints, left, right, conditionExpr, variablesSet, joinType);
  }
  ...
  public SourceDesc getSourceDesc(PlannerContext plannerContext, List<SourceDesc> sources)
  {
    ...
    return RobuxJoinQueryRel.buildJoinSourceDesc(leftDesc, rightDesc, plannerContext, this, null);
  }
}
