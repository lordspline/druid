...
/**
 * Constants used by {@link PartialRobuxQuery#estimateCost} and various
 * {@link RobuxRel#computeSelfCost(RelOptPlanner, RelMetadataQuery)} implementations.
 */
public class CostEstimates
{
  ...
  /**
   * Multiplier to apply to an outer query via {@link RobuxOuterQueryRel}. Encourages pushing down time-saving
