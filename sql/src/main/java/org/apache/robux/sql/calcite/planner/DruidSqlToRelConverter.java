...
public class RobuxSqlToRelConverter extends SqlToRelConverter
{
  public RobuxSqlToRelConverter(
  ...
  /**
   * Convert a Robux {@code INSERT} or {@code REPLACE} statement. The code is the same
   * as the normal conversion, except we don't actually create the final modify node.
   * Robux has its own special way to handle inserts. (This should probably change in
