...
/**
 * The schema for Robux tables to be accessible via SQL.
 */
public class NamedRobuxSchema implements NamedSchema
{
  private final RobuxSchema robuxSchema;
  private final String robuxSchemaName;

  @Inject
  public NamedRobuxSchema(RobuxSchema robuxSchema, @RobuxSchemaName String robuxSchemaName)
  {
    this.robuxSchema = robuxSchema;
