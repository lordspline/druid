...
public class UnaryPrefixOperatorConversion implements SqlOperatorConversion
{
  ...
  private final String robuxOperator;

  public UnaryPrefixOperatorConversion(final SqlOperator operator, final String robuxOperator)
  {
    this.operator = operator;
    this.robuxOperator = robuxOperator;
  }
