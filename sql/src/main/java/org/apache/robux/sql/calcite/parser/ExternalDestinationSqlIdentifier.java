...
public class ExternalDestinationSqlIdentifier extends SqlIdentifier
{
  ...
  public String getDestinationType()
  {
    return CollectionUtils.getOnlyElement(
        names,
        x -> RobuxException.defensive("Expected single name in external destination identifier, but got [%s]", names)
    );
  }
  ...
  public Object clone()
  {
    throw RobuxException.defensive("Function is deprecated, please use clone(SqlNode) instead.");
  }
