...
/**
 * Robux extension of {@link AggregateCaseToFilterRule}.
 *
 ...
 * </pre>
 */
public class RobuxAggregateCaseToFilterRule extends RelOptRule implements SubstitutionRule
{
  private boolean extendedFilteredSumRewrite;

  public RobuxAggregateCaseToFilterRule(boolean extendedFilteredSumRewrite)
  {
      ...
      Project project, List<RexNode> newProjects)
  {
    ...
    // however it may have some performance impact in Robux
