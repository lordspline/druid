...
/**
 * Represents Robux's concept of a "group by": dimensions, aggregations, post-aggregations, and 'having' filters. This
...
public class Grouping
{
   ...
   *
   * @see RobuxQuery#computeGrouping which uses this
   */
  public Grouping applyProject(final PlannerContext plannerContext, final Project project)
  {
    ...
    for (int i = 0; i < dimensions.size(); i++) {
      ...
      if (plannerContext.parseExpression(dimension.getRobuxExpression().getExpression()).isLiteral()
