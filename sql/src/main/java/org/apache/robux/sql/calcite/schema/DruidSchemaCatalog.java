...
/**
 * The Robux 'catalog', containing information about all Robux schemas which are available. This packages both the 'root
 ...
 * {@link org.apache.robux.server.security.Resource#getType()} to use for authorization.
 */
public class RobuxSchemaCatalog
{
  private final SchemaPlus rootSchema;
  private final Map<String, NamedSchema> namedSchemas;

  public RobuxSchemaCatalog(
  ...
  /**
   * Get all {@link NamedSchema} which belong to the Robux catalog
   */
   ...
   * the appropriate value to use for {@link org.apache.robux.server.security.Resource#getType()} during authorization
   */
  @Nullable
  ...
  public boolean equals(Object o)
  {
    ...
    final RobuxSchemaCatalog that = (RobuxSchemaCatalog) o;
