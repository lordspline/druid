...
package org.apache.robux.sql.calcite.run;
...
public enum EngineFeature
{
  ...
  /**
   * Queries of type {@link org.apache.robux.query.timeseries.TimeseriesQuery} are usable.
   */
  TIMESERIES_QUERY,

  /**
   * Queries of type {@link org.apache.robux.query.topn.TopNQuery} are usable.
   */
  TOPN_QUERY,

  /**
   * Queries of type {@link org.apache.robux.query.timeboundary.TimeBoundaryQuery} are usable.
   */
  TIME_BOUNDARY_QUERY,
  ...
  /**
   * Scan queries can use {@link org.apache.robux.query.scan.ScanQuery#getOrderBys()} that are based on something
   * other than the "__time" column.
   */
  SCAN_ORDER_BY_NON_TIME,

  /**
   * Scan queries must have {@link org.apache.robux.sql.calcite.rel.RobuxQuery#CTX_SCAN_SIGNATURE} set in their
   * query contexts.
   *
   * {@link Deprecated} Instead of the context value {@link org.apache.robux.query.scan.ScanQuery#getRowSignature()} can be used.
   */
  @Deprecated
  ...
  /**
   * Planner is permitted to use {@link org.apache.robux.sql.calcite.rel.RobuxUnionRel} to plan the top level UNION ALL.
  ...
  /**
   * Queries can write to an external datasource using {@link org.apache.robux.sql.destination.ExportDestination}
   */
  WRITE_EXTERNAL_DATA,
   ...
   * {@link org.apache.robux.timeline.partition.DimensionRangeShardSpec}.
   */
