...
public class RobuxUnionRule extends ConverterRule
{
  public RobuxUnionRule(Class<? extends RelNode> clazz, RelTrait in, RelTrait out, String descriptionPrefix)
  {
    super(
        Config.INSTANCE
