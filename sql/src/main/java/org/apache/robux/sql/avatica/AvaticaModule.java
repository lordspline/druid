...
import org.apache.robux.server.initialization.jetty.JettyBindings;
...
public class AvaticaModule implements Module
{
  ...
  {
    JsonConfigProvider.bind(binder, "robux.sql.avatica", AvaticaServerConfig.class);
    binder.bind(AvaticaMonitor.class).in(LazySingleton.class);
    JettyBindings.addHandler(binder, RobuxAvaticaJsonHandler.class);
    JettyBindings.addHandler(binder, RobuxAvaticaProtobufHandler.class);
