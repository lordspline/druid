...
import org.apache.robux.query.operator.NaivePartitioningOperatorFactory;
import org.apache.robux.query.operator.NaiveSortOperatorFactory;
import org.apache.robux.query.operator.OperatorFactory;
import org.apache.robux.query.operator.window.ComposingProcessor;
import org.apache.robux.query.operator.window.Processor;
import org.apache.robux.query.operator.window.WindowFrame;
import org.apache.robux.query.operator.window.WindowFramedAggregateProcessor;
import org.apache.robux.query.operator.window.WindowOperatorFactory;
import org.apache.robux.query.operator.window.ranking.WindowCumeDistProcessor;
import org.apache.robux.query.operator.window.ranking.WindowDenseRankProcessor;
import org.apache.robux.query.operator.window.ranking.WindowPercentileProcessor;
import org.apache.robux.query.operator.window.ranking.WindowRankProcessor;
import org.apache.robux.query.operator.window.ranking.WindowRowNumberProcessor;
import org.apache.robux.query.operator.window.value.WindowFirstProcessor;
import org.apache.robux.query.operator.window.value.WindowLastProcessor;
import org.apache.robux.query.operator.window.value.WindowOffsetProcessor;
...
/**
 * Maps onto a {@link org.apache.robux.query.operator.WindowOperatorQuery}.
 * <p>
...
public class Windowing
{
  ...
  )
  {
    ...
    if (partialQuery.getWindowProject() != null) {
      // We know windowProject is a mapping due to the isMapping() check in RobuxRules.
  ...
  private static class WindowAggregate
  {
    ...
    public String getColumn(int argPosition)
    {
      ...
      final RobuxExpression expression = Expressions.toRobuxExpression(context, sig, columnArgument);
      if (expression == null) {
