...
/**
 * Represents a SQL table that models a Robux datasource.
 * <p>
 ...
 */
public class DatasourceTable extends RobuxTable
{
  /**
  ...
  public String toString()
  {
    ...
    // effectiveMetadata.
    return "RobuxTable{physicalMetadata=" +
