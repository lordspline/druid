...
public class TimeCeilOperatorConversion implements SqlOperatorConversion
{
  ...
  )
  {
    ...
    final List<RobuxExpression> functionArgs = TimeFloorOperatorConversion.toTimestampFloorOrCeilArgs(
        plannerContext,
        rowSignature,
        call.getOperands()
    );
    ...
    return RobuxExpression.ofFunctionCall(Calcites.getColumnTypeForRelDataType(rexNode.getType()), "timestamp_ceil", functionArgs);
  }
}
