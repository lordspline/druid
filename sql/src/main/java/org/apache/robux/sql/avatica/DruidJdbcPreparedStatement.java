...
/**
 * The Robux implementation of the server-side representation of the
 ...
 * {@link RobuxJdbcResultSet}. Only one execution is active at a time.
 */
public class RobuxJdbcPreparedStatement extends AbstractRobuxJdbcStatement
{
  ...
  public RobuxJdbcPreparedStatement(
  ...
  public synchronized void execute(List<TypedValue> parameters)
  {
    ...
    try {
      ...
      resultSet = new RobuxJdbcResultSet(this, directStmt, maxRowCount, fetcherFactory);
      resultSet.execute();
    }
