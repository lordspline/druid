...
/**
 * Interface for hooks that can be invoked by {@link RobuxHookDispatcher}.
 *
 * HookKey should be added at every place a new hook is needed.
 */
@FunctionalInterface
public interface RobuxHook<T>
{
  ...
  HookKey<RelNode> ROBUX_PLAN = new HookKey<>("robuxPlan", RelNode.class);
