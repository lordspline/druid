...
import org.apache.robux.math.expr.BuiltInExprMacros;
import org.apache.robux.sql.calcite.aggregation.SqlAggregator;
import org.apache.robux.sql.calcite.aggregation.builtin.ArrayConcatSqlAggregator;
import org.apache.robux.sql.calcite.aggregation.builtin.ArraySqlAggregator;
import org.apache.robux.sql.calcite.aggregation.builtin.AvgSqlAggregator;
import org.apache.robux.sql.calcite.aggregation.builtin.BitwiseSqlAggregator;
import org.apache.robux.sql.calcite.aggregation.builtin.BuiltinApproxCountDistinctSqlAggregator;
import org.apache.robux.sql.calcite.aggregation.builtin.EarliestLatestAnySqlAggregator;
import org.apache.robux.sql.calcite.aggregation.builtin.EarliestLatestBySqlAggregator;
import org.apache.robux.sql.calcite.aggregation.builtin.GroupingSqlAggregator;
import org.apache.robux.sql.calcite.aggregation.builtin.LiteralSqlAggregator;
import org.apache.robux.sql.calcite.aggregation.builtin.MaxSqlAggregator;
import org.apache.robux.sql.calcite.aggregation.builtin.MinSqlAggregator;
import org.apache.robux.sql.calcite.aggregation.builtin.SingleValueSqlAggregator;
import org.apache.robux.sql.calcite.aggregation.builtin.StringSqlAggregator;
import org.apache.robux.sql.calcite.aggregation.builtin.SumSqlAggregator;
import org.apache.robux.sql.calcite.aggregation.builtin.SumZeroSqlAggregator;
import org.apache.robux.sql.calcite.expression.AliasedOperatorConversion;
import org.apache.robux.sql.calcite.expression.BinaryOperatorConversion;
...
import org.apache.robux.sql.calcite.expression.UnaryPrefixOperatorConversion;
import org.apache.robux.sql.calcite.expression.WindowSqlAggregate;
import org.apache.robux.sql.calcite.expression.builtin.ArrayAppendOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.ArrayConcatOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.ArrayConstructorOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.ArrayContainsOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.ArrayLengthOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.ArrayOffsetOfOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.ArrayOffsetOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.ArrayOrdinalOfOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.ArrayOrdinalOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.ArrayOverlapOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.ArrayPrependOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.ArrayQuantileOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.ArraySliceOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.ArrayToMultiValueStringOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.ArrayToStringOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.BTrimOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.CastOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.CeilOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.CoalesceOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.ComplexDecodeBase64OperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.ConcatOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.ContainsOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.DateTruncOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.DecodeBase64UTFOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.DivOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.ExtractOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.FloorOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.GreatestOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.HumanReadableFormatOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.IPv4AddressMatchOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.IPv4AddressParseOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.IPv4AddressStringifyOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.IPv6AddressMatchOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.LPadOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.LTrimOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.LeastOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.LeftOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.LikeOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.MillisToTimestampOperatorConversion;
...
import org.apache.robux.sql.calcite.expression.builtin.NestedDataOperatorConversions;
import org.apache.robux.sql.calcite.expression.builtin.ParseLongOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.PositionOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.RPadOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.RTrimOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.RegexpExtractOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.RegexpLikeOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.RegexpReplaceOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.ReinterpretOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.RepeatOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.ReverseOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.RightOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.SafeDivideOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.ScalarInArrayOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.SearchOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.StringFormatOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.StringToArrayOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.StrposOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.SubstringOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.TextcatOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.TimeArithmeticOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.TimeCeilOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.TimeExtractOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.TimeFloorOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.TimeFormatOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.TimeParseOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.TimeShiftOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.TimestampToMillisOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.TrimOperatorConversion;
import org.apache.robux.sql.calcite.expression.builtin.TruncateOperatorConversion;
import org.apache.robux.sql.calcite.external.TableAppendMacro;
...
public class RobuxOperatorTable implements SqlOperatorTable
{
  ...
  private static final List<SqlOperatorConversion> BITWISE_OPERATOR_CONVERSIONS =
      ImmutableList.<SqlOperatorConversion>builder()
                   .add(OperatorConversions.robuxBinaryLongFn("BITWISE_AND", "bitwiseAnd"))
                   .add(OperatorConversions.robuxUnaryLongFn("BITWISE_COMPLEMENT", "bitwiseComplement"))
                   .add(OperatorConversions.robuxBinaryLongFn("BITWISE_OR", "bitwiseOr"))
                   .add(OperatorConversions.robuxBinaryLongFn("BITWISE_SHIFT_LEFT", "bitwiseShiftLeft"))
                   .add(OperatorConversions.robuxBinaryLongFn("BITWISE_SHIFT_RIGHT", "bitwiseShiftRight"))
                   .add(OperatorConversions.robuxBinaryLongFn("BITWISE_XOR", "bitwiseXor"))
                   .add(
                       OperatorConversions.robuxUnaryLongFn(
                           "BITWISE_CONVERT_DOUBLE_TO_LONG_BITS",
                           "bitwiseConvertDoubleToLongBits"
                       )
                   )
                   .add(
                       OperatorConversions.robuxUnaryDoubleFn(
  ...
  private static final Map<OperatorKey, SqlOperator> CONVERTLET_OPERATORS =
      RobuxConvertletTable.knownOperators()
                          .stream()
  ...
  public List<SqlOperator> getOperatorList()
  {
    ...
    retVal.addAll(RobuxConvertletTable.knownOperators());
    return retVal;
  }
  ...
  {
    if (!RobuxOperatorTable.isFunctionSyntax(syntax)) {
      return syntax;
    } else {
