...
public class RobuxTableScanRule extends RelOptRule
{
  private final PlannerContext plannerContext;

  public RobuxTableScanRule(final PlannerContext plannerContext)
  {
  ...
  public void onMatch(final RelOptRuleCall call)
  {
    ...
    if (robuxTable != null) {
      call.transformTo(
          RobuxQueryRel.scanTable(scan, table, robuxTable, plannerContext)
      );
    }
  }
}
