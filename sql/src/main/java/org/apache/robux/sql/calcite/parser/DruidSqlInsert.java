...
import org.apache.robux.sql.calcite.planner.RobuxSqlIngestOperator;

import javax.annotation.Nonnull;
import javax.annotation.Nullable;

/**
 * Extends the 'insert' call to hold custom parameters specific to Robux i.e. PARTITIONED BY and CLUSTERED BY
 * This class extends the {@link RobuxSqlIngest} so that this SqlNode can be used in
 * {@link org.apache.calcite.sql2rel.SqlToRelConverter} for getting converted into RelNode, and further processing
 */
public class RobuxSqlInsert extends RobuxSqlIngest
{
  ...
  public static final SqlOperator OPERATOR = RobuxSqlIngestOperator.INSERT_OPERATOR;

  public static RobuxSqlInsert create(
   ...
   * {@link org.apache.robux.sql.calcite.planner.IngestHandler#validate()} performs checks to ensure that. This helps
