...
public class ExternalTableScan extends AbstractRelNode
{
  ...
  private final ExternalTable robuxTable;

  public ExternalTableScan(
      final RelOptCluster cluster,
      final ObjectMapper jsonMapper,
      final ExternalTable robuxTable
  )
  {
    super(cluster, cluster.traitSetOf(Convention.NONE));
    this.jsonMapper = jsonMapper;
    this.robuxTable = robuxTable;
  }
  ...
  {
    return robuxTable.getRowType(getCluster().getTypeFactory());
  }
  ...
  public RelWriter explainTerms(RelWriter pw)
  {
    ...
    try {
      dataSourceString = jsonMapper.writeValueAsString(robuxTable.getDataSource());
    }
