...
/**
 * Bridge between Robux and SQL aggregators.
 */
public interface SqlAggregator
{
  ...
  /**
   * Returns a Robux Aggregation corresponding to a SQL {@link AggregateCall}. This method should ignore filters;
   ...
   *                              aggregators, where required. This is set for subqueries where Robux's native query
   *                              layer does not do this automatically.
   * @return aggregation, or null if the call cannot be translated
   */
  @Nullable
  default Aggregation toRobuxAggregation(
  ...
  {
    return toRobuxAggregation(plannerContext,
