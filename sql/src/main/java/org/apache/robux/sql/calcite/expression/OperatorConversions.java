...
public class OperatorConversions
{
  ...
  @Nullable
  public static RobuxExpression convertDirectCall(
  ...
  )
  {
    return convertCall(
        ...
        rowSignature,
        rexNode,
        robuxExpressions -> RobuxExpression.ofFunctionCall(
  ...
  @Nullable
  public static RobuxExpression convertDirectCallWithExtraction(
      final PlannerContext plannerContext,
      final RowSignature rowSignature,
      final RexNode rexNode,
      final String functionName,
      final Function<List<RobuxExpression>, SimpleExtraction> simpleExtractionFunction
  )
  {
    return convertCall(
        plannerContext,
        ...
        robuxExpressions -> RobuxExpression.ofExpression(
            Calcites.getColumnTypeForRelDataType(rexNode.getType()),
            simpleExtractionFunction == null ? null : simpleExtractionFunction.apply(robuxExpressions),
            RobuxExpression.functionCall(functionName),
            robuxExpressions
        )
    );
  }
  ...
  @Nullable
  public static RobuxExpression convertCallBuilder(
      final PlannerContext plannerContext,
      final RowSignature rowSignature,
      final RexNode rexNode,
      final RobuxExpression.ExpressionGenerator expressionGenerator
  )
  {
    return convertCall(
        plannerContext,
        rowSignature,
        rexNode,
        (operands) -> RobuxExpression.ofExpression(
            Calcites.getColumnTypeForRelDataType(rexNode.getType()),
            expressionGenerator,
            operands
        )
  ...
  @Nullable
  public static RobuxExpression convertCall(
      final PlannerContext plannerContext,
      final RowSignature rowSignature,
      final RexNode rexNode,
      final RobuxExpression.RobuxExpressionCreator expressionFunction
  )
  {
  ...
  @Nullable
  public static RobuxExpression convertCallWithPostAggOperands(
      final PlannerContext plannerContext,
      final RowSignature rowSignature,
      final RexNode rexNode,
      final RobuxExpression.RobuxExpressionCreator expressionFunction,
  ...
  )
  {
    ...
    final List<RobuxExpression> robuxExpressions = Expressions.toRobuxExpressionsWithPostAggOperands(
        plannerContext,
        rowSignature,
        call.getOperands(),
  ...
  /**
   * Translate a Calcite {@code RexNode} to a Robux PostAggregator
   *
  ...
  public static class AggregatorBuilder extends OperatorBuilder<SqlAggFunction>
  {
    ...
    public SqlAggFunction build()
    {
      ...
      class RobuxSqlAggFunction extends SqlAggFunction
      {
        public RobuxSqlAggFunction()
        {
          super(
              name,
              null,
      ...
      return new RobuxSqlAggFunction();
    }
  }
  ...
  public static DirectOperatorConversion robuxUnaryLongFn(String sqlOperator, String robuxFunctionName)
  {
  ...
  public static DirectOperatorConversion robuxBinaryLongFn(String sqlOperator, String robuxFunctionName)
  {
    return new DirectOperatorConversion(
        operatorBuilder(sqlOperator)
  ...
  public static DirectOperatorConversion robuxUnaryDoubleFn(String sqlOperator, String robuxFunctionName)
  {
    return new DirectOperatorConversion(
