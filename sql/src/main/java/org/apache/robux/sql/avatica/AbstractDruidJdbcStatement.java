 ...
 * {@code PreparedStatement} implementations in Robux. Statement use
 * {@link RobuxJdbcResultSet} objects to iterate through rows: zero
 * or one may be open at any time, and a single statement supports
 * multiple result sets concurrently. Robux closes the result set after
 ...
 */
public abstract class AbstractRobuxJdbcStatement implements Closeable
{
  ...
  protected RobuxJdbcResultSet resultSet;
  protected SqlQueryPlus sqlQuery;

  public AbstractRobuxJdbcStatement(
  ...
  public void closeResultSet()
  {
    ...
    RobuxJdbcResultSet currentResultSet;
    synchronized (this) {
  ...
  protected synchronized RobuxJdbcResultSet requireResultSet()
  {
    if (resultSet == null) {
