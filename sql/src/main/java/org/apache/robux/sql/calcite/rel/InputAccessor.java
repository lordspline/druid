...
public class InputAccessor
{
  ...
  private final RelDataType inputRobuxRowType;
      ...
      RowSignature rowSignature)
  {
    ...
    this.inputRobuxRowType = RowSignatures.toRelDataType(inputRowSignature, getRexBuilder().getTypeFactory());
  }
  ...
  public RexNode getField(int argIndex)
  {
    if (argIndex < inputFieldCount) {
      ...
      if (flattenedProject != null) {
        ...
        return RexInputRef.of(argIndex, inputRobuxRowType);
      }
    } else {
