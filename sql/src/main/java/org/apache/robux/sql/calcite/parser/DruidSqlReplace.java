...
/**
 * Extends the 'replace' call to hold custom parameters specific to Robux i.e. PARTITIONED BY and the PARTITION SPECS
 ...
 */
public class RobuxSqlReplace extends RobuxSqlIngest
{
  public static final String SQL_REPLACE_TIME_CHUNKS = "sqlReplaceTimeChunks";

  public static final SqlOperator OPERATOR = RobuxSqlIngestOperator.REPLACE_OPERATOR;

  private final SqlNode replaceTimeQuery;

  public static RobuxSqlReplace create(
