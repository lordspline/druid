...
/**
 * Robux-specific version of {@link SqlUserDefinedTableMacro} which
...
public class BaseUserDefinedTableMacro extends SqlUserDefinedTableMacro
{
  ...
  // Copy of Calcite method with Robux-specific code added
  private static Object coerce(Object o, RelDataType type) throws NonLiteralException
  {
    if (o == null) {
      return null;
    }
    // Robux-specific code to handle arrays. Although the type
