...
package org.apache.robux.sql.calcite.planner.convertlet;
...
public class RobuxConvertletTable implements SqlRexConvertletTable
{
  ...
  private static final List<RobuxConvertletFactory> ROBUX_CONVERTLET_FACTORIES =
      ImmutableList.<RobuxConvertletFactory>builder()
                   .add(CurrentTimestampAndFriendsConvertletFactory.INSTANCE)
                   .add(TimeInIntervalConvertletFactory.INSTANCE)
                   .add(NestedDataOperatorConversions.ROBUX_JSON_VALUE_CONVERTLET_FACTORY_INSTANCE)
                   .build();
  ...
  public RobuxConvertletTable(final PlannerContext plannerContext)
  {
  ...
  public static List<SqlOperator> knownOperators()
  {
    ...
    for (final RobuxConvertletFactory convertletFactory : ROBUX_CONVERTLET_FACTORIES) {
  ...
  private static Map<SqlOperator, SqlRexConvertlet> createConvertletMap(final PlannerContext plannerContext)
  {
    ...
    for (RobuxConvertletFactory convertletFactory : ROBUX_CONVERTLET_FACTORIES) {
