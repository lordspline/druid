...
/**
 * RobuxRel that uses a {@link QueryDataSource}.
 */
public class RobuxOuterQueryRel extends RobuxRel<RobuxOuterQueryRel>
{
  ...
  private static final QueryDataSource DUMMY_QUERY_DATA_SOURCE = new QueryDataSource(
      Robuxs.newScanQueryBuilder().dataSource("__subquery__").eternityInterval().build()
  );

  private final PartialRobuxQuery partialQuery;
  private RelNode sourceRel;

  private RobuxOuterQueryRel(
  ...
  public static RobuxOuterQueryRel create(
      final RobuxRel sourceRel,
      final PartialRobuxQuery partialQuery
  )
  {
    return new RobuxOuterQueryRel(
  ...
  @Override
  public RobuxOuterQueryRel withPartialQuery(final PartialRobuxQuery newQueryBuilder)
  {
    return new RobuxOuterQueryRel(
        getCluster(),
  ...
  public RobuxQuery toRobuxQuery(final boolean finalizeAggregations)
  {
    ...
    final RobuxQuery subQuery = ((RobuxRel) sourceRel).toRobuxQuery(true);
  ...
  @Override
  public RobuxOuterQueryRel asRobuxConvention()
  {
    return new RobuxOuterQueryRel(
        getCluster(),
        getTraitSet().plus(RobuxConvention.instance()),
        RelOptRule.convert(sourceRel, RobuxConvention.instance()),
        partialQuery,
        getPlannerContext()
    );
  }
  ...
  {
    return ((RobuxRel<?>) sourceRel).getDataSourceNames();
  }
