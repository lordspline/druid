...
/**
 * {@link RobuxLogicalNode} convention node for {@link Project} plan node.
 */
public class RobuxProject extends Project implements RobuxLogicalNode
{
  public RobuxProject(
  ...
  {
    return new RobuxProject(getCluster(), traitSet, input, exps, rowType);
  }
  ...
  public static RobuxProject create(final RelNode input, final List<? extends RexNode> projects, RelDataType rowType)
  {
    ...
    return new RobuxProject(cluster, traitSet, input, projects, rowType);
  }
}
