...
/**
 * Rule that pushes LIMIT and OFFSET into a {@link RobuxUnionRel}.
 */
public class RobuxSortUnionRule extends RelOptRule
{

  private static final RobuxSortUnionRule INSTANCE = new RobuxSortUnionRule();

  private RobuxSortUnionRule()
  {
    super(operand(Sort.class, operand(RobuxUnionRel.class, any())));
  }

  public static RobuxSortUnionRule instance()
  {
    return INSTANCE;
  }
