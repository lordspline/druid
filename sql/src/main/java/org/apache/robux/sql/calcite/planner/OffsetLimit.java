...
public class OffsetLimit
{
  ...
  public RexNode getOffsetAsRexNode(final RexBuilder builder)
  {
    if (offset == 0) {
      ...
      return builder.makeLiteral(
          offset,
          new BasicSqlType(RobuxTypeSystem.INSTANCE, SqlTypeName.BIGINT),
          false
      );
    }
  }
  ...
  public org.apache.robux.query.operator.OffsetLimit toOperatorOffsetLimit()
  {
    if (hasLimit()) {
      return new org.apache.robux.query.operator.OffsetLimit(offset, limit);
    } else {
      return new org.apache.robux.query.operator.OffsetLimit(offset, -1);
    }
  }
}
