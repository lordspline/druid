...
public class RobuxTypeSystem implements RelDataTypeSystem
{
  public static final RobuxTypeSystem INSTANCE = new RobuxTypeSystem();
  public static final RelDataTypeFactory TYPE_FACTORY = new SqlTypeFactoryImpl(RobuxTypeSystem.INSTANCE);

  /**
   * Robux uses millisecond precision for timestamps internally. This is also the default at the SQL layer.
   */
  public static final int DEFAULT_TIMESTAMP_PRECISION = 3;

  private RobuxTypeSystem()
  {
    // Singleton.
  }
