...
/**
 * Robux-specific implementation of the EXTEND operator in Calcite, which
...
public class ExtendOperator extends SqlInternalOperator
{
  ...
  /**
   * Rewrite the EXTEND node (which, in Robux, has a structure different
  ...
  public SqlNode rewriteCall(SqlValidator validator, SqlCall call)
  {
    ...
    // The table function must be a Robux-defined table macro function
