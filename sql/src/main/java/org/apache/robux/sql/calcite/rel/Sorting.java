...
/**
 * Represents Robux's concept of sorting and limiting, including post-sort projections. The sorting and limiting piece
 * may map onto multiple Robux concepts: LimitSpec (for groupBy), TopNMetricSpec and threshold (for topN),
