 ...
 * This version
 */
public class RobuxUserDefinedTableMacro extends SchemaAwareUserDefinedTableMacro implements AuthorizableOperator
{
  public RobuxUserDefinedTableMacro(final RobuxTableMacro macro)
  {
    super(
