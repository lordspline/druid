...
public abstract class BaseExpressionDimFilterOperatorConversion extends DirectOperatorConversion
{
   ...
   * @param robuxExpressions arguments of the call converted to {@link RobuxExpression}
   */
  protected DimFilter toExpressionFilter(
      PlannerContext plannerContext,
      List<RobuxExpression> robuxExpressions
  )
  {
    final String filterExpr = RobuxExpression.functionCall(getRobuxFunctionName()).compile(robuxExpressions);
