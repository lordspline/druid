...
import org.apache.robux.sql.calcite.filtration.MoveTimeFiltersToIntervals;
...
public class RobuxSqlParserUtils
{
  private static final Logger log = new Logger(RobuxSqlParserUtils.class);
   ...
   *
   * @throws RobuxException if SqlNode cannot be converted to a granularity
   */
  @Nullable
  ...
  private static RobuxException makeInvalidPartitionByException(SqlNode sqlNode)
  {
   ...
   * @throws RobuxException if the SqlNode cannot be converted to a list of intervals
   */
   ...
   * @throws RobuxException if any of the clustered by columns contain DESCENDING order.
   */
   ...
   * @throws RobuxException if the SqlNode cannot be converted a Dimfilter
   */
   ...
   * @throws RobuxException if the SQL node is not an SqlIdentifier
   */
   ...
   * @throws RobuxException if the SQL node is not a SqlTimestampLiteral
   */
  ...
  public static RobuxException problemParsing(String message)
  {
