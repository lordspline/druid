...
import org.apache.robux.catalog.model.table.BaseTableFunction;
 ...
 * a Robux JSON signature, or an SQL {@code EXTEND} list of columns.
 * As with all table functions, the {@code EXTEND} is optional.
 */
public class ExternalOperatorConversion extends RobuxExternTableMacroConversion
{
  ...
  private static RobuxException badArgumentException(
      Throwable cause,
      String fieldName
  )
  {
