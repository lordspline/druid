...
public class HadoopRobuxDetermineConfigurationJobTest
{
  @Test
  public void testRunWithHashedPartitionsSpecCreateHashBasedNumberedShardSpecWithHashPartitionFunction()
  {
    ...
    final HadoopRobuxIndexerConfig config = Mockito.mock(HadoopRobuxIndexerConfig.class);
    ...
    final HadoopRobuxDetermineConfigurationJob job = new HadoopRobuxDetermineConfigurationJob(config);
