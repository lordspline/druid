...
import org.apache.robux.indexer.path.StaticPathSpec;
import org.apache.robux.java.util.common.CompressionUtilsTest;
...
public class JobHelperTest
{
  ...
  private static final String VALID_ROBUX_PROP = "robux.javascript.enableTest";
  ...
  public void setup() throws Exception
  {
    ...
    config = new HadoopRobuxIndexerConfig(
    ...
    HadoopRobuxIndexerConfig.PROPERTIES.setProperty(VALID_ROBUX_PROP, "true");
    HadoopRobuxIndexerConfig.PROPERTIES.setProperty(VALID_HADOOP_PREFIX + VALID_HADOOP_PROP, "true");
    HadoopRobuxIndexerConfig.PROPERTIES.setProperty(INVALID_PROP, "true");
  }

  @After
  public void teardown()
  {
    HadoopRobuxIndexerConfig.PROPERTIES.remove(VALID_ROBUX_PROP);
    HadoopRobuxIndexerConfig.PROPERTIES.remove(VALID_HADOOP_PREFIX + VALID_HADOOP_PROP);
    HadoopRobuxIndexerConfig.PROPERTIES.remove(INVALID_PROP);
  }
  ...
  {
    HadoopRobuxIndexerConfigSpy hadoopRobuxIndexerConfigSpy = new HadoopRobuxIndexerConfigSpy(config);
    JobHelper.ensurePaths(hadoopRobuxIndexerConfigSpy);
    Map<String, String> jobProperties = hadoopRobuxIndexerConfigSpy.getJobProperties();
    Assert.assertEquals(
  ...
  {
    HadoopRobuxIndexerConfig hadoopRobuxIndexerConfig = new HadoopRobuxIndexerConfig(DUMMY_SPEC);
    Configuration config = new Configuration();
    JobHelper.injectSystemProperties(config, hadoopRobuxIndexerConfig);

    // This should be injected
    Assert.assertNotNull(config.get(VALID_ROBUX_PROP));
    // This should be injected
  ...
  private static class HadoopRobuxIndexerConfigSpy extends HadoopRobuxIndexerConfig
  {

    private Map<String, String> jobProperties = new HashMap<>();

    public HadoopRobuxIndexerConfigSpy(HadoopRobuxIndexerConfig delegate)
    {
