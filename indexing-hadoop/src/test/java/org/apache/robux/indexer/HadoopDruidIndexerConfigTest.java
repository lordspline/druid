...
public class HadoopRobuxIndexerConfigTest
{
  private static final ObjectMapper JSON_MAPPER;
  // testing member to verify that RobuxModule gets node-roles set supplied through the static initialization of
  // HadoopRobuxIndexerConfig class.
  private static final RobuxModule MY_MODULE;

  static {
    JSON_MAPPER = new DefaultObjectMapper();
    JSON_MAPPER.setInjectableValues(new InjectableValues.Std().addValue(ObjectMapper.class, JSON_MAPPER));
    MY_MODULE = new RobuxModule()
    {
      @Inject
  ...
  public void testHashedBucketSelection()
  {
    ...
    HadoopIngestionSpec spec = new HadoopIngestionSpecBuilder()
        ...
        .build();
    HadoopRobuxIndexerConfig config = HadoopRobuxIndexerConfig.fromSpec(spec);
  ...
  public void testGetTargetPartitionSizeWithHashedPartitions()
  {
    HadoopIngestionSpec spec = new HadoopIngestionSpecBuilder()
        ...
        .build();
    HadoopRobuxIndexerConfig config = new HadoopRobuxIndexerConfig(spec);
  ...
  private static class HadoopIngestionSpecBuilder
  {
    private static final DataSchema DATA_SCHEMA =
        DataSchema.builder()
                  ...
                  .withObjectMapper(HadoopRobuxIndexerConfigTest.JSON_MAPPER)
                  .build();
