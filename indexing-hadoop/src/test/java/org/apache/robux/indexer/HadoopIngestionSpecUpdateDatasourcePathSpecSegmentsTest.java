...
import org.apache.robux.indexer.path.MultiplePathSpec;
import org.apache.robux.indexer.path.PathSpec;
import org.apache.robux.indexer.path.StaticPathSpec;
import org.apache.robux.indexer.path.UsedSegmentsRetriever;
...
public class HadoopIngestionSpecUpdateDatasourcePathSpecSegmentsTest
{
  ...
  public void testUpdateSegmentListIfDatasourcePathSpecIsUsedWithNoDatasourcePathSpec() throws Exception
  {
    ...
    HadoopRobuxIndexerConfig config = testRunUpdateSegmentListIfDatasourcePathSpecIsUsed(pathSpec, null);
  ...
  public void testUpdateSegmentListIfDatasourcePathSpecIsUsedWithJustDatasourcePathSpec() throws Exception
  {
    ...
    HadoopRobuxIndexerConfig config = testRunUpdateSegmentListIfDatasourcePathSpecIsUsed(
        pathSpec,
  ...
  private HadoopRobuxIndexerConfig testRunUpdateSegmentListIfDatasourcePathSpecIsUsed(
      ...
      throws Exception
  {
    ...
    return HadoopRobuxIndexerConfig.fromString(jsonMapper.writeValueAsString(spec));
  }
}
