...
public class HadoopTaskTest
{
  ...
  public void testBuildClassLoader() throws Exception
  {
    ...
    final Class<?> robuxHadoopConfigClazz = Class.forName(
        "org.apache.robux.indexer.HadoopRobuxIndexerConfig",
        false,
        classLoader
    );
    assertClassLoaderIsSingular(robuxHadoopConfigClazz.getClassLoader());
  }
  ...
  public static void assertClassLoaderIsSingular(ClassLoader classLoader)
  {
    ...
    final ClassLoader appLoader = HadoopRobuxIndexerConfig.class.getClassLoader();
