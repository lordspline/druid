...
import org.apache.robux.indexer.hadoop.DatasourceRecordReader;
...
public class BatchDeltaIngestionTest
{
  ...
  static {
    ...
    INDEX_IO = HadoopRobuxIndexerConfig.INDEX_IO;
  ...
  public void testReindexing() throws Exception
  {
    ...
    HadoopRobuxIndexerConfig config = makeHadoopRobuxIndexerConfig(
        ImmutableMap.of(
            "type",
            "dataSource",
            "ingestionSpec",
   ...
   * See https://github.com/apache/robux/issues/5277 .
   */
  @Test
  ...
  private HadoopRobuxIndexerConfig makeHadoopRobuxIndexerConfig(Map<String, Object> inputSpec, File tmpDir)
      throws Exception
  {
    return makeHadoopRobuxIndexerConfig(inputSpec, tmpDir, null);
  }
  ...
  private HadoopRobuxIndexerConfig makeHadoopRobuxIndexerConfig(
      ...
      throws Exception
  {
    HadoopRobuxIndexerConfig config = new HadoopRobuxIndexerConfig(
    ...
    config = HadoopRobuxIndexerConfig.fromSpec(config.getSchema());
    return config;
  }
