 ...
 *
 */
public class HadoopRobuxDetermineConfigurationJob implements Jobby
{
  private static final Logger log = new Logger(HadoopRobuxDetermineConfigurationJob.class);
  private final HadoopRobuxIndexerConfig config;
  private Jobby job;
  private String hadoopJobIdFile;

  @Inject
  public HadoopRobuxDetermineConfigurationJob(HadoopRobuxIndexerConfig config)
  {
    this.config = config;
  }
  ...
  private static Jobby createPartitionJob(HadoopRobuxIndexerConfig config)
  {
    final PartitionsSpec partitionsSpec = config.getPartitionsSpec();
    if (partitionsSpec instanceof HashedPartitionsSpec) {
