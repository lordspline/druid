...
public class HadoopIndexTask extends HadoopTask implements ChatHandler
{
  ...
  /**
   * @param spec is used by the HadoopRobuxIndexerJob to set up the appropriate parameters
   *             for creating Robux index segments. It may be modified.
   *             <p/>
  ...
  private TaskStatus runInternal(TaskToolbox toolbox) throws Exception
  {
    ...
    try {
      ...
      Object determinePartitionsInnerProcessingRunner = HadoopTask.getForeignClassloaderObject(
          "org.apache.robux.indexer.HadoopIndexTask$HadoopDetermineConfigInnerProcessingRunner",
          loader
      );
      ...
      Object innerProcessingRunner = HadoopTask.getForeignClassloaderObject(
          "org.apache.robux.indexer.HadoopIndexTask$HadoopIndexGeneratorInnerProcessingRunner",
          loader
      );
    ...
    if (hadoopJobIdFileExists() && !ingestionState.equals(IngestionState.COMPLETED)) {
      ...
      try {
        ...
        Object killMRJobInnerProcessingRunner = HadoopTask.getForeignClassloaderObject(
            "org.apache.robux.indexer.HadoopIndexTask$HadoopKillMRJobIdProcessingRunner",
            loader
        );
  ...
  )
  {
    ...
    try {
      final Class<?> clazz = loader.loadClass(
          "org.apache.robux.indexer.HadoopIndexTask$HadoopRenameSegmentIndexFilesRunner"
      );
  ...
  )
  {
    ...
    try {
      ...
      Object indexerGeneratorCleanupRunner = HadoopTask.getForeignClassloaderObject(
          "org.apache.robux.indexer.HadoopIndexTask$HadoopIndexerGeneratorCleanupRunner",
          loader
      );
  ...
  {
    private HadoopRobuxDetermineConfigurationJob job;
    ...
    public String runTask(String[] args) throws Exception
    {
      ...
      final HadoopIngestionSpec theSchema = HadoopRobuxIndexerConfig.JSON_MAPPER
          .readValue(
              schema,
              HadoopIngestionSpec.class
          );
      final HadoopRobuxIndexerConfig config = HadoopRobuxIndexerConfig.fromSpec(
          theSchema
      ...
      job = new HadoopRobuxDetermineConfigurationJob(config);
      job.setHadoopJobIdFile(hadoopJobIdFile);

      log.info("Starting a hadoop determine configuration job...");
      if (job.run()) {
        return HadoopRobuxIndexerConfig.JSON_MAPPER.writeValueAsString(
  ...
  {
    private HadoopRobuxIndexerJob job;
    ...
    public String runTask(String[] args) throws Exception
    {
      ...
      job = new HadoopRobuxIndexerJob(config, maybeHandler);
      job.setHadoopJobIdFile(hadoopJobIdFile);
    ...
    public String[] runTask(String[] args) throws Exception
    {
      ...
      try {
        if (hadoopJobIdFile.exists()) {
          jobId = HadoopRobuxIndexerConfig.JSON_MAPPER.readValue(hadoopJobIdFile, String.class);
        }
      }
      catch (Exception e) {
  ...
  public static class HadoopRenameSegmentIndexFilesRunner
  {
    ...
    public void runTask(String[] args) throws Exception
    {
      ...
      try {
        indexerSchema = HadoopRobuxIndexerConfig.JSON_MAPPER.readValue(
            hadoopIngestionSpecStr,
            HadoopIngestionSpec.class
        );
        dataSegmentAndIndexZipFilePaths = HadoopRobuxIndexerConfig.JSON_MAPPER.readValue(
            dataSegmentAndIndexZipFilePathListStr,
