...
public class StringFieldReaderTest extends InitializedNullHandlingTest
{
  ...
  public void test_makeDimensionSelector_multiString()
  {
    ...
    Assert.assertTrue(readSelector.makeValueMatcher(StringPredicateRobuxPredicateFactory.equalTo("bar")).matches(false));
    Assert.assertFalse(readSelector.makeValueMatcher(StringPredicateRobuxPredicateFactory.equalTo("baz")).matches(false));
  }
  ...
  public void test_makeDimensionSelector_multiString_withExtractionFn()
  {
    ...
    Assert.assertTrue(readSelector.makeValueMatcher(StringPredicateRobuxPredicateFactory.equalTo("ar")).matches(false));
    Assert.assertFalse(readSelector.makeValueMatcher(StringPredicateRobuxPredicateFactory.equalTo("bar")).matches(false));
  }
