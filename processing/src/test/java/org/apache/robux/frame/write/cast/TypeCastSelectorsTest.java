...
public class TypeCastSelectorsTest extends InitializedNullHandlingTest
{
  ...
  public void test_readXAsLongArray()
  {
    ...
    Assert.assertThrows(RobuxException.class, selector::getLong);
    Assert.assertThrows(RobuxException.class, selector::getDouble);
    Assert.assertThrows(RobuxException.class, selector::getFloat);
    Assert.assertThrows(RobuxException.class, selector::isNull);
