...
package org.apache.robux.frame.field;

import org.apache.datasketches.memory.WritableMemory;
import org.apache.robux.frame.FrameType;
import org.apache.robux.frame.key.KeyOrder;
import org.apache.robux.frame.write.FrameWriterTestData;
...
import org.apache.robux.query.rowsandcols.MapOfColumnsRowsAndColumns;
import org.apache.robux.query.rowsandcols.column.ColumnAccessor;
import org.apache.robux.query.rowsandcols.concrete.RowBasedFrameRowsAndColumnsTest;
import org.apache.robux.segment.BaseFloatColumnValueSelector;
import org.apache.robux.segment.ColumnValueSelector;
import org.apache.robux.segment.DimensionDictionarySelector;
...
public class FloatFieldReaderTest extends InitializedNullHandlingTest
{
  ...
  public FloatFieldReaderTest(FrameType frameType)
  {
  ...
  {
    writeToMemory(null);
    Assert.assertTrue(FloatFieldReader.forPrimitive(frameType).isNull(memory, MEMORY_POSITION));
  }
  ...
  {
    writeToMemory(5.1f);
    Assert.assertFalse(FloatFieldReader.forPrimitive(frameType).isNull(memory, MEMORY_POSITION));
  }
  ...
  public void test_makeDimensionSelector_defaultOrNull()
  {
    ...
    Assert.assertFalse(readSelector.makeValueMatcher(StringPredicateRobuxPredicateFactory.equalTo("0.0")).matches(false));
    Assert.assertTrue(readSelector.makeValueMatcher(StringPredicateRobuxPredicateFactory.of(RobuxObjectPredicate.isNull())).matches(false));
  }
  ...
  public void test_makeDimensionSelector_aValue()
  {
    ...
    Assert.assertTrue(readSelector.makeValueMatcher(StringPredicateRobuxPredicateFactory.equalTo("5.1"))
                                  .matches(false));
    Assert.assertFalse(readSelector.makeValueMatcher(StringPredicateRobuxPredicateFactory.equalTo("5")).matches(false));
  }
  ...
  public void test_makeDimensionSelector_aValue_extractionFn()
  {
    ...
    Assert.assertTrue(readSelector.makeValueMatcher(StringPredicateRobuxPredicateFactory.equalTo("0.5"))
                                  .matches(false));
    Assert.assertFalse(readSelector.makeValueMatcher(StringPredicateRobuxPredicateFactory.equalTo("2")).matches(false));
  }
