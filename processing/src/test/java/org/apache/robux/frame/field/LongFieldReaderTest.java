...
public class LongFieldReaderTest extends InitializedNullHandlingTest
{
  ...
  public void test_makeDimensionSelector_defaultOrNull()
  {
    ...
    Assert.assertFalse(readSelector.makeValueMatcher(StringPredicateRobuxPredicateFactory.equalTo("0")).matches(false));
  ...
  public void test_makeDimensionSelector_aValue()
  {
    ...
    Assert.assertTrue(readSelector.makeValueMatcher(StringPredicateRobuxPredicateFactory.equalTo("5")).matches(false));
