...
public class RowKeyComparisonRunLengthsTest
{
  ...
  public void testRunLengthsWithInvalidOrder()
  {
    ...
    final RowSignature signature = RowSignature.builder()
                                               ...
                                               .build();
    Assert.assertThrows(RobuxException.class, () -> RowKeyComparisonRunLengths.create(keyColumns, signature));
  }
  ...
  public void testRunLengthsWithEmptyType()
  {
    ...
    final RowSignature signature1 = RowSignature.builder()
                                                .add("a", null)
                                                .build();
    Assert.assertThrows(RobuxException.class, () -> RowKeyComparisonRunLengths.create(keyColumns, signature1));

    final RowSignature signature2 = RowSignature.builder()
                                                .add("a", ColumnType.UNKNOWN_COMPLEX)
                                                .build();
    Assert.assertThrows(RobuxException.class, () -> RowKeyComparisonRunLengths.create(keyColumns, signature2));
  }
