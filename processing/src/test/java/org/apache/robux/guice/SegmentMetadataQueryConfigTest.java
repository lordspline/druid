...
public class SegmentMetadataQueryConfigTest
{
  ...
  public void testSerdeSegmentMetadataQueryConfig()
  {
    ...
    String actualDefaultAnalysis = props.getProperty("robux.query.segmentMetadata.defaultAnalysisTypes");
    ...
    Assert.assertEquals(
        props.getProperty("robux.query.segmentMetadata.defaultHistory"),
