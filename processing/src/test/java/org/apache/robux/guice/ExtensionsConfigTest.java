...
public class ExtensionsConfigTest
{
  ...
  public void testSerdeWithDefaults() throws Exception
  {
    ...
    Assert.assertNull(config.getHadoopContainerRobuxClasspath());
  ...
  public void testSerdeWithNonDefaults() throws Exception
  {
    String json = "{\n"
                  ...
                  + "  \"hadoopContainerRobuxClasspath\": \"testHadoopContainerClasspath\",\n"
                  + "  \"loadList\": [\"b\",\"a\"]\n"
                  + "}";
    ObjectMapper mapper = TestHelper.makeJsonMapper();
    ...
    Assert.assertEquals("testHadoopContainerClasspath", config.getHadoopContainerRobuxClasspath());
