...
public class RobuxSecondaryModuleTest
{
  private static final String PROPERTY_NAME = "robux.injected.val";
    ...
    return Guice.createInjector(
        ImmutableList.of(
            ...
            (Module) binder -> {
              ...
              JsonConfigProvider.bind(binder, "robux.injected", InjectedParameter.class);
            }
        )
    );
  }
