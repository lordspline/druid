...
import org.apache.robux.segment.DimensionHandlerProvider;
...
public class BuiltInTypesModuleTest
{
  ...
  public void testOverride()
  {
    DimensionHandlerUtils.DIMENSION_HANDLER_PROVIDERS.remove(NestedDataComplexTypeSerde.TYPE_NAME);
    Properties props = new Properties();
    props.setProperty("robux.indexing.formats.stringMultiValueHandlingMode", "sorted_array");
    Injector gadget = makeInjector(props);
  ...
  public void testOverrideMultiValueHandlingModeCaseInsensitive()
  {
    ...
    props.setProperty("robux.indexing.formats.stringMultiValueHandlingMode", "ARRAY");
  ...
  {
    final Properties props = new Properties();
    props.setProperty("robux.indexing.formats.stringMultiValueHandlingMode", "boo");
    final Injector gadget = makeInjector(props);
    ...
    Assert.assertTrue(exception.getMessage().contains(
        "Invalid value[boo] specified for 'robux.indexing.formats.stringMultiValueHandlingMode'."
