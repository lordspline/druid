...
package org.apache.robux.utils;
...
public class ConnectionUriUtilsTest
{
  ...
  {
    private static final String MYSQL_URI = "jdbc:mysql://localhost:3306/test?user=robux&password=diurd&keyonly&otherOptions=wat";
    private static final String MARIA_URI = "jdbc:mariadb://localhost:3306/test?user=robux&password=diurd&keyonly&otherOptions=wat";
    private static final String POSTGRES_URI = "jdbc:postgresql://localhost:3306/test?user=robux&password=diurd&keyonly&otherOptions=wat";
    private static final String UNKNOWN_URI = "jdbc:robux://localhost:8888/query/v2/sql/avatica?user=robux&password=diurd&keyonly&otherOptions=wat";
