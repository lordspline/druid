...
public class TestObjectBasedColumnSelector
{
  ...
  public void testNull()
  {
    ...
    assertThrows(RobuxException.class, () -> selector.getFloat());
    assertThrows(RobuxException.class, () -> selector.getDouble());
    assertThrows(RobuxException.class, () -> selector.getLong());
  ...
  public void testInvalidIsNullUse()
  {
    ...
    RobuxException e = assertThrows(RobuxException.class, () -> selector.isNull());
