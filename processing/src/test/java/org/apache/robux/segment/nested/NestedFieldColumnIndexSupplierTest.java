...
import org.apache.robux.collections.bitmap.MutableBitmap;
...
import org.apache.robux.segment.data.FixedIndexedWriter;
import org.apache.robux.segment.data.FrontCodedIntArrayIndexed;
import org.apache.robux.segment.data.FrontCodedIntArrayIndexedWriter;
...
import org.apache.robux.segment.serde.Serializer;
import org.apache.robux.segment.writeout.OnHeapMemorySegmentWriteOutMedium;
...
public class NestedFieldColumnIndexSupplierTest extends InitializedNullHandlingTest
{
  ...
  public void testSingleTypeStringColumnRangeIndexWithPredicate() throws IOException
  {
    ...
    BitmapColumnIndex forRange = rangeIndex.forRange(
        ...
        "g",
        true,
        RobuxObjectPredicate.notEqualTo("fooo")
    );
    ImmutableBitmap bitmap = forRange.computeBitmapResult(bitmapResultFactory, false);
    checkBitmap(bitmap, 0, 9);
    ...
    forRange = rangeIndex.forRange(
        ...
        "g",
        true,
        RobuxObjectPredicate.equalTo("fooo")
    );
    bitmap = forRange.computeBitmapResult(bitmapResultFactory, false);
    ...
    forRange = rangeIndex.forRange(
        ...
        null,
        true,
        RobuxObjectPredicate.alwaysTrue()
    );
    bitmap = forRange.computeBitmapResult(bitmapResultFactory, false);
    checkBitmap(bitmap, 0, 2, 4, 5, 6, 9);
  }
  ...
  public void testSingleTypeStringColumnPredicateIndex() throws IOException
  {
    ...
    RobuxPredicateIndexes predicateIndex = indexSupplier.as(RobuxPredicateIndexes.class);
    Assert.assertNotNull(predicateIndex);
    RobuxPredicateFactory predicateFactory = new InDimFilter.InFilterRobuxPredicateFactory(
        null,
