...
public class ComplexMetricsTest
{
  ...
  public void testConflicting()
  {
    ...
    expectedException.expectMessage("Incompatible serializer for type[hyperUnique] already exists. Expected [org.apache.robux.query.aggregation.SerializablePairLongStringComplexMetricSerde], found [org.apache.robux.query.aggregation.hyperloglog.HyperUniquesSerde");
