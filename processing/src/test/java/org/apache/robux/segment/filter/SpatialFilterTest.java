...
import org.apache.robux.collections.spatial.search.RectangularBound;
...
import org.apache.robux.query.aggregation.TestObjectColumnSelector;
...
public class SpatialFilterTest extends InitializedNullHandlingTest
{
  ...
  @Test
  public void testEqualsContractForBoundRobuxPredicateFactory()
  {
    EqualsVerifier.forClass(SpatialFilter.BoundRobuxPredicateFactory.class).usingGetClass().verify();
  }
