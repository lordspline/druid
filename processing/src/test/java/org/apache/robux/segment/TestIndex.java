...
{
  public static final String SAMPLE_NUMERIC_JSON = "robux.sample.numeric.json";
  public static final String SAMPLE_NUMERIC_JSON_TOP = "robux.sample.numeric.top.json";
  public static final String SAMPLE_NUMERIC_JSON_BOTTOM = "robux.sample.numeric.bottom.json";
