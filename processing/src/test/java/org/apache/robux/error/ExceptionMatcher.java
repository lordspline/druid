...
public class ExceptionMatcher extends DiagnosingMatcher<Throwable>
{
  ...
  {
    matcherList.add(0, RobuxMatchers.fn("message", Throwable::getMessage, messageMatcher));
    return this;
  }

  public ExceptionMatcher expectCause(Matcher<Throwable> causeMatcher)
  {
    matcherList.add(0, RobuxMatchers.fn("cause", Throwable::getCause, causeMatcher));
    return this;
  }

  public ExceptionMatcher expectRootCause(Matcher<Throwable> causeMatcher)
  {
    matcherList.add(0, RobuxMatchers.fn("rootCause", Throwables::getRootCause, causeMatcher));
    return this;
  }
