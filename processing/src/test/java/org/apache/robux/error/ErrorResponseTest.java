...
public class ErrorResponseTest
{
  ...
  public void testSanity()
  {
    ...
    MatcherAssert.assertThat(
        ...
        RobuxExceptionMatcher.invalidSqlInput().expectMessageIs("bad sql!")
    );
  }
  ...
  public void testQueryExceptionCompat()
  {
    ErrorResponse response = new ErrorResponse(
        RobuxException.fromFailure(new QueryExceptionCompat(new QueryTimeoutException()))
    );
    ...
    MatcherAssert.assertThat(
        ...
        (Matcher) Matchers.hasEntry(
            ...
            Matchers.allOf(
                RobuxMatchers.mapMatcher(
                    "errorClass", "org.apache.robux.query.QueryTimeoutException",
    ...
    MatcherAssert.assertThat(
        recomposed.getUnderlyingException(),
        new RobuxExceptionMatcher(RobuxException.Persona.OPERATOR, RobuxException.Category.TIMEOUT, "legacyQueryException")
  ...
  {
    ErrorResponse response = new ErrorResponse(RobuxException.fromFailure(new QueryExceptionCompat(new QueryTimeoutException(
        null,
        "hostname"
    ))));
    final Map<String, Object> asMap = response.getAsMap();
