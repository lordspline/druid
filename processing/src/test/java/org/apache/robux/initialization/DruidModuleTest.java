...
public class RobuxModuleTest
{
  @Test
  public void testOverride()
  {
    Injector initInjector = Guice.createInjector(new LocalProviderModule(10));
    RobuxModule overrideModule = RobuxModule.override(new LocalProviderModule(1), new LocalProviderModule(2));
  ...
  static class LocalProviderModule implements RobuxModule
  {
    private int val;
