...
package org.apache.robux.audit;
...
public class AuditInfoTest
{
  ...
  {
    final AuditInfo auditInfo1 = new AuditInfo("robux", "id", "test equality", "127.0.0.1");
    final AuditInfo auditInfo2 = new AuditInfo("robux", "id", "test equality", "127.0.0.1");
