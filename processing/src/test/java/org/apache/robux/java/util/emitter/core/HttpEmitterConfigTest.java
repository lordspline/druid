...
public class HttpEmitterConfigTest
{
  ...
  public void testDefaults()
  {
    ...
    props.put("org.apache.robux.java.util.emitter.recipientBaseUrl", "http://example.com/");
  ...
  {
    final Properties props = new Properties();
    props.put("org.apache.robux.java.util.emitter.http.url", "http://example.com/");
  ...
  {
    final Properties props = new Properties();
    props.setProperty("org.apache.robux.java.util.emitter.flushMillis", "1");
    props.setProperty("org.apache.robux.java.util.emitter.flushCount", "2");
    props.setProperty("org.apache.robux.java.util.emitter.recipientBaseUrl", "http://example.com/");
    props.setProperty("org.apache.robux.java.util.emitter.basicAuthentication", "a:b");
    props.setProperty("org.apache.robux.java.util.emitter.batchingStrategy", "NEWLINES");
    props.setProperty("org.apache.robux.java.util.emitter.maxBatchSize", "4");
    props.setProperty("org.apache.robux.java.util.emitter.flushTimeOut", "1000");
    props.setProperty("org.apache.robux.java.util.emitter.batchQueueSizeLimit", "2500");
    props.setProperty("org.apache.robux.java.util.emitter.httpTimeoutAllowanceFactor", "3.0");
    props.setProperty("org.apache.robux.java.util.emitter.minHttpTimeoutMillis", "100");
  ...
  public void testSettingEverythingLegacy()
  {
    ...
    props.setProperty("org.apache.robux.java.util.emitter.flushMillis", "1");
    props.setProperty("org.apache.robux.java.util.emitter.flushCount", "2");
    props.setProperty("org.apache.robux.java.util.emitter.http.url", "http://example.com/");
    props.setProperty("org.apache.robux.java.util.emitter.http.basicAuthentication", "a:b");
    props.setProperty("org.apache.robux.java.util.emitter.http.batchingStrategy", "newlines");
    props.setProperty("org.apache.robux.java.util.emitter.http.maxBatchSize", "4");
    props.setProperty("org.apache.robux.java.util.emitter.http.flushTimeOut", "1000");
    props.setProperty("org.apache.robux.java.util.emitter.http.batchQueueSizeLimit", "2500");
    props.setProperty("org.apache.robux.java.util.emitter.http.httpTimeoutAllowanceFactor", "3.0");
    props.setProperty("org.apache.robux.java.util.emitter.http.minHttpTimeoutMillis", "100");
