...
import org.apache.robux.java.util.emitter.service.UnitEvent;
...
public class EmitterTest
{
  ...
  private HttpPostEmitter sizeBasedEmitterGeneralizedCreation(int size)
  {
    ...
    props.setProperty("org.apache.robux.java.util.emitter.type", "http");
    props.setProperty("org.apache.robux.java.util.emitter.recipientBaseUrl", TARGET_URL);
    props.setProperty("org.apache.robux.java.util.emitter.flushMillis", String.valueOf(Long.MAX_VALUE));
    props.setProperty("org.apache.robux.java.util.emitter.flushCount", String.valueOf(size));
    props.setProperty(
        "org.apache.robux.java.util.emitter.flushTimeOut",
