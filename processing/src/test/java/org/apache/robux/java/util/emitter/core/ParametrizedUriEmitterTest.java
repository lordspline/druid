...
public class ParametrizedUriEmitterTest
{
  ...
  private Emitter parametrizedEmmiter(String uriPattern) throws Exception
  {
    ...
    props.setProperty("org.apache.robux.java.util.emitter.type", "parametrized");
    props.setProperty("org.apache.robux.java.util.emitter.recipientBaseUrlPattern", uriPattern);
    props.setProperty(
        "org.apache.robux.java.util.emitter.httpEmitting.flushTimeOut",
