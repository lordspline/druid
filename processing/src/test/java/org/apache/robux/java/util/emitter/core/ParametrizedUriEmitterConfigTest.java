...
public class ParametrizedUriEmitterConfigTest
{
  ...
  public void testSettingEverything()
  {
    ...
    props.setProperty("org.apache.robux.java.util.emitter.httpEmitting.flushMillis", "1");
    props.setProperty("org.apache.robux.java.util.emitter.httpEmitting.flushCount", "2");
    props.setProperty("org.apache.robux.java.util.emitter.httpEmitting.basicAuthentication", "a:b");
    props.setProperty("org.apache.robux.java.util.emitter.httpEmitting.batchingStrategy", "NEWLINES");
    props.setProperty("org.apache.robux.java.util.emitter.httpEmitting.maxBatchSize", "4");
    props.setProperty("org.apache.robux.java.util.emitter.httpEmitting.flushTimeOut", "1000");
