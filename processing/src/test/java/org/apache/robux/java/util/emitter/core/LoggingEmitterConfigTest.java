...
public class LoggingEmitterConfigTest
{
  ...
  {
    final Properties props = new Properties();
    props.setProperty("org.apache.robux.java.util.emitter.loggerClass", "Foo");
    props.setProperty("org.apache.robux.java.util.emitter.logLevel", "INFO");
  ...
  {
    final Properties props = new Properties();
    props.setProperty("org.apache.robux.java.util.emitter.logging.class", "Foo");
    props.setProperty("org.apache.robux.java.util.emitter.logging.level", "INFO");
