...
public class QueryContextTest
{
  ...
  /**
   * Tests the several ways that Robux code parses context strings into Long
  ...
  public void testGetLongCompatibility() throws JsonProcessingException
  {
    ...
    {
      // Hexadecimal numbers are not supported in JSON. Robux also does not support
      // them in strings.
      String value = "0xabcd";
      assertThrows(BadQueryContextException.class, () -> getContextLong(value));
    ...
    {
      // Leading zeros supported by Robux parsing, but not by JSON.
      String value = "05";
...

    {
      ...
      // not support this syntax, and neither does Robux's string-to-long conversion.
      String value = "1_234";
      assertThrows(BadQueryContextException.class, () -> getContextLong(value));
      assertNull(getDimensionLong(value));
      assertThrows(JsonParseException.class, () -> getJsonLong(value));
  ...
  {
    Query<?> timeseries = Robuxs.newTimeseriesQueryBuilder()
                                .dataSource("test")
