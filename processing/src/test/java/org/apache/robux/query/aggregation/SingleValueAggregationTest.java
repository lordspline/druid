...
public class SingleValueAggregationTest extends InitializedNullHandlingTest
{
  ...
  public void testLongAggregator()
  {
    ...
    Assert.assertThrows(RobuxException.class, () -> longAggFactory.getComparator());
    ...
    Assert.assertThrows(RobuxException.class, () -> aggregate(selectorLong, agg));
  }
  ...
  public void testLongBufferAggregator()
  {
    ...
    Assert.assertThrows(RobuxException.class, () -> aggregate(selectorLong, agg, buffer, 0));
  }

  @Test
  public void testCombine()
  {
    Assert.assertThrows(RobuxException.class, () -> longAggFactory.combine(9223372036854775800L, 9223372036854775803L));
  }
  ...
  public void testDoubleAggregator()
  {
    ...
    Assert.assertThrows(RobuxException.class, () -> aggregate(selectorDouble, agg));
  }
  ...
  public void testDoubleBufferAggregator()
  {
    ...
    Assert.assertThrows(RobuxException.class, () -> aggregate(selectorDouble, agg, buffer, 0));
  }
  ...
  public void testFloatAggregator()
  {
    ...
    Assert.assertThrows(RobuxException.class, () -> aggregate(selectorFloat, agg));
  }
  ...
  public void testFloatBufferAggregator()
  {
    ...
    Assert.assertThrows(RobuxException.class, () -> aggregate(selectorFloat, agg, buffer, 0));
  }
  ...
  public void testStringAggregator()
  {
    ...
    Assert.assertThrows(RobuxException.class, () -> aggregate(selectorString, agg));
  }
  ...
  public void testStringBufferAggregator()
  {
    ...
    Assert.assertThrows(RobuxException.class, () -> aggregate(selectorString, agg, buffer, 0));
  }
