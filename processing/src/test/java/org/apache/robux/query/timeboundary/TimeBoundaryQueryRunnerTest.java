...
package org.apache.robux.query.timeboundary;
...
public class TimeBoundaryQueryRunnerTest extends InitializedNullHandlingTest
{
  ...
  public void testFilteredTimeBoundaryQuery() throws IOException
  {
    ...
    TimeBoundaryQuery timeBoundaryQuery = Robuxs.newTimeBoundaryQueryBuilder()
                                                .dataSource("testing")
  ...
  {
    TimeBoundaryQuery maxTimeBoundaryQuery = Robuxs.newTimeBoundaryQueryBuilder()
                                                   .dataSource("testing")
                                                   .bound(TimeBoundaryQuery.MAX_TIME)
                                                   .build();
    ResponseContext context = ConcurrentResponseContext.createEmpty();
  ...
  {
    TimeBoundaryQuery minTimeBoundaryQuery = Robuxs.newTimeBoundaryQueryBuilder()
                                                   .dataSource("testing")
                                                   .bound(TimeBoundaryQuery.MIN_TIME)
                                                   .build();
    ResponseContext context = ConcurrentResponseContext.createEmpty();
