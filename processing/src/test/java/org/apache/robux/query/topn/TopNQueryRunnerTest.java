...
import org.apache.robux.query.TestQueryRunners;
...
public class TopNQueryRunnerTest extends InitializedNullHandlingTest
{
  ...
  {
    // this tests the stack overflow issue from https://github.com/apache/robux/issues/4628
    TopNQuery query = new TopNQueryBuilder()
        .dataSource(QueryRunnerTestHelper.DATA_SOURCE)
        .granularity(QueryRunnerTestHelper.ALL_GRAN)
  ...
  /**
   * Regression test for https://github.com/apache/robux/issues/5132
   */
  @Test
