...
import org.apache.robux.segment.CloseableShapeshifter;
import org.apache.robux.segment.TestSegmentForAs;
...
public class SegmentToRowsAndColumnsOperatorTest
{
  ...
  public void testNotShapeshiftable()
  {
    ...
    try {
      ...
      Assert.assertEquals(
          e.getMessage(),
          "Segment [class org.apache.robux.segment.TestSegmentForAs] cannot shapeshift"
      );
  ...
  public void testCanShiftButNotToARAC()
  {
    ...
    try {
      ...
      Assert.assertEquals(
          e.getMessage(),
          "Cannot work with segment of type[class org.apache.robux.segment.TestSegmentForAs]"
      );
      exceptionThrown = true;
    }
    Assert.assertTrue(exceptionThrown);
