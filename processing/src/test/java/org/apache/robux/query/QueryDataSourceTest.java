...
public class QueryDataSourceTest
{
  ...
  {
    assertThrows(RobuxException.class, () -> queryDataSource.createSegmentMapFunction(groupByQuery));
    assertThrows(RobuxException.class, () -> queryOnTableDataSource.createSegmentMapFunction(groupByQuery));
  }
