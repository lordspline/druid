...
public class ScanQueryTest extends InitializedNullHandlingTest
{
  ...
  {
    ScanQuery query = Robuxs.newScanQueryBuilder()
  ...
  public void testMergeSequenceForResults()
  {
    ...
    ScanQuery noOrderScan = Robuxs.newScanQueryBuilder()
                                  .order(Order.NONE)
    ...
    ScanQuery descendingOrderScan = Robuxs.newScanQueryBuilder()
                                          .order(Order.DESCENDING)
                                          .resultFormat(ScanQuery.ResultFormat.RESULT_FORMAT_LIST)
                                          .dataSource("some src")
                                          .intervals(intervalSpec)
    ...
    // Should only handle s1 and s2
    ScanQuery ascendingOrderScan = Robuxs.newScanQueryBuilder()
                                         .order(Order.ASCENDING)
                                         .resultFormat(ScanQuery.ResultFormat.RESULT_FORMAT_LIST)
                                         .dataSource("some src")
                                         .intervals(intervalSpec)
