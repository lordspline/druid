...
package org.apache.robux.query.monomorphicprocessing;
...
public class StringRuntimeShapeTest
{
  ...
  public void testStringRuntimeShape()
  {
    ...
    Assert.assertEquals(
        "org.apache.robux.query.monomorphicprocessing.StringRuntimeShapeTest$Bar {\n"
        + "  foo: org.apache.robux.query.monomorphicprocessing.StringRuntimeShapeTest$Foo {\n"
        + "    flag1: true,\n"
        + "    flag2: false,\n"
        + "    key: value,\n"
        + "    empty: org.apache.robux.query.monomorphicprocessing.StringRuntimeShapeTest$Empty,\n"
        ...
        + "  },\n"
        + "  array: [\n"
        + "    org.apache.robux.query.monomorphicprocessing.StringRuntimeShapeTest$Foo {\n"
        + "      flag1: true,\n"
        + "      flag2: false,\n"
        + "      key: value,\n"
        + "      empty: org.apache.robux.query.monomorphicprocessing.StringRuntimeShapeTest$Empty,\n"
