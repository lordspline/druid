...
package org.apache.robux.query.aggregation.firstlast.first;
...
import org.apache.robux.query.aggregation.firstlast.FirstLastVectorAggregator;
...
public class FloatFirstVectorAggregatorTest extends InitializedNullHandlingTest
{
  ...
  @Test
  public void testAggregateNulls1()
  {
    target1.init(buf, 0);
