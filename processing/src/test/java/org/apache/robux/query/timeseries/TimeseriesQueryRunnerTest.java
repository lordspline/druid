...
import org.apache.robux.query.MetricsEmittingQueryRunner;
...
public class TimeseriesQueryRunnerTest extends InitializedNullHandlingTest
{
  ...
  {
    TimeseriesQuery query1 = Robuxs.newTimeseriesQueryBuilder()
                                   .dataSource(QueryRunnerTestHelper.DATA_SOURCE)
    ...
    TimeseriesQuery query2 = Robuxs.newTimeseriesQueryBuilder()
                                   .dataSource(QueryRunnerTestHelper.DATA_SOURCE)
                                   .granularity("DAY")
                                   .intervals(
                                       Collections.singletonList(
  ...
  public void testTimeseriesWithFirstLastAggregator()
  {
    ...
    // There's a difference between ascending and descending results since granularity of robux.sample.tsv is days,
