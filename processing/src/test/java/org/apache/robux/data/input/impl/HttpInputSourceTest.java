...
public class HttpInputSourceTest
{
  ...
  {
    final HttpInputSourceConfig customConfig = new HttpInputSourceConfig(ImmutableSet.of("robux"), null);
    new HttpInputSource(
        ImmutableList.of(URI.create("robux:///")),
        "myName",
        new DefaultPasswordProvider("myPassword"),
        null,
        null,
  ...
  public void testEmptyAllowedHeaders()
  {
    ...
    expectedException.expectMessage(
        ...
        + "You can control the allowed headers by updating robux.ingestion.http.allowedHeaders");
