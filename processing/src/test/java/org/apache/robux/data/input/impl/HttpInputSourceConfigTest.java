...
public class HttpInputSourceConfigTest
{
  ...
  {
    HttpInputSourceConfig config = new HttpInputSourceConfig(ImmutableSet.of("robux"), null);
    Assert.assertEquals(ImmutableSet.of("robux"), config.getAllowedProtocols());
  }
