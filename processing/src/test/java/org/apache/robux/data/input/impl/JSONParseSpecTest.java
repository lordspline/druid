  ...
  public void testParseRowWithNullsInArrays()
  {
    final JSONParseSpec parseSpec = new JSONParseSpec(
        ...
        new JSONPathSpec(
            true,
            ImmutableList.of(
                // https://github.com/apache/robux/issues/6653 $.x.y.z where y is missing
                new JSONPathFieldSpec(JSONPathFieldType.PATH, "foo", "$.baz.[?(@.maybe_object)].maybe_object"),
                // https://github.com/apache/robux/issues/6653 $.x.y.z where y is from an array and is null
