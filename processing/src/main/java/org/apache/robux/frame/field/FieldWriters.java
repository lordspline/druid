...
import org.apache.robux.frame.write.RowBasedFrameWriterFactory;
import org.apache.robux.frame.write.UnsupportedColumnTypeException;
import org.apache.robux.frame.write.cast.TypeCastSelectors;
 ...
 *
 * Most callers should use {@link org.apache.robux.frame.write.FrameWriters} to build frames from
...
public class FieldWriters
{
  ...
  )
  {
    ...
    return FloatFieldWriter.forPrimitive(selector, frameType);
  }
  ...
  )
  {
    ...
    return DoubleFieldWriter.forPrimitive(selector, frameType);
  }
  ...
  )
  {
    ...
    return NumericArrayFieldWriter.getFloatArrayFieldWriter(selector, frameType);
  }
