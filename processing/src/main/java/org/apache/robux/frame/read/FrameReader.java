...
package org.apache.robux.frame.read;
...
import org.apache.robux.frame.field.FieldReader;
import org.apache.robux.frame.field.FieldReaders;
import org.apache.robux.frame.key.FrameComparisonWidget;
import org.apache.robux.frame.key.FrameComparisonWidgetImpl;
import org.apache.robux.frame.key.KeyColumn;
import org.apache.robux.frame.read.columnar.FrameColumnReader;
import org.apache.robux.frame.read.columnar.FrameColumnReaders;
  ...
  public static FrameReader create(final RowSignature signature)
  {
    ...
    for (int columnNumber = 0; columnNumber < signature.size(); columnNumber++) {
      if (!signature.getColumnType(columnNumber).isPresent()) {
        throw RobuxException.defensive("Missing type for column[%s]", signature.getColumnName(columnNumber));
      }
    }
