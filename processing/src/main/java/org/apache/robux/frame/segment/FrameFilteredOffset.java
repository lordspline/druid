...
/**
 * Copy of {@link org.apache.robux.segment.FilteredOffset} that does not require bitmap indexes.
 *
 * In a future where {@link org.apache.robux.segment.FilteredOffset} is opened up for usage outside of regular segments,
 * this class could be removed and usages could be migrated to {@link org.apache.robux.segment.FilteredOffset}.
 */
public class FrameFilteredOffset extends SimpleSettableOffset
{
  ...
  /**
   * See {@link org.apache.robux.segment.FilteredOffset#clone()} for notes.
   */
  @Override
  public Offset clone()
  {
