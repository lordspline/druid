...
package org.apache.robux.frame.write.cast;
...
import org.apache.robux.segment.RowIdSupplier;
...
public class ObjectToArrayColumnValueSelector implements ColumnValueSelector<Object[]>
{
  ...
  )
  {
    ...
    if (!desiredType.isArray() || desiredType.getElementType() == null) {
      throw RobuxException.defensive("Expected array with nonnull element type, got[%s]", desiredType);
    }
  }
  ...
  {
    throw RobuxException.defensive("Unexpected call to getDouble on array selector");
  }

  @Override
  public float getFloat()
  {
    throw RobuxException.defensive("Unexpected call to getFloat on array selector");
  }

  @Override
  public long getLong()
  {
    throw RobuxException.defensive("Unexpected call to getLong on array selector");
  }

  @Override
  public boolean isNull()
  {
    throw RobuxException.defensive("Unexpected call to isNull on array selector");
  }
