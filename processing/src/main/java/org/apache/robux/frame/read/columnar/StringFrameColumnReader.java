...
package org.apache.robux.frame.read.columnar;
...
import org.apache.robux.frame.read.FrameReaderUtils;
import org.apache.robux.frame.write.FrameWriterUtils;
import org.apache.robux.frame.write.columnar.FrameColumnWriters;
import org.apache.robux.frame.write.columnar.StringFrameColumnWriter;
...
import org.apache.robux.query.rowsandcols.column.Column;
import org.apache.robux.query.rowsandcols.column.ColumnAccessorBasedColumn;
import org.apache.robux.query.rowsandcols.column.accessor.ObjectColumnAccessorBase;
...
import org.apache.robux.segment.DimensionSelectorUtils;
...
public class StringFrameColumnReader implements FrameColumnReader
{
  ...
  private void validate(final Memory region)
  {
    ...
    if (region.getCapacity() < StringFrameColumnWriter.DATA_OFFSET) {
      throw RobuxException.defensive("Column[%s] is not big enough for a header", columnNumber);
    }
