...
/**
 * Writer for {@link org.apache.robux.frame.Frame}. See that class for format information.
 *
...
public interface FrameWriter extends Closeable
{
   ...
   * it is conventional (although not required) for the caller to throw {@link org.apache.robux.frame.processor.FrameRowTooLargeException}.
   *
