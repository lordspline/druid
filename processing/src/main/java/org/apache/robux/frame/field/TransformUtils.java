 ...
 * Checkout {@link org.apache.robux.frame.read.FrameReaderUtils#compareMemoryToByteArrayUnsigned} for how this byte
...
public class TransformUtils
{
  ...
  public static long transformFromDouble(final double n, final FrameType frameType)
  {
    switch (frameType) {
      ...
      default:
        throw RobuxException.defensive("Unexpected frameType[%s]", frameType);
    }
  }
