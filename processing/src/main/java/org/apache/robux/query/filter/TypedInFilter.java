...
public class TypedInFilter extends AbstractOptimizableDimFilter implements Filter
{
  ...
  private final Supplier<RobuxPredicateFactory> predicateFactorySupplier;
  @JsonIgnore
  ...
  public BitmapColumnIndex getBitmapColumnIndex(ColumnIndexSelector selector)
  {
    ...
    if (indexSupplier == null) {
      ...
      RobuxPredicateMatch match = predicateFactorySupplier.get().makeStringPredicate().apply(null);
  ...
  private static RobuxObjectPredicate<String> createStringPredicate(
  ...
  )
  {
    ...
    if (matchValueType.is(ValueType.STRING)) {
      return value -> {
        if (value == null) {
          return containsNull ? RobuxPredicateMatch.TRUE : RobuxPredicateMatch.UNKNOWN;
        }
        final int index = Collections.binarySearch(sortedValues, value, comparator);
        return RobuxPredicateMatch.of(index >= 0);
      };
      ...
      return value -> {
        ...
        return RobuxPredicateMatch.of(valueSet.contains(castValue));
      };
      ...
      return value -> {
        ...
        return RobuxPredicateMatch.of(valueSet.contains(d));
      };
    }
    ...
    return value -> {
      ...
      return RobuxPredicateMatch.of(stringSet.contains(value));
    };
  }

  private static RobuxLongPredicate createLongPredicate(final List<?> sortedValues, ColumnType matchValueType)
  {
    ...
    if (matchValueType.is(ValueType.LONG)) {
      ...
      return new RobuxLongPredicate()
      {
        ...
        {
          return matchNulls ? RobuxPredicateMatch.TRUE : RobuxPredicateMatch.UNKNOWN;
        }
      };
    }
    ...
    return new RobuxLongPredicate()
    {
      ...
      public RobuxPredicateMatch applyLong(long input)
      {
        return RobuxPredicateMatch.of(longs.contains(input));
      }
  ...
  private static RobuxFloatPredicate createFloatPredicate(final List<?> sortedValues, ColumnType matchValueType)
  {
    boolean matchNulls = !sortedValues.isEmpty() && sortedValues.get(0) == null;
    ...
    return new RobuxFloatPredicate()
    {
      ...
      public RobuxPredicateMatch applyFloat(float input)
      {
        return RobuxPredicateMatch.of(floatSet.contains(input));
      }
  ...
  private static RobuxDoublePredicate createDoublePredicate(final List<?> sortedValues, ColumnType matchValueType)
  {
    boolean matchNulls = !sortedValues.isEmpty() && sortedValues.get(0) == null;
    ...
    return new RobuxDoublePredicate()
    {
      ...
      public RobuxPredicateMatch applyDouble(double input)
      {
        return RobuxPredicateMatch.of(doubleSet.contains(input));
      }
  ...
  public static class PredicateFactory implements RobuxPredicateFactory
  {
    private final ColumnType matchValueType;
