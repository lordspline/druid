...
public class BoundDimFilter extends AbstractOptimizableDimFilter implements DimFilter
{
  ...
  public Supplier<RobuxLongPredicate> getLongPredicateSupplier()
  {
    return longPredicateSupplier;
  }

  public Supplier<RobuxFloatPredicate> getFloatPredicateSupplier()
  {
    return floatPredicateSupplier;
  }

  public Supplier<RobuxDoublePredicate> getDoublePredicateSupplier()
  {
  ...
  private Supplier<RobuxFloatPredicate> makeFloatPredicateSupplier()
  {
    return Suppliers.memoize(() -> {
      ...
      if (matchesNothing) {
        ...
        final RobuxDoublePredicate doublePredicate = RangeFilter.makeDoublePredicate(
            rangeType,
            lowerFloatBound,
            upperFloatBound
        );
