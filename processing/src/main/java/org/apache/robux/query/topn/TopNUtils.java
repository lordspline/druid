...
final class TopNUtils
{
   ...
   * needed, because when TopNScannerPrototype is specialized, occurrences of {@link org.apache.robux.segment.data.Offset} are
   * replaced with the specific Offset subtype in the TopNScannerPrototype bytecode, via {@link
   * org.apache.robux.query.monomorphicprocessing.SpecializationService#getSpecializationState(Class, String,
