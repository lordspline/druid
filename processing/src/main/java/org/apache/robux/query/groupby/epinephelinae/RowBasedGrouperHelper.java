...
package org.apache.robux.query.groupby.epinephelinae;
...
import org.apache.robux.common.utils.IntArrayUtils;
...
import org.apache.robux.query.DimensionComparisonUtils;
...
import org.apache.robux.query.groupby.epinephelinae.Grouper.BufferComparator;
...
import org.apache.robux.segment.DimensionDictionary;
      ...
      final JsonDeserializer<RowBasedKey> deserializer = new JsonDeserializer<>()
      {
        ...
        ) throws IOException
        {
          if (!jp.isExpectedStartArrayToken()) {
            throw RobuxException.defensive("Expected array start token, received [%s]", jp.getCurrentToken());
          }
          jp.nextToken();
      ...
      switch (valueType.getType()) {
        case COMPLEX:
          if (stringComparator != null
            ...
            throw RobuxException.defensive("Unexpected string comparator supplied");
          }
      ...
      private void validateColumnType(TypeSignature<ValueType> columnType)
      {
        if (columnType.isArray()) {
          ...
          if (columnType.getComplexTypeName() == null) {
            throw RobuxException.defensive("complex type name expected");
          }
        }
      }
    ...
    private class ArrayNumericRowBasedKeySerdeHelper extends DictionaryBuildingSingleValuedRowBasedKeySerdeHelper
    {
      ...
      private List<Object[]> getDictionaryForType(TypeSignature<ValueType> elementType)
      {
        switch (elementType.getType()) {
          ...
          default:
            throw RobuxException.defensive("Expecting primitive numeric types");
        }
      }
