...
import org.apache.robux.query.QueryResourceId;
import org.apache.robux.query.QueryRunner;
import org.apache.robux.query.QueryToolChest;
import org.apache.robux.query.SubqueryQueryRunner;
  ...
  )
  {
    ...
    return new CacheStrategy<>()
    {
      ...
      public boolean isCacheable(GroupByQuery query, boolean willMergeRunners, boolean bySegment)
      {
        ...
        //see PR https://github.com/apache/robux/issues/3820
          ...
          public ResultRow apply(Object input)
          {
            ...
            if (isResultLevelCache) {
              for (int postPos = 0; postPos < query.getPostAggregatorSpecs().size(); postPos++) {
                if (!results.hasNext()) {
                  throw RobuxException.defensive("Ran out of objects while reading postaggs from cache!");
                }
