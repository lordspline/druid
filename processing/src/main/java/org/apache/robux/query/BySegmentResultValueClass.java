...
public class BySegmentResultValueClass<T> implements BySegmentResultValue<T>
{
   ...
   * BySegmentResultValueClass object is sent across Robux nodes, on the reciever (deserialization) side it's impossible
   * to unambiguously convert a segment id string (as transmitted in the JSON format) back into a {@code SegmentId}
   * object ({@link org.apache.robux.timeline.SegmentId#tryParse} javadoc explains that ambiguities in details). It
