...
import org.apache.robux.math.expr.vector.LongUnivariateLongFunctionVectorProcessor;
...
public class TimestampFloorExprMacro implements ExprMacroTable.ExprMacro
{
  ...
  public static class TimestampFloorExpr extends ExprMacroTable.BaseScalarMacroFunctionExpr
  {
    ...
    /**
     * Exposed for Robux SQL: this is used by Expressions.toQueryGranularity.
     */
    public Expr getArg()
    {
      return args.get(0);
