...
public class NullFilter extends AbstractOptimizableDimFilter implements Filter
{
  ...
  public static class NullPredicateFactory implements RobuxPredicateFactory
  {
    ...
    {
      return RobuxLongPredicate.MATCH_NULL_ONLY;
    }

    @Override
    public RobuxFloatPredicate makeFloatPredicate()
    {
      return RobuxFloatPredicate.MATCH_NULL_ONLY;
    }

    @Override
    public RobuxDoublePredicate makeDoublePredicate()
    {
      return RobuxDoublePredicate.MATCH_NULL_ONLY;
    }
