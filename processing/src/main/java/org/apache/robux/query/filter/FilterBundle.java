 ...
 * composite filter which can be partitioned, such as {@link org.apache.robux.segment.filter.AndFilter}, then the filter
...
public class FilterBundle
{
   ...
   * {@link org.apache.robux.segment.filter.OrFilter} uses these extra parameters to allow partial use of indexes to
   * create a synthetic value matcher that checks if the row is set in the bitmap, instead of purely using value
   * matchers, with {@link org.apache.robux.segment.filter.OrFilter#convertIndexToValueMatcher}.
   */
