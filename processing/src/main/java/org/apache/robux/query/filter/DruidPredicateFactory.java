...
public interface RobuxPredicateFactory
{
  RobuxObjectPredicate<String> makeStringPredicate();

  RobuxLongPredicate makeLongPredicate();

  RobuxFloatPredicate makeFloatPredicate();

  RobuxDoublePredicate makeDoublePredicate();

  default RobuxObjectPredicate<Object[]> makeArrayPredicate(@Nullable TypeSignature<ValueType> inputType)
  {
   ...
   *
   * @see org.apache.robux.segment.VectorColumnProcessorFactory#makeObjectProcessor
   */
  default RobuxObjectPredicate<Object> makeObjectPredicate()
  {
    final RobuxObjectPredicate<String> stringPredicate = makeStringPredicate();
