...
package org.apache.robux.query.groupby.epinephelinae.column;

import org.apache.robux.query.dimension.ColumnSelectorStrategy;
import org.apache.robux.query.groupby.ResultRow;
import org.apache.robux.query.groupby.epinephelinae.Grouper;
 ...
 *
 * @see org.apache.robux.query.groupby.epinephelinae.vector.GroupByVectorColumnSelector the vectorized version
 */
public interface GroupByColumnSelectorStrategy extends ColumnSelectorStrategy
{
  ...
  /**
   * Read the first value within a row values object (e. g. {@link org.apache.robux.segment.data.IndexedInts}, as the value in
   * a dictionary-encoded string column) and write that value to the keyBuffer at keyBufferPosition. If the row size is
   * 0 (e. g. {@link org.apache.robux.segment.data.IndexedInts#size}), write {@link #GROUP_BY_MISSING_VALUE} instead.
   *
   ...
   *                          will use the {@link org.apache.robux.query.ordering.StringComparators#LEXICOGRAPHIC}
   *                          comparator.
   *
