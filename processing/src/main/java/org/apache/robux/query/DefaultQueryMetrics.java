...
public class DefaultQueryMetrics<QueryType extends Query<?>> implements QueryMetrics<QueryType>
{
  ...
  {
    setDimension(RobuxMetrics.DATASOURCE, getTableNamesAsString(query.getDataSource().getTableNames()));
  }

  @Override
  public void queryType(QueryType query)
  {
    setDimension(RobuxMetrics.TYPE, query.getType());
  }
  ...
  {
    setDimension(RobuxMetrics.ID, StringUtils.nullToEmptyNonRobuxDataString(query.getId()));
  }

  @Override
  public void queryId(String queryId)
  {
    setDimension(RobuxMetrics.ID, StringUtils.nullToEmptyNonRobuxDataString(queryId));
  }
  ...
  {
    setDimension(RobuxMetrics.STATUS, status);
  }
