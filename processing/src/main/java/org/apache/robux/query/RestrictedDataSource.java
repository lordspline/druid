...
import org.apache.robux.segment.RestrictedSegment;
 ...
 * transformed to a RestrictedDataSource. Robux internal system and admin users would have a {@link NoRestrictionPolicy}.
 */
public class RestrictedDataSource implements DataSource
{
  ...
  public DataSource withPolicies(Map<String, Optional<Policy>> policyMap, PolicyEnforcer policyEnforcer)
  {
    ...
    if (newPolicy.isEmpty() || newPolicy.get() instanceof NoRestrictionPolicy) {
      ...
      // robux-internal calls with NoRestrictionPolicy: allow
    ...
    // authorized robux-internal request.
