...
package org.apache.robux.query.groupby.having;
...
class HavingSpecMetricComparator
{
  ...
  {
    if (value == null) {
      throw RobuxException.defensive("Unexpected null match value");
    }
    ...
    if (metricValueObj != null) {
      ...
      if (metricValueObj instanceof Long || metricValueObj instanceof Integer) {
        ...
        if (value instanceof Long || value instanceof Integer) {
          ...
          throw RobuxException.defensive("Number was[%s]?!?", value.getClass().getName());
        }
      ...
      throw RobuxException.defensive("Unexpected null metric value");
    }
  }
