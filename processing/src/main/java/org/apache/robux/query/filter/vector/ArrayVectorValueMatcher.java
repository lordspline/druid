...
public class ArrayVectorValueMatcher implements VectorValueMatcherFactory
{
  ...
  @Override
  public VectorValueMatcher makeMatcher(RobuxPredicateFactory predicateFactory)
  {
    final RobuxObjectPredicate<Object[]> predicate = predicateFactory.makeArrayPredicate(columnType);
