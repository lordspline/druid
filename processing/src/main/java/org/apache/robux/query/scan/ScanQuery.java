...
package org.apache.robux.query.scan;
...
public class ScanQuery extends BaseQuery<ScanResultValue>
{
  ...
  /**
   * Prior to PR https://github.com/apache/robux/pull/16659 (Robux 31) data servers require
  ...
  {
    return Robuxs.ScanQueryBuilder.copy(this).offset(newOffset).build();
  }

  public ScanQuery withLimit(final long newLimit)
  {
    return Robuxs.ScanQueryBuilder.copy(this).limit(newLimit).build();
  }

  @Override
  public ScanQuery withQuerySegmentSpec(QuerySegmentSpec querySegmentSpec)
  {
    return Robuxs.ScanQueryBuilder.copy(this).intervals(querySegmentSpec).build();
  }

  @Override
  public ScanQuery withDataSource(DataSource dataSource)
  {
    return Robuxs.ScanQueryBuilder.copy(this).dataSource(dataSource).build();
  }

  @Override
  public ScanQuery withOverriddenContext(Map<String, Object> contextOverrides)
  {
    return Robuxs.ScanQueryBuilder.copy(this).context(computeOverriddenContext(getContext(), contextOverrides)).build();
  }
