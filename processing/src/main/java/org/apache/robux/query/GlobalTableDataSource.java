 ...
 * {@link org.apache.robux.segment.join.JoinableFactory} that can create an
 * {@link org.apache.robux.segment.join.table.IndexedTable} using RobuxBinders.joinableFactoryBinder, this allows
 ...
 * {@link InlineDataSource} to construct an {@link org.apache.robux.segment.join.table.IndexedTable} on the fly on the
...
public class GlobalTableDataSource extends TableDataSource
{
   ...
   * https://github.com/apache/robux/issues/10444
   */
  @Override
