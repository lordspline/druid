...
import org.apache.robux.segment.filter.ConstantMatcherType;
...
import org.apache.robux.segment.vector.VectorSizeInspector;
 ...
 *
 * @see org.apache.robux.query.filter.ValueMatcher, the non-vectorized version
 */
public interface VectorValueMatcher extends VectorSizeInspector
{
   ...
   * @param includeUnknown mapping for Robux native two state logic system into SQL three-state logic system. If set
   ...
   * {@link ReadableVectorMatch} as selections, to participate in Robux 2-state logic system to SQL 3-state logic
   * system conversion.
   */
   ...
   * any null elements to the {@link ReadableVectorMatch} as selections, to participate in Robux 2-state logic system
   ...
   * as selections, to participate in Robux 2-state logic system to SQL 3-state logic system conversion.
   */
   ...
   * selections, to participate in Robux 2-state logic system to SQL 3-state logic system conversion.
   */
