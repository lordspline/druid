...
package org.apache.robux.query.planning;
...
public class ExecutionVertex
{
   ...
   *
   * @throws RobuxException error of type {@link RobuxException.Category#DEFENSIVE} if the {@link #getBaseDataSource()}
  ...
  public final TableDataSource getBaseTableDataSource()
  {
    if (baseDataSource instanceof TableDataSource) {
      ...
      throw RobuxException.defensive("Base dataSource[%s] is not a table!", baseDataSource);
    }
  }
