...
package org.apache.robux.query.union;
...
public class UnionQuery implements Query<Object>
{
  ...
  {
    throw RobuxException.defensive("This is not supported. Use getDataSources instead!");
  }
  ...
  {
    throw RobuxException.defensive("Use QueryToolChest to get a Runner");
  }
  ...
  public static RobuxException methodNotSupported()
  {
    return RobuxException.defensive("Method not supported. This method is not expected to be called!");
  }
