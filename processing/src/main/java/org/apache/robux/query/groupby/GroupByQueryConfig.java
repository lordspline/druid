...
public class GroupByQueryConfig
{
  ...
  public long getActualMaxSelectorDictionarySize(final RobuxProcessingConfig processingConfig)
  {
  ...
  public long getActualMaxMergingDictionarySize(final RobuxProcessingConfig processingConfig)
  {
   ...
   *
   * This mirroring is done to maintain continuity in behavior between Robux versions. If an operator wants to use
