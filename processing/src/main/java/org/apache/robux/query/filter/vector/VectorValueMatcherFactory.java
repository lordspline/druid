...
{
  /**
   * Specialized value matcher for string equality used by {@link org.apache.robux.query.filter.SelectorDimFilter}
   */
  VectorValueMatcher makeMatcher(@Nullable String value);

  /**
   * Specialized value matcher for equality used by {@link org.apache.robux.query.filter.EqualityFilter}. The
  ...
  VectorValueMatcher makeMatcher(RobuxPredicateFactory predicateFactory);
}
