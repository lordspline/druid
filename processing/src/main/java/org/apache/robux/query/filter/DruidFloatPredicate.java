...
public interface RobuxFloatPredicate
{
  RobuxFloatPredicate ALWAYS_FALSE_WITH_NULL_UNKNOWN = input -> RobuxPredicateMatch.FALSE;

  RobuxFloatPredicate ALWAYS_TRUE = input -> RobuxPredicateMatch.TRUE;

  RobuxFloatPredicate MATCH_NULL_ONLY = new RobuxFloatPredicate()
  {
    @Override
  ...
  RobuxPredicateMatch applyFloat(float input);
