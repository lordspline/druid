 ...
 * following reasons: 1) The query is not supported yet. 2) The query is not something Robux would ever supports.
 * For these cases, the exact causes and details should also be documented in Robux user facing documents.
 * <p>
