...
public interface BufferAggregator extends HotLoopCallee
{
   ...
   * have an {@link AggregatorFactory#getIntermediateType()} ()} of {@link org.apache.robux.segment.column.ValueType#FLOAT}.
   ...
   */
  @SuppressWarnings("unused") // Unused today, but may be used in the future by https://github.com/apache/robux/pull/10001
   ...
   *
   * Implementations are only required to support this method if they are aggregations which
   * have an {@link AggregatorFactory#getIntermediateType()} of  of {@link org.apache.robux.segment.column.ValueType#LONG}.
   * If unimplemented, throwing an {@link UnsupportedOperationException} is common and recommended.
   *
   * @param buf byte buffer storing the byte array representation of the aggregate
   * @param position offset within the byte buffer at which the aggregate value is stored
   ...
   *
   * Implementations are only required to support this method if they are aggregations which
   * have an {@link AggregatorFactory#getIntermediateType()} of  of {@link org.apache.robux.segment.column.ValueType#DOUBLE}.
   * If unimplemented, throwing an {@link UnsupportedOperationException} is common and recommended.
   *
