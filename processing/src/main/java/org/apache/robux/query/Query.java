...
import org.apache.robux.query.select.SelectQuery;
...
public interface Query<T>
{
   ...
   * point. Extensions can choose to rely on this default to retain compatibility with core Robux.
   *
