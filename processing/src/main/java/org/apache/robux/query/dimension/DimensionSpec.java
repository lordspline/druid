...
package org.apache.robux.query.dimension;
...
public interface DimensionSpec extends Cacheable
{
   ...
   * {@link org.apache.robux.segment.vector.VectorColumnSelectorFactory#makeSingleValueDimensionSelector(DimensionSpec)}
   *
   ...
   * produced with
   * {@link org.apache.robux.segment.vector.VectorColumnSelectorFactory#makeMultiValueDimensionSelector(DimensionSpec)}
   *
   * Decoration allows a {@link DimensionSpec} to customize the behavior of the underlying selector, for example
   * transforming or filtering values.
   */
