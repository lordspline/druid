...
public class Groupers
{
  ...
  private static final AggregateResult DICTIONARY_FULL_ZERO_COUNT = AggregateResult.partial(
      ...
      + "disk spilling by setting robux.query.groupBy.maxOnDiskStorage to an amount of bytes "
      + "available on your machine for on-disk scratch files. "
      + "See https://robux.apache.org/docs/latest/querying/groupbyquery.html#memory-tuning-and-resource-limits "
      + "for details."
  );
  ...
  private static final AggregateResult HASH_TABLE_FULL_ZERO_COUNT = AggregateResult.partial(
      ...
      + "available, consider increasing robux.processing.buffer.sizeBytes. "
      + "See https://robux.apache.org/docs/latest/querying/groupbyquery.html#memory-tuning-and-resource-limits "
      + "for details."
  );
