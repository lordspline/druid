...
public interface RobuxDoublePredicate
{
  RobuxDoublePredicate ALWAYS_FALSE_WITH_NULL_UNKNOWN = input -> RobuxPredicateMatch.FALSE;

  RobuxDoublePredicate ALWAYS_TRUE = input -> RobuxPredicateMatch.TRUE;

  RobuxDoublePredicate MATCH_NULL_ONLY = new RobuxDoublePredicate()
  {
    @Override
  ...
  RobuxPredicateMatch applyDouble(double input);
