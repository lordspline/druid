...
import org.apache.robux.query.groupby.epinephelinae.column.GroupByColumnSelectorPlus;
import org.apache.robux.query.groupby.epinephelinae.column.GroupByColumnSelectorStrategy;
...
/**
 * Contains logic to process a groupBy query on a single {@link org.apache.robux.segment.CursorFactory} in a
 ...
 * <p>
 * This code runs on anything that processes {@link org.apache.robux.segment.CursorFactory} directly, typically data
 ...
 *
 * @see org.apache.robux.query.groupby.epinephelinae.vector.VectorGroupByEngine for vectorized version of this class
 */
public class GroupByQueryEngine
{
  ...
  private abstract static class GroupByEngineIterator<KeyType> implements Iterator<ResultRow>, Closeable
  {
    ...
    protected final CursorGranularizer granularizer;
    ...
    )
    {
      ...
      this.timestamp = fudgeTimestamp != null ? fudgeTimestamp : granularizer.getBucketStart();
