...
import org.apache.robux.query.topn.HeapBasedTopNAlgorithm;
import org.apache.robux.query.topn.TopNCursorInspector;
import org.apache.robux.query.topn.TopNParams;
import org.apache.robux.query.topn.TopNQuery;
import org.apache.robux.query.topn.TopNResultBuilder;
...
/**
 * This {@link ColumnSelectorStrategy} is used by all {@link org.apache.robux.query.topn.TopNAlgorithm} to provide
...
public interface TopNColumnAggregatesProcessor<ValueSelectorType> extends ColumnSelectorStrategy
{
   ...
   *
   * Create an Aggregator[][] using {@link org.apache.robux.query.topn.BaseTopNAlgorithm.AggregatorArrayProvider} and
   ...
   *     {@link org.apache.robux.query.topn.BaseTopNAlgorithm#makeAggregators} and the provided cursor and query,
