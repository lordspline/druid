...
import org.apache.robux.query.AbstractPrioritizedQueryRunnerCallable;
...
import org.apache.robux.query.groupby.GroupByQueryResources;
...
import org.apache.robux.query.groupby.epinephelinae.RowBasedGrouperHelper.RowBasedKey;
 ...
 *
 * Used by
 * {@link org.apache.robux.query.groupby.GroupingEngine#mergeRunners(QueryProcessingPool, Iterable)}
 */
public class GroupByMergingQueryRunner implements QueryRunner<ResultRow>
{
  ...
  public Sequence<ResultRow> run(final QueryPlus<ResultRow> queryPlus, final ResponseContext responseContext)
  {
    ...
    final File temporaryStorageDirectory = new File(
        processingTmpDir,
        StringUtils.format("robux-groupBy-%s_%s", UUID.randomUUID(), query.getId())
    );
