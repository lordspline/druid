...
package org.apache.robux.query.aggregation.firstlast;
    ...
    extends FirstLastVectorAggregator<String, SerializablePairLongString>
{
  ...
  {
    throw RobuxException.defensive("This method is not applicable to the SingleStringFirstLastDimensionVectorAggregator");
  }
  ...
  private static class SingleValueDimensionVectorSelectorAdapter implements VectorValueSelector
  {
    ...
    {
      throw RobuxException.defensive("Unexpected call");
    }
