...
public interface LookupExtractorFactory extends Supplier<LookupExtractor>
{
  ...
  /**
   * <p>
   *   This method will be called to stop the LookupExtractor upon Robux process stop. This would be used, for
   ...
   *   when Robux process was being stopped to be restarted.
