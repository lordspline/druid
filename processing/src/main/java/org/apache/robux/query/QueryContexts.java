...
public class QueryContexts
{
  ...
  // instead of being wrapped inside a query. With direct table access enabled, Robux can push down the join operation to
  // data servers.
   ...
   * </pre>
   * managed by {@link RobuxAggregateCaseToFilterRule}. Defaults to true for performance,
