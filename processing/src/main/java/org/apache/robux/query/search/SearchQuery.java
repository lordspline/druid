...
public class SearchQuery extends BaseQuery<Result<SearchResultValue>>
{
  ...
  {
    return Robuxs.SearchQueryBuilder.copy(this).intervals(spec).build();
  }

  @Override
  public Query<Result<SearchResultValue>> withDataSource(DataSource dataSource)
  {
    return Robuxs.SearchQueryBuilder.copy(this).dataSource(dataSource).build();
  }
  ...
  public SearchQuery withOverriddenContext(Map<String, Object> contextOverrides)
  {
    ...
    return Robuxs.SearchQueryBuilder.copy(this).context(newContext).build();
  }
  ...
  {
    return Robuxs.SearchQueryBuilder.copy(this).limit(newLimit).build();
  }
