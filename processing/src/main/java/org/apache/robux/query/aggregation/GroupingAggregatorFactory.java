...
import org.apache.robux.annotations.EverythingIsNonnullByDefault;
import org.apache.robux.query.aggregation.constant.LongConstantAggregator;
import org.apache.robux.query.aggregation.constant.LongConstantBufferAggregator;
import org.apache.robux.query.aggregation.constant.LongConstantVectorAggregator;
 ...
 *                             {@code groupings}. This argument cannot be passed by the user. It is set by robux engine
 *                             when a particular subtotal spec is being processed. Whenever robux engine processes a new
 ...
 *  Since it is a non-trivial special aggregation, implementing it required changes in core robux engine to work. There
 *  were few approaches. We chose the approach that required least changes in core robux.
 *  Refer to https://github.com/apache/robux/pull/10518#discussion_r532941216 for more details.
 *
