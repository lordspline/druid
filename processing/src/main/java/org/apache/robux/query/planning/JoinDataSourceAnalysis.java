 ...
 *
 * The base datasource is the one that will be considered by the core Robux query stack for scanning via
 * {@link org.apache.robux.segment.Segment} and {@link org.apache.robux.segment.CursorFactory}. The other leaf
 ...
 * neatly onto a series of hash table lookups at query time. The user/system generating the queries, e.g. the robux-sql
