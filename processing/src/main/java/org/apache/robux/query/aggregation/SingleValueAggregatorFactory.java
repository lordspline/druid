...
public class SingleValueAggregatorFactory extends AggregatorFactory
{
  ...
  {
    throw RobuxException.defensive("Single Value Aggregator would not have more than one row to compare");
  }
  ...
  {
    throw RobuxException.defensive("Single Value Aggregator would not have more than one row to combine");
  }
