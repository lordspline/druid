  ...
  public Sequence<T> run(QueryPlus<T> queryPlus, ResponseContext responseContext)
  {
    ...
    switch (serializationMode) {
      ...
      case FRAMES:
        ...
        ).orElseThrow(() -> RobuxException.defensive("Unable to materialize the results as frames."));
        break;
      default:
        throw RobuxException.defensive("Not supported serializationMode [%s].", serializationMode);
    }
