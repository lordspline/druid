...
import org.apache.robux.query.topn.types.TopNColumnAggregatesProcessorFactory;
...
public class TopNQueryEngine
{
   ...
   * {@link org.apache.robux.segment.DimensionSelector#lookupName(int)} until as late as possible in query processing.
   * <p>
