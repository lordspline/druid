 ...
 * merging (see {@link org.apache.robux.segment.IndexMerger}).
 *
...
public interface AggregateCombiner<T> extends ColumnValueSelector<T>
{
   ...
   *
   * If the selector is an {@link org.apache.robux.segment.ObjectColumnSelector}, the object returned from {@link
   * org.apache.robux.segment.ObjectColumnSelector#getObject()} must not be modified, and must not become a subject for
   ...
   *
   * Unlike {@link AggregatorFactory#combine}, if the selector is an {@link org.apache.robux.segment.ObjectColumnSelector}, the
   * object returned from {@link org.apache.robux.segment.ObjectColumnSelector#getObject()} must not be modified, and must not
