...
package org.apache.robux.query.groupby.epinephelinae.vector;
...
import org.apache.robux.query.aggregation.AggregatorAdapters;
...
import org.apache.robux.query.groupby.epinephelinae.AggregateResult;
import org.apache.robux.query.groupby.epinephelinae.BufferArrayGrouper;
import org.apache.robux.query.groupby.epinephelinae.CloseableGrouperIterator;
import org.apache.robux.query.groupby.epinephelinae.HashVectorGrouper;
import org.apache.robux.query.groupby.epinephelinae.VectorGrouper;
import org.apache.robux.query.groupby.epinephelinae.collection.MemoryPointer;
import org.apache.robux.query.vector.VectorCursorGranularizer;
...
import org.apache.robux.segment.vector.VectorCursor;
...
/**
 * Contains logic to process a groupBy query on a single {@link org.apache.robux.segment.CursorFactory} in a vectorized
 * manner. This code runs on anything that processes {@link org.apache.robux.segment.CursorFactory} directly, typically
 * data servers like Historicals.
 * <p>
 * Used for vectorized processing by {@link GroupingEngine#process}.
 *
 * @see org.apache.robux.query.groupby.epinephelinae.GroupByQueryEngine for non-vectorized version of this logic
 */
