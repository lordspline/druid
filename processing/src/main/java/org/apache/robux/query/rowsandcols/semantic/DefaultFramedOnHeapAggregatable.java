...
import org.apache.robux.query.operator.window.WindowFrame.Groups;
import org.apache.robux.query.operator.window.WindowFrame.OffsetFrame;
import org.apache.robux.query.operator.window.WindowFrame.Rows;
...
import org.apache.robux.segment.ObjectBasedColumnSelector;
...
public class DefaultFramedOnHeapAggregatable implements FramedOnHeapAggregatable
{
  ...
  public static Iterable<AggInterval> buildIteratorFor(AppendableRowsAndColumns rac, WindowFrame frame)
  {
    ...
    throw RobuxException.defensive("Unable to handle WindowFrame [%s]!", frame);
  }
