 ...
 * org.apache.robux.query.aggregation.cardinality.CardinalityAggregatorFactory}).
...
public abstract class AggregatorFactory implements Cacheable
{
   ...
   * {@link org.apache.robux.segment.ColumnValueSelector} and it's subinterfaces to get inputs and implements {@code
   * ColumnValueSelector} to provide output.
   *
   * @see AggregateCombiner
   * @see org.apache.robux.segment.IndexMerger
   */
   ...
   *
   * The main user of this method is {@link org.apache.robux.segment.incremental.OnheapIncrementalIndex}, which
   ...
   * {@link org.apache.robux.sql.calcite.rel.RobuxQuery#computeAggregations}. We can use withName("total") to set the output name
   ...
   * {@link org.apache.robux.segment.projections.QueryableProjection} can be used instead of the base table during
   * {@link org.apache.robux.segment.CursorFactory#makeCursorHolder(CursorBuildSpec)}, which checks if this
