...
package org.apache.robux.indexer.partitions;

/**
 * In Robux, ingested data are primarily partitioned based on time range (@link GranularitySpec#getSegmentGranularity),
...
public enum SecondaryPartitionType
{
   ...
   * @see org.apache.robux.timeline.partition.NumberedShardSpec
   */
  LINEAR,
  /**
   ...
   * @see org.apache.robux.timeline.partition.HashBasedNumberedShardSpec
   */
  HASH,
  /**
   ...
   * @see org.apache.robux.timeline.partition.DimensionRangeShardSpec
   */
  RANGE
}
