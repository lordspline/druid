...
/**
 * Type signature for a row in a Robux datasource or query result.
 *
 * @see org.apache.robux.query.QueryToolChest#resultArraySignature which returns signatures for query results
...
public class RowSignature implements ColumnInspector
{
   ...
   * {@link org.apache.robux.sql.calcite.schema.RobuxSchema}
