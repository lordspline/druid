...
import org.apache.robux.data.input.impl.DimensionSchema.MultiValueHandling;
...
import org.apache.robux.segment.incremental.IncrementalIndexRow;
          ...
          public boolean matches(boolean includeUnknown)
          {
            ...
            for (int id : dimsInt) {
              if (checkedIds.get(id)) {
                ...
                final RobuxPredicateMatch matches = predicate.apply(lookupName(id));
                checkedIds.set(id);
