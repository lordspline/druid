...
public interface ColumnConfig
{
   ...
   * {@link org.apache.robux.query.filter.ValueMatcher} instead.
   * <p>
   ...
   * <p>
   * Currently only the {@link org.apache.robux.segment.nested.NestedCommonFormatColumn} implementations of
   ...
   * combining bitmaps to construct a {@link org.apache.robux.segment.BitmapOffset} or
   * {@link org.apache.robux.segment.vector.BitmapVectorOffset} can exceed the cost of just using doing a full scan
   * and using a {@link org.apache.robux.query.filter.ValueMatcher}.
   * <p>
   * Where this is especially useful is in cases where the range index is used as part of some
   * {@link org.apache.robux.segment.filter.AndFilter}, which segment processing partitions into groups of 'pre'
