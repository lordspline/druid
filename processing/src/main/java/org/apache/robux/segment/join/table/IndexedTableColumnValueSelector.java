...
public class IndexedTableColumnValueSelector implements ColumnValueSelector<Object>
{
  ...
  public double getDouble()
  {
    ...
    assert !isNull();
    throw RobuxException.defensive("Called getDouble on a non-numeric value");
  }
  ...
  public float getFloat()
  {
    ...
    assert !isNull();
    throw RobuxException.defensive("Called getFloat on a non-numeric value");
  }
  ...
  public long getLong()
  {
    ...
    assert !isNull();
    throw RobuxException.defensive("Called getLong on a non-numeric value");
  }
