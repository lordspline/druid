...
public interface DimensionMerger
{
   ...
   *   org.apache.robux.segment.incremental.IncrementalIndexAdapter#getDimValueLookup(String)}) dictionary encoding information
   *   from the adapters
   ...
   * See {@link org.apache.robux.segment.serde.NullColumnPartSerde} for how null-only columns are stored in the segment.
   */
