...
package org.apache.robux.segment.data;

import org.apache.robux.annotations.SubclassesMustBePublic;
 ...
 * org.apache.robux.query.topn.Historical1SimpleDoubleAggPooledTopNScannerPrototype} and {@link
 * org.apache.robux.query.topn.HistoricalSingleValueDimSelector1SimpleDoubleAggPooledTopNScannerPrototype} during
 * specialization, and specialized version of those prototypes must be able to any subclass of Offset.
 *
 * This interface is the core "pointer" interface that is used to create {@link org.apache.robux.segment.ColumnValueSelector}s
 * over historical segments. It's counterpart for incremental index is {@link
 * org.apache.robux.segment.incremental.IncrementalIndexRowHolder}.
 */
...
public abstract class Offset implements ReadableOffset, Cloneable
{
   ...
   * org.apache.robux.segment.FilteredOffset} and reduce reference indirection, when only {@link ReadableOffset} API is needed.
   */
