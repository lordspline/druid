 ...
 * {@link org.apache.robux.segment.projections.Projections}.
 *
 * @see #getFilter()
 * @see #getInterval()
...
public class CursorBuildSpec
{
   ...
   * selectors created from the {@link Cursor} or {@link org.apache.robux.segment.vector.VectorCursor}
   */
  @Nullable
   ...
   * {@link org.apache.robux.segment.vector.VectorCursor}
   */
   ...
   * specializing the {@link Cursor} or {@link org.apache.robux.segment.vector.VectorCursor} if any pre-aggregated
   * data is available.
   */
  @Nullable
   ...
   * {@link org.apache.robux.segment.vector.VectorCursor} if any pre-aggregated data is available.
   */
  @Nullable
   ...
   * {@link org.apache.robux.segment.vector.VectorCursor} if data matching the preferred ordering is available.
   * <p>
   ...
   * {@link Cursor} and {@link org.apache.robux.segment.vector.VectorCursor} such as
   * {@link org.apache.robux.query.QueryContexts#VECTORIZE_KEY} and
   * {@link org.apache.robux.query.QueryContexts#VECTOR_SIZE_KEY}
   */
   ...
   * {@link org.apache.robux.segment.vector.VectorCursor} creation.
   */
  @Nullable
  ...
  public static class CursorBuildSpecBuilder
  {
     ...
     * combined with an {@link org.apache.robux.segment.filter.AndFilter}. If {@link #physicalColumns} is set,
    ...
    {
      RobuxException.conditionalDefensive(filterToAdd != null, "filterToAdd must not be null");
