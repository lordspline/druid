...
package org.apache.robux.segment.projections;

import org.apache.robux.segment.ColumnSelectorFactory;
import org.apache.robux.segment.CursorBuildSpec;
import org.apache.robux.segment.RemapColumnSelectorFactory;
import org.apache.robux.segment.vector.RemapVectorColumnSelectorFactory;
import org.apache.robux.segment.vector.VectorColumnSelectorFactory;

import java.util.Map;

/**
 * Represents a projection of some base table available to use to build a {@link org.apache.robux.segment.CursorHolder}
 * by a {@link org.apache.robux.segment.CursorFactory}.
 * <p>
 * Projections are a type of invisible materialized view stored inside of a {@link org.apache.robux.segment.Segment}
 * which can be automatically used if they match the {@link CursorBuildSpec} argument passed to
 * {@link org.apache.robux.segment.CursorFactory#makeCursorHolder(CursorBuildSpec)}.
 * <p>
 ...
 * {@link org.apache.robux.segment.CursorFactory} to build a {@link org.apache.robux.segment.CursorHolder} for the
 ...
 * constructed by that {@link org.apache.robux.segment.CursorHolder} whenever it builds a
 * {@link org.apache.robux.segment.Cursor} or {@link org.apache.robux.segment.vector.VectorCursor} to ensure that all
 * the selectors needed to satisfy the original {@link CursorBuildSpec} are available at the correct names.
 * 
 * @see org.apache.robux.segment.QueryableIndexCursorFactory#makeCursorHolder(CursorBuildSpec)
 * @see org.apache.robux.segment.incremental.IncrementalIndexCursorFactory#makeCursorHolder(CursorBuildSpec)
 */
public class QueryableProjection<T>
{
   ...
   * {@link org.apache.robux.segment.CursorFactory}
   */
