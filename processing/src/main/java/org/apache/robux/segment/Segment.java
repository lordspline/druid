...
import org.apache.robux.query.datasourcemetadata.DataSourceMetadataResultValue;
...
/**
 * The difference between this class and {@link org.apache.robux.timeline.DataSegment} is that {@link
 * org.apache.robux.timeline.DataSegment} contains the segment metadata only, while this class represents the actual
...
public interface Segment extends Closeable
{
   ...
   *   <li> {@link CloseableShapeshifter}, stepping stone to {@link org.apache.robux.query.rowsandcols.RowsAndColumns}.
   ...
   * {@link org.apache.robux.query.planning.ExecutionVertex#createSegmentMapFunction(PolicyEnforcer)}.
   */
