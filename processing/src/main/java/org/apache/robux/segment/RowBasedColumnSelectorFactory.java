...
public class RowBasedColumnSelectorFactory<T> implements ColumnSelectorFactory
{
   ...
   *                                    {@link org.apache.robux.segment.column.RowSignature#empty()}.
            ...
            try {
              ...
              if (rawValue == null || rawValue instanceof String) {
                ...
                for (final Object item : ((List) rawValue)) {
                  ...
                  // Behavior with null item is to convert it to string "null". This is not what most other areas of Robux
