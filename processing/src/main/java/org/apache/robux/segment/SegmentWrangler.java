 ...
 *
 * @see org.apache.robux.guice.RobuxBinders#segmentWranglerBinder  to register factories
 */
public interface SegmentWrangler
{
   ...
   * where any Robux server could scan its data).
   *
   * Note: there are no SegmentWranglers for 'table' datasources (Robux's distributed datasources) because those are
