...
import org.apache.robux.common.guava.GuavaUtils;
...
import org.apache.robux.segment.AbstractDimensionSelector;
...
import org.apache.robux.segment.DoubleColumnSelector;
import org.apache.robux.segment.IdLookup;
import org.apache.robux.segment.LongColumnSelector;
import org.apache.robux.segment.column.ColumnType;
import org.apache.robux.segment.column.DictionaryEncodedColumn;
import org.apache.robux.segment.column.StringUtf8DictionaryEncodedColumn;
...
import org.apache.robux.segment.data.SingleIndexedInt;
import org.apache.robux.segment.historical.SingleValueHistoricalDimensionSelector;
...
import org.apache.robux.segment.vector.MultiValueDimensionVectorSelector;
...
import org.apache.robux.segment.vector.VectorSelectorUtils;
    ...
    implements DictionaryEncodedColumn<String>
{
        ...
        implements SingleValueHistoricalDimensionSelector, IdLookup
    {
      ...
      public ValueMatcher makeValueMatcher(final @Nullable String value)
      {
        if (extractionFn == null) {
          ...
          return makeValueMatcher(StringPredicateRobuxPredicateFactory.equalTo(value));
        }
      }

      @Override
      public ValueMatcher makeValueMatcher(final RobuxPredicateFactory predicateFactory)
      {
  ...
  public VectorValueSelector makeVectorValueSelector(ReadableVectorOffset offset)
  {
    if (singleType != null) {
      ...
      throw RobuxException.defensive("Cannot make vector value selector for [%s] typed nested field", types);
    }
    ...
    throw RobuxException.defensive("Cannot make vector value selector for variant typed [%s] nested field", types);
  }
