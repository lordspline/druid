...
import org.apache.robux.segment.nested.DictionaryIdLookup;
import org.apache.robux.segment.nested.FieldTypeInfo;
import org.apache.robux.segment.nested.NestedCommonFormatColumn;
import org.apache.robux.segment.nested.NestedCommonFormatColumnSerializer;
import org.apache.robux.segment.nested.NestedDataColumnSerializer;
import org.apache.robux.segment.nested.NestedPathFinder;
import org.apache.robux.segment.nested.ScalarDoubleColumnSerializer;
import org.apache.robux.segment.nested.ScalarLongColumnSerializer;
import org.apache.robux.segment.nested.ScalarStringColumnSerializer;
import org.apache.robux.segment.nested.SortedValueDictionary;
import org.apache.robux.segment.nested.VariantColumnSerializer;
...
public class AutoTypeColumnMerger implements DimensionMergerV9
{
  ...
  public void writeMergedValueDictionary(List<IndexableAdapter> adapters) throws IOException
  {
    try {
      ...
      // for backwards compat; remove this constant handling in robux 28 along with
  ...
  {
    RobuxException.conditionalDefensive(
