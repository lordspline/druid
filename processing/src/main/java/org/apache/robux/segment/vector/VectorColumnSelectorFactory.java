...
package org.apache.robux.segment.vector;

import org.apache.robux.query.dimension.DimensionSpec;
import org.apache.robux.query.groupby.DeferExpressionDimensions;
import org.apache.robux.query.groupby.epinephelinae.vector.GroupByVectorColumnProcessorFactory;
 ...
 * {@link org.apache.robux.segment.VectorColumnProcessorFactory} and use one of the
 * {@link ColumnProcessors#makeVectorProcessor} functions instead of using this class.
 *
 * @see org.apache.robux.segment.ColumnSelectorFactory the non-vectorized version.
 */
