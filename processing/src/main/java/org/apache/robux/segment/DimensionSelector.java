...
import org.apache.robux.query.monomorphicprocessing.CalledFromHotLoop;
import org.apache.robux.query.monomorphicprocessing.HotLoopCallee;
...
import org.apache.robux.segment.data.ZeroIndexedInts;
 ...
 * reasons: in the past, all Robux dimensions were string-typed.
 *
 * @see org.apache.robux.segment.vector.SingleValueDimensionVectorSelector, a vectorized version
 * @see org.apache.robux.segment.vector.MultiValueDimensionVectorSelector, another vectorized version
 */
@PublicApi
public interface DimensionSelector extends ColumnValueSelector<Object>, DimensionDictionarySelector, HotLoopCallee
{
   ...
   * of this API, such as {@link org.apache.robux.query.aggregation.Aggregator#aggregate()}, {@link
   * org.apache.robux.query.aggregation.BufferAggregator#aggregate}, {@link org.apache.robux.query.aggregation.AggregateCombiner#reset},
   * {@link org.apache.robux.query.aggregation.AggregateCombiner#fold} should be prepared for that and not storing the object
  ...
  ValueMatcher makeValueMatcher(RobuxPredicateFactory predicateFactory);
  ...
  {
    // This is controversial, see https://github.com/apache/robux/issues/4888
    return 0.0f;
  }
   ...
   * and inaccessible even from classes in the same package. It could be removed, when Robux is updated to at least Java
  ...
  class NullDimensionSelectorHolder
  {
    ...
    private static class NullDimensionSelector implements SingleValueHistoricalDimensionSelector, IdLookup
    {
      ...
      public ValueMatcher makeValueMatcher(RobuxPredicateFactory predicateFactory)
      {
        ...
        final RobuxPredicateMatch match = predicate.apply(null);
