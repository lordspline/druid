...
import org.apache.robux.annotations.SubclassesMustOverrideEqualsAndHashCode;
import org.apache.robux.java.util.common.Cacheable;
import org.apache.robux.query.dimension.DimensionSpec;
import org.apache.robux.query.filter.ColumnIndexSelector;
import org.apache.robux.query.groupby.DeferExpressionDimensions;
import org.apache.robux.query.groupby.epinephelinae.vector.GroupByVectorColumnSelector;
...
import org.apache.robux.segment.virtual.FallbackVirtualColumn;
...
public interface VirtualColumn extends Cacheable
{
   ...
   * @param deferExpressionDimensions active value of {@link org.apache.robux.query.groupby.GroupByQueryConfig#CTX_KEY_DEFER_EXPRESSION_DIMENSIONS}
   *
