...
/**
 * TypeStrategy provides value comparison and binary serialization for Robux types. This can be obtained for ANY Robux
...
public interface TypeStrategy<T> extends Comparator<Object>, Hash.Strategy<T>
{
   ...
   * {@link org.apache.robux.math.expr.BuiltInExprMacros.ComplexDecodeBase64ExprMacro}.
   */
  ...
  {
    throw RobuxException.defensive("Not implemented. Check groupable() first");
  }
