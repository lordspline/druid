...
/**
 * This interface represents a complex column and can be implemented by robux extension writer of a custom column
 * with arbitrary serialization instead of a custom column that serializes rows of objects serialized using
 * {@link org.apache.robux.segment.data.GenericIndexed} class which is default implementation of "writeToXXX" methods in
 * {@link org.apache.robux.segment.serde.ComplexColumnSerializer}. In that case {@link GenericIndexedBasedComplexColumn}
 * should be used.
 */
@ExtensionPoint
public interface ComplexColumn extends BaseColumn
{
   ...
   * on {@link org.apache.robux.segment.data.GenericIndexed} in {@link org.apache.robux.segment.serde.ComplexColumnSerializer}.
