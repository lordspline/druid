...
import org.apache.robux.segment.index.IndexedStringDictionaryEncodedStringValueIndex;
import org.apache.robux.segment.index.IndexedStringRobuxPredicateIndexes;
import org.apache.robux.segment.index.IndexedUtf8LexicographicalRangeIndexes;
import org.apache.robux.segment.index.IndexedUtf8ValueIndexes;
  ...
  public <T> T as(Class<T> clazz)
  {
    if (bitmaps != null) {
      ...
      if (clazz.equals(NullValueIndex.class)) {
        ...
        return (T) new IndexedStringRobuxPredicateIndexes<>(
            bitmapFactory,
