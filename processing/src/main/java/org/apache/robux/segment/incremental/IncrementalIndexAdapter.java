...
import org.apache.robux.segment.IntIteratorUtils;
import org.apache.robux.segment.Metadata;
import org.apache.robux.segment.TransformableRowIterator;
...
public class IncrementalIndexAdapter implements IndexableAdapter
{
  ...
  public IndexableAdapter getProjectionAdapter(String projection)
  {
    ...
    throw RobuxException.defensive("projection inception");
  }
  ...
  public Metadata getMetadata()
  {
    ...
    throw RobuxException.defensive("cannot get metadata of projection");
  }
