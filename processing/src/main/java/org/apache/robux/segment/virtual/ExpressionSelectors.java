...
public class ExpressionSelectors
{
   ...
   *
   * @see org.apache.robux.segment.BaseNullableColumnValueSelector#isNull() for why this only works in the numeric case
   */
  @VisibleForTesting
   ...
   * and by {@link org.apache.robux.segment.transform.ExpressionTransform} which should be reconsidered if we ever
