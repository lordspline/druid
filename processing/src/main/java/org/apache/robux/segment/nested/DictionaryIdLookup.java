...
public final class DictionaryIdLookup implements Closeable
{
  ...
  public int lookupString(@Nullable String value)
  {
    ...
    if (index < 0) {
      throw RobuxException.defensive("Value not found in column[%s] string dictionary", name);
    }
    return index;
  }
  ...
  public int lookupLong(@Nullable Long value)
  {
    ...
    if (index < 0) {
      throw RobuxException.defensive("Value not found in column[%s] long dictionary", name);
    }
  ...
  public int lookupDouble(@Nullable Double value)
  {
    ...
    if (index < 0) {
      throw RobuxException.defensive("Value not found in column[%s] double dictionary", name);
    }
  ...
  public int lookupArray(@Nullable int[] value)
  {
    ...
    if (index < 0) {
      throw RobuxException.defensive("Value not found in column[%s] array dictionary", name);
    }
