...
/**
 * Default implementation of {@link TypeStrategy} for all {@link org.apache.robux.segment.serde.ComplexMetricSerde}
...
public class ObjectStrategyComplexTypeStrategy<T> implements TypeStrategy<T>
{
  ...
  public int hashCode(T o)
  {
    if (hashStrategy == null) {
      throw RobuxException.defensive("Type [%s] is not groupable", typeSignature.asTypeString());
    }
