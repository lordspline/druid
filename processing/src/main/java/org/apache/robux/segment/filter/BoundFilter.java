...
public class BoundFilter implements Filter
{
  ...
  public BitmapColumnIndex getBitmapColumnIndex(ColumnIndexSelector selector)
  {
    ...
    if (indexSupplier == null) {
      ...
      final RobuxPredicateMatch match = getPredicateFactory().makeStringPredicate().apply(null);
  ...
  {
    return new BoundDimFilterRobuxPredicateFactory(extractionFn, boundDimFilter);
  }
  ...
  @VisibleForTesting
  static class BoundDimFilterRobuxPredicateFactory implements RobuxPredicateFactory
  {
    private final ExtractionFn extractionFn;
    private final BoundDimFilter boundDimFilter;
    ...
    BoundDimFilterRobuxPredicateFactory(ExtractionFn extractionFn, BoundDimFilter boundDimFilter)
    {
    ...
    public RobuxObjectPredicate<String> makeStringPredicate()
    {
      if (extractionFn != null) {
        return input -> RobuxPredicateMatch.of(doesMatch(extractionFn.apply(input), boundDimFilter));
      }
      return input -> RobuxPredicateMatch.of(doesMatch(input, boundDimFilter));
    ...
    public RobuxLongPredicate makeLongPredicate()
    {
      ...
      return input -> RobuxPredicateMatch.of(doesMatch(String.valueOf(input), boundDimFilter));
    }
    ...
    public boolean equals(Object o)
    {
      ...
      BoundDimFilterRobuxPredicateFactory that = (BoundDimFilterRobuxPredicateFactory) o;
