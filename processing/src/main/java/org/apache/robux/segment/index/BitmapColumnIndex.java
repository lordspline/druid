...
/**
 * Common interface for bitmap indexes for use by {@link org.apache.robux.query.filter.Filter} for cursor creation, to
...
public interface BitmapColumnIndex
{
   ...
   *
   * @param bitmapResultFactory helper to format the {@link org.apache.robux.collections.bitmap.ImmutableBitmap} in a
   ...
   * @param includeUnknown      mapping for Robux native two state logic system into SQL three-state logic system. If
