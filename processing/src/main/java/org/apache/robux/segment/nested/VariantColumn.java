...
import org.apache.robux.segment.column.ColumnTypeFactory;
    ...
    implements DictionaryEncodedColumn<String>, NestedCommonFormatColumn
{
  ...
  public VectorValueSelector makeVectorValueSelector(ReadableVectorOffset offset)
  {
    ...
    throw RobuxException.defensive("Cannot make vector value selector for variant typed [%s] column", variantTypes);
  }
