...
public final class DimensionSelectorUtils
{
  ...
  public static ValueMatcher makeValueMatcherGeneric(DimensionSelector selector, @Nullable String value)
  {
    ...
    if (idLookup != null) {
      ...
      return makeDictionaryEncodedValueMatcherGeneric(selector, StringPredicateRobuxPredicateFactory.equalTo(value));
    } else {
  ...
  /**
   * Generic implementation of {@link DimensionSelector#makeValueMatcher(RobuxPredicateFactory)}, uses
   * {@link DimensionSelector#getRow()} of the given {@link DimensionSelector}. "Lazy" DimensionSelectors could delegate
   * {@code makeValueMatcher()} to this method, but encouraged to implement {@code makeValueMatcher()} themselves,
   * bypassing the {@link IndexedInts} abstraction.
   */
  public static ValueMatcher makeValueMatcherGeneric(DimensionSelector selector, RobuxPredicateFactory predicateFactory)
  {
  ...
  public static BitSet makePredicateMatchingSet(DimensionSelector selector, RobuxObjectPredicate<String> predicate, boolean includeUnknown)
  {
