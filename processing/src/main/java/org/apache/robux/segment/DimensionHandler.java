 ...
 * such as {@link org.apache.robux.segment.incremental.IncrementalIndex} and {@link IndexMerger} and allowing for abstracted
    ...
    <EncodedType extends Comparable<EncodedType>, EncodedKeyComponentType, ActualType extends Comparable<ActualType>>
{
   ...
   *
   * This method exists for backwards compatiblity with older versions of Robux since this is an unofficial extension
   ...
   * org.apache.robux.segment.selector.settable.SettableLongColumnValueSelector}, etc.
   */
