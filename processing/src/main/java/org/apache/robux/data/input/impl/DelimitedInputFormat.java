...
public class DelimitedInputFormat extends FlatTextInputFormat
{
   ...
   * For example, it may happen when running Robux Hadoop indexing jobs, since we may inherit the version provided by
   * the Hadoop cluster. See https://github.com/apache/robux/issues/6801.
   */
