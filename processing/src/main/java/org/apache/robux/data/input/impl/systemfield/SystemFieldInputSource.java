...
package org.apache.robux.data.input.impl.systemfield;
 ...
 * {@link org.apache.robux.data.input.impl.InputEntityIteratingReader}.
 */
public interface SystemFieldInputSource extends InputSource
{
   ...
   * example, if a {@link org.apache.robux.data.input.impl.LocalInputSource} is configured to return
   * {@link SystemField#BUCKET} then it will show up in this list, even though its value is always null. For another
   * example in a different direction, if a {@link org.apache.robux.data.input.impl.LocalInputSource} is *not*
