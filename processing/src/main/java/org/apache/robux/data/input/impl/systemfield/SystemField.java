 ...
 * contains things related to {@link org.apache.robux.data.input.InputSource}. Perhaps, in the future, system fields
 * may be generated from segment scans as well (for example "__segment_id" returning the
 * {@link org.apache.robux.timeline.SegmentId}). At that point this enum may move to a more central location.
 */
