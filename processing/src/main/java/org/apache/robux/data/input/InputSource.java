...
import org.apache.robux.data.input.impl.CombiningInputSource;
...
public interface InputSource
{
   ...
   * a fixed format. For example, robux inputSource always reads segments. These inputSources should return false for
   * this method.
   */
  boolean needsFormat();
