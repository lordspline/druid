...
import org.apache.robux.java.util.common.parsers.ParserUtils;
...
public class DimensionsSpec
{
  ...
  public static final String WARNING_NON_TIME_SORT_ORDER = StringUtils.format(
      ...
      + "version of Robux, and certain queries cannot run on them. See "
      + "https://robux.apache.org/docs/latest/ingestion/partitioning#sorting for details before setting "
      + "%s to[false].",
