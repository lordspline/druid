...
import org.apache.robux.java.util.common.parsers.CloseableIteratorWithMetadata;
 ...
 * For example, {@link org.apache.robux.data.input.impl.DelimitedValueReader} parses bytes into string lines, and then parses
...
public abstract class IntermediateRowParsingReader<T> implements InputEntityReader
{
   ...
   * For example, in case of {@link org.apache.robux.data.input.impl.FileEntity}, file name containing erroneous records
   * or in case of {@link org.apache.robux.data.input.impl.HttpEntity}, the endpoint containing the erroneous data can
