...
public class HashBasedNumberedShardSpec extends NumberedShardSpec
{
   ...
   * {@link org.apache.robux.indexer.partitions.HashedPartitionsSpec} at ingestion time. This is because the default
  ...
  {
    // partitionFunction can be null when you read a shardSpec of a segment created in an old version of Robux.
    // The current version of Robux will always specify a partitionFunction on newly created segments.
