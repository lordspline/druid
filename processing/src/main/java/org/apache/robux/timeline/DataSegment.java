...
package org.apache.robux.timeline;
...
import org.apache.robux.jackson.CommaListJoinDeserializer;
import org.apache.robux.jackson.CommaListJoinSerializer;
...
/**
 * Metadata of Robux's data segment. An immutable object.
 * <p>
...
public class DataSegment implements Comparable<DataSegment>, Overshadowable<DataSegment>
{
  ...
  /*
   * The difference between this class and org.apache.robux.segment.Segment is that this class contains the segment
   * metadata only, while org.apache.robux.segment.Segment represents the actual body of segment data, queryable.
   */
   ...
   * task. True by default see {@link org.apache.robux.indexing.common.task.Tasks#DEFAULT_STORE_COMPACTION_STATE}.
   * Also, this field can be pruned in many Robux modules when this class is loaded from the metadata store.
  ...
  )
  {
    ...
    // A null value for projections means that this segment is not aware of projections (launched in robux 32).
