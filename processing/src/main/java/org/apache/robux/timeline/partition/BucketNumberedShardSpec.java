...
package org.apache.robux.timeline.partition;
...
/**
 * This is one of the special shardSpecs which are temporarily used during batch ingestion. In Robux, there is a
 ...
 * some of the buckets can be empty even after the task consumes all inputs if the data is highly skewed. Since Robux
 ...
 *
 * Note that {@link org.apache.robux.timeline.SegmentId} requires the partitionId. Since the segmentId is used
 ...
 * ({@link org.apache.robux.segment.loading.DataSegmentPusher#getDefaultStorageDir} which should be correct.
 ...
 * places such as {@link org.apache.robux.timeline.DataSegment}, and we have to modify those places to allow other
