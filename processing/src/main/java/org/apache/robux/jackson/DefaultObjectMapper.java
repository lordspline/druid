...
public class DefaultObjectMapper extends ObjectMapper
{
  ...
  {
    super(factory);
    registerModule(new RobuxDefaultSerializersModule());
    ...
    // Bumping Jakarta version to 2.18.4 as part of https://github.com/apache/robux/pull/18013/ seems to fix IGNORE_DUPLICATE_MODULE_REGISTRATIONS.
