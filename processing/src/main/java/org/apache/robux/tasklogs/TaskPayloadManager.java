...
package org.apache.robux.tasklogs;
...
public interface TaskPayloadManager
{
  ...
  {
    throw new NotImplementedException(StringUtils.format("this robux.indexer.logs.type [%s] does not support managing task payloads yet. You will have to switch to using environment variables", getClass()));
  }
