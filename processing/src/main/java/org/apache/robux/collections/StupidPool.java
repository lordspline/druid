...
import org.apache.robux.java.util.common.Cleaners;
...
public class StupidPool<T> implements NonBlockingPool<T>
{
  ...
  static {
    if (Boolean.parseBoolean(System.getProperty("robux.test.stupidPool.poison"))) {
      POISONED.set(true);
    }
  }
   ...
   * this, StupidPool should be made closeable (or implement {@link org.apache.robux.java.util.common.lifecycle.LifecycleStop}
