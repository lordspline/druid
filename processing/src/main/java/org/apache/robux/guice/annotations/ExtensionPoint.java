...
package org.apache.robux.guice.annotations;
 ...
 * may be subclassed in extensions in order to add functionality to Robux. Extension points may change in breaking ways
 * only between major Robux release lines (e.g. 0.10.x -> 0.11.0), but otherwise must remain stable. Extension points
