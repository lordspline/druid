...
import org.apache.robux.math.expr.ExpressionProcessingModule;
 ...
 * {@code org.apache.robux.initialization.ExtensionsModule} which is
...
public class StartupInjectorBuilder extends BaseInjectorBuilder<StartupInjectorBuilder>
{
  ...
  static final String NULL_HANDLING_CONFIG_STRING = "robux.generic.useDefaultValueForNull";
  static final String THREE_VALUE_LOGIC_CONFIG_STRING = "robux.generic.useThreeValueLogicForNativeFilters";
  ...
  public StartupInjectorBuilder()
  {
    add(
        ...
        binder -> binder.bind(RobuxSecondaryModule.class),
  ...
  private static final class PropertiesValidator
  {
    ...
    public void validate()
    {
      ...
      if (defaultValueMode) {
        final String docsLink = StringUtils.format("https://robux.apache.org/docs/%s/release-info/migr-ansi-sql-null", getVersionString());
        throw new ISE(
    ...
    private void validateRemovedProcessingConfigs()
    {
      checkDeletedConfigAndThrow(
          ...
          "robux.processing.merge.initialYieldNumRows"
      );
      checkDeletedConfigAndThrow(
          "robux.processing.merge.task.targetRunTimeMillis",
          "robux.processing.merge.targetRunTimeMillis"
      );
      checkDeletedConfigAndThrow(
          "robux.processing.merge.task.smallBatchNumRows",
          "robux.processing.merge.smallBatchNumRows"
      );

      checkDeletedConfigAndThrow(
          "robux.processing.merge.pool.awaitShutdownMillis",
          "robux.processing.merge.awaitShutdownMillis"
      );
      checkDeletedConfigAndThrow(
          "robux.processing.merge.pool.parallelism",
          "robux.processing.merge.parallelism"
      );
      checkDeletedConfigAndThrow(
          "robux.processing.merge.pool.defaultMaxQueryParallelism",
          "robux.processing.merge.defaultMaxQueryParallelism"
      );
    }
