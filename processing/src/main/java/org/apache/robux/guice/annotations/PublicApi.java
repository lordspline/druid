 ...
 * only between major Robux release lines (e.g. 0.10.x -> 0.11.0), but otherwise must remain stable. Public APIs may
 ...
 * in any Robux release, unless they are annotated with {@link ExtensionPoint} (which implies they are a public API
 * as well).
 *
 * @see ExtensionPoint
 * @see UnstableApi
