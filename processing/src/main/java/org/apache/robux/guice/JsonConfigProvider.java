 ...
 * </pre>
 * <br/>
 * In the above case, {@code robux.server} should be a key found in the {@code Properties} bound elsewhere.
 * The value of that key should directly relate to the fields in {@code RobuxServerConfig.class}.
 *
 ...
 * <br/>
 *
 * An example might be if RobuxServerConfig.class were
 *
 * <pre>
 ...
 *
 * <pre>
 *   robux.server.hostname=0.0.0.0
 *   robux.server.port=3333
 * </pre>
 *
 * Then this would bind a singleton instance of a RobuxServerConfig object with hostname = "0.0.0.0" and port = 3333.
 *
 * If the port weren't set in the properties, then the default of 8080 would be taken.  Essentially, it is the same as
 * subtracting the "robux.server" prefix from the properties and building a Map which is then passed into
