...
{
  public static final String PROPERTY_BASE = "robux.extensions";
  ...
  @JsonProperty
  private String hadoopContainerRobuxClasspath = null;

  //Only applicable when hadoopContainerRobuxClasspath is explicitly specified.
  @JsonProperty
  ...
  public String getHadoopContainerRobuxClasspath()
  {
    return hadoopContainerRobuxClasspath;
  }
  ...
  /**
   * List of extension {@code RobuxModule} class names that should be used in an
  ...
  public String toString()
  {
    return "ExtensionsConfig{" +
           ...
           ", hadoopContainerRobuxClasspath='" + hadoopContainerRobuxClasspath + '\'' +
