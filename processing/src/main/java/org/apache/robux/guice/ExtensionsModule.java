 ...
 * for Robux servers. Not visible to the {@link StartupInjectorBuilder},
...
public class ExtensionsModule implements Module
{
   ...
   * startup to the main injector. Not done in {@code RobuxSecondaryModule}
   * because extensions are loaded only in the server, but
   * {@code RobuxSecondaryModule} is used for tests and clients also.
   */
