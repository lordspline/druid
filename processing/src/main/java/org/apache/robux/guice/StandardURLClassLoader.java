...
/**
 * The ClassLoader that gets used when robux.extensions.useExtensionClassloaderFirst = false.
 */
public class StandardURLClassLoader extends URLClassLoader
{
  private final List<ClassLoader> extensionDependencyClassLoaders;

  public StandardURLClassLoader(final URL[] urls, final ClassLoader robuxLoader, final List<ClassLoader> extensionDependencyClassLoaders)
  {
    super(urls, robuxLoader);
