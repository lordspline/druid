 ...
 */
@ExtensionPoint
public interface RobuxModule extends com.google.inject.Module
{
  static RobuxModule override(com.google.inject.Module baseModule, com.google.inject.Module overrideGuiceModule)
  {
    return new RobuxModule()
    {
      ...
      {
        if (baseModule instanceof RobuxModule) {
          return ((RobuxModule) baseModule).getJacksonModules();
        }
