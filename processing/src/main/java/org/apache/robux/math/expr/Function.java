...
package org.apache.robux.math.expr;
...
import org.apache.robux.math.expr.vector.VectorConditionalProcessors;
import org.apache.robux.math.expr.vector.VectorMathProcessors;
import org.apache.robux.math.expr.vector.VectorProcessors;
import org.apache.robux.math.expr.vector.VectorStringProcessors;
...
public interface Function extends NamedFunction
{
  ...
  class CoalesceFunc implements Function
  {
    ...
    public ExprEval apply(List<Expr> args, Expr.ObjectBinding bindings)
    {
      ...
      throw RobuxException.defensive("Not reached, argument count must be at least 1");
    }
   ...
   * by {@link org.apache.robux.segment.virtual.ExpressionSelectors#supplierFromDimensionSelector} when the 3rd
   ...
   * {@link org.apache.robux.segment.virtual.ExpressionSelectors#supplierFromDimensionSelector} when "homogenize"
   * is true.
   */
