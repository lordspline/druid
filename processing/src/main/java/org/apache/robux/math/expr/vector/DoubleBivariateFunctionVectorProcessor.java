 ...
 *
 * this one is specialized for producing double[], see {@link LongBivariateFunctionVectorProcessor} for
 * long[] primitives.
 */
    ...
    implements ExprVectorProcessor<double[]>
{
  ...
  protected DoubleBivariateFunctionVectorProcessor(
  ...
  )
  {
    this.left = left;
    this.right = right;
    this.outValues = new double[left.maxVectorSize()];
