...
import org.apache.robux.math.expr.vector.functional.DoubleBivariateLongsFunction;

/**
 * specialized {@link DoubleBivariateFunctionVectorProcessor} for processing (long[], long[]) -> double[]
 */
public final class DoubleBivariateLongsFunctionVectorProcessor
    extends DoubleBivariateFunctionVectorProcessor<long[], long[]>
{
  private final DoubleBivariateLongsFunction longsFunction;

  public DoubleBivariateLongsFunctionVectorProcessor(
