...
import org.apache.robux.math.expr.vector.FallbackVectorProcessor;
...
/**
 * Mechanism by which Robux expressions can define new functions for the Robux expression language. When
...
public class ExprMacroTable
{
   ...
   * parsing generated expressions which translate {@link org.apache.robux.java.util.common.granularity.Granularity}
   * into {@link Expr}
   */
