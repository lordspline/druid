 ...
 *
 * this one is specialized for producing long[], see {@link DoubleUnivariateFunctionVectorProcessor} for
 * double[] primitives.
 */
public abstract class LongUnivariateFunctionVectorProcessor<TInput> implements ExprVectorProcessor<long[]>
{
  final ExprVectorProcessor<TInput> processor;
  final boolean[] outNulls;
  final long[] outValues;

  public LongUnivariateFunctionVectorProcessor(
