 ...
 */
public abstract class VectorMathBivariateDoubleProcessorFactory implements BivariateFunctionVectorProcessorFactory
{
  @Override
  ...
  public abstract ExprVectorProcessor<double[]> longsProcessor(
      Expr.VectorInputBindingInspector inspector,
      Expr left,
      Expr right
  );

  public abstract ExprVectorProcessor<double[]> longDoubleProcessor(
      Expr.VectorInputBindingInspector inspector,
      Expr left,
      Expr right
  );

  public abstract ExprVectorProcessor<double[]> doubleLongProcessor(
      Expr.VectorInputBindingInspector inspector,
      Expr left,
      Expr right
  );

  public abstract ExprVectorProcessor<double[]> doublesProcessor(
      Expr.VectorInputBindingInspector inspector,
      Expr left,
      Expr right
  );
