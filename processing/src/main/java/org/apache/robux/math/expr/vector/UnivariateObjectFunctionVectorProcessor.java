 ...
 */
public abstract class UnivariateObjectFunctionVectorProcessor<TInput, TOutput> implements ExprVectorProcessor<TOutput>
{
  final ExprVectorProcessor<TInput> processor;
  final boolean[] outNulls;
  final TOutput outValues;

  public UnivariateObjectFunctionVectorProcessor(
