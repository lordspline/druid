...
public class ExpressionProcessingConfig
{
  ...
  public static final String NULL_HANDLING_LEGACY_LOGICAL_OPS_STRING = "robux.expressions.useStrictBooleans";
  // Coerce arrays to multi value strings
  public static final String PROCESS_ARRAYS_AS_MULTIVALUE_STRINGS_CONFIG_STRING =
      "robux.expressions.processArraysAsMultiValueStrings";
  ...
  public static final String HOMOGENIZE_NULL_MULTIVALUE_STRING_ARRAYS =
      "robux.expressions.homogenizeNullMultiValueStringArrays";
  public static final String ALLOW_VECTORIZE_FALLBACK = "robux.expressions.allowVectorizeFallback";
