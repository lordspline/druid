...
package org.apache.robux.math.expr.vector;
...
import org.apache.robux.math.expr.Exprs;
...
public class VectorProcessors
{
   ...
   *
   * @see org.apache.robux.math.expr.ConstantExpr
   */
  public static <T> ExprVectorProcessor<T> constant(@Nullable Object constant, int maxVectorSize, ExpressionType type)
  {
    if (type.isNumeric()) {
      throw RobuxException.defensive("Type[%s] should use the numeric constant creator instead", type);
    }
   ...
   * {@link org.apache.robux.segment.vector.VectorValueSelector} or
   * {@link org.apache.robux.segment.vector.VectorObjectSelector}.
   *
   * @see org.apache.robux.math.expr.IdentifierExpr
   */
   ...
   *
   * @see org.apache.robux.math.expr.Function.ParseLong
   */
   ...
   *
   * @see org.apache.robux.math.expr.Function.IsNullFunc
   */
   ...
   *
   * @see org.apache.robux.math.expr.Function.IsNotNullFunc
   */
   ...
   *    true -> false (0)
   *
   * @see org.apache.robux.math.expr.UnaryNotExpr
   */
   ...
   *    false/false -> false (0)
   *
   * @see org.apache.robux.math.expr.BinOrExpr
   */
   ...
   *
   * @see org.apache.robux.math.expr.BinAndExpr
   */
