...
package org.apache.robux.java.util.common.guava;
 ...
 *
 * See proposal: https://github.com/apache/robux/issues/8577
 *
 * Functionally equivalent to wrapping {@link org.apache.robux.common.guava.CombiningSequence} around a
...
public class ParallelMergeCombiningSequence<T> extends YieldingSequenceBase<T>
{
  ...
  // see PR https://github.com/apache/robux/pull/8578 for details
   ...
   * {@link org.apache.robux.common.guava.CombiningSequence}, where the {@link Ordering} is used to both set the sort
   ...
   * registered with {@link org.apache.robux.query.QueryWatcher#registerQueryFuture} to participate in query
