...
package org.apache.robux.java.util.common.lifecycle;
 ...
 *    org.apache.robux.server.initialization.jetty.JettyServerModule, but any sort of 'server' that expects most (or
...
public class Lifecycle
{
  ...
  public void addMaybeStartHandler(Handler handler, Stage stage) throws Exception
  {
    if (!startStopLock.tryLock()) {
      ...
      // spot wrong use of Lifecycle instead of entering deadlock, like https://github.com/apache/robux/issues/3579.
