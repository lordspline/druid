 ...
 * should be.
 */
public class NotYetImplemented extends RobuxException.Failure
{
  public static RobuxException ex(Throwable t, String msg, Object... args)
  {
    return RobuxException.fromFailure(new NotYetImplemented(t, msg, args));
  }
  ...
  {
    bob = bob.forPersona(RobuxException.Persona.DEVELOPER)
