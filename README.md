...
For the fastest way to try Druid:

```bash
# Download and run Druid locally
./bin/start-micro-quickstart
```

This will start Druid in single-server mode with sample data. The web console will be available at [http://localhost:8888](http://localhost:8888).
