...
import { RobuxError, getRobuxErrorMessage } from './robux-query';

describe('RobuxQuery', () => {
  describe('RobuxError.extractStartRowColumn', () => {
    it('works for single error 1', () => {
      expect(
        RobuxError.extractStartRowColumn({
          sourceType: 'sql',
          line: '2',
          column: '12',
          token: "AS \\'l\\'",
  ...
  describe('RobuxError.extractEndRowColumn', () => {
    it('works for single error 1', () => {
      expect(
        RobuxError.extractEndRowColumn({
          sourceType: 'sql',
          line: '2',
          column: '12',
          token: "AS \\'l\\'",
  ...
  describe('RobuxError.getSuggestion', () => {
    it('works for ==', () => {
      const sql = sane`
        SELECT *
        FROM wikipedia -- test ==
      ...
      `;
      const suggestion = RobuxError.getSuggestion(
