...
export const NATIVE_JSON_QUERY_COMPLETIONS: JsonCompletionRule[] = [
  ...
  // Query type values
  {
    ...
    completions: [
      ...
      { value: 'scan', documentation: 'Scan query to return raw Robux rows' },
  ...
  // Expression filter properties
  {
    ...
    completions: [{ value: 'expression', documentation: 'Robux expression that returns boolean' }],
  },
  ...
  // Post-aggregation types
  {
    ...
    completions: [
      ...
      { value: 'expression', documentation: 'Robux expression post-aggregation' },
  ...
  // Expression post-aggregation properties
  {
    ...
    condition: obj => obj.type === 'expression',
    completions: [
      { value: 'expression', documentation: 'Robux expression to evaluate' },
      { value: 'ordering', documentation: 'Ordering for result values' },
  ...
  // Virtual column types
  {
    ...
    completions: [
      {
        value: 'expression',
        documentation: 'Expression-based virtual column using Robux expressions',
      },
  ...
  // Expression virtual column properties
  {
    ...
    condition: obj => obj.type === 'expression',
    completions: [
      { value: 'expression', documentation: 'Robux expression that takes a row as input' },
      {
        value: 'outputType',
