...
export const METRIC_SPEC_FIELDS: Field<MetricSpec>[] = [
  {
    ...
    type: 'string',
    required: true,
    info: <>The metric name as it will appear in Robux.</>,
    ...
    info: (
      <>
        <p>
          ...
          Note that after you index with a particular size, robux will persist sketch in segments
  ...
  },
  {
    ...
    info: (
      <>
        ...
        This would be the case if you use datasketches library outside of Robux, say with Pig/Hive,
        to produce the data that you are ingesting into Robux
      </>
    ),
  },
  // arrayOfDoublesSketch
  ...
  // hyperUnique
  {
    ...
    info: (
      <>
        This can be set to true to index precomputed HLL (Base64 encoded output from robux-hll is
        expected).
      </>
    ),
  },
