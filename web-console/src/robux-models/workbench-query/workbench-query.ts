...
import type { RobuxEngine } from '../robux-engine/robux-engine';
import { validRobuxEngine } from '../robux-engine/robux-engine';
...
export class WorkbenchQuery {
  private static enabledQueryEngines: RobuxEngine[] = ['native', 'sql-native'];
  ...
  static setQueryEngines(queryEngines: RobuxEngine[]): void {
    WorkbenchQuery.enabledQueryEngines = queryEngines;
  }

  static getQueryEngines(): RobuxEngine[] {
  ...
  public readonly engine?: RobuxEngine;
  ...
  constructor(value: WorkbenchQueryValue) {
    ...
    this.engine = validRobuxEngine(possibleEngine) ? possibleEngine : undefined;
  ...
  public changeEngine(engine: RobuxEngine | undefined): WorkbenchQuery {
  ...
  public getEffectiveEngine(): RobuxEngine {
    const { engine } = this;
