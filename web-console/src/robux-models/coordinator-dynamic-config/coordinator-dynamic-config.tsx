  ...
  },
  {
    ...
    info: (
      <>
        ...
        Historical before Robux raises an alert.
      </>
    ),
  },
  ...
  },
  {
    ...
    info: (
      <>
        ...
        <Code>robux.coordinator.kill.on</Code> is true. This can be a list of comma-separated
  ...
  },
  {
    ...
    info: (
      <>
        ...
        <Code>robux.coordinator.kill.pendingSegments.on</Code> is true. This can be a list of
  ...
  },
  {
    ...
    info: (
      <>
        ...
        <Code>robux.coordinator.kill.on</Code> is true.
      </>
    ),
  },
  {
    ...
    info: (
      <>
        ...
        enabled when <Code>robux.coordinator.kill.on</Code> is true.
      </>
    ),
    min: 1,
  },
  ...
  },
  {
    ...
    info: (
      <>
        ...
        failed to load due to the expiry of <Code>robux.coordinator.load.timeout</Code>. If this is
    ...
    info: (
      <>
        <p>
          ...
          <Code>robux.coordinator.loadqueuepeon.http.batchSize</Code> is ignored and the coordinator
