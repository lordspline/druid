...
export interface DimensionFiltersWithRest {
  ...
  restFilter?: RobuxFilter;
}

export function splitFilter(filter: RobuxFilter | null): DimensionFiltersWithRest {
  const inputAndFilters: RobuxFilter[] = filter
  ...
  const dimensionFilters: RobuxFilter[] = inputAndFilters.filter(
    f => typeof getFilterDimension(f) === 'string',
  );
  const restFilters: RobuxFilter[] = inputAndFilters.filter(
    f => typeof getFilterDimension(f) !== 'string',
  );
...
export function getFilterDimension(filter: RobuxFilter): string | undefined {
...
export const FILTER_FIELDS: Field<RobuxFilter>[] = [
  {
    name: 'type',
    type: 'string',
    required: true,
