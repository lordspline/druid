...
import org.apache.robux.server.coordinator.balancer.BalancerSegmentHolder;
import org.apache.robux.server.coordinator.balancer.ReservoirSegmentSampler;
      ...
      serverHolders.add(
          new ServerHolder(
              new ImmutableRobuxServer(
                  new RobuxServerMetadata("id", "host", null, 10000000L, ServerType.HISTORICAL, "hot", 1),
                  3000L,
                  ImmutableMap.of("test", new ImmutableRobuxDataSource("test", Collections.emptyMap(), segments)),
                  segments.size()
              ),
