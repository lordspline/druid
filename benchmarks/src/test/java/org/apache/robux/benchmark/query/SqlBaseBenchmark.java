...
import org.apache.robux.frame.segment.FrameSegment;
...
import org.apache.robux.query.aggregation.datasketches.hll.sql.HllSketchApproxCountDistinctSqlAggregator;
import org.apache.robux.query.aggregation.datasketches.hll.sql.HllSketchApproxCountDistinctUtf8SqlAggregator;
import org.apache.robux.query.aggregation.datasketches.hll.sql.HllSketchEstimateOperatorConversion;
import org.apache.robux.query.aggregation.datasketches.quantiles.DoublesSketchModule;
import org.apache.robux.query.aggregation.datasketches.quantiles.sql.DoublesSketchApproxQuantileSqlAggregator;
import org.apache.robux.query.aggregation.datasketches.quantiles.sql.DoublesSketchObjectSqlAggregator;
import org.apache.robux.query.aggregation.datasketches.quantiles.sql.DoublesSketchQuantileOperatorConversion;
import org.apache.robux.query.aggregation.datasketches.quantiles.sql.DoublesSketchQuantilesOperatorConversion;
import org.apache.robux.query.aggregation.datasketches.theta.SketchModule;
import org.apache.robux.query.aggregation.datasketches.theta.sql.ThetaSketchApproxCountDistinctSqlAggregator;
import org.apache.robux.query.aggregation.datasketches.theta.sql.ThetaSketchEstimateOperatorConversion;
import org.apache.robux.query.aggregation.datasketches.tuple.ArrayOfDoublesSketchModule;
import org.apache.robux.query.lookup.LookupExtractor;
...
import org.apache.robux.segment.QueryableIndexPhysicalSegmentInspector;
import org.apache.robux.segment.QueryableIndexSegment;
import org.apache.robux.segment.column.StringEncodingStrategy;
import org.apache.robux.segment.data.CompressionStrategy;
import org.apache.robux.segment.data.FrontCodedIndexed;
...
import org.apache.robux.sql.calcite.SqlVectorizedExpressionResultConsistencyTest;
...
import org.apache.robux.sql.calcite.aggregation.builtin.CountSqlAggregator;
...
public class SqlBaseBenchmark
{
  ...
  public void setup() throws JsonProcessingException
  {
    ...
    try (final RobuxPlanner planner = plannerFactory.createPlannerForTesting(
        engine,
    ...
    try (final RobuxPlanner planner = plannerFactory.createPlannerForTesting(engine, getQuery(), getContext())) {
      final PlannerResult plannerResult = planner.plan();
      final Sequence<Object[]> resultSequence = plannerResult.run().getResults();
  ...
  private static RobuxOperatorTable createOperatorTable(final Injector injector)
  {
    try {
      ...
      return new RobuxOperatorTable(aggregators, operators);
    }
    catch (Exception e) {
