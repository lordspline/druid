...
package org.apache.robux.benchmark.lookup;

import com.google.common.collect.ImmutableMap;
import org.apache.robux.benchmark.query.SqlBaseBenchmark;
...
public class SqlReverseLookupBenchmark
{
  ...
  public void planEquals(Blackhole blackhole)
  {
    ...
    try (final RobuxPlanner planner = plannerFactory.createPlannerForTesting(engine, sql, ImmutableMap.of())) {
