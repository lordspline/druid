...
public class InPlanningBenchmark
{
  ...
  private static final RobuxProcessingConfig PROCESSING_CONFIG = new RobuxProcessingConfig()
  {
    @Override
  ...
  private Sequence<Object[]> getPlan(String sql, @Nullable Blackhole blackhole)
  {
    ...
    try (final RobuxPlanner planner = plannerFactory.createPlannerForTesting(engine, sql, context)) {
