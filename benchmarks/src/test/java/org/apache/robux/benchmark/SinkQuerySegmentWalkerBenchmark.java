...
import org.apache.robux.segment.realtime.appenderator.StreamAppenderatorTester;
...
public class SinkQuerySegmentWalkerBenchmark
{
  ...
  {
    final String userConfiguredCacheDir = System.getProperty("robux.benchmark.cacheDir", System.getenv("ROBUX_BENCHMARK_CACHE_DIR"));
