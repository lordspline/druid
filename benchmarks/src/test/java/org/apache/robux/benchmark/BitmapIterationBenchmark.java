...
import org.apache.robux.collections.bitmap.BitSetBitmapFactory;
 ...
 * "usage cost" of different {@link org.apache.robux.segment.data.BitmapSerdeFactory}.
 *
 * @see #iter(IterState)
...
public class BitmapIterationBenchmark
{
  ...
  /**
   * General benchmark of bitmap iteration, this is a part of {@link org.apache.robux.segment.IndexMerger#merge} and
   ...
   * from realtime nodes, see {@link org.apache.robux.segment.StringDimensionIndexer#fillBitmapsFromUnsortedEncodedKeyComponent}.
   ...
   * from query processing of historical nodes, when {@link org.apache.robux.segment.filter.AndFilter} is used.
   */
  @Benchmark
   ...
   * query processing on historical nodes, when filters like {@link org.apache.robux.segment.filter.DimensionPredicateFilter},
   * {@link org.apache.robux.query.filter.RegexDimFilter}, {@link org.apache.robux.query.filter.SearchQueryDimFilter} and similar are
   * used.
   */
  @Benchmark
