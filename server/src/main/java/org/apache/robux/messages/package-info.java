 ...
 *
 * On the downstream (server) side, messages are placed into an {@link org.apache.robux.messages.server.Outbox}
 * and served by a {@link org.apache.robux.messages.server.MessageRelayResource}.
 *
 * On the upstream (client) side, messages are retrieved by {@link org.apache.robux.messages.client.MessageRelays}
 * using {@link org.apache.robux.messages.client.MessageRelayClient}.
 *
 ...
 * {@link org.apache.robux.server.coordination.ChangeRequestHttpSyncer}.
 */

package org.apache.robux.messages;
