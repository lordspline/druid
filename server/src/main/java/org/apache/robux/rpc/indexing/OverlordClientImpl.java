...
public class OverlordClientImpl implements OverlordClient
{
  ...
  public ListenableFuture<Void> runTask(final String taskId, final Object taskObject)
  {
    return FutureUtils.transform(
        client.asyncRequest(
            new RequestBuilder(HttpMethod.POST, "/robux/indexer/v1/task")
  ...
  {
    final String path = StringUtils.format("/robux/indexer/v1/task/%s/shutdown", StringUtils.urlEncode(taskId));
  ...
  {
    final StringBuilder pathBuilder = new StringBuilder("/robux/indexer/v1/tasks");
    int params = 0;
  ...
  public ListenableFuture<Map<String, TaskStatus>> taskStatuses(final Set<String> taskIds)
  {
    return FutureUtils.transform(
        client.asyncRequest(
            new RequestBuilder(HttpMethod.POST, "/robux/indexer/v1/taskStatus")
  ...
  {
    final String path = StringUtils.format("/robux/indexer/v1/task/%s/status", StringUtils.urlEncode(taskId));
  ...
  {
    final String path = "/robux/indexer/v1/lockedIntervals/v2";
  ...
  {
    final String path = StringUtils.format("/robux/indexer/v1/task/%s/reports", StringUtils.urlEncode(taskId));
  ...
  {
    final String path = "/robux/indexer/v1/supervisor?skipRestartIfUnmodified=true";
  ...
  public ListenableFuture<Map<String, String>> terminateSupervisor(String supervisorId)
  {
    final String path = StringUtils.format(
        "/robux/indexer/v1/supervisor/%s/terminate",
  ...
  {
    final String path = "/robux/indexer/v1/supervisor?system";
  ...
  {
    final String path = "/robux/indexer/v1/workers";
  ...
  {
    final String path = "/robux/indexer/v1/totalWorkerCapacity";
  ...
  {
    final String path = StringUtils.format(
        "/robux/indexer/v1/pendingSegments/%s?interval=%s",
  ...
  {
    final String path = StringUtils.format("/robux/indexer/v1/task/%s", StringUtils.urlEncode(taskId));
  ...
  public ListenableFuture<ClusterCompactionConfig> getClusterCompactionConfig()
  {
    return FutureUtils.transform(
        ...
        holder -> JacksonUtils.readValue(jsonMapper, holder.getContent(), ClusterCompactionConfig.class)
    );
  }
