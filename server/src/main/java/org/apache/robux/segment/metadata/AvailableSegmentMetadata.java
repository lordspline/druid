...
public class AvailableSegmentMetadata
{
  public static Builder builder(
      DataSegment segment,
      long isRealtime,
      Set<RobuxServerMetadata> segmentServers,
  ...
  private final Set<RobuxServerMetadata> segmentServers;
  ...
  public Set<RobuxServerMetadata> getReplicas()
  {
  ...
  public static class Builder
  {
    ...
    private Set<RobuxServerMetadata> segmentServers;
    @Nullable
    ...
    private Builder(
        DataSegment segment,
        long isRealtime,
        Set<RobuxServerMetadata> servers,
    ...
    public Builder withReplicas(Set<RobuxServerMetadata> servers)
    {
      this.segmentServers = servers;
      return this;
    }
