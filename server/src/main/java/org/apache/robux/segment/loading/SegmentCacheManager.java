...
public interface SegmentCacheManager
{
  ...
  /**
   * Returns a {@link ReferenceCountedSegmentProvider} that will be added by the {@link org.apache.robux.server.SegmentManager}
   * to the {@link org.apache.robux.timeline.VersionedIntervalTimeline}. This method can be called multiple times
   * by the {@link org.apache.robux.server.SegmentManager} and implementation can either return same {@link ReferenceCountedSegmentProvider}
   ...
   * added by the {@link org.apache.robux.server.SegmentManager} to the {@link org.apache.robux.timeline.VersionedIntervalTimeline}
