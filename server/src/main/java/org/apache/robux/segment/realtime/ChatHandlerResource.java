...
import org.apache.robux.server.initialization.jetty.BadRequestException;
...
@Path("/robux/worker/v1/chat")
public class ChatHandlerResource
{
  public static final String TASK_ID_HEADER = "X-Robux-Task-Id";
