...
public interface TuningConfig
{
   ...
   * in-memory data are slower due to using {@link org.apache.robux.segment.incremental.IncrementalIndex}
   * instead of {@link org.apache.robux.segment.QueryableIndex}, we cap the row count of in-memory data.
   */
