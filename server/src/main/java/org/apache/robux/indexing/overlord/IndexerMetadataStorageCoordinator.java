...
public interface IndexerMetadataStorageCoordinator
{
   ...
   * @param interval      an optional interval to search over. If none is specified, {@link org.apache.robux.java.util.common.Intervals#ETERNITY}
   ...
   *      Segments that have no {@code used_status_last_updated} time (due to an upgrade from legacy Robux) will
   ...
   *
   * @return Number of segments updated
   * @throws org.apache.robux.error.RobuxException of category INVALID_INPUT if
