...
public interface SupervisorSpec
{
   ...
   * org.apache.robux.sql.calcite.schema.SystemSchema.SupervisorsTable
   *
   ...
   * @throws RobuxException if the spec update is not allowed
   */
  default void validateSpecUpdateTo(SupervisorSpec proposedSpec) throws RobuxException
  {
