...
public class StatusResource
{
  ...
  private final RobuxServerConfig robuxServerConfig;
  ...
  public StatusResource(
      ...
      final RobuxServerConfig robuxServerConfig,
      final ExtensionsLoader extnLoader,
      final RuntimeInfo runtimeInfo
  )
  {
    this.properties = properties;
    this.robuxServerConfig = robuxServerConfig;
  ...
  public Map<String, String> getProperties()
  {
    ...
    Set<String> hiddenProperties = robuxServerConfig.getHiddenProperties();
  ...
  public static class Status
  {
    ...
    public Status(Collection<RobuxModule> modules, RuntimeInfo runtimeInfo)
    {
      this.version = getRobuxVersion();
      this.modules = getExtensionVersions(modules);
      this.memory = new Memory(runtimeInfo);
    }

    private String getRobuxVersion()
    {
    ...
    public String toString()
    {
      ...
      output.append(StringUtils.format("Robux version - %s", version)).append(lineSeparator).append(lineSeparator);

      if (modules.size() > 0) {
        output.append("Registered Robux Modules").append(lineSeparator);
      } else {
        output.append("No Robux Modules loaded !");
      }
     ...
     */
    private List<ModuleVersion> getExtensionVersions(Collection<RobuxModule> robuxModules)
    {
      List<ModuleVersion> moduleVersions = new ArrayList<>();
      for (RobuxModule module : robuxModules) {
