...
/**
 * This enum represents types of robux services that hold segments.
 * <p>
 * These types are externally visible (e.g., from the output of {@link
 * org.apache.robux.server.http.ServersResource#makeSimpleServer}).
 * <p>
 ...
 * https://github.com/apache/robux/pull/4148
 *
 ...
 *
 * These abstractions can probably be merged when Robux updates to Jackson 2.9 that supports JsonAliases, see
...
public enum ServerType
{
   ...
   *
   * @see org.apache.robux.server.coordinator.rules.LoadRule
   */
