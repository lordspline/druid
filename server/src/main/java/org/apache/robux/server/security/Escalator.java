...
public interface Escalator
{
   ...
   * <p>
   * This HTTP client is used for internal communications between Robux nodes, such as when a broker communicates
   * with a historical node during query processing.
   *
   * @param baseClient Base HTTP client for internal Robux communications
   *
