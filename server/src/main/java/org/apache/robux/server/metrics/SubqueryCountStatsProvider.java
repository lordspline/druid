...
public class SubqueryCountStatsProvider
{
  ...
  /**
   * @return Count of subqueries where the results are materialized as {@link org.apache.robux.frame.Frame}
   */
   ...
   * {@link org.apache.robux.segment.column.RowSignature}. This is expected to be the most common and already known
