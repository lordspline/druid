...
public interface CoordinatorDuty
{
   ...
   * Input params can be used and modified. The returned RobuxCoordinatorRuntimeParams is passed to the next duty.
   *
   ...
   * {@link org.apache.robux.server.coordinator.RobuxCoordinator.DutiesRunnable}) from running until the next
   * cycle.
   */
  @Nullable
  RobuxCoordinatorRuntimeParams run(RobuxCoordinatorRuntimeParams params);
}
