...
public class RobuxCompactionConfig
{
  public static final String CONFIG_KEY = "coordinator.compaction.config";

  private static final RobuxCompactionConfig EMPTY_INSTANCE
      = new RobuxCompactionConfig(List.of(), null, null, null, null, null);

  private final List<DataSourceCompactionConfig> compactionConfigs;
  private final ClusterCompactionConfig clusterConfig;

  /**
   * Creates a copy of this {@link RobuxCompactionConfig} with the given
   * datasource compaction configs.
   */
  public RobuxCompactionConfig withDatasourceConfigs(
      List<DataSourceCompactionConfig> compactionConfigs
  )
  {
    return new RobuxCompactionConfig(compactionConfigs, clusterConfig);
  }

  /**
   * Creates a copy of this {@link RobuxCompactionConfig} by updating the
   * fields provided in the {@link ClusterCompactionConfig}.
   */
  public RobuxCompactionConfig withClusterConfig(
  ...
  public RobuxCompactionConfig withDatasourceConfig(DataSourceCompactionConfig dataSourceConfig)
  {
  ...
  public static RobuxCompactionConfig empty()
  {
    return EMPTY_INSTANCE;
  }

  @JsonCreator
  public RobuxCompactionConfig(
  ...
  public boolean equals(Object o)
  {
    ...
    RobuxCompactionConfig that = (RobuxCompactionConfig) o;
