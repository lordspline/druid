...
import org.apache.robux.server.coordinator.loading.SegmentHolder;
...
/**
 */
public class RobuxCoordinatorRuntimeParams
{
  private final RobuxCluster robuxCluster;
  ...
  private final RobuxCompactionConfig compactionConfig;
  ...
  private RobuxCoordinatorRuntimeParams(
      ...
      RobuxCompactionConfig compactionConfig,
  ...
  {
    this.robuxCluster = robuxCluster;
  ...
  public RobuxCluster getRobuxCluster()
  {
    return robuxCluster;
  }
  ...
  public RobuxCompactionConfig getCompactionConfig()
  {
  ...
  {
    private RobuxCluster robuxCluster;
    ...
    private RobuxCompactionConfig compactionConfig;
    ...
    private Builder()
    {
      ...
      this.compactionConfig = RobuxCompactionConfig.empty();
      this.broadcastDatasources = Collections.emptySet();
    }

    private Builder(
        RobuxCluster cluster,
        StrategicSegmentAssigner segmentAssigner,
        TreeSet<DataSegment> usedSegmentsNewestFirst,
        DataSourcesSnapshot dataSourcesSnapshot,
        CoordinatorDynamicConfig coordinatorDynamicConfig,
    ...
    public RobuxCoordinatorRuntimeParams build()
    {
      ...
      return new RobuxCoordinatorRuntimeParams(
          robuxCluster,
          segmentAssigner,
          usedSegmentsNewestFirst,
          dataSourcesSnapshot,
    ...
    private void initSegmentAssignerIfRequired()
    {
      ...
      Preconditions.checkNotNull(robuxCluster);
    ...
    public Builder withRobuxCluster(RobuxCluster cluster)
    {
      this.robuxCluster = cluster;
      return this;
    }
    ...
    public Builder withCompactionConfig(RobuxCompactionConfig config)
    {
