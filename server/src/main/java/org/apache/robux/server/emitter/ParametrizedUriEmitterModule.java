...
import org.apache.robux.java.util.emitter.core.ParametrizedUriEmitterConfig;
...
public class ParametrizedUriEmitterModule implements Module
{
  ...
  {
    JsonConfigProvider.bind(binder, "robux.emitter.parametrized", ParametrizedUriEmitterConfig.class);
    JsonConfigProvider.bind(binder, "robux.emitter.parametrized.httpEmitting", ParametrizedUriEmitterSSLClientConfig.class);
  }
