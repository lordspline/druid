...
public abstract class QueryResultPusher
{
  ...
  public Response push()
  {
    ...
    try {
      ...
      return handleRobuxException(resultsWriter, e);
    }
  ...
  {
    return handleRobuxException(resultsWriter, RobuxException.fromFailure(new QueryExceptionCompat(e)));
  }

  private void incrementQueryCounterForException(final RobuxException e)
  {
  ...
  private Response handleRobuxException(ResultsWriter resultsWriter, RobuxException e)
  {
    ...
    if (response == null) {
      return handleRobuxExceptionBeforeResponseStarted(
          e,
          contentType,
  ...
  /**
   * Generates a response for a {@link RobuxException} that occurs prior to any query results being sent out.
   */
  public static Response handleRobuxExceptionBeforeResponseStarted(
      final RobuxException e,
  ...
  public class StreamingHttpResponseAccumulator implements Accumulator<Response, Object>, Closeable
  {
    ...
    public void initialize()
    {
      ...
      if (!initialized) {
        ...
        DirectRobuxClient.removeMagicResponseContextFields(responseContext);
    ...
    {
      // Limit the response-context header, see https://github.com/apache/robux/issues/2331
