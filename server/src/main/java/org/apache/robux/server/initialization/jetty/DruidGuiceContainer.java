...
import org.apache.robux.guice.RobuxScopes;
...
public class RobuxGuiceContainer extends GuiceContainer
{
  @Nonnull
  public static Map<Scope, ComponentScope> populateScopeMap(Map<Scope, ComponentScope> map)
  {
    ...
    map.put(RobuxScopes.SINGLETON, ComponentScope.Singleton);
    return map;
  }
