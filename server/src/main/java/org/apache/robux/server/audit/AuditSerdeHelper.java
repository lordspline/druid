...
import org.apache.robux.guice.annotations.JsonNonNull;
 ...
 * {@link org.apache.robux.audit.AuditManager} to serialize/deserialize audit
...
public class AuditSerdeHelper
{
  ...
  private static final String PAYLOAD_TRUNCATED_MSG =
      "Payload truncated as it exceeds 'robux.audit.manager.maxPayloadSizeBytes'";
   ...
   *
   * @return true only if the event was not initiated by the Robux system OR if
