...
import org.apache.robux.server.initialization.jetty.ServletFilterHolder;
 ...
 * - A method for authenticating credentials contained in a JDBC connection context, used for authenticating Robux SQL
...
public interface Authenticator extends ServletFilterHolder
{
   ...
   * <p>
   * If the authentication succeeds, the Filter should set the "Robux-Authentication-Result" attribute in the request,
   ...
   * <p>
   * If the "Robux-Authentication-Result" attribute is already set (i.e., request has been authenticated by an
   ...
   * This is used to secure JDBC access for Robux SQL.
   * <p>
