...
import org.apache.robux.client.indexing.ClientCompactionRunnerInfo;
import org.apache.robux.client.indexing.ClientCompactionTaskDimensionsSpec;
...
import org.apache.robux.server.compaction.CompactionCandidate;
import org.apache.robux.server.compaction.CompactionCandidateSearchPolicy;
import org.apache.robux.server.compaction.CompactionSegmentIterator;
import org.apache.robux.server.compaction.CompactionStatusTracker;
import org.apache.robux.server.compaction.PriorityBasedCompactionSegmentIterator;
...
{
  /**
   * Must be the same as org.apache.robux.indexing.common.task.CompactionTask.TYPE.
   */
  public static final String COMPACTION_TASK_TYPE = "compact";
  /**
   * Must be the same as org.apache.robux.indexing.common.task.Tasks.STORE_COMPACTION_STATE_KEY
   */
  ...
  public void run(
      RobuxCompactionConfig dynamicConfig,
  ...
  private int getCompactionTaskCapacity(RobuxCompactionConfig dynamicConfig)
  {
