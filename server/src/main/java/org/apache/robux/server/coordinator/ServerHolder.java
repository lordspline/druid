...
/**
 * Encapsulates the state of a RobuxServer during a single coordinator run.
 * <p>
...
public class ServerHolder implements Comparable<ServerHolder>
{
  ...
  private final ImmutableRobuxServer server;
  ...
  public ServerHolder(ImmutableRobuxServer server, LoadQueuePeon peon)
  {
    this(server, peon, false, 0, 1);
  }

  public ServerHolder(ImmutableRobuxServer server, LoadQueuePeon peon, boolean isDecommissioning)
  {
    this(server, peon, isDecommissioning, 0, 1);
  }

  public ServerHolder(
      ImmutableRobuxServer server,
      LoadQueuePeon peon,
   ...
   *
   * @param server                 Underlying Robux server
  ...
  public ImmutableRobuxServer getServer()
  {
    return server;
  }
