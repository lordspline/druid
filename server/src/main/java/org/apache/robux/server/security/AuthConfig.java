...
public class AuthConfig
{
   ...
   */
  public static final String ROBUX_AUTHENTICATION_RESULT = "Robux-Authentication-Result";

  /**
   * HTTP attribute set when a static method in AuthorizationUtils performs an authorization check on the request.
   */
  public static final String ROBUX_AUTHORIZATION_CHECKED = "Robux-Authorization-Checked";

  public static final String ROBUX_ALLOW_UNSECURED_PATH = "Robux-Allow-Unsecured-Path";
  ...
  /**
   * Set of context keys which are always permissible because something in the Robux
   ...
   * <ul>
   * <li>Allow Robux-defined keys.</li>
