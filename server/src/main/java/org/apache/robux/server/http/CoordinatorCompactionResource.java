...
import org.apache.robux.server.compaction.CompactionProgressResponse;
...
@Path("/robux/coordinator/v1/compaction")
public class CoordinatorCompactionResource
{
  ...
  /**
   * This API is meant to only be used by Robux's integration tests.
   */
  @POST
  @Path("/compact")
