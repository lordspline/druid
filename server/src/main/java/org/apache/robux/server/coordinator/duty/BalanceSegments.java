...
import org.apache.robux.server.coordinator.balancer.TierSegmentBalancer;
...
public class BalanceSegments implements CoordinatorDuty
{
  ...
  public RobuxCoordinatorRuntimeParams run(RobuxCoordinatorRuntimeParams params)
  {
    ...
    params.getRobuxCluster().getManagedHistoricals().forEach(
   ...
   */
  private int getMaxSegmentsToMove(RobuxCoordinatorRuntimeParams params)
  {
    final CoordinatorDynamicConfig dynamicConfig = params.getCoordinatorDynamicConfig();
    if (dynamicConfig.isSmartSegmentLoading()) {
      final Pair<Integer, Integer> numHistoricalsAndSegments = getNumHistoricalsAndSegments(params.getRobuxCluster());
   ...
   */
  private Pair<Integer, Integer> getNumHistoricalsAndSegments(RobuxCluster cluster)
  {
