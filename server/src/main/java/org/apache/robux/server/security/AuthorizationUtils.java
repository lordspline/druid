...
package org.apache.robux.server.security;
...
import org.apache.robux.audit.RequestInfo;
...
public class AuthorizationUtils
{
   ...
   * <p>
   * This function will set the ROBUX_AUTHORIZATION_CHECKED attribute in the request. If this attribute is already set
   ...
   * it:
   * <ul>
   * <li>Header {@link AuditManager#X_ROBUX_AUTHOR}</li>
   * <li>Header {@link AuditManager#X_ROBUX_COMMENT}</li>
   * <li>Attribute {@link AuthConfig#ROBUX_AUTHENTICATION_RESULT}</li>
  ...
  {
    final String author = request.getHeader(AuditManager.X_ROBUX_AUTHOR);
    final String comment = request.getHeader(AuditManager.X_ROBUX_COMMENT);
  ...
  {
    if (request.getAttribute(AuthConfig.ROBUX_ALLOW_UNSECURED_PATH) != null) {
      return AuthorizationResult.ALLOW_NO_RESTRICTION;
    }

    if (request.getAttribute(AuthConfig.ROBUX_AUTHORIZATION_CHECKED) != null) {
    ...
    request.setAttribute(AuthConfig.ROBUX_AUTHORIZATION_CHECKED, authResult.allowBasicAccess());
    return authResult;
  }

  /**
   * Sets the {@link AuthConfig#ROBUX_AUTHORIZATION_CHECKED} attribute in the {@link HttpServletRequest} to true. This method is generally used
  ...
  public static void setRequestAuthorizationAttributeIfNeeded(final HttpServletRequest request)
  {
    ...
    if (request.getAttribute(AuthConfig.ROBUX_AUTHORIZATION_CHECKED) != null) {
      throw RobuxException.defensive("Request already had authorization check.");
    }
