 ...
 *
 * @deprecated as Robux has already migrated to HTTP-based segment loading and
 * will soon migrate to HTTP-based inventory view using {@code SegmentListerResource}.
 *
 * @see org.apache.robux.server.http.SegmentListerResource
 */
@Deprecated
public class ZkCoordinator
{
  ...
  private final RobuxServerMetadata me;
