...
public class SecuritySanityCheckFilter implements Filter
{
      ...
      throws IOException, ServletException
  {
    ...
    Boolean authInfoChecked = (Boolean) request.getAttribute(AuthConfig.ROBUX_AUTHORIZATION_CHECKED);
    Boolean allowUnsecured = (Boolean) request.getAttribute(AuthConfig.ROBUX_ALLOW_UNSECURED_PATH);

    AuthenticationResult result = (AuthenticationResult) request.getAttribute(AuthConfig.ROBUX_AUTHENTICATION_RESULT);
