...
/**
 */
@Path("/robux/coordinator/v1/intervals")
public class IntervalsResource
{
  ...
  public Response getIntervals(@Context final HttpServletRequest req)
  {
    ...
    final Set<ImmutableRobuxDataSource> datasources = InventoryViewUtils.getSecuredDataSources(
        req,
        serverInventoryView,
        authorizerMapper
    );
    ...
    for (ImmutableRobuxDataSource dataSource : datasources) {
  ...
  private void setProperties(
      ...
      ImmutableRobuxDataSource dataSource, DataSegment dataSegment
  )
  {
