...
public class SelfDiscoveryResource
{
  ...
  public SelfDiscoveryResource(
      @Self RobuxNode thisRobuxNode,
      @Self Set<NodeRole> thisNodeRoles,
      RobuxNodeDiscoveryProvider nodeDiscoveryProvider,
      Lifecycle lifecycle
  )
  {
    ...
    thisNodeRoles.forEach(
        thisNodeRole -> {
          Lifecycle.Handler selfDiscoveryListenerRegistrator = new Lifecycle.Handler()
          {
            ...
            public void start()
            {
              selfDiscoveredRoles.add(nodeDiscoveryProvider.getForNode(thisRobuxNode, thisNodeRole));
            }
          ...
          // Using Lifecycle.Stage.SERVER because RobuxNodeDiscoveryProvider should be already started when
