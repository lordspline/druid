...
public class CoordinatorDutyGroup
{
  ...
  private final RobuxCoordinator.DutyGroupHelper coordinator;
  ...
  public CoordinatorDutyGroup(
      ...
      Duration period,
      RobuxCoordinator.DutyGroupHelper coordinator
  )
  {
    this.name = name;
    this.duties = duties;
   ...
   * during the run.
   */
  public void run(RobuxCoordinatorRuntimeParams params)
  {
    markRunStarted();
