...
public class AuthorizerMapperModule implements RobuxModule
{
  private static final String AUTHORIZER_PROPERTIES_FORMAT_STRING = "robux.auth.authorizer.%s";
  ...
  private static class AuthorizerMapperProvider implements Provider<AuthorizerMapper>
  {
    ...
    public AuthorizerMapper get()
    {
      ...
      for (String authorizerName : authorizers) {
        ...
        String nameProperty = StringUtils.format("robux.auth.authorizer.%s.name", authorizerName);
