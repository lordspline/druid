 ...
 * Security-sensitive endpoints will need to extract the identity string contained in the request's Robux-Auth-Token
 ...
 * After a request is authorized, a new attribute, "Robux-Authorization-Checked", should be set in the
...
public interface Authorizer
{
   ...
   * <p>
   * If the action involves reading a table, the outcome could include {@link org.apache.robux.query.policy.Policy} restrictions.
   * However, if the action does not involve reading a table, there must be no {@link org.apache.robux.query.policy.Policy} restrictions.
   *
