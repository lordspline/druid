...
import org.apache.robux.java.util.emitter.core.HttpEmitterConfig;
import org.apache.robux.java.util.emitter.core.HttpPostEmitter;
...
public class HttpEmitterModule implements Module
{
  ...
  {
    JsonConfigProvider.bind(binder, "robux.emitter.http", HttpEmitterConfig.class);
    JsonConfigProvider.bind(binder, "robux.emitter.http.ssl", HttpEmitterSSLClientConfig.class);
