...
public class LoadQueueTaskMaster
{
  ...
  private LoadQueuePeon createPeon(ImmutableRobuxServer server)
  {
  ...
  public LoadQueuePeon getPeonForServer(ImmutableRobuxServer server)
  {
   ...
   */
  public synchronized void resetPeonsForNewServers(List<ImmutableRobuxServer> currentServers)
  {
    if (!isLeader.get()) {
      return;
    }
