 ...
 *
 * Any method that is not explicitly allowed by a Robux admin or one of the {@link #SUPPORTED_METHODS} that Robux
 * requires to operate, will be rejected.
 */
public class AllowHttpMethodsResourceFilter implements Filter
{
  /**
   * Robux always allows GET, POST, PUT and DELETE methods.
   */
  @VisibleForTesting
