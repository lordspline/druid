 ...
 * {@link RobuxCompactionConfig}. The {@link RobuxCompactionConfig} contains the entire config for the
...
public class DataSourceCompactionConfigHistory
{
  ...
  public void add(RobuxCompactionConfig compactionConfig, AuditInfo auditInfo, DateTime auditTime)
  {
