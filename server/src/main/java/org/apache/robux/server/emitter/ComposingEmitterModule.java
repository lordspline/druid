...
import org.apache.robux.java.util.emitter.core.ComposingEmitter;
...
/**
 */
public class ComposingEmitterModule implements RobuxModule
{
  ...
  {
    JsonConfigProvider.bind(binder, "robux.emitter.composing", ComposingEmitterConfig.class);
  }
