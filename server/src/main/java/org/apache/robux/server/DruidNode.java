...
public class RobuxNode
{
  ...
  /**
   * This property indicates whether the robux node's internal jetty server bind on {@link RobuxNode#host}.
   ...
   * Please use {@link RobuxNode#plaintextPort} instead, which if set will be used and hence this has -1 as default value.
   */
  @Deprecated
  @JsonProperty
  @Max(0xffff)
  ...
  )
  {
    ...
    if (!enableTlsPort && !enablePlaintextPort) {
      throw new IAE("At least one of the robux.enablePlaintextPort or robux.enableTlsPort needs to be true.");
    }
    ...
    if (enableTlsPort && (tlsPort == null || tlsPort < 0)) {
      throw new IAE("A valid tlsPort needs to specified when robux.enableTlsPort is set");
    }
  ...
  public RobuxNode withService(String service)
  {
    return new RobuxNode(service, host, bindOnHost, plaintextPort, tlsPort, enablePlaintextPort, enableTlsPort);
  }
  ...
  public boolean equals(Object o)
  {
    ...
    RobuxNode robuxNode = (RobuxNode) o;
    return port == robuxNode.port &&
           bindOnHost == robuxNode.bindOnHost &&
           plaintextPort == robuxNode.plaintextPort &&
           enablePlaintextPort == robuxNode.enablePlaintextPort &&
           tlsPort == robuxNode.tlsPort &&
           enableTlsPort == robuxNode.enableTlsPort &&
           Objects.equals(serviceName, robuxNode.serviceName) &&
           Objects.equals(host, robuxNode.host);
  }
