...
public interface TLSCertificateChecker
{
   ...
   *
   * This controls the certificate check used by Robux's server, checking certificates for internal requests made
   * by other Robux services and user-submitted requests.
   *
   ...
   *
   * This controls the certificate check used by Robux's internal client, used to validate the certificates of other Robux services.
   *
