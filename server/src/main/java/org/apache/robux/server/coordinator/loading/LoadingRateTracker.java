...
public class LoadingRateTracker
{
   ...
   *
   * @throws RobuxException if called without making a prior call to
  ...
  {
    if (!isLoadingBatch()) {
      throw RobuxException.defensive("markBatchLoadingStarted() must be called before tracking load progress.");
    }
