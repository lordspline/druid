...
/**
 * Defines the 'role' of a Robux service, utilized to strongly type announcement and service discovery.
 *
 ...
 *
 * The historical context of why the enum was different from {@link org.apache.robux.server.coordination.ServerType}
 ...
 *
 * These abstractions can all potentially be merged when Robux updates to Jackson 2.9 that supports JsonAliases,
 * see https://github.com/apache/robux/issues/7152.
 */
public class NodeRole
{
  ...
  /**
   * Create a custom node role. Known Robux node roles should ALWAYS use the built-in static node roles:
  ...
  public Named getRobuxServiceInjectName()
  {
