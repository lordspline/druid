 ...
 * with the subtype key of {@link RobuxService}. It seems to happen to work
 ...
 * but uses {@link org.apache.robux.jackson.RobuxServiceSerializer}.
 ...
 * we can remove RobuxServiceSerializer as well.
 *
 * The set of properties to serialize is hard-coded in RobuxServiceSerializer.
 * If you want to add a new field in this class before we remove the "type" field,
 * you must add a proper handling of that new field in RobuxServiceSerializer as well.
 *
 * For deserialization, RobuxServices are deserialized as a part of {@link DiscoveryRobuxNode}.
 * To handle the bug of the duplicate "type" key, DiscoveryRobuxNode first deserializes
 * the JSON to {@link org.apache.robux.jackson.StringObjectPairList},
 * handles the duplicate "type" keys in the StringObjectPairList,
 * and then finally converts it to a RobuxService. See {@link DiscoveryRobuxNode#toMap(List)}.
 *
 * @see org.apache.robux.jackson.RobuxServiceSerializer
 * @see DiscoveryRobuxNode#toMap(List)
 */
public class DataNodeService extends RobuxService
{
  ...
  /**
   * This JSON creator requires for the "type" subtype key of {@link RobuxService} to appear before
