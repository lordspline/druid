...
package org.apache.robux.metadata.segment;
...
class SqlSegmentMetadataTransaction implements SegmentMetadataTransaction
{
  ...
  public Set<DataSegmentPlus> findUsedSegmentsPlusOverlappingAnyOf(List<Interval> intervals)
  {
    try (CloseableIterator<DataSegmentPlus> iterator
      ...
      throw RobuxException.defensive(e, "Error while retrieving used segments");
    }
  }
  ...
  )
  {
    try (final CloseableIterator<DataSegment> iterator =
      ...
      throw RobuxException.defensive(e, "Error while reading unused segments");
    }
  }
  ...
  {
    if (date == null) {
      throw RobuxException.defensive("Created date cannot be null");
    }
