...
class HeapMemoryDatasourceSegmentCache extends ReadWriteCache implements AutoCloseable
{
  ...
  {
    throw RobuxException.defensive("Unsupported: Unused segments are not cached");
  }
  ...
  public boolean updateSegmentPayload(DataSegment segment)
  {
    ...
    throw RobuxException.defensive("Unsupported: Segment payload updates are not supported in the cache");
  }
