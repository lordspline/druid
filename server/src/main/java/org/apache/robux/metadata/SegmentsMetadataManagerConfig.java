...
{
  public static final String CONFIG_PREFIX = "robux.manager.segments";
    ...
    if (this.killUnused.isEnabled() && this.useIncrementalCache == SegmentMetadataCache.UsageMode.NEVER) {
      throw RobuxException
          ...
          .build(
              ...
              + " Set 'robux.manager.segments.useIncrementalCache=always'"
              + " or 'robux.manager.segments.useIncrementalCache=ifSynced' to enable the cache."
          );
    }
  }
