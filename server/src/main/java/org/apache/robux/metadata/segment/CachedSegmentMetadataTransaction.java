...
import org.apache.robux.metadata.segment.cache.DatasourceSegmentCache;
...
class CachedSegmentMetadataTransaction implements SegmentMetadataTransaction
{
  ...
  CachedSegmentMetadataTransaction(
      ...
      RobuxLeaderSelector leaderSelector,
  ...
  )
  {
    ...
    if (leaderSelector.isLeader()) {
      ...
      throw RobuxException.forPersona(RobuxException.Persona.USER)
                          .ofCategory(RobuxException.Category.SERVICE_UNAVAILABLE)
