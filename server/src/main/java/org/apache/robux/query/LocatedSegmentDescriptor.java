...
public class LocatedSegmentDescriptor
{
  ...
  private final List<RobuxServerMetadata> locations;
  ...
  public LocatedSegmentDescriptor(
      ...
      @JsonProperty("locations") List<RobuxServerMetadata> locations
  )
  {
  ...
  public LocatedSegmentDescriptor(SegmentDescriptor descriptor, long size, List<RobuxServerMetadata> candidates)
  {
  ...
  public List<RobuxServerMetadata> getLocations()
  {
    return locations;
  }
