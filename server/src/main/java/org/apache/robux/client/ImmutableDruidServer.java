 ...
 * in tests.
 *
 * @see RobuxServer - a mutable counterpart of this class
 */
public class ImmutableRobuxServer
{
  private final RobuxServerMetadata metadata;
  private final long currSize;
  private final ImmutableMap<String, ImmutableRobuxDataSource> dataSources;
  private final int numSegments;

  public ImmutableRobuxServer(
      RobuxServerMetadata metadata,
      long currSize,
      ImmutableMap<String, ImmutableRobuxDataSource> dataSources,
      int numSegments
  )
  {
  ...
  {
    ImmutableRobuxDataSource dataSource = dataSources.get(segmentId.getDataSource());
    if (dataSource == null) {
      return null;
    }
  ...
  public Iterable<ImmutableRobuxDataSource> getDataSources()
  {
    return dataSources.values();
  }

  public ImmutableRobuxDataSource getDataSource(String name)
  {
    return dataSources.get(name);
  }

  /**
   * Returns a lazy collection with all segments in all data sources stored on this ImmutableRobuxServer to be used for
  ...
  public boolean equals(Object o)
  {
    ...
    ImmutableRobuxServer that = (ImmutableRobuxServer) o;
