...
public interface ServerView
{
  ...
  interface ServerCallback
  {
     ...
     */
    CallbackAction serverAdded(RobuxServer server);
     ...
     * should remain registered.
     */
    CallbackAction serverRemoved(RobuxServer server);
  }
  ...
  interface SegmentCallback
  {
     ...
     * should remain registered.
     */
    CallbackAction segmentRemoved(RobuxServerMetadata server, DataSegment segment);
