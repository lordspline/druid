...
{
  @Nullable
  default <T> QueryableRobuxServer pick(@Nullable Query<T> query, Set<QueryableRobuxServer> servers, DataSegment segment)
  {
    return Iterables.getOnlyElement(pick(query, servers, segment, 1), null);
  }

  default <T> List<QueryableRobuxServer> pick(@Nullable Query<T> query, Set<QueryableRobuxServer> servers, DataSegment segment,
  ...
  @Deprecated
  @Nullable
  default QueryableRobuxServer pick(Set<QueryableRobuxServer> servers, DataSegment segment)
  {
    return pick(null, servers, segment);
  }

  @Deprecated
  default List<QueryableRobuxServer> pick(Set<QueryableRobuxServer> servers, DataSegment segment, int numServersToPick)
  {
