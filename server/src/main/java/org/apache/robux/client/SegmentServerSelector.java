...
/**
 * Given a {@link SegmentDescriptor}, get a {@link ServerSelector} to use to pick a {@link RobuxServer} to query.
 *
 * Used by {@link CachingClusteredClient} on the broker to fan out queries to historical and realtime data. Used
 * by {@link org.apache.robux.server.LocalQuerySegmentWalker} on the broker for on broker queries
 */
