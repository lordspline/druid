...
public interface HistoricalFilter
{
  ...
  /**
   * Returns a {@link Int2ObjectRBTreeMap} after performing a filtering on the {@link QueryableRobuxServer}, based
   * on the cloneQueryMode paramter. The map in the parameter is not modified.
   */
  Int2ObjectRBTreeMap<Set<QueryableRobuxServer>> getQueryableServers(
