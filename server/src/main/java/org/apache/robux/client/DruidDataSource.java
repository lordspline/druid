 ...
 *
 * @see ImmutableRobuxDataSource - an immutable counterpart of this class
 */
public class RobuxDataSource
{
  ...
  public RobuxDataSource(String name, Map<String, String> properties)
  {
  ...
  public RobuxDataSource addSegment(DataSegment dataSegment)
  {
  ...
  public ImmutableRobuxDataSource toImmutableRobuxDataSource()
  {
    return new ImmutableRobuxDataSource(name, properties, idToSegmentMap);
  }

  @Override
  public String toString()
  {
    return "RobuxDataSource{" +
  ...
  {
    throw new UnsupportedOperationException("Use ImmutableRobuxDataSource instead");
  }
