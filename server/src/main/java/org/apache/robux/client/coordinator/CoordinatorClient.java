...
public interface CoordinatorClient
{
   ...
   * <p>
   * API: {@code GET /robux/coordinator/v1/compaction/status}
   *
   ...
   * <p>
   * API: {@code GET /robux/coordinator/v1/config}
   */
   ...
   * <p>
   * API: {@code POST /robux/coordinator/v1/config}
   */
   ...
   * <p>
   * API: {@code POST /robux/coordinator/v1/lookups/config}
   */
   ...
   * <p>
   * API: {@code GET /robux/coordinator/v1/lookups/config/<tier>}
   *
   ...
   * <p>
   * API: {@code GET /robux/coordinator/v1/metadata/segments?includeOvershadowedStatus}
   *
   ...
   * <p>
   * API: {@code GET /robux/coordinator/v1/rules}
   */
   ...
   * <p>
   * API: {@code GET /robux/coordinator/v1/leader}
   */
   ...
   * <p>
   * API: {@code POST /robux/coordinator/v1/rules}
   */
