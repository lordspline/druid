...
public interface TierSelectorStrategy
{
  ...
  @Deprecated
  @Nullable
  default QueryableRobuxServer pick(Int2ObjectRBTreeMap<Set<QueryableRobuxServer>> prioritizedServers, DataSegment segment)
  {
    return pick(null, prioritizedServers, segment);
  }

  @Deprecated
  default List<QueryableRobuxServer> pick(
  ...
  @Nullable
  default <T> QueryableRobuxServer pick(@Nullable Query<T> query,
      Int2ObjectRBTreeMap<Set<QueryableRobuxServer>> prioritizedServers,
      DataSegment segment)
  {
  ...
  default <T> List<QueryableRobuxServer> pick(
