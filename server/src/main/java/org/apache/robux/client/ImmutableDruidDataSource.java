 ...
 * source.
 *
 * @see RobuxDataSource - a mutable counterpart of this class
 */
public class ImmutableRobuxDataSource
{
   ...
   */
  public ImmutableRobuxDataSource(String name, Map<String, String> properties, Map<SegmentId, DataSegment> idToSegments)
  {
  ...
  @JsonCreator
  public ImmutableRobuxDataSource(
  ...
  /**
   * Returns the sum of the {@link DataSegment#getSize() sizes} of all segments in this ImmutableRobuxDataSource.
   */
  @JsonIgnore
  ...
  public String toString()
  {
    ...
    return "ImmutableRobuxDataSource{"
           + "name='" + name
  ...
  /**
   * ImmutableRobuxDataSource should be considered a container, not a data class. The idea is the same as behind
   * prohibiting/limiting equals() (and therefore usage as HashSet/HashMap keys) of DataSegment: see
   * https://github.com/apache/robux/issues/6358. When somebody wants to deduplicate ImmutableRobuxDataSource
   * objects, they would need to put them into a Map<String, ImmutableRobuxDataSource> and resolve conflicts by name
   * manually.
   *
   * See https://github.com/apache/robux/issues/7858
   */
  @Override
  public boolean equals(Object o)
  {
    throw new UnsupportedOperationException("ImmutableRobuxDataSource shouldn't be used as the key in containers");
  }
  ...
  public boolean equalsForTesting(Object o)
  {
    ...
    final ImmutableRobuxDataSource that = (ImmutableRobuxDataSource) o;
