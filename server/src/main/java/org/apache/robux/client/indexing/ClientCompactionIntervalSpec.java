 ...
 *
 * Should be synchronized with org.apache.robux.indexing.common.task.CompactionIntervalSpec.
 */
public class ClientCompactionIntervalSpec
{
  ...
  public static ClientCompactionIntervalSpec fromSegments(List<DataSegment> segments, @Nullable Granularity segmentGranularity)
  {
    ...
    if (segmentGranularity != null) {
      ...
      // This is because Robux's WEEK segments alway start and end on Monday. In the above example, 2015-01-26 and 2015-03-02
