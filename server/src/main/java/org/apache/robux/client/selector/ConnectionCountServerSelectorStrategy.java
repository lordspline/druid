...
{
  private static final Comparator<QueryableRobuxServer> COMPARATOR =
      Comparator.comparingDouble(s ->
                                     ((DirectRobuxClient) s.getQueryRunner()).getNumOpenConnections()
                                     + ThreadLocalRandom.current().nextDouble()
      );

  @Nullable
  @Override
  public QueryableRobuxServer pick(Set<QueryableRobuxServer> servers, DataSegment segment)
  {
