...
public class CaffeineCache implements org.apache.robux.client.cache.Cache
{
  ...
  @Override
  public org.apache.robux.client.cache.CacheStats getStats()
  {
    ...
    return new org.apache.robux.client.cache.CacheStats(
        stats.hitCount(),
        stats.missCount(),
        cache.estimatedSize(),
        size,
