...
{
  /**
   * Submit the given {@code sqlQuery} to the Broker's SQL query endpoint, {@code /robux/v2/sql/}.
   */
  ListenableFuture<String> submitSqlQuery(ClientSqlQuery sqlQuery);

  /**
   * Submit the given {@code sqlQuery} to the Broker's SQL task endpoint, {@code /robux/v2/sql/task/}.
   */
