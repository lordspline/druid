...
package org.apache.robux.curator.inventory;
...
/**
 * This class is deprecated. Use {@link org.apache.robux.client.HttpServerInventoryView} for segment discovery.
 *
...
public class CuratorInventoryManager<ContainerClass, InventoryClass>
{
  ...
  )
  {
    ...
    this.cacheFactory = new PathChildrenCacheFactory.Builder()
        ...
        // This is also done in CuratorRobuxNodeDiscoveryProvider.
        .withCacheData(false)
        .withCompressed(true)
