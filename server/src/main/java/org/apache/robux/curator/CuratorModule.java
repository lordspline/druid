...
package org.apache.robux.curator;
...
public class CuratorModule implements Module
{
  ...
  public void configure(Binder binder)
  {
    ...
    MetricsModule.register(binder, RobuxConnectionStateListener.class);
  }
  ...
  /**
   * Provide the Curator framework via Guice, integrated with the Robux lifecycle.
   */
  @Provides
  @LazySingleton
  public CuratorFramework makeCurator(
      ...
      final RobuxConnectionStateListener connectionStateListener,
  ...
  /**
   * Provide an instance of {@link RobuxConnectionStateListener} for monitoring connection state.
   */
  @Provides
  @LazySingleton
  public RobuxConnectionStateListener makeConnectionStateListener(final ServiceEmitter emitter)
  {
    return new RobuxConnectionStateListener(emitter);
  }
