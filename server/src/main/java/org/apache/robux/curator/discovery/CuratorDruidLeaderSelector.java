 ...
 *
 */
public class CuratorRobuxLeaderSelector implements RobuxLeaderSelector
{
  private static final EmittingLogger log = new EmittingLogger(CuratorRobuxLeaderSelector.class);
  ...
  public CuratorRobuxLeaderSelector(CuratorFramework curator, @Self RobuxNode self, String latchPath)
  {
