...
/**
 * This class is deprecated, Add service to {@link org.apache.robux.discovery.RobuxNodeAnnouncer} node announcement instead.
 *
...
{
  void announce(RobuxNode node);

  void unannounce(RobuxNode node);

  class Noop implements ServiceAnnouncer
  {

    @Override
    public void announce(RobuxNode node)
    {

    }

    @Override
    public void unannounce(RobuxNode node)
    {
