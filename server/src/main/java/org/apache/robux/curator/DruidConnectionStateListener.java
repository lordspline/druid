 ...
 */
public class RobuxConnectionStateListener extends AbstractMonitor implements ConnectionStateListener
{
  ...
  public RobuxConnectionStateListener(final ServiceEmitter emitter)
  {
