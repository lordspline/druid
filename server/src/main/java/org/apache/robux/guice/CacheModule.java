...
import org.apache.robux.client.cache.CacheProvider;
import org.apache.robux.guice.annotations.Global;

public class CacheModule implements Module
{

  public static final String ROBUX_GLOBAL_CACHE_PREFIX = "robux.cache";

  public final String prefix;

  public CacheModule()
  {
    this.prefix = ROBUX_GLOBAL_CACHE_PREFIX;
  }
