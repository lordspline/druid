...
import org.apache.robux.curator.announcement.PathChildrenAnnouncer;
import org.apache.robux.curator.announcement.ServiceAnnouncer;
import org.apache.robux.guice.annotations.DirectExecutorAnnouncer;
...
import org.apache.robux.server.coordination.DataSegmentAnnouncerProvider;
...
public class AnnouncerModule implements Module
{
  ...
  {
    JsonConfigProvider.bind(binder, "robux.announcer", BatchDataSegmentAnnouncerConfig.class);
    JsonConfigProvider.bind(binder, "robux.announcer", DataSegmentAnnouncerProvider.class);
