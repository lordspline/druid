...
/**
 */
public class LocalDataStorageRobuxModule implements RobuxModule
{
  ...
  private static void bindDeepStorageLocal(Binder binder)
  {
    ...
    JsonConfigProvider.bind(binder, "robux.storage", LocalDataSegmentPusherConfig.class);
  }
  ...
  public List<? extends Module> getJacksonModules()
  {
    return ImmutableList.of(
        new Module()
        {
          ...
          {
            return "RobuxLocalStorage-" + System.identityHashCode(this);
          }
