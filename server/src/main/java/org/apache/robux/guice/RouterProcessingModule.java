 ...
 * thread pools on Router Robux node type. Router needs to inject those resources, because it depends on
 * {@link org.apache.robux.query.QueryToolChest}s, and they couple query type aspects not related to processing and
...
public class RouterProcessingModule implements Module
{
  ...
  @Provides
  @ManageLifecycle
  public QueryProcessingPool getProcessingExecutorPool(RobuxProcessingConfig config)
  {
  ...
  @LazySingleton
  @Merging
  public BlockingPool<ByteBuffer> getMergeBufferPool(RobuxProcessingConfig config)
  {
