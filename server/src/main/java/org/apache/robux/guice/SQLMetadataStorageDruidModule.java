...
import org.apache.robux.server.audit.AuditManagerConfig;
import org.apache.robux.server.audit.AuditSerdeHelper;
import org.apache.robux.server.audit.SQLAuditManager;

public class SQLMetadataStorageRobuxModule implements Module
{
  public static final String PROPERTY = "robux.metadata.storage.type";
  final String type;

  public SQLMetadataStorageRobuxModule(String type)
  {
    this.type = type;
  }
  ...
  {
    JsonConfigProvider.bind(binder, "robux.audit.manager", AuditManagerConfig.class);

    PolyBind.createChoice(
        binder,
        "robux.audit.manager.type",
