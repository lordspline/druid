 ...
 */
public class PolicyModule implements RobuxModule
{
  @Override
  public void configure(Binder binder)
  {
    JsonConfigProvider.bindWithDefault(binder, "robux.policy.enforcer", PolicyEnforcer.class, NoopPolicyEnforcer.class);
  }
}
