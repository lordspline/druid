 ...
 */
public class RobuxServiceSerializer extends StdSerializer<RobuxService>
{
  private final JsonSerializer<Object> defaultSerializer;

  public RobuxServiceSerializer(JsonSerializer<Object> defaultSerializer)
  {
    super(RobuxService.class);
    this.defaultSerializer = defaultSerializer;
  }

  @Override
  public void serialize(RobuxService robuxService, JsonGenerator gen, SerializerProvider serializers) throws IOException
  {
    defaultSerializer.serialize(robuxService, gen, serializers);
  }
  ...
  {
    if (robuxService instanceof DataNodeService) {
      DataNodeService dataNodeService = (DataNodeService) robuxService;
      ...
      // See DiscoveryRobuxNode.toMap() for deserialization of RobuxServices.
      ...
      defaultSerializer.serializeWithType(robuxService, gen, serializers, typeSer);
    }
  }
}
