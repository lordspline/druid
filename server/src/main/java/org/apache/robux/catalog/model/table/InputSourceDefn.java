...
/**
 * Metadata definition for one Robux input source.
 * <p>
 * This class models the merger of a catalog definition (where the input source is stored
 * as serialized JSON), and table function parameters to produce a Robux input source.
...
public interface InputSourceDefn
{
   ...
   *
   * @throws org.apache.robux.java.util.common.IAE if the spec
   ...
   *
   * @throws org.apache.robux.java.util.common.IAE if the function arguments
   *         are invalid
   */
   ...
   * @return a fully-defined external table to be handed off to the Calcite planner.
   *
   * @throws org.apache.robux.java.util.common.IAE if the spec properties are invalid,
