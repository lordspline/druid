...
public class ColumnSpec
{
  ...
  /**
   * The data type of the column expressed as a supported Robux type. The data type here must
   * directly match a Robux storage type.
   */
  private final String dataType;

  /**
   * Properties for the column. At present, these are all user and application defined.
   * For example, a UI layer might want to store a display format. Robux may define
