...
import org.apache.robux.catalog.model.ModelProperties.ObjectPropertyDefn;
import org.apache.robux.catalog.model.ModelProperties.PropertyDefn;
 ...
 * The components are derived from those for Robux ingestion: an
 ...
 * Since Robux never ingests the same data twice, the actual external table needs
 ...
 *
 * An external table can be thought of as a "connection", though Robux does not
 ...
 * complete. The spec is a named entry in the Robux catalog</dd>
 * <dt>Complete spec</dt>
 ...
 * <p>
 * Robux's input sources all require formats. However, some sources may not actually
 ...
 * <h4>Extensions</h4>
 *
 * This class is designed to work both with "well known" Robux input sources and formats,
