...
/**
 * Catalog definitions for the Robux input formats. Maps from catalog and SQL
 * functions to the Robux input format implementations.
 */
public class InputFormats
{
   ...
   * {@link org.apache.robux.data.input.impl.FlatTextInputFormat
