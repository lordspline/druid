...
import org.apache.robux.segment.realtime.sink.Committers;
...
public class StreamAppenderatorTest extends InitializedNullHandlingTest
{
  ...
  public void testDelayedDrop() throws Exception
  {
    ...
    try (
      ...
      // Query1: 2000/2001
      final TimeseriesQuery query1 = Robuxs.newTimeseriesQueryBuilder()
  ...
  public void testQueryBySegments_withSegmentVersionUpgrades() throws Exception
  {
    try (
      ...
      final TimeseriesQuery query1 = Robuxs.newTimeseriesQueryBuilder()
                                           ...
                                           .build();
      final TimeseriesQuery query1_B = Robuxs.newTimeseriesQueryBuilder()
                                           .dataSource(StreamAppenderatorTester.DATASOURCE)
                                           .aggregators(
                                               Arrays.asList(
                                                   new LongSumAggregatorFactory("count", "count"),
                                           ...
                                           .build();
      final TimeseriesQuery query1_C = Robuxs.newTimeseriesQueryBuilder()
                                           .dataSource(StreamAppenderatorTester.DATASOURCE)
                                           .aggregators(
                                               Arrays.asList(
                                                   new LongSumAggregatorFactory("count", "count"),
      ...
      final TimeseriesQuery query2 = Robuxs.newTimeseriesQueryBuilder()
                                           .dataSource(StreamAppenderatorTester.DATASOURCE)
                                           .aggregators(
                                               Arrays.asList(
                                                   new LongSumAggregatorFactory("count", "count"),
                                           ...
                                           .build();
      final TimeseriesQuery query2_B = Robuxs.newTimeseriesQueryBuilder()
                                           .dataSource(StreamAppenderatorTester.DATASOURCE)
                                           .aggregators(
                                               Arrays.asList(
                                                   new LongSumAggregatorFactory("count", "count"),
                                           ...
                                           .build();
      final TimeseriesQuery query2_C = Robuxs.newTimeseriesQueryBuilder()
                                           .dataSource(StreamAppenderatorTester.DATASOURCE)
                                           .aggregators(
                                               Arrays.asList(
                                                   new LongSumAggregatorFactory("count", "count"),
      ...
      final TimeseriesQuery query3 = Robuxs.newTimeseriesQueryBuilder()
                                           .dataSource(StreamAppenderatorTester.DATASOURCE)
                                           .aggregators(
                                               Arrays.asList(
                                                   new LongSumAggregatorFactory("count", "count"),
                                           ...
                                           .build();
      final TimeseriesQuery query3_B = Robuxs.newTimeseriesQueryBuilder()
                                           .dataSource(StreamAppenderatorTester.DATASOURCE)
                                           .aggregators(
                                               Arrays.asList(
                                                   new LongSumAggregatorFactory("count", "count"),
                                           ...
                                           .build();
      final TimeseriesQuery query3_C = Robuxs.newTimeseriesQueryBuilder()
                                           .dataSource(StreamAppenderatorTester.DATASOURCE)
                                           .aggregators(
                                               Arrays.asList(
                                                   new LongSumAggregatorFactory("count", "count"),
      ...
      final ScanQuery query4 = Robuxs.newScanQueryBuilder()
                                     .dataSource(StreamAppenderatorTester.DATASOURCE)
                                     .intervals(
                                         new MultipleSpecificSegmentSpec(
                                             ImmutableList.of(
                                     ...
                                     .build();
      final ScanQuery query4_B = Robuxs.newScanQueryBuilder()
                                     .dataSource(StreamAppenderatorTester.DATASOURCE)
                                     .intervals(
                                         new MultipleSpecificSegmentSpec(
                                             ImmutableList.of(
                                     ...
                                     .resultFormat(ScanQuery.ResultFormat.RESULT_FORMAT_COMPACTED_LIST)
                                     .build();
      final ScanQuery query4_C = Robuxs.newScanQueryBuilder()
                                     .dataSource(StreamAppenderatorTester.DATASOURCE)
                                     .intervals(
                                         new MultipleSpecificSegmentSpec(
                                             ImmutableList.of(
  ...
  public void testQueryByIntervals_withSegmentVersionUpgrades() throws Exception
  {
    try (
      ...
      final TimeseriesQuery query4 = Robuxs.newTimeseriesQueryBuilder()
                                           .dataSource(StreamAppenderatorTester.DATASOURCE)
                                           .intervals(
                                               ImmutableList.of(
