...
public class StorageLocationSelectorStrategyTest
{
  ...
  {
    //no robux.segmentCache.locationSelector.strategy specified, the default will be used
    final Properties props = new Properties();
    props.setProperty("robux.segmentCache.locations", "[{\"path\": \"/tmp/robux/indexCache\"}]");
    ...
    Assert.assertEquals(LeastBytesUsedStorageLocationSelectorStrategy.class,
                        strategy.getClass());
    Assert.assertEquals("/tmp/robux/indexCache", strategy.getLocations().next().getPath().getAbsolutePath());
  }
  ...
  public void testRoundRobinSelectorStrategyConfig()
  {
    final Properties props = new Properties();
    props.setProperty("robux.segmentCache.locations", "[{\"path\": \"/tmp/robux/indexCache\"}]");
    props.setProperty("robux.segmentCache.locationSelector.strategy", "roundRobin");
  ...
  public void testLeastBytesUsedSelectorStrategyConfig()
  {
    final Properties props = new Properties();
    props.setProperty("robux.segmentCache.locations", "[{\"path\": \"/tmp/robux/indexCache\"}]");
    props.setProperty("robux.segmentCache.locationSelector.strategy", "leastBytesUsed");
  ...
  public void testRandomSelectorStrategyConfig()
  {
    final Properties props = new Properties();
    props.setProperty("robux.segmentCache.locations", "[{\"path\": \"/tmp/robux/indexCache\"}]");
    props.setProperty("robux.segmentCache.locationSelector.strategy", "random");
  ...
  {
    final Properties props = new Properties();
    props.setProperty("robux.segmentCache.locationSelector.strategy", "mostAvailableSize");
    props.setProperty("robux.segmentCache.locations", "[{\"path\": \"/tmp/robux/indexCache\"}]");
