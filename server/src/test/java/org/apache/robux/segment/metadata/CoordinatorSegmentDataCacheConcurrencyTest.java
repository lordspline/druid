...
public class CoordinatorSegmentDataCacheConcurrencyTest extends SegmentMetadataCacheTestBase
{
  ...
  public void setUp() throws Exception
  {
    ...
    serverView.registerTimelineCallback(
        Execs.singleThreaded("ServerViewInit-RobuxSchemaConcurrencyTest-%d"),
        new TimelineServerView.TimelineCallback()
        {
          ...
          @Override
          public CallbackAction serverSegmentRemoved(RobuxServerMetadata server, DataSegment segment)
          {
            return null;
          }
  ...
  private static class TestCoordinatorServerView extends CoordinatorServerView
  {
    public TestCoordinatorServerView(
        ...
        @Nullable DirectRobuxClientFactory robuxClientFactory
    )
    {
      super(baseView, segmentWatcherConfig, emitter, robuxClientFactory);
    }
