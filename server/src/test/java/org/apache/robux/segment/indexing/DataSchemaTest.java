...
package org.apache.robux.segment.indexing;
...
import org.apache.robux.common.utils.IdUtilsTest;
...
public class DataSchemaTest extends InitializedNullHandlingTest
{
  ...
  public void testSerdeWithInvalidParserMap() throws Exception
  {
    ...
    expectedException.expectMessage(
        "Cannot construct instance of `org.apache.robux.data.input.impl.StringInputRowParser`, problem: parseSpec"
    );
  ...
  public void testEmptyDatasource()
  {
    ...
    RobuxExceptionMatcher.ThrowingSupplier thrower =
        () -> DataSchema.builder()
                        .withDataSource("")
                        .withParserMap(parser)
                        .withAggregators(
  ...
  public void testInvalidWhitespaceDatasource()
  {
    ...
    for (Map.Entry<String, String> entry : invalidCharToDataSourceName.entrySet()) {
      ...
      RobuxExceptionMatcher.invalidInput().expectMessageIs(msg).assertThrowsAndMatches(
          () -> DataSchema.builder()
