...
/**
 */
public class CuratorRobuxLeaderSelectorTest extends CuratorTestBase
{
  private static final Logger logger = new Logger(CuratorRobuxLeaderSelectorTest.class);
  ...
  public void testSimple() throws Exception
  {
    ...
    CuratorRobuxLeaderSelector leaderSelector1 = new CuratorRobuxLeaderSelector(
        curator,
    ...
    CuratorRobuxLeaderSelector leaderSelector2 = new CuratorRobuxLeaderSelector(
        curator,
    ...
    CuratorRobuxLeaderSelector leaderSelector3 = new CuratorRobuxLeaderSelector(
        curator,
  ...
  public void test_becomeLeader_triggersCleanup_onFailure() throws InterruptedException
  {
    ...
    final CuratorRobuxLeaderSelector leaderSelector = new CuratorRobuxLeaderSelector(
        curator,
        new RobuxNode("s1", "h1", false, 8080, null, true, false),
        "/testLatchPath"
    );
