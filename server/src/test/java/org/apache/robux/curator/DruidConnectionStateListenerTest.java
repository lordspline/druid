...
public class RobuxConnectionStateListenerTest
{
  private StubServiceEmitter emitter;
  private RobuxConnectionStateListener listener;

  @Before
  public void setUp()
  {
    emitter = new StubServiceEmitter("RobuxConnectionStateListenerTest", "localhost");
    listener = new RobuxConnectionStateListener(emitter);
  }
