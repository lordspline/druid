...
public final class CuratorModuleTest
{
  ...
  @Ignore("Verifies changes in https://github.com/apache/robux/pull/8458, but overkill for regular testing")
  @Test
  public void ignoresDeprecatedCuratorConfigProperties()
  {
    Properties props = new Properties();
    String deprecatedPropName = CuratorConfig.CONFIG_PREFIX + ".terminateRobuxProcessOnConnectFail";
