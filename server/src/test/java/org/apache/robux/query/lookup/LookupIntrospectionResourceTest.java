...
import org.apache.robux.server.WebserverTestUtils;
...
public class LookupIntrospectionResourceTest
{
  ...
  public void testGetKey()
  {
    ...
    ClientResponse resp = service.path("/robux/v1/lookups/introspect/lookupId1/keys")
  ...
  public void testGetValue()
  {
    ...
    ClientResponse resp = service.path("/robux/v1/lookups/introspect/lookupId1/values")
                                 .accept(MediaType.APPLICATION_JSON)
                                 .get(ClientResponse.class);
    String s = resp.getEntity(String.class);
  ...
  public void testGetMap()
  {
    ...
    ClientResponse resp = service.path("/robux/v1/lookups/introspect/lookupId1/")
                                 .accept(MediaType.APPLICATION_JSON)
                                 .get(ClientResponse.class);
    String s = resp.getEntity(String.class);
