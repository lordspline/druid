...
public class LocatedSegmentDescriptorSerdeTest
{
  ...
  public void testDimensionsSpecSerde() throws Exception
  {
    LocatedSegmentDescriptor expected = new LocatedSegmentDescriptor(
        ...
        65535,
        Arrays.asList(
            new RobuxServerMetadata("server1", "host1", null, 30000L, ServerType.HISTORICAL, "tier1", 0),
            new RobuxServerMetadata("server2", "host2", null, 40000L, ServerType.HISTORICAL, "tier1", 1),
            new RobuxServerMetadata("server3", "host3", null, 50000L, ServerType.REALTIME, "tier2", 2)
        )
    );
