 ...
 * {@link CachingClusteredClient}. In this class, each {@link RobuxServer} serves one segment
...
public abstract class QueryRunnerBasedOnClusteredClientTestBase
{
  ...
  protected List<RobuxServer> servers;
  ...
  protected void addServer(RobuxServer server, DataSegment dataSegment, QueryableIndex queryableIndex)
  {
  ...
  {
    return Robuxs.newTimeseriesQueryBuilder()
                 ...
                 .context(
                     ImmutableMap.of(
                         DirectRobuxClient.QUERY_FAIL_TIME,
