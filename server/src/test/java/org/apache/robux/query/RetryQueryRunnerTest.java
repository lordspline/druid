...
import org.apache.robux.client.SimpleServerView;
import org.apache.robux.client.TestHttpClient.SimpleServerManager;
...
import org.apache.robux.segment.SegmentMissingException;
...
public class RetryQueryRunnerTest extends QueryRunnerBasedOnClusteredClientTestBase
{
  ...
  /**
   * Drops a segment from the RobuxServer. This method doesn't update the server view, but the server will stop
   * serving queries for the dropped segment.
   */
  private NonnullPair<DataSegment, QueryableIndex> dropSegmentFromServer(RobuxServer fromServer)
  {
  ...
  /**
   * Drops a segment from the RobuxServer and update the server view.
   */
  private NonnullPair<DataSegment, QueryableIndex> unannounceSegmentFromServer(RobuxServer fromServer)
  {
   ...
   */
  private void dropSegmentFromServerAndAddNewServerForSegment(RobuxServer fromServer)
  {
