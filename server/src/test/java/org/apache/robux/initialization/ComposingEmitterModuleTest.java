...
import org.apache.robux.server.emitter.ComposingEmitterConfig;
import org.apache.robux.server.emitter.ComposingEmitterModule;
    ...
    Injector injector = Guice.createInjector(
        ...
        new Module()
        {
          ...
          public void configure(Binder binder)
          {
            ...
            props.put("robux.emitter.composing.emitters", "[\"" + testEmitterType + "\"]");
