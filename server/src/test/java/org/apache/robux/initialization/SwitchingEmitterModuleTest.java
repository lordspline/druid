...
import org.apache.robux.server.emitter.SwitchingEmitterConfig;
import org.apache.robux.server.emitter.SwitchingEmitterModule;
    ...
    Injector injector = Guice.createInjector(
        ...
        new Module()
        {
          ...
          public void configure(Binder binder)
          {
            ...
            props.put("robux.emitter.switching.defaultEmitters", defaultEmittersValue);
            props.put("robux.emitter.switching.emitters", emittersValue);
