...
import org.apache.robux.server.log.EmittingRequestLogger;
...
public class QueryableModuleTest
{
  ...
  public void testGetEmitterRequestLoggerProvider()
  {
    ...
    properties.setProperty("robux.request.logging.type", "emitter");
    properties.setProperty("robux.request.logging.feed", "requestlog");
