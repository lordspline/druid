...
public class RobuxInjectorBuilderTest
{
  ...
  private static class MockRobuxModule implements RobuxModule
  {
    @Inject
    public Properties properties;
  ...
  private static class MockRoleModule extends MockRobuxModule
  {
  }
  ...
  public void testAddInputModules() throws IOException
  {
    ...
    MockRobuxModule robuxModule = new MockRobuxModule();
    Injector injector = new CoreInjectorBuilder(
        new StartupInjectorBuilder()
          .forTests()
          .withProperties(props)
  ...
  private void verifyInjector(Injector injector) throws IOException
  {
    ...
    // And that the Robux module set up Jackson.
  ...
  public void testAddInputClasses() throws IOException
  {
    ...
    Injector injector = new CoreInjectorBuilder(
        ...
        .addInput(MockRobuxModule.class)
        .build();
  ...
  {
    RobuxInjectorBuilder builder = new CoreInjectorBuilder(
        new StartupInjectorBuilder()
          .forTests()
          .withEmptyProperties()
          .build()
  ...
  public void testAddModules() throws IOException
  {
    Injector injector = new CoreInjectorBuilder(
        ...
        .addModules(new MockGuiceModule(), new MockRobuxModule())
        .build();
  ...
  public void testAddAll() throws IOException
  {
    Injector injector = new CoreInjectorBuilder(
        ...
        .addAll(Arrays.asList(new MockGuiceModule(), new MockRobuxModule()))
        .build();
  ...
  {
    Properties props = new Properties();
    props.put(ModulesConfig.PROPERTY_BASE + ".excludeList", "[\"" + MockRobuxModule.class.getName() + "\"]");
    Injector injector = new CoreInjectorBuilder(
        new StartupInjectorBuilder()
          .withExtensions()
          .withProperties(props)
