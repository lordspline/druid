    ...
    extends JsonConfigTesterBase<JsonConfigTesterBaseTest.Sample>
{
  ...
  {
    Assert.assertEquals("0", testProperties.getProperty("robux.test.prefix.primitiveInt"));
    Assert.assertEquals("false", testProperties.getProperty("robux.test.prefix.primitiveBoolean"));
    Assert.assertTrue(!testProperties.getProperty("robux.test.prefix.text").isEmpty());
    Assert.assertEquals("[]", testProperties.getProperty("robux.test.prefix.list"));
    Assert.assertEquals("[]", testProperties.getProperty("robux.test.prefix.set"));
    Assert.assertEquals("{}", testProperties.getProperty("robux.test.prefix.map"));
