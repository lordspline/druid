...
import org.apache.robux.client.indexing.IndexingWorker;
...
import org.apache.robux.indexer.report.KillTaskReport;
...
import org.apache.robux.server.compaction.NewestSegmentFirstPolicy;
...
public class OverlordClientImplTest
{
  ...
  public void test_findCurrentLeader() throws Exception
  {
    serviceClient.expectAndRespond(
        new RequestBuilder(HttpMethod.GET, "/robux/indexer/v1/leader"),
  ...
  {
    serviceClient.expectAndRespond(
        new RequestBuilder(HttpMethod.GET, "/robux/indexer/v1/tasks"),
        HttpResponseStatus.OK,
        ImmutableMap.of(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON),
  ...
  {
    serviceClient.expectAndRespond(
        new RequestBuilder(HttpMethod.GET, "/robux/indexer/v1/tasks?state=RUNNING"),
        HttpResponseStatus.OK,
        ImmutableMap.of(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON),
        jsonMapper.writeValueAsBytes(STATUSES)
    );
  ...
  {
    serviceClient.expectAndRespond(
        new RequestBuilder(HttpMethod.GET, "/robux/indexer/v1/tasks?state=RUNNING&datasource=foo"),
        HttpResponseStatus.OK,
        ImmutableMap.of(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON),
        jsonMapper.writeValueAsBytes(STATUSES)
    );
  ...
  {
    serviceClient.expectAndRespond(
        new RequestBuilder(HttpMethod.GET, "/robux/indexer/v1/tasks?datasource=foo"),
        HttpResponseStatus.OK,
        ImmutableMap.of(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON),
        jsonMapper.writeValueAsBytes(STATUSES)
    );
  ...
  public void test_taskStatuses_RUNNING_foo_zero() throws Exception
  {
    serviceClient.expectAndRespond(
        new RequestBuilder(
            HttpMethod.GET,
            "/robux/indexer/v1/tasks?state=RUNNING&datasource=foo%3F&max=0"
        ),
        HttpResponseStatus.OK,
        ImmutableMap.of(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON),
        jsonMapper.writeValueAsBytes(STATUSES)
  ...
  public void test_findLockedIntervals() throws Exception
  {
    ...
    serviceClient.expectAndRespond(
        new RequestBuilder(HttpMethod.POST, "/robux/indexer/v1/lockedIntervals/v2")
  ...
  public void test_postSupervisor() throws Exception
  {
    ...
    serviceClient.expectAndRespond(
        new RequestBuilder(HttpMethod.POST, "/robux/indexer/v1/supervisor?skipRestartIfUnmodified=true")
  ...
  public void test_supervisorStatuses() throws Exception
  {
    ...
    serviceClient.expectAndRespond(
        new RequestBuilder(HttpMethod.GET, "/robux/indexer/v1/supervisor?system"),
        HttpResponseStatus.OK,
        ImmutableMap.of(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON),
        jsonMapper.writeValueAsBytes(statuses)
    );
  ...
  public void test_taskReportAsMap() throws Exception
  {
    ...
    serviceClient.expectAndRespond(
        new RequestBuilder(HttpMethod.GET, "/robux/indexer/v1/task/testTaskId/reports"),
        HttpResponseStatus.OK,
        ImmutableMap.of(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON),
  ...
  public void test_getTaskReport_empty()
  {
    ...
    serviceClient.expectAndRespond(
        new RequestBuilder(HttpMethod.GET, "/robux/indexer/v1/task/" + taskID + "/reports"),
        HttpResponseStatus.OK,
        Collections.emptyMap(),
        StringUtils.toUtf8("{}")
    );
  ...
  public void test_getTotalWorkerCapacity() throws Exception
  {
    ...
    // Mock response for /robux/indexer/v1/totalWorkerCapacity
    ...
    serviceClient.expectAndRespond(
        new RequestBuilder(HttpMethod.GET, "/robux/indexer/v1/totalWorkerCapacity"),
        HttpResponseStatus.OK,
        Collections.emptyMap(),
  ...
  public void test_getWorkers() throws Exception
  {
    ...
    serviceClient.expectAndRespond(
        new RequestBuilder(HttpMethod.GET, "/robux/indexer/v1/workers"),
        HttpResponseStatus.OK,
        Collections.emptyMap(),
  ...
  public void test_killPendingSegments() throws Exception
  {
    serviceClient.expectAndRespond(
        new RequestBuilder(
            HttpMethod.DELETE,
            "/robux/indexer/v1/pendingSegments/foo?interval=2000-01-01T00%3A00%3A00.000Z%2F2001-01-01T00%3A00%3A00.000Z"
        ),
        HttpResponseStatus.OK,
        Collections.emptyMap(),
  ...
  public void test_taskPayload() throws ExecutionException, InterruptedException, JsonProcessingException
  {
    ...
    serviceClient.expectAndRespond(
        new RequestBuilder(HttpMethod.GET, "/robux/indexer/v1/task/" + taskID),
        HttpResponseStatus.OK,
        Collections.emptyMap(),
  ...
  {
    serviceClient.expectAndRespond(
        new RequestBuilder(HttpMethod.GET, "/robux/indexer/v1/compaction/isSupervisorEnabled"),
        HttpResponseStatus.OK,
        Collections.emptyMap(),
      ...
      throws JsonProcessingException, ExecutionException, InterruptedException
  {
    ...
    serviceClient.expectAndRespond(
        new RequestBuilder(HttpMethod.GET, "/robux/indexer/v1/compaction/config/cluster"),
        HttpResponseStatus.OK,
        Collections.emptyMap(),
      ...
      throws ExecutionException, InterruptedException, JsonProcessingException
  {
    ...
    serviceClient.expectAndRespond(
        new RequestBuilder(HttpMethod.POST, "/robux/indexer/v1/compaction/config/cluster")
  ...
  public void test_markSegmentAsUsed() throws Exception
  {
    ...
    final String url = StringUtils.format(
        "/robux/indexer/v1/datasources/%s/segments/%s",
  ...
  public void test_markNonOvershadowedSegmentsAsUsed_bySegmentIds() throws Exception
  {
    ...
    final String url = StringUtils.format(
        "/robux/indexer/v1/datasources/%s/markUsed",
        TestDataSource.WIKI
    );
  ...
  public void test_markSegmentsAsUnused_bySegmentIds() throws Exception
  {
    ...
    final String url = StringUtils.format(
        "/robux/indexer/v1/datasources/%s/markUnused",
        TestDataSource.WIKI
    );
  ...
  {
    final String url = StringUtils.format(
        "/robux/indexer/v1/datasources/%s",
        TestDataSource.WIKI
    );
