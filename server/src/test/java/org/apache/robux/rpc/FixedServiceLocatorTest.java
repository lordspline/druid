...
{
  public static final RobuxServerMetadata DATA_SERVER_1 = new RobuxServerMetadata(
      "TestDataServer",
      "hostName:9092",
      null,
      2,
  ...
  public static final RobuxServerMetadata DATA_SERVER_2 = new RobuxServerMetadata(
      "TestDataServer",
      "hostName:8083",
      null,
      2,
  ...
  public void test_locate_singleServer() throws ExecutionException, InterruptedException
  {
    FixedServiceLocator serviceLocator =
        new FixedServiceLocator(ServiceLocation.fromRobuxServerMetadata(DATA_SERVER_1));

    Assert.assertEquals(
        ServiceLocations.forLocation(ServiceLocation.fromRobuxServerMetadata(DATA_SERVER_1)),
  ...
  public void test_locate_multipleServers() throws ExecutionException, InterruptedException
  {
    final ServiceLocations locations = ServiceLocations.forLocations(
        ImmutableSet.of(
            ServiceLocation.fromRobuxServerMetadata(DATA_SERVER_1),
            ServiceLocation.fromRobuxServerMetadata(DATA_SERVER_2)
        )
    );
