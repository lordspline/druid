...
public class ServiceLocationTest
{
  ...
  @Test
  public void test_fromRobuxServerMetadata_withPort()
  {
    RobuxServerMetadata robuxServerMetadata = new RobuxServerMetadata(
        "name",
        "hostName:9092",
        null,
        1,
    ...
    Assert.assertEquals(
        ...
        ServiceLocation.fromRobuxServerMetadata(robuxServerMetadata)
    );
  }

  @Test
  public void test_fromRobuxServerMetadata_withTlsPort()
  {
    RobuxServerMetadata robuxServerMetadata = new RobuxServerMetadata(
        "name",
        null,
