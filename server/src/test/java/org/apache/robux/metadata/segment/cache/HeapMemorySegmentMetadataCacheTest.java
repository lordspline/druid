...
package org.apache.robux.metadata.segment.cache;
...
import org.apache.robux.metadata.IndexerSqlMetadataStorageCoordinatorTestBase;
...
public class HeapMemorySegmentMetadataCacheTest
{
  ...
  {
    setupTargetWithCaching(SegmentMetadataCache.UsageMode.ALWAYS);
    RobuxExceptionMatcher.defensive().expectMessageIs(
