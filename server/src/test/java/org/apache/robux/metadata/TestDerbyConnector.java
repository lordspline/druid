...
import org.apache.robux.metadata.storage.derby.DerbyConnector;
...
public class TestDerbyConnector extends DerbyConnector
{
  ...
  )
  {
    this(
        connectorConfig,
        tablesConfig,
        "jdbc:derby:memory:robuxTest" + dbSafeUUID(),
  ...
  public TestDerbyConnector()
  {
    this(
        ...
        MetadataStorageTablesConfig.fromBase("robuxTest" + dbSafeUUID()),
        CentralizedDatasourceSchemaConfig.create()
    );
  }
