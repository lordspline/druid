...
import org.apache.robux.catalog.model.facade.DatasourceFacade.ColumnFacade;
...
public class DatasourceTableTest
{
  ...
  public void testColumns()
  {
    ...
    // Can have a legal scalar type
    {
      ...
      assertSame(ColumnType.STRING, col.robuxType());
    }
  ...
  public void testTimeColumn()
  {
    ...
    // Time column can have no type
    {
      ...
      assertTrue(col.hasType());
      assertSame(ColumnType.LONG, col.robuxType());
    }
