...
import org.apache.robux.java.util.common.guava.TestSequence;
...
import org.apache.robux.server.coordination.ServerManagerTest;
  ...
  public void testGetQueryRunnerForSegments_singleIntervalLargeSegments()
  {
    ...
    timeline.addAll(
        Iterators.transform(dataSegments.iterator(), segment -> {
          ...
          ss.addServerAndUpdateSegment(new QueryableRobuxServer(
              server,
              new MockQueryRunner()
          ), segment);
    ...
    CachingClusteredClient cachingClusteredClient = new CachingClusteredClient(
        ...
        new CacheConfig(),
        Mockito.mock(RobuxHttpClientConfig.class),
