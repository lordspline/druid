...
public class CacheDistributionTest
{
  ...
  public void testDistribution()
  {
    KetamaNodeLocator locator = new KetamaNodeLocator(
        ImmutableList.of(
            dummyNode("robux-cache.0001", 11211),
            dummyNode("robux-cache.0002", 11211),
            dummyNode("robux-cache.0003", 11211),
            dummyNode("robux-cache.0004", 11211),
            dummyNode("robux-cache.0005", 11211)
        ),
        hash,
