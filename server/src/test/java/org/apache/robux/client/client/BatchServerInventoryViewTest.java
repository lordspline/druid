...
import org.apache.robux.server.coordination.BatchDataSegmentAnnouncer;
import org.apache.robux.server.coordination.CuratorDataSegmentServerAnnouncer;
...
import org.apache.robux.server.initialization.BatchDataSegmentAnnouncerConfig;
...
public class BatchServerInventoryViewTest
{
  ...
  public void setUp() throws Exception
  {
    ...
    RobuxServerMetadata serverMetadata = new RobuxServerMetadata(
        "id",
        "host",
        null,
        Long.MAX_VALUE,
    ...
    filteredBatchServerInventoryView = new BatchServerInventoryView(
        ...
        {
          @Override
          public boolean apply(@Nullable Pair<RobuxServerMetadata, DataSegment> input)
          {
    ...
    {
      @Override
      protected RobuxServer addInnerInventory(RobuxServer container, String inventoryKey, Set<DataSegment> inventory)
      {
        RobuxServer server = super.addInnerInventory(container, inventoryKey, inventory);
  ...
  public void testRun() throws Exception
  {
    ...
    RobuxServer server = Iterables.get(batchServerInventoryView.getInventory(), 0);
  ...
  public void testRunWithFilter() throws Exception
  {
    ...
    RobuxServer server = Iterables.get(filteredBatchServerInventoryView.getInventory(), 0);
    Set<DataSegment> segments = Sets.newHashSet(server.iterateAllSegments());
