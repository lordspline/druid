...
public class ReservoirSegmentSamplerTest
{
  ...
  public void testSegmentsOnBrokersAreIgnored()
  {
    ...
    final ServerHolder broker = new ServerHolder(
        new RobuxServer("broker1", "broker1", null, 1000, ServerType.BROKER, null, 1)
  ...
  {
    final RobuxServer server =
        new RobuxServer(serverName, serverName, null, 100000, ServerType.HISTORICAL, "normal", 1);
