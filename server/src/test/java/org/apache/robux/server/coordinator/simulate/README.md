...
The primary test target is the `RobuxCoordinator` itself. The behaviour of the following entities can also be verified
using simulations:
...
public class SimpleSimulationTest extends CoordinatorSimulationBaseTest
{
  ...
  public void testShiftSegmentsToDifferentTier()
  {
    ...
    // Create servers
    RobuxServer historicalTier1 = createHistoricalTier(1, "tier_1", 10000);
    RobuxServer historicalTier2 = createHistoricalTier(1, "tier_2", 20000);
...
See `org.apache.robux.server.coordinator.simulate.SegmentLoadingTest`
