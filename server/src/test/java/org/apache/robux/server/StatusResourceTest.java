...
import org.apache.robux.guice.PropertiesModule;
...
public class StatusResourceTest
{
  ...
  public void testLoadedModules()
  {
    ...
    Collection<RobuxModule> modules = ImmutableList.of(new TestRobuxModule());
  ...
  private void testHiddenPropertiesWithPropertyFileName(String fileName) throws Exception
  {
    ...
    Set<String> hiddenProperties = new ObjectMapper().readValue(
        returnedProperties.get("robux.server.hiddenProperties"),
        new TypeReference<>() {}
    );
