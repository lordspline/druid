...
package org.apache.robux.server.audit;
...
{
  private static final String CONFIG_BASE = "robux.audit.manager";
  ...
  public void testLogAuditConfigWithDefaults()
  {
    ...
    props.setProperty("robux.audit.manager.type", "log");
  ...
  public void testLogAuditConfigWithOverrides()
  {
    ...
    final Properties props = new Properties();
    props.setProperty("robux.audit.manager.type", "log");
    props.setProperty("robux.audit.manager.logLevel", "WARN");
    props.setProperty("robux.audit.manager.auditSystemRequests", "true");
  ...
  public void testSqlAuditConfigWithOverrides()
  {
    ...
    final Properties props = new Properties();
    props.setProperty("robux.audit.manager.type", "sql");
    props.setProperty("robux.audit.manager.skipNullField", "true");
    props.setProperty("robux.audit.manager.maxPayloadSizeBytes", "100");
    props.setProperty("robux.audit.manager.auditHistoryMillis", "1000");
    props.setProperty("robux.audit.manager.includePayloadAsDimensionInMetric", "true");
