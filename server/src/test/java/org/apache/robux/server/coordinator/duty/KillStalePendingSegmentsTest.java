...
public class KillStalePendingSegmentsTest
{
  ...
  {
    RobuxCoordinatorRuntimeParams params = createParamsWithDatasources(TestDataSource.WIKI).build();
    killDuty.run(params);
  ...
  public void testRetentionStarts1DayBeforeLatestCompletedOrEarliestActiveTask()
  {
    ...
    RobuxCoordinatorRuntimeParams params = createParamsWithDatasources(TestDataSource.WIKI, TestDataSource.KOALA).build();
    killDuty.run(params);
  ...
  private RobuxCoordinatorRuntimeParams.Builder createParamsWithDatasources(String... datasources)
  {
    RobuxCoordinatorRuntimeParams.Builder builder = RobuxCoordinatorRuntimeParams.builder();
