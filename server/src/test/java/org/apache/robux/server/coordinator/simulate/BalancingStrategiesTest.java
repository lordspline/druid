...
public class BalancingStrategiesTest extends CoordinatorSimulationBaseTest
{
  ...
  {
    final List<RobuxServer> historicals = new ArrayList<>();
    for (int i = 0; i < 5; i++) {
    ...
    for (RobuxServer historical : historicals) {
  ...
  public void testClusterGetsBalancedWhenServerIsAdded()
  {
    ...
    final RobuxServer newHistorical = createHistorical(4, Tier.T1, SIZE_1TB);
  ...
  public void testClusterGetsBalancedWhenServerIsRemoved()
  {
    ...
    // Remove a historical
    final RobuxServer removedHistorical = historicals.remove(4);
