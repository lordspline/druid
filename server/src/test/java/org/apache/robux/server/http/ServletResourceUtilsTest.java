...
public class ServletResourceUtilsTest
{
  ...
  {
    RobuxException exception = InvalidInput.exception("Invalid value of [%s]", "inputKey");
    ...
    MatcherAssert.assertThat(
        ...
        RobuxExceptionMatcher.invalidInput().expectMessageIs("Invalid value of [inputKey]")
    );
  }
}
