...
public class LookupLoadingSpecTest
{
  ...
  {
    RobuxException exception = Assert.assertThrows(RobuxException.class, () -> LookupLoadingSpec.loadOnly(null));
  ...
  {
    final RobuxException exception = Assert.assertThrows(RobuxException.class, () -> LookupLoadingSpec.createFromContext(
