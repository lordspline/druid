...
{
  private RobuxServer historicalT11;
  private RobuxServer historicalT12;
  private RobuxServer historicalT13;
  private RobuxServer historicalT21;
  private RobuxServer historicalT22;
  ...
  public void testLoadingDoesNotOverassignHistorical()
  {
    ...
    final RobuxServer historicalT11 = createHistorical(1, Tier.T1, 1000);
  ...
  public void testTierShiftDoesNotCauseUnderReplication()
  {
    ...
    final RobuxServer historicalT23 = createHistorical(3, Tier.T2, 10_000);
  ...
  private int getNumLoadedSegments(RobuxServer... servers)
  {
    int numLoaded = 0;
    for (RobuxServer server : servers) {
