...
public class ServerHolderTest
{
  ...
  private static final Map<String, ImmutableRobuxDataSource> DATA_SOURCES = ImmutableMap.of(
      "src1", new ImmutableRobuxDataSource("src1", Collections.emptyMap(), Collections.singletonList(SEGMENTS.get(0))),
      "src2", new ImmutableRobuxDataSource("src2", Collections.emptyMap(), Collections.singletonList(SEGMENTS.get(1)))
  );
  ...
  public void testCompareTo()
  {
    ...
    final ServerHolder h1 = new ServerHolder(
        new ImmutableRobuxServer(
            new RobuxServerMetadata("name1", "host1", null, 100L, ServerType.HISTORICAL, "tier1", 0),
            0L,
    ...
    final ServerHolder h2 = new ServerHolder(
        new ImmutableRobuxServer(
            new RobuxServerMetadata("name1", "host1", null, 200L, ServerType.HISTORICAL, "tier1", 0),
            100L,
            ImmutableMap.of("src1", DATA_SOURCES.get("src1")),
            1
        ),
    ...
    final ServerHolder h3 = new ServerHolder(
        new ImmutableRobuxServer(
            new RobuxServerMetadata("name1", "host1", null, 1000L, ServerType.HISTORICAL, "tier1", 0),
            990L,
            ImmutableMap.of("src1", DATA_SOURCES.get("src1")),
            1
        ),
    ...
    final ServerHolder h4 = new ServerHolder(
        new ImmutableRobuxServer(
            new RobuxServerMetadata("name1", "host1", null, 50L, ServerType.HISTORICAL, "tier1", 0),
            0L,
            ImmutableMap.of("src1", DATA_SOURCES.get("src1")),
            1
        ),
  ...
  public void testEquals()
  {
    ...
    final ServerHolder h2 = new ServerHolder(
        new ImmutableRobuxServer(
            new RobuxServerMetadata("name2", "host1", null, 200L, ServerType.HISTORICAL, "tier1", 0),
            100L,
            ImmutableMap.of("src1", DATA_SOURCES.get("src1")),
            1
        ),
    ...
    final ServerHolder h3 = new ServerHolder(
        new ImmutableRobuxServer(
            new RobuxServerMetadata("name1", "host2", null, 200L, ServerType.HISTORICAL, "tier1", 0),
            100L,
            ImmutableMap.of("src1", DATA_SOURCES.get("src1")),
            1
        ),
    ...
    final ServerHolder h4 = new ServerHolder(
        new ImmutableRobuxServer(
            new RobuxServerMetadata("name1", "host1", null, 200L, ServerType.HISTORICAL, "tier2", 0),
            100L,
            ImmutableMap.of("src1", DATA_SOURCES.get("src1")),
            1
        ),
    ...
    final ServerHolder h5 = new ServerHolder(
        new ImmutableRobuxServer(
            new RobuxServerMetadata("name1", "host1", null, 100L, ServerType.REALTIME, "tier1", 0),
            0L,
            ImmutableMap.of("src1", DATA_SOURCES.get("src1")),
            1
        ),
