...
public class BroadcastDatasourceLoadingSpecTest
{
  ...
  {
    RobuxException exception = Assert.assertThrows(RobuxException.class, () -> BroadcastDatasourceLoadingSpec.loadOnly(null));
  ...
  {
    final RobuxException exception = Assert.assertThrows(RobuxException.class, () -> BroadcastDatasourceLoadingSpec.createFromContext(
  ...
  {
    final RobuxException exception = Assert.assertThrows(RobuxException.class, () ->
        BroadcastDatasourceLoadingSpec.createFromContext(
            ImmutableMap.of(
