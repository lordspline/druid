...
public class BalanceSegmentsTest
{
  ...
  private RobuxServer server1;
  private RobuxServer server2;
  private RobuxServer server3;
  private RobuxServer server4;
  ...
  public void setUp()
  {
    ...
    server1 = new RobuxServer("server1", "server1", null, 100L, ServerType.HISTORICAL, "normal", 0);
    server2 = new RobuxServer("server2", "server2", null, 100L, ServerType.HISTORICAL, "normal", 0);
    server3 = new RobuxServer("server3", "server3", null, 100L, ServerType.HISTORICAL, "normal", 0);
    server4 = new RobuxServer("server4", "server4", null, 100L, ServerType.HISTORICAL, "normal", 0);
  ...
  public void testMoveFromDecommissioningServer()
  {
    ...
    RobuxCoordinatorRuntimeParams params = defaultRuntimeParamsBuilder(decommissioningServer, activeServer)
        .withDynamicConfigs(
            CoordinatorDynamicConfig.builder()
                                    .withSmartSegmentLoading(false)
  ...
  public void testRun1()
  {
    ...
    RobuxCoordinatorRuntimeParams params = defaultRuntimeParamsBuilder(
  ...
  private CoordinatorRunStats runBalancer(RobuxCoordinatorRuntimeParams params)
  {
  ...
  private RobuxCoordinatorRuntimeParams.Builder defaultRuntimeParamsBuilder(
      ServerHolder... servers
  )
  {
    return RobuxCoordinatorRuntimeParams
        .builder()
        .withRobuxCluster(RobuxCluster.builder().addTier("normal", servers).build())
  ...
  private ServerHolder createHolder(RobuxServer server, DataSegment... loadedSegments)
  {
    return createHolder(server, false, loadedSegments);
  }

  private ServerHolder createHolder(RobuxServer server, boolean isDecommissioning, DataSegment... loadedSegments)
  {
