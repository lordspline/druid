...
public abstract class BaseJettyTest
{
  ...
  {
    System.setProperty("robux.server.http.numThreads", "20");
    System.setProperty("robux.server.http.maxIdleTime", "PT1S");
    System.setProperty("robux.global.http.readTimeout", "PT1S");
  }
  ...
  public static class ClientHolder
  {
    ...
    {
      final Lifecycle robuxLifecycle = new Lifecycle();
