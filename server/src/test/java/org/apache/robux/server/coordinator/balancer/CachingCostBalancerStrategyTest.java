...
public class CachingCostBalancerStrategyTest
{
  ...
  {
    RobuxServer robuxServer = new RobuxServer(name, host, null, maxSize, ServerType.HISTORICAL, "normal", 0);
    createDataSegments(numberOfSegments, random, referenceTime)
        .forEach(robuxServer::addDataSegment);
    return new ServerHolder(
        robuxServer.toImmutableRobuxServer(),
