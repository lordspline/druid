...
import org.apache.robux.client.SegmentServerSelector;
...
import org.apache.robux.query.context.ResponseContext.Keys;
...
/**
 * Mimics the behavior of {@link org.apache.robux.client.CachingClusteredClient} when it queries data servers (like
 * Historicals, which use {@link org.apache.robux.server.coordination.ServerManager}). Used by {@link QueryStackTests}.
 *
...
public class TestClusterQuerySegmentWalker implements QuerySegmentWalker
{
  ...
  public <T> QueryRunner<T> getQueryRunnerForSegments(final Query<T> query, final Iterable<SegmentDescriptor> specs)
  {
    ...
    // the LocalQuerySegmentWalker constructor instead since this walker does not mimic remote RobuxServer objects
