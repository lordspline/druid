...
package org.apache.robux.server.coordination;
...
import org.apache.robux.client.cache.LocalCacheProvider;
...
import org.apache.robux.query.NoopQueryRunner;
...
import org.apache.robux.segment.TestSegmentUtils;
import org.apache.robux.segment.TestSegmentUtils.SegmentForTesting;
...
import org.apache.robux.test.utils.TestSegmentCacheManager;
...
public class ServerManagerTest
{
  ...
  public void testGetQueryRunnerForSegments_forUnknownQueryThrowingException()
  {
    ...
    Query<?> query = Robuxs.newTimeBoundaryQueryBuilder()
                           .dataSource("test")
  ...
  )
  {
    ...
    return searchQuery(new QueryDataSource(Robuxs.newTimeseriesQueryBuilder()
  ...
  {
    return Robuxs.newSearchQueryBuilder()
                 .dataSource(datasource)
