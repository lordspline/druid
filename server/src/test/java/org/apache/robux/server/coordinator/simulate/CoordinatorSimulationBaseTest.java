...
import org.apache.robux.server.coordinator.rules.ForeverDropRule;
    ...
    MetricsVerifier
{
  ...
  static Map<String, Object> filterByServer(RobuxServer server)
  {
   ...
   */
  static RobuxServer createHistorical(int uniqueIdInTier, String tier, long serverSizeMb)
  {
    final String name = tier + "__" + "hist__" + uniqueIdInTier;
    return new RobuxServer(name, name, name, serverSizeMb << 20, ServerType.HISTORICAL, tier, 1);
  }
