...
import org.apache.robux.audit.AuditInfo;
...
import org.apache.robux.java.util.common.concurrent.DirectExecutorService;
...
import org.apache.robux.java.util.metrics.MetricsVerifier;
...
import org.apache.robux.server.coordinator.MetadataManager;
import org.apache.robux.server.coordinator.balancer.BalancerStrategyFactory;
import org.apache.robux.server.coordinator.balancer.CachingCostBalancerStrategyConfig;
import org.apache.robux.server.coordinator.balancer.CachingCostBalancerStrategyFactory;
import org.apache.robux.server.coordinator.balancer.CostBalancerStrategyFactory;
import org.apache.robux.server.coordinator.balancer.DiskNormalizedCostBalancerStrategyFactory;
import org.apache.robux.server.coordinator.balancer.RandomBalancerStrategyFactory;
...
public class CoordinatorSimulationBuilder
{
  ...
  private List<RobuxServer> servers;
  ...
  public CoordinatorSimulationBuilder withServers(List<RobuxServer> servers)
  {
    this.servers = servers;
    return this;
  }

  public CoordinatorSimulationBuilder withServers(RobuxServer... servers)
  {
  ...
  public CoordinatorSimulation build()
  {
    ...
    final RobuxCoordinator coordinator = new RobuxCoordinator(
      ...
      CoordinatorSimulation.CoordinatorState, CoordinatorSimulation.ClusterState
  {
    ...
    private SimulationImpl(RobuxCoordinator coordinator, Environment env)
    {
      this.env = env;
    ...
    @Override
    public RobuxServer getInventoryView(String serverName)
    {
  ...
  private static class Environment
  {
    ...
    private final AtomicReference<CoordinatorDynamicConfig> dynamicConfig
        = new AtomicReference<>();
    private final TestRobuxLeaderSelector leaderSelector
    ...
    private final RobuxCoordinatorConfig coordinatorConfig;
    ...
    )
    {
      ...
      this.coordinatorConfig = new RobuxCoordinatorConfig(
    ...
    private JacksonConfigManager mockConfigManager()
    {
      ...
      EasyMock.expect(
          jacksonConfigManager.watch(
              ...
              EasyMock.eq(RobuxCompactionConfig.class),
              EasyMock.anyObject()
          )
