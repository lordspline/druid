...
public class ForeverLoadRuleTest
{
  ...
  public void testSerde() throws Exception
  {
    ...
    Assert.assertEquals(ImmutableMap.of(RobuxServer.DEFAULT_TIER, RobuxServer.DEFAULT_NUM_REPLICANTS), rule.getTieredReplicants());
  }
  ...
  public void testShouldCreateDefaultTier() throws Exception
  {
    ...
    Assert.assertEquals(ImmutableMap.of(RobuxServer.DEFAULT_TIER, RobuxServer.DEFAULT_NUM_REPLICANTS), inputForeverLoadRule.getTieredReplicants());
  }
