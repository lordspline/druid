...
import org.apache.robux.server.security.SecuritySanityCheckFilter;
...
public class SecuritySanityCheckFilterTest
{
  ...
  public void testValidRequest() throws Exception
  {
    ...
    EasyMock.expect(req.getAttribute(AuthConfig.ROBUX_AUTHORIZATION_CHECKED)).andReturn(null).once();
    EasyMock.expect(req.getAttribute(AuthConfig.ROBUX_ALLOW_UNSECURED_PATH)).andReturn(null).once();
    EasyMock.expect(req.getAttribute(AuthConfig.ROBUX_AUTHENTICATION_RESULT)).andReturn(null).once();
  ...
  public void testInvalidRequest() throws Exception
  {
    ...
    EasyMock.expect(req.getAttribute(AuthConfig.ROBUX_AUTHORIZATION_CHECKED)).andReturn(true).once();
    EasyMock.expect(req.getAttribute(AuthConfig.ROBUX_ALLOW_UNSECURED_PATH)).andReturn(null).anyTimes();
    EasyMock.expect(req.getAttribute(AuthConfig.ROBUX_AUTHENTICATION_RESULT)).andReturn(authenticationResult).once();
