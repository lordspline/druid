...
public class RobuxCompactionConfigTest
{
  ...
  {
    final RobuxCompactionConfig defaultConfig = RobuxCompactionConfig.empty();
    final String json = MAPPER.writeValueAsString(defaultConfig);

    RobuxCompactionConfig deserialized = MAPPER.readValue(json, RobuxCompactionConfig.class);
  ...
  {
    final RobuxCompactionConfig config = new RobuxCompactionConfig(
        Arrays.asList(
  ...
  {
    final RobuxCompactionConfig config = RobuxCompactionConfig.empty();
    ...
    final RobuxCompactionConfig copy = config.withClusterConfig(clusterConfig);
  ...
  public void testCopyWithDatasourceConfigs()
  {
    ...
    final DataSourceCompactionConfig dataSourceConfig = InlineSchemaDataSourceCompactionConfig
        ...
        .build();
    final RobuxCompactionConfig copy
