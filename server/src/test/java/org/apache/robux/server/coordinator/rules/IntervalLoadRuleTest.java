...
public class IntervalLoadRuleTest
{
  ...
  public void testSerde() throws Exception
  {
    IntervalLoadRule rule = new IntervalLoadRule(
        Intervals.of("0/3000"),
        ImmutableMap.of(RobuxServer.DEFAULT_TIER, 2),
        null
    );
  ...
  public void testShouldCreateDefaultTier() throws Exception
  {
    ...
    Assert.assertEquals(ImmutableMap.of(RobuxServer.DEFAULT_TIER, RobuxServer.DEFAULT_NUM_REPLICANTS), inputIntervalLoadRule.getTieredReplicants());
  }
