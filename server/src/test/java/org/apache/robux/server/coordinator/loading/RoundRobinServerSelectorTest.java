...
public class RoundRobinServerSelectorTest
{
  ...
  public void testSingleIterator()
  {
    ...
    RobuxCluster cluster = RobuxCluster
        .builder()
  ...
  {
    RobuxCluster cluster = RobuxCluster.builder().addTier(TIER).build();
    final RoundRobinServerSelector selector = new RoundRobinServerSelector(cluster);
  ...
  {
    RobuxCluster cluster = RobuxCluster.builder().addTier(
        TIER,
  ...
  private ServerHolder createHistorical(String name, long size)
  {
    return new ServerHolder(
        new RobuxServer(name, name, null, size, ServerType.HISTORICAL, TIER, 1)
