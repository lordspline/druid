...
public class AsyncManagementForwardingServletTest extends BaseJettyTest
{
  ...
  {
    COORDINATOR_EXPECTED_REQUEST.path = "/robux/coordinator/v1/datasources";
  ...
  {
    COORDINATOR_EXPECTED_REQUEST.path = "/robux/coordinator/v1/loadstatus";
  ...
  {
    COORDINATOR_EXPECTED_REQUEST.path = "/robux/coordinator/v1/datasources/myDatasource";
  ...
  {
    COORDINATOR_EXPECTED_REQUEST.path = "/robux/coordinator/v1/datasources/myDatasource/intervals/2016-06-27_2016-06-28";
  ...
  {
    COORDINATOR_EXPECTED_REQUEST.path = "/robux/coordinator/v1/metadata/datasources/myDatasource/segments";
    COORDINATOR_EXPECTED_REQUEST.method = "POST";
    COORDINATOR_EXPECTED_REQUEST.headers = ImmutableMap.of("Authorization", "Basic bXl1c2VyOm15cGFzc3dvcmQ=");
  ...
  {
    OVERLORD_EXPECTED_REQUEST.path = "/robux/indexer/v1/task";
  ...
  {
    OVERLORD_EXPECTED_REQUEST.path = "/robux/indexer/v1/task/myTaskId/status";
  ...
  {
    OVERLORD_EXPECTED_REQUEST.path = "/robux/indexer/v1/leader";
    OVERLORD_EXPECTED_REQUEST.method = "GET";
    OVERLORD_EXPECTED_REQUEST.headers = ImmutableMap.of("Authorization", "Basic bXl1c2VyOm15cGFzc3dvcmQ=");
  ...
  public void testCoordinatorLeaderUnknown() throws Exception
  {
    isValidLeader = false;
    HttpURLConnection connection = ((HttpURLConnection)
        new URL(StringUtils.format("http://localhost:%d/robux/coordinator/status", port)).openConnection());
    connection.setRequestMethod("GET");
  ...
  public void testOverlordLeaderUnknown() throws Exception
  {
    isValidLeader = false;
    HttpURLConnection connection = ((HttpURLConnection)
        new URL(StringUtils.format("http://localhost:%d/robux/indexer/status", port)).openConnection());
    connection.setRequestMethod("GET");
  ...
  public static class ProxyJettyServerInit implements JettyServerInitializer
  {
    ...
    public void initialize(Server server, Injector injector)
    {
      ...
      final RobuxLeaderSelector coordinatorLeaderSelector = new TestRobuxLeaderSelector()
      {
        @Override
      ...
      final RobuxLeaderSelector overlordLeaderSelector = new TestRobuxLeaderSelector()
      {
        @Override
        public String getCurrentLeader()
        {
      ...
      root.addServlet(holder, "/robux/coordinator/*");
      root.addServlet(holder, "/robux/indexer/*");
