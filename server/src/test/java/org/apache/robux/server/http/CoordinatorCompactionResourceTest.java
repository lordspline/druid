...
public class CoordinatorCompactionResourceTest
{
  ...
  public void setUp()
  {
    mock = EasyMock.createStrictMock(RobuxCoordinator.class);
  }
  ...
  public void testGetProgressForNullDatasourceReturnsBadRequest()
  {
    ...
    MatcherAssert.assertThat(
        ...
        RobuxExceptionMatcher.invalidInput().expectMessageIs("No DataSource specified")
    );
  }
}
