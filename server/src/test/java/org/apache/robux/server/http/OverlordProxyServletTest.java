...
public class OverlordProxyServletTest
{
  ...
  public void testRewriteURI() throws URISyntaxException
  {
    ...
    EasyMock.expect(request.getRequestURI()).andReturn("/robux/over%3Alord/worker").anyTimes();
    ...
    Assert.assertEquals("https://overlord:port/robux/over%3Alord/worker?param1=test&param2=test2", uri.toString());
