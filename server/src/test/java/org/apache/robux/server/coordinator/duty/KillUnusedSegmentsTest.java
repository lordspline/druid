...
import org.apache.robux.metadata.SqlSegmentsMetadataManagerTestBase;
...
public class KillUnusedSegmentsTest
{
  ...
  private RobuxCoordinatorRuntimeParams.Builder paramsBuilder;
  ...
  public void setup()
  {
    ...
    paramsBuilder = RobuxCoordinatorRuntimeParams.builder()
  ...
  {
    paramsBuilder.withDynamicConfigs(dynamicConfigBuilder.build());
    final RobuxCoordinatorRuntimeParams params = killDuty.run(paramsBuilder.build());
