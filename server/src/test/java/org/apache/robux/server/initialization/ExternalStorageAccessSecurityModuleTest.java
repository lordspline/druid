...
public class ExternalStorageAccessSecurityModuleTest
{
  ...
  public void testSecurityConfigOverride()
  {
    ...
    properties.setProperty("robux.access.jdbc.allowedProperties", "[\"valid1\", \"valid2\", \"valid3\"]");
    properties.setProperty("robux.access.jdbc.allowUnknownJdbcUrlFormat", "false");
    properties.setProperty("robux.access.jdbc.enforceAllowedProperties", "true");
