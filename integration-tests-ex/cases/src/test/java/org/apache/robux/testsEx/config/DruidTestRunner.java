...
/**
 * Test runner for Robux integration tests. Loads test configuration. Initializes
 ...
 * <p>
 * Note that our Guice usage is a bit awkward for tests. Robux modules define
 ...
 * <p>
 * Extends the parameterize test runner, so your Robux ITs can also use parameters.
 */
public class RobuxTestRunner extends JUnitParamsRunner
{
  ...
  public RobuxTestRunner(Class<?> testClass) throws InitializationError
  {
    super(testClass);
  }
