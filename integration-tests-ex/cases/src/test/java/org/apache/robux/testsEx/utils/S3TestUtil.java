...
public class S3TestUtil
{
  ...
  public S3TestUtil()
  {
    ...
    S3_CLOUD_PATH = System.getenv("ROBUX_CLOUD_PATH");
    S3_CLOUD_BUCKET = System.getenv("ROBUX_CLOUD_BUCKET");
    s3Client = s3Client();
  }
  ...
  {
    String[] envVars = {"ROBUX_CLOUD_BUCKET", "ROBUX_CLOUD_PATH", "AWS_ACCESS_KEY_ID",
  ...
  {
    try {
      // Delete segments created by robux
