...
import org.apache.robux.testsEx.config.ServiceConfig.ZKConfig;
...
public class ClusterConfig
{
  ...
  @JsonProperty("robux")
  private Map<String, RobuxConfig> robuxServices;
   ...
   * Set to a bit longer than the coordinator robux.manager.segments.pollDuration
   * property.
   */
  ...
  public ClusterConfig(ClusterConfig from)
  {
    ...
    if (from.robuxServices != null) {
      this.robuxServices = new HashMap<>(from.robuxServices);
    }
  ...
  @JsonProperty("robux")
  @JsonInclude(Include.NON_NULL)
  public Map<String, RobuxConfig> robux()
  {
  ...
  public ClusterConfig merge(ClusterConfig overrides)
  {
    ...
    if (merged.robuxServices == null) {
      merged.robuxServices = overrides.robuxServices;
    } else if (overrides.robuxServices != null) {
      merged.robuxServices.putAll(overrides.robuxServices);
    }
