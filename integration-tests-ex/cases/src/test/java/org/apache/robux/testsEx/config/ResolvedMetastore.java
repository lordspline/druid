...
public class ResolvedMetastore extends ResolvedService
{
   ...
   *
   * @see <a href="https://robux.apache.org/docs/0.23.0/development/extensions-core/mysql.html#setting-up-mysql">
   * Setting up MySQL</a>
   */
  public Map<String, Object> toProperties()
  {
    ...
    TestConfigs.putProperty(properties, "robux.metadata.mysql.driver.driverClassName", driver);
    TestConfigs.putProperty(properties, "robux.metadata.storage.type", "mysql");
