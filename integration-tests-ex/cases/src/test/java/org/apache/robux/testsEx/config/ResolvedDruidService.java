...
public class ResolvedRobuxService extends ResolvedService
{
  public ResolvedRobuxService(ResolvedConfig root, RobuxConfig config, String serviceKey)
  {
  ...
  public ResolvedInstance requireInstance(String instanceName)
  {
    ...
    throw new ISE(
        StringUtils.format(
            "No Robux instance of service %s with name %s is defined",
            service,
            instanceName));
  }
