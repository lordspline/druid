...
import org.apache.robux.testsEx.categories.AzureDeepStorage;
 ...
 * ROBUX_CLOUD_PATH - path inside the container where the test data files will be uploaded
 * <p>
 * The AZURE account, key and container should be set in AZURE_ACCOUNT, AZURE_KEY and AZURE_CONTAINER respectively.
 * <p>
 * <a href="https://robux.apache.org/docs/latest/development/extensions-core/azure.html">Azure Deep Storage setup in robux</a>
 */
