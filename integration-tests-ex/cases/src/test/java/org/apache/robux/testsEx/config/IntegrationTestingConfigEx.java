...
class IntegrationTestingConfigEx implements IntegrationTestingConfig
{
  ...
  {
    ResolvedRobuxService serviceConfig = config.requireCoordinator();
  ...
  {
    ResolvedRobuxService serviceConfig = config.requireOverlord();
    return serviceConfig.resolveUrl(serviceConfig.tagOrDefault("one"));
  }
  ...
  {
    ResolvedRobuxService indexer = config.robuxService(ResolvedConfig.INDEXER);
    if (indexer == null) {
  ...
  {
    ResolvedRobuxService serviceConfig = config.requireRouter();
  ...
  {
    ResolvedRobuxService serviceConfig = config.requireBroker();
