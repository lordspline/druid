...
public class ServiceConfig
{
   ...
   * {@link org.apache.robux.curator.CuratorConfig}
   */
  ...
  /**
   * Represents a Robux service (of one or more instances) running
   * in the test cluster. The service name comes from the key used
   * in the {@code robux} map: <code><pre>
   * robux:
   ...
   * config tag is set.
   */
  public static class RobuxConfig extends ServiceConfig
  {
