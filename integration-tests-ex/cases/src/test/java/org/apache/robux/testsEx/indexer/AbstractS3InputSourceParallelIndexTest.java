...
import org.apache.robux.testsEx.utils.S3TestUtil;
 ...
 * "ROBUX_CLOUD_BUCKET", "ROBUX_CLOUD_PATH", "AWS_ACCESS_KEY_ID", "AWS_SECRET_ACCESS_KEY", "AWS_REGION"
...
public abstract class AbstractS3InputSourceParallelIndexTest extends AbstractCloudInputSourceParallelIndexTest
{
  ...
  {
    // Deleting folder created for storing segments (by robux) after test is completed
