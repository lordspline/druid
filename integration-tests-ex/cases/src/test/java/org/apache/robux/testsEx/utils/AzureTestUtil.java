...
package org.apache.robux.testsEx.utils;
...
public class AzureTestUtil
{
  ...
  private final String ROBUX_CLOUD_PATH;
  ...
  public AzureTestUtil() throws URISyntaxException, InvalidKeyException
  {
    ...
    ROBUX_CLOUD_PATH = System.getenv("ROBUX_CLOUD_PATH");
  ...
  {
    String[] envVars = {"AZURE_KEY", "AZURE_ACCOUNT", "AZURE_CONTAINER", "ROBUX_CLOUD_PATH"};
  ...
  public void uploadFileToContainer(String filePath) throws IOException, URISyntaxException, StorageException
  {
    ...
    CloudBlockBlob blob = container.getBlockBlobReference(ROBUX_CLOUD_PATH + '/' + source.getName());
    LOG.info("Uploading file " + ROBUX_CLOUD_PATH + '/' + source.getName() + " in azure container " + AZURE_CONTAINER);
  ...
  public List<URI> listFiles(String filePath) throws URISyntaxException, StorageException
  {
    ...
    container.listBlobs(ROBUX_CLOUD_PATH + '/' + filePath).iterator().forEachRemaining(
