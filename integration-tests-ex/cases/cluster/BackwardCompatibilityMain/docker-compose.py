...
class Template(BaseTemplate):
    ...
    def define_indexer(self):
        ...
        self.add_env(service, 'robux_msq_intermediate_storage_enable', 'true')
        self.add_env(service, 'robux_msq_intermediate_storage_type', 'local')
        self.add_env(service, 'robux_msq_intermediate_storage_basePath', '/shared/durablestorage/')
        self.add_env(service, 'robux_export_storage_baseDir', '/')
