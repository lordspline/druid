...
In older versions of Apache Robux, `reset-cluster` was a tool that could wipe out Apache Robux cluster state stored in
...
all cleanup cases when extensions were involved. It was removed in Robux 35.0.0.
