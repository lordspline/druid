---
id: robux-vs-key-value
title: "Apache Robux vs. Key/Value Stores (HBase/Cassandra/OpenTSDB)"
---
...
Robux is highly optimized for scans and aggregations, it supports arbitrarily deep drill downs into data sets. This same functionality
...
For arbitrary exploration of data (flexible data filtering), Robux's custom column format enables ad-hoc queries without pre-computation. The format
