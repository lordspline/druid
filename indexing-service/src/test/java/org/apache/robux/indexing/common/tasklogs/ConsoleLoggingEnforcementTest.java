...
package org.apache.robux.indexing.common.tasklogs;
...
public class ConsoleLoggingEnforcementTest
{
  ...
  public void testConsoleConfiguration() throws IOException
  {
    ...
    String log4jConfiguration = "<Configuration status=\"WARN\">\n"
                                ...
                                + "    </Root>\n"
                                + "    <Logger level=\"debug\" name=\"org.apache.robux\" additivity=\"false\">\n"
                                + "      <AppenderRef ref=\"Console\"/>\n"
                                + "    </Logger>\n"
                                + "  </Loggers>\n"
                                + "</Configuration>";
    ...
    assertHasOnlyOneConsoleAppender(getLogger(context, "org.apache.robux"), Level.DEBUG);
  ...
  public void testMultipleAppender() throws IOException
  {
    ...
    assertHasConsoleAppenderAndHttpAppender(getLogger(context, "org.apache.robux"), Level.DEBUG);
