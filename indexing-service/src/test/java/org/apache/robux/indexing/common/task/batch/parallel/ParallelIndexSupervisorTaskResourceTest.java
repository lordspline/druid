...
import org.apache.robux.indexing.common.task.SegmentAllocators;
...
public class ParallelIndexSupervisorTaskResourceTest extends AbstractParallelIndexSupervisorTaskTest
{
  ...
  private static HttpServletRequest newRequest()
  {
    ...
    EasyMock.expect(request.getAttribute(AuthConfig.ROBUX_AUTHORIZATION_CHECKED)).andReturn(null);
