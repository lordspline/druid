...
package org.apache.robux.indexing.common.task.concurrent;
...
import org.apache.robux.indexing.overlord.TestTaskToolboxFactory;
...
public class ConcurrentReplaceAndAppendTest extends IngestionTestBase
{
  ...
  public void setup()
  {
    ...
    TaskRunner taskRunner = new ThreadingTaskRunner(
        ...
        new RobuxNode("middleManager", "host", false, 8091, null, true, false),
