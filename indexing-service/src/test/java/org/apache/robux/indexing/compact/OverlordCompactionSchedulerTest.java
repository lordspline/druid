...
import org.apache.robux.server.compaction.CompactionStatistics;
import org.apache.robux.server.compaction.CompactionStatus;
import org.apache.robux.server.compaction.CompactionStatusTracker;
import org.apache.robux.server.compaction.Table;
...
public class OverlordCompactionSchedulerTest
{
  ...
  private void initScheduler()
  {
    ...
    scheduler = new OverlordCompactionScheduler(
        ...
        () -> RobuxCompactionConfig.empty().withClusterConfig(compactionConfig.get()),
