...
public class RobuxInputSourceTest
{
  ...
  public void testSerdeUsingIntervals() throws Exception
  {
    ...
    Assert.assertThat(inputSource, CoreMatchers.instanceOf(RobuxInputSource.class));
    Assert.assertEquals(
        new RobuxInputSource(
            "foo",
  ...
  public void testReaderColumnsFilterWithMetricGiven()
  {
    ...
    RobuxInputSource robuxInputSource = new RobuxInputSource(
        datasource,
        interval,
        null,
        null,
    ...
    InputRowSchema inputSourceReader = robuxInputSource.getInputRowSchemaToUse(inputRowSchema);
  ...
  public void testGetTypes()
  {
    ...
    Assert.assertEquals(ImmutableSet.of(RobuxInputSource.TYPE_KEY), robuxInputSource.getTypes());
  }
}
