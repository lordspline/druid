...
import org.apache.robux.indexing.common.actions.LocalTaskActionClient;
import org.apache.robux.indexing.common.actions.TaskActionTestKit;
import org.apache.robux.indexing.common.task.NoopTask;
import org.apache.robux.indexing.common.task.Task;
import org.apache.robux.indexing.common.task.TaskMetrics;
...
import org.apache.robux.metadata.UnusedSegmentKillerConfig;
...
public class UnusedSegmentsKillerTest
{
  ...
  public void test_run_prioritizesOlderIntervals()
  {
    ...
    final List<Interval> killIntervals = events.stream().map(event -> {
      final String taskId = (String) event.getUserDims().get(RobuxMetrics.TASK_ID);
