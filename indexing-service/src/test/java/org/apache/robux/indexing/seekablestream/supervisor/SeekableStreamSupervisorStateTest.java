...
package org.apache.robux.indexing.seekablestream.supervisor;
...
import org.apache.robux.indexing.overlord.supervisor.SupervisorStateManager.BasicState;
import org.apache.robux.indexing.overlord.supervisor.SupervisorStateManagerConfig;
import org.apache.robux.indexing.overlord.supervisor.autoscaler.LagStats;
import org.apache.robux.indexing.seekablestream.SeekableStreamDataSourceMetadata;
...
import org.apache.robux.indexing.seekablestream.SeekableStreamIndexTaskClientFactory;
import org.apache.robux.indexing.seekablestream.SeekableStreamIndexTaskIOConfig;
...
import org.apache.robux.indexing.seekablestream.SeekableStreamSequenceNumbers;
import org.apache.robux.indexing.seekablestream.SeekableStreamStartSequenceNumbers;
import org.apache.robux.indexing.seekablestream.common.OrderedSequenceNumber;
import org.apache.robux.indexing.seekablestream.common.RecordSupplier;
import org.apache.robux.indexing.seekablestream.common.StreamException;
import org.apache.robux.indexing.seekablestream.common.StreamPartition;
import org.apache.robux.indexing.seekablestream.supervisor.SeekableStreamSupervisorStateManager.SeekableStreamExceptionEvent;
import org.apache.robux.indexing.seekablestream.supervisor.SeekableStreamSupervisorStateManager.SeekableStreamState;
...
import org.apache.robux.metadata.PendingSegmentRecord;
...
public class SeekableStreamSupervisorStateTest extends EasyMockSupport
{
  ...
  public void setupTest()
  {
    ...
    EasyMock.expect(spec.getContextValue(RobuxMetrics.TAGS)).andReturn(METRIC_TAGS).anyTimes();
  ...
  public void testIdleStateTransition() throws Exception
  {
    ...
    EasyMock.expect(spec.getTuningConfig()).andReturn(getTuningConfig()).anyTimes();
    EasyMock.expect(spec.getEmitter()).andReturn(emitter).anyTimes();
    EasyMock.expect(spec.getMonitorSchedulerConfig()).andReturn(new RobuxMonitorSchedulerConfig() {
      @Override
  ...
  public void testEmitBothLag() throws Exception
  {
    ...
    final Map<String, Object> dimFilters = ImmutableMap.of(RobuxMetrics.TAGS, METRIC_TAGS);
  ...
  public void testEmitNoticesQueueSize() throws Exception
  {
    ...
    final Map<String, Object> dimFilters = ImmutableMap.of(
        RobuxMetrics.TAGS, METRIC_TAGS,
        RobuxMetrics.DATASOURCE, "testDS"
    );
  ...
  {
    EasyMock.expect(spec.isSuspended()).andReturn(false).anyTimes();
    RobuxMonitorSchedulerConfig config = new RobuxMonitorSchedulerConfig();
