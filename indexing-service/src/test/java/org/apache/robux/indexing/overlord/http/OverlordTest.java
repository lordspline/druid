...
public class OverlordTest
{
  ...
  public void setUp() throws Exception
  {
    ...
    EasyMock.expect(req.getAttribute(AuthConfig.ROBUX_AUTHORIZATION_CHECKED)).andReturn(null).anyTimes();
  ...
  public void testOverlordRun() throws Exception
  {
    ...
    Assert.assertEquals(overlord.getCurrentLeader(), robuxNode.getHostAndPort());
    ...
    Assert.assertEquals(robuxNode.getHostAndPort(), response.getEntity());
