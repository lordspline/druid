...
import org.apache.robux.query.RobuxProcessingBufferConfig;
...
import org.apache.robux.segment.incremental.AppendableIndexBuilder;
...
public class SeekableStreamAppenderatorConfigTest
{
  ...
  public void test_calculateDefaultMaxColumnsToMerge_direct2g_xmx1g_maxBytesAuto_2proc_1merge()
  {
    Assert.assertEquals(
        ...
        SeekableStreamAppenderatorConfig.calculateDefaultMaxColumnsToMerge(
            new RobuxProcessingConfigTest.MockRuntimeInfo(2, 2_000_000_000L, 1_000_000_000L),
  ...
  public void test_calculateDefaultMaxColumnsToMerge_direct1800m_xmx1g_maxBytesUnlimited_2proc_1merge()
  {
    Assert.assertEquals(
        15258,
        SeekableStreamAppenderatorConfig.calculateDefaultMaxColumnsToMerge(
            new RobuxProcessingConfigTest.MockRuntimeInfo(2, 1_800_000_000L, 1_000_000_000L),
            new MockProcessingConfig(2, 1, 100_000_000),
            new MockTuningConfig(-1, 500_000_000L)
        )
    );
  ...
  public void test_calculateDefaultMaxColumnsToMerge_direct1800m_xmx1g_maxBytesUnlimited_3proc_2merge()
  {
    Assert.assertEquals(
        13224,
        SeekableStreamAppenderatorConfig.calculateDefaultMaxColumnsToMerge(
            new RobuxProcessingConfigTest.MockRuntimeInfo(3, 1_800_000_000L, 1_000_000_000L),
  ...
  private static class MockProcessingConfig extends RobuxProcessingConfig
  {
    public MockProcessingConfig(final int numThreads, final int numMergeBuffers, final int bufferSize)
    {
      super(
          ...
          null,
          null,
          new RobuxProcessingBufferConfig(HumanReadableBytes.valueOf(bufferSize), null, null),
          null,
