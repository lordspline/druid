...
import org.apache.robux.indexing.overlord.supervisor.Supervisor;
...
import org.apache.robux.indexing.seekablestream.supervisor.LagAggregator;
import org.apache.robux.indexing.seekablestream.supervisor.SeekableStreamSupervisor;
import org.apache.robux.indexing.seekablestream.supervisor.SeekableStreamSupervisorIOConfig;
import org.apache.robux.indexing.seekablestream.supervisor.SeekableStreamSupervisorIngestionSpec;
import org.apache.robux.indexing.seekablestream.supervisor.SeekableStreamSupervisorReportPayload;
...
import org.apache.robux.indexing.seekablestream.supervisor.autoscaler.LagBasedAutoScaler;
import org.apache.robux.indexing.seekablestream.supervisor.autoscaler.LagBasedAutoScalerConfig;
import org.apache.robux.indexing.seekablestream.supervisor.autoscaler.NoopTaskAutoScaler;
...
import org.apache.robux.metadata.TestSupervisorSpec;
...
public class SeekableStreamSupervisorSpecTest extends EasyMockSupport
{
  ...
  private RobuxMonitorSchedulerConfig monitorSchedulerConfig;
  ...
  public void setUp()
  {
    ...
    monitorSchedulerConfig = EasyMock.mock(RobuxMonitorSchedulerConfig.class);
    ...
    EasyMock.expect(spec.getContextValue(RobuxMetrics.TAGS)).andReturn(null).anyTimes();
  }
  ...
  private static class TestSeekableStreamSupervisorSpec extends SeekableStreamSupervisorSpec
  {
    ...
    public TestSeekableStreamSupervisorSpec(
        ...
        RobuxMonitorSchedulerConfig monitorSchedulerConfig,
        RowIngestionMetersFactory rowIngestionMetersFactory,
  ...
  public void test_validateSpecUpdateTo_ShortCircuits()
  {
    ...
    MatcherAssert.assertThat(
        assertThrows(RobuxException.class, () -> originalSpec.validateSpecUpdateTo(proposedSpec)),
    ...
    MatcherAssert.assertThat(
        assertThrows(RobuxException.class, () -> originalSpec.validateSpecUpdateTo(otherSpec)),
        new RobuxExceptionMatcher(
            RobuxException.Persona.USER,
            RobuxException.Category.INVALID_INPUT,
            "invalidInput"
  ...
  public void test_validateSpecUpdateTo_SourceStringComparisons()
  {
    ...
    MatcherAssert.assertThat(
        assertThrows(RobuxException.class, () -> originalSpec.validateSpecUpdateTo(proposedSpecDiffSource)),
        new RobuxExceptionMatcher(
            RobuxException.Persona.USER,
            RobuxException.Category.INVALID_INPUT,
            "invalidInput"
