...
public class SupervisorManagerTest extends EasyMockSupport
{
  ...
  public void testCreateOrUpdateAndStartSupervisorIllegalEvolution()
  {
    ...
    resetAll();
    exception.expect(RobuxException.class);
    replayAll();
  ...
  public void testHandoffTaskGroupsEarlyOnNonStreamSupervisor()
  {
    ...
    MatcherAssert.assertThat(
        Assert.assertThrows(RobuxException.class, () -> manager.handoffTaskGroupsEarly("id3", ImmutableList.of(1))),
  ...
  public void testResetOnNonStreamSupervisor()
  {
    ...
    MatcherAssert.assertThat(
        Assert.assertThrows(RobuxException.class, () -> manager.resetSupervisor("id3", null)),
        new RobuxExceptionMatcher(
            RobuxException.Persona.USER,
            RobuxException.Category.UNSUPPORTED,
            "general"
