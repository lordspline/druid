...
import org.apache.robux.data.input.InputEntity.CleanableFile;
...
import org.apache.robux.data.input.impl.InputStatsImpl;
...
import org.apache.robux.hll.HyperLogLogHash;
...
import org.apache.robux.java.util.common.guava.BaseSequence.IteratorMaker;
...
public class RobuxSegmentReaderTest extends InitializedNullHandlingTest
{
  @Rule
  ...
  {
    final RobuxSegmentReader reader = new RobuxSegmentReader(
  ...
  @Test
  public void testRobuxTombstoneSegmentReader() throws IOException
  {
    final RobuxTombstoneSegmentReader reader = new RobuxTombstoneSegmentReader(
  ...
  @Test
  public void testRobuxTombstoneSegmentReaderNotCreatedFromTombstone()
  {
    Exception exception = assertThrows(
        IllegalArgumentException.class,
        () -> new RobuxTombstoneSegmentReader(
            makeInputEntity(
    ...
    Assert.assertEquals(
        "RobuxSegmentInputEntity must be created from a tombstone.",
  ...
  public void testMakeCloseableIteratorFromSequenceAndSegmentFileCloseYielderOnClose() throws IOException
  {
    ...
    try (CloseableIterator<Map<String, Object>> iterator =
             RobuxSegmentReader.makeCloseableIteratorFromSequenceAndSegmentFile(sequence, cleanableFile)) {
  ...
  public static RobuxSegmentInputEntity makeInputEntity(
  ...
  {
    return new RobuxSegmentInputEntity(
  ...
  public static RobuxSegmentInputEntity makeTombstoneInputEntity(final Interval interval)
  {
    return new RobuxSegmentInputEntity(
        new NoopSegmentCacheManager(),
        DataSegment.builder()
  ...
  private List<InputRow> readRows(RobuxSegmentReader reader) throws IOException
  {
  ...
  private List<InputRow> readRows(RobuxTombstoneSegmentReader reader) throws IOException
  {
    final List<InputRow> rows = new ArrayList<>();
    try (final CloseableIterator<Map<String, Object>> iterator = reader.intermediateRowIterator()) {
      while (iterator.hasNext()) {
