...
public class ForkingTaskRunnerTest
{
                                                            ...
                                                            JsonProcessingException
  {
    ...
    final String taskContent = "{\n"
                               ...
                               + "  \"isReadyResult\" : \"YES\",\n"
                               + "  \"context\" : {\n"
                               + "    \"robux.indexer.runner.javaOptsArray\" : [ \"-Xmx10g\", \"-Xms10g\" ],\n"
                               + "    \"robux.indexer.fork.property.robux.processing.numThreads\" : 4,\n"
                               + "    \"robux.indexer.runner.javaOpts\" : \"-Xmx1g -Xms1g\"\n"
                               + "  }\n"
                               + "}";
  ...
  public void testInvalidTaskContextJavaOptsArray() throws JsonProcessingException
  {
    final String taskContent = "{\n"
                               ...
                               + "  \"isReadyResult\" : \"YES\",\n"
                               + "  \"context\" : {\n"
                               + "    \"robux.indexer.runner.javaOptsArray\" : \"not a string array\",\n"
                               + "    \"robux.indexer.runner.javaOpts\" : \"-Xmx1g -Xms1g\"\n"
                               + "  }\n"
                               + "}";
    final Task task = OBJECT_MAPPER.readValue(taskContent, NoopTask.class);
