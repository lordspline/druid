...
import org.apache.robux.indexing.common.RetryPolicy;
...
import org.apache.robux.rpc.ServiceClosedException;
import org.apache.robux.rpc.ServiceLocation;
import org.apache.robux.rpc.ServiceLocations;
import org.apache.robux.rpc.ServiceLocator;
import org.apache.robux.rpc.ServiceNotAvailableException;
    ...
    implements SeekableStreamIndexTaskClient<PartitionIdType, SequenceOffsetType>
{
  ...
  {
    private static final String BASE_PATH = "/robux/worker/v1/chat";
