...
package org.apache.robux.indexing.seekablestream.extension;
 ...
 *
 * This interface is only used by the robux-kafka-indexing-service extension, but the interface definition must
 * be placed in a non-extension module in order for other extensions to be able to provide subtypes visible within
 * the robux-kafka-indexing-service extension.
 */
@ExtensionPoint
