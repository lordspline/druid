...
package org.apache.robux.indexing.seekablestream.supervisor.autoscaler;

import org.apache.commons.collections4.queue.CircularFifoQueue;
import org.apache.robux.indexing.overlord.supervisor.SupervisorSpec;
import org.apache.robux.indexing.overlord.supervisor.autoscaler.AggregateFunction;
...
public class LagBasedAutoScaler implements SupervisorTaskAutoScaler
{
  ...
  )
  {
    ...
    metricBuilder = ServiceMetricEvent.builder()
                                      ...
                                      .setDimension(RobuxMetrics.STREAM, this.supervisor.getIoConfig().getStream());
  }
