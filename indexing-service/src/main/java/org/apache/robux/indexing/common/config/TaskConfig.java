...
package org.apache.robux.indexing.common.config;
...
import org.apache.robux.segment.realtime.appenderator.TaskDirectory;
 ...
 * <p>
 * See {@link org.apache.robux.indexing.overlord.config.DefaultTaskConfig} if you want to apply the same configuration
...
public class TaskConfig implements TaskDirectory
{
  ...
  @JsonProperty
  private final boolean ignoreTimestampSpecForRobuxInputSource;
  ...
  public TaskConfig(
      ...
      @JsonProperty("ignoreTimestampSpecForRobuxInputSource") boolean ignoreTimestampSpecForRobuxInputSource,
  ...
  )
  {
    ...
    this.ignoreTimestampSpecForRobuxInputSource = ignoreTimestampSpecForRobuxInputSource;
  ...
  private TaskConfig(
      ...
      boolean ignoreTimestampSpecForRobuxInputSource,
  ...
  @JsonProperty
  public boolean isIgnoreTimestampSpecForRobuxInputSource()
  {
    return ignoreTimestampSpecForRobuxInputSource;
  }
  ...
  public TaskConfig withBaseTaskDir(File baseTaskDir)
  {
    return new TaskConfig(
        ...
        directoryLockTimeout,
        shuffleDataLocations,
        ignoreTimestampSpecForRobuxInputSource,
        storeEmptyColumns,
        encapsulatedTask,
