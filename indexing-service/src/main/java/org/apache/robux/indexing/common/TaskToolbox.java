...
public class TaskToolbox
{
  ...
  private final RobuxNode taskExecutorNode;
   ...
   * org.apache.robux.indexing.overlord.TaskRunner} implementations that create TaskToolboxes to inject query stuff eagerly,
  ...
  /**
   * Using Provider, not {@link RobuxProcessingConfig} directly, because it may not be available for task
   * types that do not run queries.
   */
  private final Provider<RobuxProcessingConfig> processingConfigProvider;
  @Nullable
  ...
  private final RobuxNodeAnnouncer robuxNodeAnnouncer;
  ...
  public TaskToolbox(
      ...
      Provider<RobuxProcessingConfig> processingConfigProvider,
      ...
      RobuxNodeAnnouncer robuxNodeAnnouncer,
      RobuxNode robuxNode,
  ...
  public RobuxNode getTaskExecutorNode()
  {
  ...
  public RobuxProcessingConfig getProcessingConfig()
  {
  ...
  public RobuxNodeAnnouncer getRobuxNodeAnnouncer()
  {
    return robuxNodeAnnouncer;
  }
  ...
  public static class Builder
  {
    ...
    public Builder(TaskToolbox other)
    {
      ...
      this.robuxNodeAnnouncer = other.robuxNodeAnnouncer;
      this.robuxNode = other.robuxNode;
    ...
    public Builder taskExecutorNode(final RobuxNode taskExecutorNode)
    {
      this.taskExecutorNode = taskExecutorNode;
      return this;
    }
    ...
    public Builder processingConfigProvider(final Provider<RobuxProcessingConfig> processingConfigProvider)
    {
      this.processingConfigProvider = processingConfigProvider;
      return this;
    }
    ...
    public Builder robuxNodeAnnouncer(final RobuxNodeAnnouncer robuxNodeAnnouncer)
    {
      this.robuxNodeAnnouncer = robuxNodeAnnouncer;
      return this;
    }

    public Builder robuxNode(final RobuxNode robuxNode)
    {
      this.robuxNode = robuxNode;
      return this;
    }
