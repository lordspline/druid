...
public class RobuxSegmentReader extends IntermediateRowParsingReader<Map<String, Object>>
{
  ...
  )
  {
    ...
    this.intervalFilter = ((RobuxSegmentInputEntity) baseInputEntity).getIntervalFilter();
  }
