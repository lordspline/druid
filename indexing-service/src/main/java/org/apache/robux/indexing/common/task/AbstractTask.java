...
import org.apache.robux.indexing.common.actions.UpdateLocationAction;
import org.apache.robux.indexing.common.actions.UpdateStatusAction;
...
public abstract class AbstractTask implements Task
{
  ...
  )
  {
    ...
    // Copy the given context into a new mutable map because the Robux indexing service can add some internal contexts.
  ...
  public String setup(TaskToolbox toolbox) throws Exception
  {
    if (toolbox.getConfig().isEncapsulatedTask()) {
      ...
      RobuxNode node = toolbox.getTaskExecutorNode();
