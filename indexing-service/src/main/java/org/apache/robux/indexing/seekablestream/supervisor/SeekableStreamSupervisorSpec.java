...
public abstract class SeekableStreamSupervisorSpec implements SupervisorSpec
{
  ...
  protected final RobuxMonitorSchedulerConfig monitorSchedulerConfig;
  ...
  public RobuxMonitorSchedulerConfig getMonitorSchedulerConfig()
  {
   ...
   * @throws RobuxException if the proposed spec update is not allowed
   */
  @Override
  public void validateSpecUpdateTo(SupervisorSpec proposedSpec) throws RobuxException
  {
