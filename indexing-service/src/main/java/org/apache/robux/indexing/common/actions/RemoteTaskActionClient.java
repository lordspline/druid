...
public class RemoteTaskActionClient implements TaskActionClient
{
  ...
  public <RetType> RetType submit(TaskAction<RetType> taskAction) throws IOException
  {
    ...
    try {
      ...
      // not have access to the TaskAction class. (OverlordClient is in the robux-server package, and TaskAction
      // is in the robux-indexing-service package.)
      final Map<String, Object> response = jsonMapper.readValue(
          client.request(
              new RequestBuilder(HttpMethod.POST, "/robux/indexer/v1/action")
