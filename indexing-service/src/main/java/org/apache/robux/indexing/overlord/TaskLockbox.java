...
import org.apache.robux.indexing.common.actions.SegmentAllocateRequest;
import org.apache.robux.indexing.common.actions.SegmentAllocateResult;
    ...
    try {
      ...
      switch (taskLock.getGranularity()) {
        ...
        case TIME_CHUNK:
          ...
          break;
        default:
          throw RobuxException.defensive("Unknown lockGranularity[%s]", taskLock.getGranularity());
      }
