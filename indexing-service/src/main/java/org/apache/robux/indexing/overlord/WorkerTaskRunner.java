...
public interface WorkerTaskRunner extends TaskRunner
{
   ...
   *
   * This method is called by {@link org.apache.robux.indexing.overlord.autoscaling.ProvisioningStrategy}
   * implementations. It is expected that the lazy workers returned by this method will be terminated using
   * {@link org.apache.robux.indexing.overlord.autoscaling.AutoScaler#terminate(List)}.
   *
