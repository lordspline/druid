...
public class SamplerConfig
{
   ...
   *     value is reached
   *   - The estimated size of the {@link org.apache.robux.client.indexing.SamplerResponse} crosses
  ...
  /**
   * Maximum number of bytes in memory that the {@link org.apache.robux.segment.incremental.IncrementalIndex} used by
   * {@link InputSourceSampler#sample(org.apache.robux.data.input.InputSource, org.apache.robux.data.input.InputFormat, org.apache.robux.segment.indexing.DataSchema, SamplerConfig)}
  ...
  /**
   * Maximum number of bytes to accumulate for a {@link org.apache.robux.client.indexing.SamplerResponse} before
   * shutting off sampling. To directly control the size of the
   * {@link org.apache.robux.segment.incremental.IncrementalIndex} used for sampling, use
