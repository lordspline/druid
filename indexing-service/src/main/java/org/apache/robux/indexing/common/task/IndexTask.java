...
import org.apache.robux.indexer.Checks;
import org.apache.robux.indexer.IngestionState;
import org.apache.robux.indexer.Property;
import org.apache.robux.indexer.TaskStatus;
import org.apache.robux.indexer.granularity.ArbitraryGranularitySpec;
...
import org.apache.robux.indexer.partitions.SecondaryPartitionType;
...
import org.apache.robux.indexing.common.task.batch.parallel.PartialHashSegmentGenerateTask;
import org.apache.robux.indexing.common.task.batch.parallel.TombstoneHelper;
import org.apache.robux.indexing.common.task.batch.parallel.iterator.DefaultIndexTaskInputRowIteratorBuilder;
import org.apache.robux.indexing.common.task.batch.partition.CompletePartitionAnalysis;
import org.apache.robux.indexing.common.task.batch.partition.HashPartitionAnalysis;
import org.apache.robux.indexing.common.task.batch.partition.LinearPartitionAnalysis;
import org.apache.robux.indexing.common.task.batch.partition.PartitionAnalysis;
import org.apache.robux.indexing.input.RobuxInputSource;
import org.apache.robux.indexing.input.TaskInputSource;
...
import org.apache.robux.segment.realtime.ChatHandler;
...
import org.apache.robux.segment.realtime.appenderator.AppenderatorConfig;
import org.apache.robux.segment.realtime.appenderator.BaseAppenderatorDriver;
...
import org.apache.robux.segment.realtime.appenderator.TransactionalSegmentPublisher;
    ...
    try (final BatchAppenderatorDriver driver = BatchAppenderators.newDriver(appenderator, toolbox, segmentAllocator)) {
      ...
      if (published == null) {
        ...
        updateAndWriteCompletionReports(
            ...
            inputSource instanceof RobuxInputSource
            ? (long) ((RobuxInputSource) inputSource).getNumberOfSegmentsRead()
            : null,
