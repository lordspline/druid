...
import org.apache.robux.indexing.common.task.batch.MaxAllowedLocksExceededException;
...
import org.apache.robux.java.util.common.granularity.IntervalsByGranularity;
...
public abstract class AbstractBatchIndexTask extends AbstractTask
{
   ...
   * The returned iterator can throw {@link org.apache.robux.java.util.common.parsers.ParseException}s in
  ...
  /**
   * <p>
   * This task will overwrite some segments with data read from input source outside of Robux.
    ...
    try (
      ...
      toolbox.getEmitter().emit(
          new ServiceMetricEvent.Builder()
              ...
              .setDimensionIfNotNull(RobuxMetrics.TAGS, getContextValue(RobuxMetrics.TAGS))
