 ...
 * @see org.apache.robux.server.coordinator.duty.KillUnusedSegments for legacy
...
public class UnusedSegmentsKiller implements OverlordDuty
{
  ...
  public UnusedSegmentsKiller(
      ...
      @IndexingService RobuxLeaderSelector leaderSelector,
    ...
    try {
      ...
      dataSourceToIntervalCounts.forEach(
          (dataSource, intervalCount) -> emitMetric(
              ...
              intervalCount,
              Map.of(RobuxMetrics.DATASOURCE, dataSource)
          )
      );
  ...
  private void runKillTask(KillCandidate candidate, String taskId)
  {
    ...
    try {
      ...
      emitMetric(Metric.PROCESSED_KILL_JOBS, 1L, Map.of(RobuxMetrics.DATASOURCE, candidate.dataSource));
    }
  }
