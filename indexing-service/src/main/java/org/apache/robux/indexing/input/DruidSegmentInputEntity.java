...
public class RobuxSegmentInputEntity implements InputEntity
{
  private static final EmittingLogger log = new EmittingLogger(RobuxSegmentInputEntity.class);

  private final SegmentCacheManager segmentCacheManager;
  private final DataSegment segment;
  private final Interval intervalFilter;

  RobuxSegmentInputEntity(SegmentCacheManager segmentCacheManager, DataSegment segment, Interval intervalFilter)
  {
