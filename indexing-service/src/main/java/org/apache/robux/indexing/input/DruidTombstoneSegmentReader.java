 ...
 */
public class RobuxTombstoneSegmentReader extends IntermediateRowParsingReader<Map<String, Object>>
{
  public RobuxTombstoneSegmentReader(
      RobuxSegmentInputEntity source
  )
  {
