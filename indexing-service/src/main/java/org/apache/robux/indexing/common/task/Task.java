...
import org.apache.robux.indexer.TaskIdentifier;
...
import org.apache.robux.indexing.common.task.batch.parallel.LegacySinglePhaseSubTask;
import org.apache.robux.indexing.common.task.batch.parallel.ParallelIndexSupervisorTask;
import org.apache.robux.indexing.common.task.batch.parallel.PartialDimensionCardinalityTask;
import org.apache.robux.indexing.common.task.batch.parallel.PartialDimensionDistributionTask;
import org.apache.robux.indexing.common.task.batch.parallel.PartialGenericSegmentMergeTask;
import org.apache.robux.indexing.common.task.batch.parallel.PartialHashSegmentGenerateTask;
import org.apache.robux.indexing.common.task.batch.parallel.PartialRangeSegmentGenerateTask;
import org.apache.robux.indexing.common.task.batch.parallel.SinglePhaseSubTask;
...
public interface Task
{
   ...
   * @see org.apache.robux.indexing.overlord.http.OverlordResource#taskPost
   */
  ...
  /**
   * @return The types of {@link org.apache.robux.data.input.InputSource} that the task uses. Empty set is returned if
   ...
   * {@link org.apache.robux.server.security.AuthConfig#enableInputSourceSecurity} config.
   ...
   * - When the task is executed by a middleManager, {@link org.apache.robux.indexing.overlord.ForkingTaskRunner} kills
   *   the process running the task, which triggers
   *   {@link org.apache.robux.indexing.overlord.SingleTaskBackgroundRunner#stop}.
   * - When the task is executed by an indexer, {@link org.apache.robux.indexing.overlord.ThreadingTaskRunner#shutdown}
