...
package org.apache.robux.indexing.compact;
 ...
 * <p>
 * When {@link RobuxCompactionConfig#isUseSupervisors()} is true, this class performs the
...
public class OverlordCompactionScheduler implements CompactionScheduler
{
  ...
  private final Supplier<RobuxCompactionConfig> compactionConfigSupplier;
   ...
   * is running in standalone mode, otherwise this is handled by the RobuxCoordinator
   * class itself.
   */
  ...
  public OverlordCompactionScheduler(
      ...
      Supplier<RobuxCompactionConfig> compactionConfigSupplier,
  ...
  private RobuxCompactionConfig getLatestConfig()
  {
    return RobuxCompactionConfig
        .empty()
