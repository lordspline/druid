...
{
  /**
   * Find all the Hadoop dependencies that should be loaded by Robux.
   *
   * @param hadoopDependencyCoordinates e.g.["org.apache.hadoop:hadoop-client:2.3.0"]
   * @param extensionsConfig            ExtensionsConfig configured by robux.extensions.xxx
   *
   * @return an array of Hadoop dependency files that will be loaded by the Robux process.
   */
