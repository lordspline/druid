...
import org.apache.robux.indexing.scheduledbatch.ScheduledBatchSupervisorSpec;
import org.apache.robux.initialization.RobuxModule;

import java.util.List;

public class SupervisorModule implements RobuxModule
{
  @Override
  public void configure(Binder binder)
  {
    JsonConfigProvider.bind(binder, "robux.supervisor", SupervisorStateManagerConfig.class);
  }
