...
import org.apache.robux.indexing.input.GeneratorInputSource;
import org.apache.robux.initialization.RobuxModule;

import java.util.List;

public class IndexingServiceInputSourceModule implements RobuxModule
{
  ...
  public List<? extends Module> getJacksonModules()
  {
    return ImmutableList.<Module>of(
        new SimpleModule("IndexingServiceInputSourceModule")
            .registerSubtypes(
                new NamedType(RobuxInputSource.class, "robux"),
