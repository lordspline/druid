...
{
  public static final String INDEXER_RUNNER_PROPERTY_PREFIX = "robux.indexer.runner";
  ...
  public static void configureTaskRunnerConfigs(Binder binder)
  {
    ...
    JsonConfigProvider.bind(binder, "robux.zk.paths.indexer", IndexerZkConfig.class);
  }
}
