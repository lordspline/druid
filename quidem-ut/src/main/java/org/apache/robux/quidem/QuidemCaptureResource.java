...
public class QuidemCaptureResource
{
  public static final File RECORD_PATH = ProjectPathUtils
      .getPathFromProjectRoot("quidem-ut/src/test/quidem/org.apache.robux.quidem.QTest");
  private URI quidemURI;
  private QuidemRecorder recorder = null;
  private RobuxHookDispatcher hookDispatcher;

  @Inject
  public QuidemCaptureResource(@Named("quidem") URI quidemURI, RobuxHookDispatcher hookDispatcher)
  {
