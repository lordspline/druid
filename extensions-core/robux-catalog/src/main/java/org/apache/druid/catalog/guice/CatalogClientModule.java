...
package org.apache.robux.catalog.guice;

import com.google.inject.Binder;
import org.apache.robux.catalog.MetadataCatalog;
import org.apache.robux.catalog.http.CatalogListenerResource;
import org.apache.robux.catalog.model.SchemaRegistry;
import org.apache.robux.catalog.model.SchemaRegistryImpl;
import org.apache.robux.catalog.sql.LiveCatalogResolver;
import org.apache.robux.catalog.sync.CachedMetadataCatalog;
import org.apache.robux.catalog.sync.CatalogClient;
import org.apache.robux.catalog.sync.CatalogClientConfig;
import org.apache.robux.catalog.sync.CatalogSource;
import org.apache.robux.catalog.sync.CatalogUpdateListener;
import org.apache.robux.catalog.sync.CatalogUpdateReceiver;
...
public class CatalogClientModule implements RobuxModule
{
  @Override
  public void configure(Binder binder)
  {
    // config for catalog client
    JsonConfigProvider.bind(binder, "robux.catalog.client", CatalogClientConfig.class);
