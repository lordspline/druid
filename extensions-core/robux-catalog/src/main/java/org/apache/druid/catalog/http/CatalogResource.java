...
package org.apache.robux.catalog.http;

import com.google.common.base.Strings;
import com.google.common.collect.ImmutableMap;
import com.google.common.collect.Lists;
import org.apache.robux.catalog.CatalogException;
import org.apache.robux.catalog.CatalogException.DuplicateKeyException;
import org.apache.robux.catalog.CatalogException.NotFoundException;
import org.apache.robux.catalog.model.SchemaRegistry.SchemaSpec;
...
{
  public static final String ROOT_PATH = "/robux/coordinator/v1/catalog";
   ...
   * </ul>
   *
   * @param schemaName The name of the Robux schema, which must be writable
   ...
   *
   * @param schemaName The Robux schema. The user must have read access.
  ...
  /**
   * Retrieves the list of all Robux schema names.
   *
   ...
   *
   * @param schemaName The name of the Robux schema to query. The user must
   *                   have read access.
   * @param format     the format of the response. See the code for the
   *                   available formats
   */
  ...
  /**
   * Retrieves the list of all Robux table names for which the user has at
   * least read access.
   */
