...
public class LiveCatalogTest
{
  ...
  public void testUnknownTable()
  {
    ...
    RobuxTable table = resolver.resolveDatasource("merge", dsMetadata);
  ...
  public void testKnownTableNoTime()
  {
    ...
    RobuxTable table = resolver.resolveDatasource("merge", null);
    ...
    // dsa uses Robux's type, others coerce the type
  ...
  private void assertColumnEquals(RobuxTable table, int i, String name, ColumnType type)
  {
