...
public class CacheNotifierTest
{
  ...
  {
    RobuxNode node1 = new RobuxNode("service", "host1", true, 1000, 0, true, false);
    RobuxNode node2 = new RobuxNode("service", "host2", true, 1000, 0, true, false);
    List<RobuxNode> nodes = Arrays.asList(node1, node2);
    Supplier<Iterable<RobuxNode>> nodeSupplier = () -> nodes;
