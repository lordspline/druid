...
public class CatalogClientModuleTest
{
  ...
  public void testClientConfigOverrides()
  {
    ...
    props.setProperty("robux.catalog.client.pollingPeriod", "300000");
    props.setProperty("robux.catalog.client.maxRandomDelay", "60000");
    props.setProperty("robux.catalog.client.maxSyncRetries", "1");
