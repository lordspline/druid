...
package org.apache.robux.data.input.parquet.simple;

import com.jayway.jsonpath.Configuration;
import com.jayway.jsonpath.JsonPath;
import com.jayway.jsonpath.Option;
import com.jayway.jsonpath.spi.json.JsonProvider;
import org.apache.robux.java.util.common.parsers.NotImplementedMappingProvider;
...
public class ParquetGroupFlattenerMaker implements ObjectFlatteners.FlattenerMaker<Group>
{
   ...
   * garbage that downstream robux cannot understand can be left behind in list and map types, so we deal with it here.
   */
