...
package org.apache.robux.data.input.parquet.avro;
...
import org.apache.robux.data.input.avro.AvroFlattenerMaker;
...
public class ParquetAvroHadoopInputRowParser implements InputRowParser<GenericRecord>
{
  ...
  /**
   * imitate avro extension {@link org.apache.robux.data.input.avro.AvroParsers#parseGenericRecord}
   */
  @Nonnull
  @Override
