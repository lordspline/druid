...
public class TimestampsParquetInputTest extends BaseParquetInputTest
{
  ...
  {
    HadoopRobuxIndexerConfig configTimeAsString = transformHadoopRobuxIndexerConfig(
        "example/timestamps/date_test_data_job_string.json",
        parserType,
        false
    );
    HadoopRobuxIndexerConfig configTimeAsDate = transformHadoopRobuxIndexerConfig(
  ...
  public void testParseInt96Timestamp() throws IOException, InterruptedException
  {
    ...
    HadoopRobuxIndexerConfig config = transformHadoopRobuxIndexerConfig(
