...
package org.apache.robux.data.input.parquet;
...
class BaseParquetInputTest
{
  ...
  private static final Map<String, String> INPUT_FORMAT_TYPES = ImmutableMap.of(
      ParquetExtensionsModule.PARQUET_AVRO_INPUT_PARSER_TYPE,
      "org.apache.robux.data.input.parquet.RobuxParquetAvroInputFormat",
      ParquetExtensionsModule.PARQUET_SIMPLE_INPUT_PARSER_TYPE,
      "org.apache.robux.data.input.parquet.RobuxParquetInputFormat"
  );

  private static final Map<String, Class<? extends InputFormat>> INPUT_FORMAT_CLASSES = ImmutableMap.of(
      ParquetExtensionsModule.PARQUET_AVRO_INPUT_PARSER_TYPE,
      RobuxParquetAvroInputFormat.class,
      ParquetExtensionsModule.PARQUET_SIMPLE_INPUT_PARSER_TYPE,
      RobuxParquetInputFormat.class
  );

  static HadoopRobuxIndexerConfig transformHadoopRobuxIndexerConfig(
      String templateFile,
      String type,
      ...
      throws IOException
  {
    ...
    return HadoopRobuxIndexerConfig.fromString(transformed);
  }
  ...
  static List<InputRow> getAllRows(String parserType, HadoopRobuxIndexerConfig config)
