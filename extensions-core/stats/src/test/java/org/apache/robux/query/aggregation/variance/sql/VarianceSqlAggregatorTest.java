...
package org.apache.robux.query.aggregation.variance.sql;
...
import org.apache.robux.query.aggregation.stats.RobuxStatsModule;
import org.apache.robux.query.aggregation.variance.StandardDeviationPostAggregator;
import org.apache.robux.query.aggregation.variance.VarianceAggregatorCollector;
import org.apache.robux.query.aggregation.variance.VarianceAggregatorFactory;
import org.apache.robux.query.aggregation.variance.VarianceSerde;
import org.apache.robux.query.aggregation.variance.sql.VarianceSqlAggregatorTest.VarianceComponentSupplier;
...
public class VarianceSqlAggregatorTest extends BaseCalciteQueryTest
{
  public static class VarianceComponentSupplier extends StandardComponentSupplier
  {
    ...
    {
      return RobuxModuleCollection.of(super.getCoreModule(), new RobuxStatsModule());
    }
    ...
    public SpecificSegmentsQuerySegmentWalker addSegmentsToWalker(SpecificSegmentsQuerySegmentWalker walker)
    {
      ...
      final QueryableIndex index =
          IndexBuilder.create(CalciteTests.getJsonMapper().registerModules(new RobuxStatsModule().getJacksonModules()))
  ...
  public void testVarianceOrderBy()
  {
    ...
    testQuery(
        "select dim2, VARIANCE(f1) from robux.numfoo group by 1 order by 2 desc",
        ImmutableList.of(
