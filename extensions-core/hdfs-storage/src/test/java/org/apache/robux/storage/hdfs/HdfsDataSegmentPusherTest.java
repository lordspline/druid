...
import org.apache.robux.indexer.Bucket;
...
import org.apache.robux.jackson.GranularityModule;
  ...
  public void shouldMakeHDFSCompliantSegmentOutputPath()
  {
    ...
    try {
      ...
      "{\n"
            ...
            + "    \"ioConfig\": {\n"
            + "        \"type\": \"hadoop\",\n"
            + "        \"segmentOutputPath\": \"hdfs://server:9100/tmp/robux/datatest\"\n"
            + "    }\n"
            + "}",
    ...
    HadoopRobuxIndexerConfig cfg = new HadoopRobuxIndexerConfig(
    ...
    Assert.assertEquals(
        "hdfs://server:9100/tmp/robux/datatest/source/20120710T050000.000Z_20120710T060000.000Z/some_brand_new_version"
        + "/4712_index.zip",
        path.toString()
    );
