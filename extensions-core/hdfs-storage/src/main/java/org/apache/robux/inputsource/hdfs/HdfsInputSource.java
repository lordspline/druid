...
package org.apache.robux.inputsource.hdfs;
...
import org.apache.robux.data.input.impl.systemfield.SystemFieldInputSource;
...
import org.apache.robux.storage.hdfs.HdfsStorageRobuxModule;
...
{
  static final String TYPE_KEY = HdfsStorageRobuxModule.SCHEME;
