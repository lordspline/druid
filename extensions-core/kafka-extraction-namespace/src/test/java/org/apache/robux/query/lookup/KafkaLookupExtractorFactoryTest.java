...
import org.apache.robux.server.lookup.namespace.cache.MockNamespaceExtractionCacheManager;
...
public class KafkaLookupExtractorFactoryTest
{
  ...
  public void setUp()
  {
    mapper.setInjectableValues(new InjectableValues()
    {
      ...
      {
        if ("org.apache.robux.server.lookup.namespace.cache.NamespaceExtractionCacheManager".equals(valueId)) {
          return cacheManager;
        } else {
          return null;
        }
