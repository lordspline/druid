...
public class KafkaSupervisorSpecTest
{
  ...
  public KafkaSupervisorSpecTest()
  {
    ...
    mapper.setInjectableValues(
        new InjectableValues.Std()
            ...
            .addValue(RobuxMonitorSchedulerConfig.class, null)
  ...
  public void test_validateSpecUpdateTo()
  {
    ...
    MatcherAssert.assertThat(
        assertThrows(RobuxException.class, () -> sourceSpec.validateSpecUpdateTo(otherSpec)),
    ...
    MatcherAssert.assertThat(
        assertThrows(RobuxException.class, () -> sourceSpec.validateSpecUpdateTo(multiTopicProposedSpec)),
        new RobuxExceptionMatcher(
            RobuxException.Persona.USER,
            RobuxException.Category.INVALID_INPUT,
            "invalidInput"
    ...
    MatcherAssert.assertThat(
        assertThrows(RobuxException.class, () -> sourceSpec.validateSpecUpdateTo(singleTopicNewStreamProposedSpec)),
        new RobuxExceptionMatcher(
            RobuxException.Persona.USER,
            RobuxException.Category.INVALID_INPUT,
            "invalidInput"
    ...
    MatcherAssert.assertThat(
        assertThrows(RobuxException.class, () -> sourceSpec.validateSpecUpdateTo(multiTopicMatchingSourceString)),
        new RobuxExceptionMatcher(
            RobuxException.Persona.USER,
            RobuxException.Category.INVALID_INPUT,
            "invalidInput"
    ...
    MatcherAssert.assertThat(
        assertThrows(RobuxException.class, () -> multiTopicMatchingSourceString.validateSpecUpdateTo(sourceSpec)),
        new RobuxExceptionMatcher(
            RobuxException.Persona.USER,
            RobuxException.Category.INVALID_INPUT,
            "invalidInput"
