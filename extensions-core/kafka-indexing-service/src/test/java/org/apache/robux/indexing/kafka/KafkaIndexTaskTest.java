...
import org.apache.robux.data.input.kafkainput.KafkaInputFormat;
import org.apache.robux.data.input.kafkainput.KafkaStringHeaderFormat;
...
import org.apache.robux.indexing.common.task.IndexTaskTest;
import org.apache.robux.indexing.common.task.ParseExceptionReport;
import org.apache.robux.indexing.common.task.Task;
import org.apache.robux.indexing.common.task.Tasks;
import org.apache.robux.indexing.kafka.supervisor.KafkaSupervisor;
...
import org.apache.robux.indexing.seekablestream.SeekableStreamIndexTaskTestBase;
import org.apache.robux.indexing.seekablestream.SeekableStreamStartSequenceNumbers;
import org.apache.robux.indexing.seekablestream.SettableByteEntity;
...
import org.apache.robux.segment.incremental.RowMeters;
import org.apache.robux.segment.indexing.DataSchema;
import org.apache.robux.segment.transform.ExpressionTransform;
...
public class KafkaIndexTaskTest extends SeekableStreamIndexTaskTestBase
{
  ...
  public void testRunOneTaskTwoPartitions() throws Exception
  {
    ...
    // desc3 will not be created in KafkaIndexTask (0.12.x) as it does not create per Kafka partition Robux segments
  ...
  {
    // This is both a serde test and a regression test for https://github.com/apache/robux/issues/7724.
  ...
  {
    ScanQuery query = new Robuxs.ScanQueryBuilder().dataSource(NEW_DATA_SCHEMA.getDataSource())
                                                   .intervals(spec)
  ...
  public void testMultipleLinesJSONText() throws Exception
  {
    ...
    //multiple objects in one Kafka record will yield 2 rows in robux
