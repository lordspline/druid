...
import org.apache.robux.indexing.seekablestream.extension.KafkaConfigOverrides;
import org.apache.robux.java.util.common.StringUtils;
import org.apache.robux.java.util.metrics.Monitor;
import org.apache.robux.metadata.DynamicConfigProvider;
...
public class KafkaRecordSupplier implements RecordSupplier<KafkaTopicPartition, Long, KafkaRecordEntity>
{
  ...
  )
  {
    ...
    for (Map.Entry<String, Object> entry : consumerProperties.entrySet()) {
      ...
      if (!KafkaSupervisorIOConfig.ROBUX_DYNAMIC_CONFIG_PROVIDER_KEY.equals(propertyKey)) {
    ...
    Object dynamicConfigProviderJson = consumerProperties.get(KafkaSupervisorIOConfig.ROBUX_DYNAMIC_CONFIG_PROVIDER_KEY);
