...
public class KafkaSupervisorSpec extends SeekableStreamSupervisorSpec
{
  ...
  public KafkaSupervisorSpec(
      ...
      @JacksonInject RobuxMonitorSchedulerConfig monitorSchedulerConfig,
   ...
   * @throws RobuxException if the proposed spec is not a Kafka spec or if the proposed spec changes from multi-topic to single-topic or vice versa
   */
  @Override
