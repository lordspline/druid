...
import org.apache.robux.common.aws.AWSClientConfig;
import org.apache.robux.common.aws.AWSEndpointConfig;
import org.apache.robux.common.aws.AWSProxyConfig;
import org.apache.robux.data.input.InputEntity;
import org.apache.robux.data.input.InputSplit;
import org.apache.robux.data.input.impl.CloudObjectInputSource;
import org.apache.robux.data.input.impl.CloudObjectLocation;
import org.apache.robux.data.input.impl.CloudObjectSplitWidget;
...
import org.apache.robux.storage.s3.S3InputDataConfig;
import org.apache.robux.storage.s3.S3StorageRobuxModule;
import org.apache.robux.storage.s3.S3Utils;
import org.apache.robux.storage.s3.ServerSideEncryptingAmazonS3;
...
{
  public static final String TYPE_KEY = S3StorageRobuxModule.SCHEME;
  ...
  {
    super(S3StorageRobuxModule.SCHEME, uris, prefixes, objects, objectGlob, systemFields);
  ...
  )
  {
    ...
    if (assumeRoleArn != null) {
      String roleSessionName = StringUtils.format("robux-s3-input-source-%s", UUID.randomUUID().toString());
