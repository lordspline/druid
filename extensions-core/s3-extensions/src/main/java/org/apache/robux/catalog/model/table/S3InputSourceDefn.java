...
import org.apache.robux.catalog.model.table.BaseTableFunction.Parameter;
import org.apache.robux.catalog.model.table.TableFunction.ParameterDefn;
import org.apache.robux.catalog.model.table.TableFunction.ParameterType;
...
public class S3InputSourceDefn extends FormattedInputSourceDefn
{
   ...
   * that bucket. That is, if the user sets this, Robux will generate the {@code objects}
  ...
  {
    jsonMap.put(InputSource.TYPE_PROPERTY, S3StorageRobuxModule.SCHEME);
