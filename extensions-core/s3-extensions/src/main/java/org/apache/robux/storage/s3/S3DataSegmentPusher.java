...
public class S3DataSegmentPusher implements DataSegmentPusher
{
  ...
  {
    return ImmutableList.of("robux.s3");
  }
  ...
  public DataSegment pushToPath(File indexFilesDir, DataSegment inSegment, String storageDirSuffix) throws IOException
  {
    ...
    final File zipOutFile = File.createTempFile("robux", "index.zip");
  ...
  /**
   * Any change in loadSpec need to be reflected {@link org.apache.robux.indexer.JobHelper#getURIFromSegment()}
   */
