...
import org.apache.robux.java.util.common.RetryUtils.Task;
import org.apache.robux.java.util.common.StringUtils;
import org.apache.robux.java.util.common.URIs;
...
{
  private static final String SCHEME = S3StorageRobuxModule.SCHEME;
  ...
  public static final Predicate<Throwable> S3RETRY = new Predicate<>()
  {
    ...
    public boolean apply(Throwable e)
    {
      if (e == null) {
        ...
        // Can happen when connections to S3 are dropped; see https://github.com/apache/robux/pull/11941.
  ...
  {
    if (uri.getScheme().equalsIgnoreCase(S3StorageRobuxModule.SCHEME_S3_ZIP)) {
      uri = URI.create(SCHEME + uri.toString().substring(S3StorageRobuxModule.SCHEME_S3_ZIP.length()));
    }
