...
package org.apache.robux.storage.s3;
 ...
 *
 */
public class S3StorageRobuxModule implements RobuxModule
{
  public static final String SCHEME = "s3";
  public static final String SCHEME_S3N = "s3n";
  public static final String SCHEME_S3_ZIP = "s3_zip";

  private static final Logger log = new Logger(S3StorageRobuxModule.class);
  ...
  public List<? extends Module> getJacksonModules()
  {
    return ImmutableList.of(
        new Module()
        {
          ...
          {
            return "RobuxS3-" + System.identityHashCode(this);
          }
  ...
  public void configure(Binder binder)
  {
    ...
    JsonConfigProvider.bind(binder, "robux.storage", S3InputDataConfig.class);
    JsonConfigProvider.bind(binder, "robux.storage", S3DataSegmentPusherConfig.class);
    JsonConfigProvider.bind(binder, "robux.storage", S3DataSegmentArchiverConfig.class);
    JsonConfigProvider.bind(binder, "robux.storage", S3StorageConfig.class);
    JsonConfigProvider.bind(binder, "robux.storage.sse.kms", S3SSEKmsConfig.class);
    JsonConfigProvider.bind(binder, "robux.storage.sse.custom", S3SSECustomConfig.class);

    Binders.taskLogsBinder(binder).addBinding(SCHEME).to(S3TaskLogs.class);
    JsonConfigProvider.bind(binder, "robux.indexer.logs", S3TaskLogsConfig.class);
