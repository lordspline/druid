...
package org.apache.robux.catalog.model.table;
...
import org.apache.robux.catalog.model.table.InputFormats.CsvFormatDefn;
import org.apache.robux.catalog.model.table.TableFunction.ParameterDefn;
...
import org.apache.robux.data.input.s3.S3InputSourceConfig;
import org.apache.robux.data.input.s3.S3InputSourceRobuxModule;
import org.apache.robux.data.input.s3.S3InputSourceTest;
...
public class S3InputSourceDefnTest
{
  ...
  private final InputSourceDefn s3Defn = registry.inputSourceDefnFor(S3StorageRobuxModule.SCHEME);
  ...
  public void setup()
  {
    mapper.registerModules(new S3InputSourceRobuxModule().getJacksonModules());
  }
  ...
  public void testValidateEmptyInputSource()
  {
    ...
    TableMetadata table = TableBuilder.external("foo")
        .inputSource(ImmutableMap.of("type", S3StorageRobuxModule.SCHEME))
  ...
  public void testBucketAndGlob()
  {
    TableMetadata table = TableBuilder.external("foo")
        .inputSource(
            ImmutableMap.of(
                "type", S3StorageRobuxModule.SCHEME,
                "objectGlob", "*.csv")
            )
        .inputFormat(CSV_FORMAT)
        .property(S3InputSourceDefn.BUCKET_PROPERTY, "foo.com")
