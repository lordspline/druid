...
public class S3StorageRobuxModuleTest
{
  @Test
  public void testSegmentKillerBoundSingleton()
  {
    ...
    Assert.assertTrue(killer.getKillers().containsKey(S3StorageRobuxModule.SCHEME_S3_ZIP));
    Assert.assertSame(
        killer.getKillers().get(S3StorageRobuxModule.SCHEME_S3_ZIP).get(),
        killer.getKillers().get(S3StorageRobuxModule.SCHEME_S3_ZIP).get()
    );
  }
  ...
  public void testSegmentArchiverBoundSingleton()
  {
    ...
    Assert.assertTrue(archiver.getArchivers().containsKey(S3StorageRobuxModule.SCHEME_S3_ZIP));
    Assert.assertSame(
        archiver.getArchivers().get(S3StorageRobuxModule.SCHEME_S3_ZIP).get(),
        archiver.getArchivers().get(S3StorageRobuxModule.SCHEME_S3_ZIP).get()
    );
  }
  ...
  public void testSegmentMoverBoundSingleton()
  {
    ...
    Assert.assertTrue(mover.getMovers().containsKey(S3StorageRobuxModule.SCHEME_S3_ZIP));
    Assert.assertSame(
        mover.getMovers().get(S3StorageRobuxModule.SCHEME_S3_ZIP).get(),
        mover.getMovers().get(S3StorageRobuxModule.SCHEME_S3_ZIP).get()
    );
  }
