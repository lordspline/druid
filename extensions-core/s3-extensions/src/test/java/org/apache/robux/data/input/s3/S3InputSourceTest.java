...
import org.apache.robux.storage.s3.NoopServerSideEncryption;
import org.apache.robux.storage.s3.S3InputDataConfig;
import org.apache.robux.storage.s3.S3TransferConfig;
...
public class S3InputSourceTest extends InitializedNullHandlingTest
{
  ...
  {
    RobuxModule baseModule = new TestS3Module();
  ...
  public static class TestS3Module implements RobuxModule
  {
    @Override
