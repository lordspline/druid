...
import org.apache.robux.data.input.AvroStreamInputRowParserTest;
import org.apache.robux.data.input.SomeAvroDatum;
...
public class SchemaRegistryBasedAvroBytesDecoderTest
{
  ...
  public void testParseHeader() throws JsonProcessingException
  {
    ...
    Map<String, String> header = DynamicConfigProviderUtils.extraConfigAndSetStringMap(
        decoder.getHeaders(),
        SchemaRegistryBasedAvroBytesDecoder.ROBUX_DYNAMIC_CONFIG_PROVIDER_KEY,
