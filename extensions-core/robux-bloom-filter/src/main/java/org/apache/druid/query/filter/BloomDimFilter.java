    ...
    return new DimensionPredicateFilter(
        ...
        new RobuxPredicateFactory()
        {
          ...
          public RobuxObjectPredicate<String> makeStringPredicate()
          {
            return str -> {
              if (str == null) {
                return RobuxPredicateMatch.of(bloomKFilter.testBytes(null, 0, 0));
              }
              return RobuxPredicateMatch.of(bloomKFilter.testString(str));
            };
          }
          ...
          public RobuxLongPredicate makeLongPredicate()
          {
            return new RobuxLongPredicate()
            {
              ...
              {
                return RobuxPredicateMatch.of(bloomKFilter.testLong(input));
              }
          ...
          public RobuxFloatPredicate makeFloatPredicate()
          {
            return new RobuxFloatPredicate()
            {
              ...
              {
                return RobuxPredicateMatch.of(bloomKFilter.testFloat(input));
              }
          ...
          public RobuxDoublePredicate makeDoublePredicate()
          {
            return new RobuxDoublePredicate()
            {
              ...
              {
                return RobuxPredicateMatch.of(bloomKFilter.testDouble(input));
              }
