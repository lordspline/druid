...
package org.apache.robux.query.aggregation.bloom.sql;
...
import org.apache.robux.query.aggregation.bloom.BloomFilterAggregatorFactory;
import org.apache.robux.query.aggregation.bloom.sql.BloomFilterSqlAggregatorTest.BloomFilterSqlAggComponentSupplier;
...
public class BloomFilterSqlAggregatorTest extends BaseCalciteQueryTest
{
  ...
  public static class BloomFilterSqlAggComponentSupplier extends StandardComponentSupplier
  {
    ...
    {
      return RobuxModuleCollection.of(super.getCoreModule(), new BloomFilterExtensionModule());
    }
