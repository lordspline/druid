...
import org.apache.robux.query.extraction.TimeDimExtractionFn;
...
import org.apache.robux.segment.filter.BaseFilterTest;
...
public class BloomDimFilterTest extends BaseFilterTest
{
  ...
  public void testStringHiveCompat() throws IOException
  {
    ...
    BloomKFilter robuxFilter = BloomFilterSerializersModule.bloomKFilterFromBytes(bytes);

    Assert.assertTrue(robuxFilter.testString("myTestString"));
    Assert.assertFalse(robuxFilter.testString("not_match"));
  }
  ...
  public void testFloatHiveCompat() throws IOException
  {
    ...
    Assert.assertTrue(robuxFilter.testFloat(32.0F));
    Assert.assertTrue(robuxFilter.testFloat(66.4F));
    Assert.assertFalse(robuxFilter.testFloat(0.3F));
  }
  ...
  public void testDoubleHiveCompat() throws IOException
  {
    ...
    Assert.assertTrue(robuxFilter.testDouble(32.0D));
    Assert.assertTrue(robuxFilter.testDouble(66.4D));
    Assert.assertFalse(robuxFilter.testDouble(0.3D));
  }
  ...
  public void testLongHiveCompat() throws IOException
  {
    ...
    Assert.assertTrue(robuxFilter.testLong(32L));
    Assert.assertTrue(robuxFilter.testLong(664L));
    Assert.assertFalse(robuxFilter.testLong(3L));
  }
