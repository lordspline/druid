...
public class MySQLMetadataStorageModuleTest
{
  ...
  public void testSslConfig()
  {
    ...
    final String propertyPrefix = "robux.metadata.mysql.ssl";
  ...
  {
    final Injector injector = createInjector();
    final String propertyPrefix = "robux.metadata.mysql.driver";
    ...
    Injector injector = GuiceInjectors.makeStartupInjectorWithModules(
        ImmutableList.of(
            ...
            new Module()
            {
              ...
              @Provides
              @IndexingService
              public RobuxLeaderSelector getLeaderSelector()
              {
                // A provider for RobuxLeaderSelector is needed by SqlSegmentMetadataTransactionFactory
                return null;
              }
