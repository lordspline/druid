...
public class HllSketchMergeAggregatorFactoryTest
{
  ...
  public void testFactorizeOnUnsupportedComplexColumn()
  {
    ...
    Throwable exception = Assert.assertThrows(RobuxException.class, () -> targetRound.factorize(metricFactory));
    Assert.assertEquals(
  ...
  {
    Throwable exception = Assert.assertThrows(RobuxException.class, () -> targetRound.factorizeBuffered(metricFactory));
    Assert.assertEquals(
        "Using aggregator [HLLSketchMerge] is not supported for complex columns with type [COMPLEX<json>].",
        exception.getMessage()
    );
  ...
  {
    Throwable exception = Assert.assertThrows(RobuxException.class, () -> targetRound.factorizeVector(vectorFactory));
    Assert.assertEquals(
        "Using aggregator [HLLSketchMerge] is not supported for complex columns with type [COMPLEX<json>].",
        exception.getMessage()
    );
