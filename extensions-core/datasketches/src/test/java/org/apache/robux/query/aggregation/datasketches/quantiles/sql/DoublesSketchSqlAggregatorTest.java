...
package org.apache.robux.query.aggregation.datasketches.quantiles.sql;
...
import org.apache.robux.query.aggregation.datasketches.quantiles.DoublesSketchAggregatorFactory;
import org.apache.robux.query.aggregation.datasketches.quantiles.DoublesSketchModule;
import org.apache.robux.query.aggregation.datasketches.quantiles.DoublesSketchToCDFPostAggregator;
import org.apache.robux.query.aggregation.datasketches.quantiles.DoublesSketchToHistogramPostAggregator;
import org.apache.robux.query.aggregation.datasketches.quantiles.DoublesSketchToQuantilePostAggregator;
import org.apache.robux.query.aggregation.datasketches.quantiles.DoublesSketchToQuantilesPostAggregator;
import org.apache.robux.query.aggregation.datasketches.quantiles.DoublesSketchToRankPostAggregator;
import org.apache.robux.query.aggregation.datasketches.quantiles.DoublesSketchToStringPostAggregator;
import org.apache.robux.query.aggregation.datasketches.quantiles.sql.DoublesSketchSqlAggregatorTest.DoublesSketchComponentSupplier;
...
public class DoublesSketchSqlAggregatorTest extends BaseCalciteQueryTest
{
  protected static class DoublesSketchComponentSupplier extends StandardComponentSupplier
  {
    ...
    {
      return RobuxModuleCollection.of(super.getCoreModule(), new DoublesSketchModule());
    }
  ...
  public void testDoublesSketchPostAggsPostSort()
  {
    testQuery(
        ...
        + "SELECT DS_QUANTILES_SKETCH(m1) as y FROM robux.foo ORDER BY DS_GET_QUANTILE(DS_QUANTILES_SKETCH(m1), 0.5) DESC LIMIT 10"
        + ")",
        Collections.singletonList(
            Robuxs.newTimeseriesQueryBuilder()
                  .dataSource(CalciteTests.DATASOURCE1)
