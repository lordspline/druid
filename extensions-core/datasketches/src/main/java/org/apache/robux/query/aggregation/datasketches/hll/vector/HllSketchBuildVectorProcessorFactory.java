...
package org.apache.robux.query.aggregation.datasketches.hll.vector;

import org.apache.robux.error.RobuxException;
import org.apache.robux.java.util.common.StringEncoding;
import org.apache.robux.query.aggregation.datasketches.hll.HllSketchBuildBufferAggregatorHelper;
...
public class HllSketchBuildVectorProcessorFactory implements VectorColumnProcessorFactory<HllSketchBuildVectorProcessor>
{
  ...
  {
    throw RobuxException.defensive("ARRAY types are not supported for hll sketch");
  }
