...
public class KllFloatsSketchToQuantilePostAggregator implements PostAggregator
{
  ...
  @JsonCreator
  public KllFloatsSketchToQuantilePostAggregator(
  ...
  {
    return new CacheKeyBuilder(PostAggregatorIds.KLL_FLOATS_SKETCH_TO_QUANTILE_CACHE_TYPE_ID)
  ...
  public boolean equals(Object o)
  {
    ...
    KllFloatsSketchToQuantilePostAggregator that = (KllFloatsSketchToQuantilePostAggregator) o;
