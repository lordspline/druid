...
public class KllFloatsSketchToRankPostAggregator implements PostAggregator
{
  ...
  @JsonCreator
  public KllFloatsSketchToRankPostAggregator(
  ...
  {
    return new CacheKeyBuilder(PostAggregatorIds.KLL_FLOATS_SKETCH_TO_RANK_CACHE_TYPE_ID)
        .appendCacheable(field).appendFloat(value).build();
  }
