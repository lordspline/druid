...
public class KllDoublesSketchBuildVectorAggregator implements VectorAggregator
{
  private final VectorValueSelector selector;
  private final KllDoublesSketchBuildBufferAggregatorHelper helper;

  KllDoublesSketchBuildVectorAggregator(
  ...
  public void aggregate(final ByteBuffer buf, final int position, final int startRow, final int endRow)
  {
    ...
    final KllDoublesSketch sketch = helper.getSketchAtPosition(buf, position);
