...
package org.apache.robux.data.input.orc;
...
public class OrcHadoopInputRowParserTest
{
  ...
  public void testTest1() throws IOException
  {
    ...
    HadoopRobuxIndexerConfig config = loadHadoopRobuxIndexerConfig("example/test_1_hadoop_job.json");
  ...
  {
    HadoopRobuxIndexerConfig config = loadHadoopRobuxIndexerConfig("example/test_2_hadoop_job.json");
    Job job = Job.getInstance(new Configuration());
    config.intoConfiguration(job);
    /*
      test_2.orc
  ...
  public void testOrcFile11Format() throws IOException
  {
    ...
    HadoopRobuxIndexerConfig config =
        loadHadoopRobuxIndexerConfig("example/orc-file-11-format-hadoop-job.json");
  ...
  public void testOrcSplitElim() throws IOException
  {
     ...
     */
    HadoopRobuxIndexerConfig config = loadHadoopRobuxIndexerConfig("example/orc_split_elim_hadoop_job.json");
    Job job = Job.getInstance(new Configuration());
    config.intoConfiguration(job);
  ...
  public void testDate1900() throws IOException
  {
     ...
     */
    HadoopRobuxIndexerConfig config = loadHadoopRobuxIndexerConfig("example/testDate1900_hadoop_job.json");
    Job job = Job.getInstance(new Configuration());
    config.intoConfiguration(job);
  ...
  public void testDate2038() throws IOException
  {
     ...
     */
    HadoopRobuxIndexerConfig config = loadHadoopRobuxIndexerConfig("example/testDate2038_hadoop_job.json");
    Job job = Job.getInstance(new Configuration());
    config.intoConfiguration(job);
  ...
  private static HadoopRobuxIndexerConfig loadHadoopRobuxIndexerConfig(String configPath)
  {
    return HadoopRobuxIndexerConfig.fromFile(new File(configPath));
  }
  ...
  private static List<InputRow> getAllRows(HadoopRobuxIndexerConfig config) throws IOException
  {
    Job job = Job.getInstance(new Configuration());
    config.intoConfiguration(job);
