...
package org.apache.robux.query.lookup.namespace;
...
import org.apache.robux.java.util.common.parsers.CSVParser;
import org.apache.robux.java.util.common.parsers.DelimitedParser;
...
import org.apache.robux.java.util.common.parsers.JSONPathParser;
  ...
  public static class TSVFlatDataParser implements FlatDataParser
  {
    ...
    )
    {
      ...
      final DelimitedParser delegate = new DelimitedParser(
          StringUtils.emptyToNullNonRobuxDataString(delimiter),
          StringUtils.emptyToNullNonRobuxDataString(listDelimiter),
          hasHeaderRow,
          skipHeaderRows,
          false
      );
