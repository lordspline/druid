...
import org.apache.robux.storage.google.GoogleStorageObjectPage;
...
public class GoogleCloudStorageInputSourceTest extends InitializedNullHandlingTest
{
  ...
  {
    final RobuxModule baseModule = new TestGoogleModule();
  ...
  private static class TestGoogleModule implements RobuxModule
  {
    @Override
