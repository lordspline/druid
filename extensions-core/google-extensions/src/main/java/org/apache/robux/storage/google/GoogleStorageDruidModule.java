...
package org.apache.robux.storage.google;
...
public class GoogleStorageRobuxModule implements RobuxModule
{
  public static final String SCHEME = "google";
  public static final String SCHEME_GS = "gs";
  private static final Logger LOG = new Logger(GoogleStorageRobuxModule.class);
  private static final String APPLICATION_NAME = "robux-google-extensions";
  ...
  {
    LOG.info("Configuring GoogleStorageRobuxModule...");

    JsonConfigProvider.bind(binder, "robux.google", GoogleInputDataConfig.class);
    JsonConfigProvider.bind(binder, "robux.google", GoogleAccountConfig.class);
    ...
    JsonConfigProvider.bind(binder, "robux.indexer.logs", GoogleTaskLogsConfig.class);
