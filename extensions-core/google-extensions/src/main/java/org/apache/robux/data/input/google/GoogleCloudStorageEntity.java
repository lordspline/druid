...
public class GoogleCloudStorageEntity extends RetryingInputEntity
{
  ...
  public URI getUri()
  {
    return location.toUri(GoogleStorageRobuxModule.SCHEME_GS);
  }
