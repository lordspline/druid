...
package org.apache.robux.data.input.google;
...
import org.apache.robux.storage.google.GoogleStorageObjectMetadata;
import org.apache.robux.storage.google.GoogleUtils;
...
{
  public static final String TYPE_KEY = GoogleStorageRobuxModule.SCHEME;
  ...
  {
    super(GoogleStorageRobuxModule.SCHEME_GS, uris, prefixes, objects, objectGlob, systemFields);
