...
import org.apache.robux.data.input.impl.prefetch.ObjectOpenFunction;
...
import org.apache.robux.storage.remote.ChunkingStorageConnector;
import org.apache.robux.storage.remote.ChunkingStorageConnectorParameters;
  ...
  public void deleteRecursively(String path) throws IOException
  {
    ...
    Iterator<GoogleStorageObjectMetadata> storageObjects = GoogleUtils.lazyFetchingStorageObjectsIterator(
        ...
        ImmutableList.of(new CloudObjectLocation(config.getBucket(), fullPath)
                             .toUri(GoogleStorageRobuxModule.SCHEME_GS)).iterator(),
