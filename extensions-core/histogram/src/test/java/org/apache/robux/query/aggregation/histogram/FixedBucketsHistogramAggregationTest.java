...
public class FixedBucketsHistogramAggregationTest extends InitializedNullHandlingTest
{
  ...
  public FixedBucketsHistogramAggregationTest(final GroupByQueryConfig config)
  {
    ...
    helper = AggregationTestHelper.createGroupByQueryAggregationTestHelper(
        Lists.newArrayList(new ApproximateHistogramRobuxModule().getJacksonModules()),
        config,
        tempFolder
    );
  }
  ...
  /**
   * When {@link org.apache.robux.segment.RowCombiningTimeAndDimsIterator#moveToNext} is merging indexes,
   * if {@link org.apache.robux.segment.MergingRowIterator#hasTimeAndDimsChangedSinceMark} is false, then
   * {@link org.apache.robux.query.aggregation.AggregateCombiner#reset} gets called. This is the only path
