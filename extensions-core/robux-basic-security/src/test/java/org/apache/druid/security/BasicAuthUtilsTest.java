...
package org.apache.robux.security;
...
import org.apache.robux.security.basic.BasicSecurityRobuxModule;
...
public class BasicAuthUtilsTest
{
  ...
  public void testPermissionSerdeIsChillAboutUnknownEnumStuffs() throws JsonProcessingException
  {
    ...
    mapper.registerModules(new BasicSecurityRobuxModule().getJacksonModules());
