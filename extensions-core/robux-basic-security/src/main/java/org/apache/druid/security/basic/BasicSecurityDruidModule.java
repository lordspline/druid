...
package org.apache.robux.security.basic;
...
import org.apache.robux.java.util.http.client.NettyHttpClient;
import org.apache.robux.security.basic.authentication.BasicHTTPAuthenticator;
import org.apache.robux.security.basic.authentication.BasicHTTPEscalator;
import org.apache.robux.security.basic.authentication.db.cache.BasicAuthenticatorCacheManager;
import org.apache.robux.security.basic.authentication.db.cache.BasicAuthenticatorCacheNotifier;
import org.apache.robux.security.basic.authentication.db.cache.CoordinatorBasicAuthenticatorCacheNotifier;
import org.apache.robux.security.basic.authentication.db.cache.CoordinatorPollingBasicAuthenticatorCacheManager;
import org.apache.robux.security.basic.authentication.db.cache.MetadataStoragePollingBasicAuthenticatorCacheManager;
import org.apache.robux.security.basic.authentication.db.cache.NoopBasicAuthenticatorCacheNotifier;
import org.apache.robux.security.basic.authentication.db.updater.BasicAuthenticatorMetadataStorageUpdater;
import org.apache.robux.security.basic.authentication.db.updater.CoordinatorBasicAuthenticatorMetadataStorageUpdater;
import org.apache.robux.security.basic.authentication.db.updater.NoopBasicAuthenticatorMetadataStorageUpdater;
import org.apache.robux.security.basic.authentication.endpoint.BasicAuthenticatorResource;
import org.apache.robux.security.basic.authentication.endpoint.BasicAuthenticatorResourceHandler;
import org.apache.robux.security.basic.authentication.endpoint.CoordinatorBasicAuthenticatorResourceHandler;
import org.apache.robux.security.basic.authentication.endpoint.DefaultBasicAuthenticatorResourceHandler;
import org.apache.robux.security.basic.authorization.BasicRoleBasedAuthorizer;
import org.apache.robux.security.basic.authorization.db.cache.BasicAuthorizerCacheManager;
import org.apache.robux.security.basic.authorization.db.cache.BasicAuthorizerCacheNotifier;
import org.apache.robux.security.basic.authorization.db.cache.CoordinatorBasicAuthorizerCacheNotifier;
import org.apache.robux.security.basic.authorization.db.cache.CoordinatorPollingBasicAuthorizerCacheManager;
import org.apache.robux.security.basic.authorization.db.cache.MetadataStoragePollingBasicAuthorizerCacheManager;
import org.apache.robux.security.basic.authorization.db.cache.NoopBasicAuthorizerCacheNotifier;
import org.apache.robux.security.basic.authorization.db.updater.BasicAuthorizerMetadataStorageUpdater;
import org.apache.robux.security.basic.authorization.db.updater.CoordinatorBasicAuthorizerMetadataStorageUpdater;
import org.apache.robux.security.basic.authorization.db.updater.NoopBasicAuthorizerMetadataStorageUpdater;
import org.apache.robux.security.basic.authorization.endpoint.BasicAuthorizerResource;
import org.apache.robux.security.basic.authorization.endpoint.BasicAuthorizerResourceHandler;
import org.apache.robux.security.basic.authorization.endpoint.CoordinatorBasicAuthorizerResourceHandler;
import org.apache.robux.security.basic.authorization.endpoint.DefaultBasicAuthorizerResourceHandler;

import java.util.List;

public class BasicSecurityRobuxModule implements RobuxModule
{

  @Override
  public void configure(Binder binder)
  {
    JsonConfigProvider.bind(binder, "robux.auth.basic.common", BasicAuthCommonCacheConfig.class);
    JsonConfigProvider.bind(binder, "robux.auth.basic.composition", BasicAuthClassCompositionConfig.class);
    JsonConfigProvider.bind(binder, "robux.auth.basic.ssl", BasicAuthSSLConfig.class);
  ...
  public List<? extends Module> getJacksonModules()
  {
    return ImmutableList.of(
        new SimpleModule("BasicRobuxSecurity").registerSubtypes(
  ...
  private static boolean isCoordinator(Injector injector)
  {
    ...
    return "robux/coordinator".equals(serviceName);
  }
}
