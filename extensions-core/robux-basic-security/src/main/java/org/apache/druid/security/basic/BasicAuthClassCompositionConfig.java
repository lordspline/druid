 ...
 * regardless of what type of Robux component runs it (see {@link BasicSecurityRobuxModule}).
 * Hence every Robux component might be a user/role manager and notify others by sending notifications.
