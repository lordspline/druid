...
package org.apache.robux.security.basic.authentication.db.cache;
...
public class CoordinatorPollingBasicAuthenticatorCacheManager implements BasicAuthenticatorCacheManager
{
  ...
  private Map<String, BasicAuthenticatorUser> tryFetchUserMapFromCoordinator(String prefix) throws Exception
  {
    ...
    Request req = robuxLeaderClient.makeRequest(
        HttpMethod.GET,
        StringUtils.format("/robux-ext/basic-security/authentication/db/%s/cachedSerializedUserMap", prefix)
    );
