...
import org.apache.robux.security.basic.CommonCacheNotifier;
...
public class CoordinatorBasicAuthorizerCacheNotifier implements BasicAuthorizerCacheNotifier
{
  ...
  )
  {
    cacheUserNotifier = new CommonCacheNotifier(
        ...
        discoveryProvider,
        httpClient,
        "/robux-ext/basic-security/authorization/listen/users/%s",
    ...
    cacheGroupMappingNotifier = new CommonCacheNotifier(
        ...
        discoveryProvider,
        httpClient,
        "/robux-ext/basic-security/authorization/listen/groupMappings/%s",
        "CoordinatorBasicAuthorizerCacheNotifier"
    );
  }
