...
package org.apache.robux.security.basic.authentication;
...
import org.apache.robux.security.basic.BasicSecurityAuthenticationException;
import org.apache.robux.security.basic.authentication.db.cache.BasicAuthenticatorCacheManager;
import org.apache.robux.security.basic.authentication.validator.CredentialsValidator;
import org.apache.robux.security.basic.authentication.validator.MetadataStoreCredentialsValidator;
        ...
        throws IOException, ServletException
    {
      ...
      try {
        ...
        if (authenticationResult != null) {
          servletRequest.setAttribute(AuthConfig.ROBUX_AUTHENTICATION_RESULT, authenticationResult);
          filterChain.doFilter(servletRequest, servletResponse);
        } else {
          if (skipOnFailure) {
