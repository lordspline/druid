...
import org.apache.robux.server.lookup.jdbc.JdbcDataFetcher;
...
public interface DataFetcher<K, V>
{
   ...
   * One use case of this method is to populate a polling cache {@link org.apache.robux.server.lookup.cache.polling.PollingCache}
   *
