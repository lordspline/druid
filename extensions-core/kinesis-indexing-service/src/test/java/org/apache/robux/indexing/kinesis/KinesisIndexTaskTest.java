...
import org.apache.robux.indexing.kinesis.supervisor.KinesisSupervisor;
...
import org.apache.robux.indexing.seekablestream.SequenceMetadata;
...
public class KinesisIndexTaskTest extends SeekableStreamIndexTaskTestBase
{
  ...
  public void testComputeFetchThreads()
  {
    final RobuxProcessingConfigTest.MockRuntimeInfo runtimeInfo =
        new RobuxProcessingConfigTest.MockRuntimeInfo(3, 1000, 10_000_000_000L);
    ...
    final RobuxProcessingConfigTest.MockRuntimeInfo runtimeInfo2 =
        new RobuxProcessingConfigTest.MockRuntimeInfo(3, 1000, 1_000_000_000);
