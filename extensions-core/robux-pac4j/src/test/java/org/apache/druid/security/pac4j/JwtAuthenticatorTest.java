...
package org.apache.robux.security.pac4j;
...
public class JwtAuthenticatorTest
{
      ...
      throws IOException, ServletException
  {
    ...
    EasyMock.expect(req.getAttribute(AuthConfig.ROBUX_AUTHENTICATION_RESULT)).andReturn(null);
  ...
  {
    HttpServletRequest req = EasyMock.createMock(HttpServletRequest.class);
    EasyMock.expect(req.getAttribute(AuthConfig.ROBUX_AUTHENTICATION_RESULT)).andReturn("AlreadyAuthenticated");
      ...
      throws IOException, ServletException, BadJOSEException, JOSEException
  {
    ...
    req.setAttribute(AuthConfig.ROBUX_AUTHENTICATION_RESULT, new AuthenticationResult("foo", "allowAll", "jwt", null));
    EasyMock.expectLastCall().times(1);
    EasyMock.replay(req);
