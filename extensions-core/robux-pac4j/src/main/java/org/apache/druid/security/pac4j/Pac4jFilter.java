...
public class Pac4jFilter implements Filter
{
      ...
      throws IOException, ServletException
  {
    ...
    // could get HTTP redirect even if one of the robux authenticators in chain has successfully authenticated.
    if (servletRequest.getAttribute(AuthConfig.ROBUX_AUTHENTICATION_RESULT) != null) {
