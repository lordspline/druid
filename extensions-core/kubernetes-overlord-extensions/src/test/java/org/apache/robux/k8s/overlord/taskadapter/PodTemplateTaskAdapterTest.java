...
public class PodTemplateTaskAdapterTest
{
  ...
  @Test
  public void test_fromTask_withoutAnnotations_throwsRobuxException()
  {
    TestPodTemplateSelector podTemplateSelector = new TestPodTemplateSelector(podTemplateSpec);
    ...
    Assert.assertThrows(RobuxException.class, () -> adapter.toTask(job));
  }
  ...
  public void test_fromTask_noTemplate()
  {
    ...
    Assert.assertThrows(RobuxException.class, () -> adapter.fromTask(task));
  }
  ...
  public void test_fromTask_taskSupportsQueries() throws IOException
  {
    ...
    Assertions.assertEquals("true", actual.getSpec().getTemplate()
        ...
        .get(0).getEnv().stream()
        .filter(env -> env.getName().equals(RobuxK8sConstants.LOAD_BROADCAST_SEGMENTS_ENV))
  ...
  public void test_fromTask_withBroadcastDatasourceLoadingModeAll() throws IOException
  {
    ...
    Assertions.assertEquals(BroadcastDatasourceLoadingSpec.Mode.ALL.toString(), actual.getSpec().getTemplate()
                                          .getSpec().getContainers()
                                          .get(0).getEnv().stream()
                                          .filter(env -> env.getName().equals(RobuxK8sConstants.LOAD_BROADCAST_DATASOURCE_MODE_ENV))
                                          .collect(Collectors.toList()).get(0).getValue());
  }
  ...
  private void assertJobSpecsEqual(Job actual, Job expected) throws IOException
  {
    ...
    String actualTaskAnnotation = actualAnnotations.get(RobuxK8sConstants.TASK);
    actualAnnotations.remove(RobuxK8sConstants.TASK);
    ...
    String expectedTaskAnnotation = expectedAnnotations.get(RobuxK8sConstants.TASK);
    expectedAnnotations.remove(RobuxK8sConstants.TASK);
