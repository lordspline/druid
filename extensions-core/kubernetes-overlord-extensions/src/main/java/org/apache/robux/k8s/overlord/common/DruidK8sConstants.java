...
public class RobuxK8sConstants
{
  ...
  public static final String ROBUX_HOST_ENV = "robux_host";
  public static final String ROBUX_HOSTNAME_ENV = "HOSTNAME";
  public static final String LABEL_KEY = "robux.k8s.peons";
  public static final String OVERLORD_NAMESPACE_KEY = "robux.overlord.namespace";
  public static final String ROBUX_LABEL_PREFIX = "robux.";
