 ...
 */
public class RobuxKubernetesHttpClientFactory implements HttpClient.Factory
{
  private final Vertx vertx;

  public RobuxKubernetesHttpClientFactory(final RobuxKubernetesHttpClientConfig httpClientConfig)
  {
    this.vertx = createVertxInstance(httpClientConfig);
  }

  @Override
  public VertxHttpClientBuilder<RobuxKubernetesHttpClientFactory> newBuilder()
  {
   ...
   */
  private static Vertx createVertxInstance(final RobuxKubernetesHttpClientConfig httpClientConfig)
  {
