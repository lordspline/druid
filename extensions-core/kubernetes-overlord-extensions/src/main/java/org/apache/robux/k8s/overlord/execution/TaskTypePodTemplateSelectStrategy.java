...
import org.apache.robux.k8s.overlord.taskadapter.PodTemplateWithName;
...
public class TaskTypePodTemplateSelectStrategy implements PodTemplateSelectStrategy
{
  ...
  {
    String templateKey = templates.containsKey(task.getType()) ? task.getType() : RobuxK8sConstants.BASE_TEMPLATE_NAME;
