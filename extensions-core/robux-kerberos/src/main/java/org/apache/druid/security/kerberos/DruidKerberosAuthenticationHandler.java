...
public class RobuxKerberosAuthenticationHandler extends KerberosAuthenticationHandler
{
  private static final Logger log = new Logger(RobuxKerberosAuthenticationHandler.class);
  ...
  public void init(Properties config) throws ServletException
  {
    try {
      ...
      for (String spnegoPrincipal : spnegoPrincipals) {
        ...
        final KerberosAuthenticator.RobuxKerberosConfiguration kerberosConfiguration =
            new KerberosAuthenticator.RobuxKerberosConfiguration(keytab, spnegoPrincipal);
