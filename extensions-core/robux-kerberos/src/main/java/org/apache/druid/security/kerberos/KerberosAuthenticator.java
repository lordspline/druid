...
package org.apache.robux.security.kerberos;
...
public class KerberosAuthenticator implements Authenticator
{
  ...
  public KerberosAuthenticator(
      ...
      @JacksonInject @Self RobuxNode node
  )
  {
    ...
    return new AuthenticationFilter()
    {
      ...
      public void init(FilterConfig filterConfig) throws ServletException
      {
        ...
        try {
          ...
          // In case of robux since the class is actually loaded as an extension and filter init is done in main thread.
          ...
          throws IOException, ServletException
      {
        ...
        if (request.getAttribute(AuthConfig.ROBUX_AUTHENTICATION_RESULT) != null) {
        ...
        try {
          ...
          if (getAuthenticationHandler().managementOperation(token, httpRequest, httpResponse)) {
            ...
            if (token != null) {
              ...
              // Since this request is validated also set ROBUX_AUTHENTICATION_RESULT
  ...
  public Map<String, String> getInitParameters()
  {
    ...
    params.put(AuthenticationFilter.AUTH_TYPE, RobuxKerberosAuthenticationHandler.class.getName());
   ...
   */
  public static class RobuxKerberosConfiguration extends Configuration
  {
    private String keytab;
    private String principal;

    public RobuxKerberosConfiguration(String keytab, String principal)
    {
      this.keytab = keytab;
  ...
  private void initializeKerberosLogin() throws ServletException
  {
    ...
    try {
      ...
      RobuxKerberosConfiguration kerberosConfiguration = new RobuxKerberosConfiguration(keytab, serverPrincipal);
