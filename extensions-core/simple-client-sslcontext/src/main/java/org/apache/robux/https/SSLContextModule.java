...
package org.apache.robux.https;
...
public class SSLContextModule implements RobuxModule
{
  @Override
  public void configure(Binder binder)
  {
    JsonConfigProvider.bind(binder, "robux.client.https", SSLClientConfig.class);
