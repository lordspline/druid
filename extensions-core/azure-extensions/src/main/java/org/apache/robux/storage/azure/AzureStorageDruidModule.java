 ...
 */
public class AzureStorageRobuxModule implements RobuxModule
{
  ...
  public List<? extends Module> getJacksonModules()
  {
    return ImmutableList.of(
        new Module()
        {
          ...
          {
            return "RobuxAzure-" + System.identityHashCode(this);
          }
  ...
  {
    JsonConfigProvider.bind(binder, "robux.azure", AzureInputDataConfig.class);
    JsonConfigProvider.bind(binder, "robux.azure", AzureDataSegmentConfig.class);
    JsonConfigProvider.bind(binder, "robux.azure", AzureAccountConfig.class);
    ...
    JsonConfigProvider.bind(binder, "robux.indexer.logs", AzureTaskLogsConfig.class);
