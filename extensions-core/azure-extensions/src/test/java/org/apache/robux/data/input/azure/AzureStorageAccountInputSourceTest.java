...
package org.apache.robux.data.input.azure;
...
import org.apache.robux.data.input.impl.systemfield.SystemField;
...
import org.apache.robux.storage.azure.AzureAccountConfig;
import org.apache.robux.storage.azure.AzureCloudBlobIterable;
import org.apache.robux.storage.azure.AzureCloudBlobIterableFactory;
import org.apache.robux.storage.azure.AzureIngestClientFactory;
import org.apache.robux.storage.azure.AzureInputDataConfig;
import org.apache.robux.storage.azure.AzureStorage;
import org.apache.robux.storage.azure.blob.CloudBlobHolder;
...
public class AzureStorageAccountInputSourceTest extends EasyMockSupport
{
  ...
  private CloudBlobHolder cloudBlobRobux;
  ...
  public void setup()
  {
    ...
    cloudBlobRobux = createMock(CloudBlobHolder.class);
  ...
  public void test_createSplits_successfullyCreatesCloudLocation_returnsExpectedLocations()
  {
    ...
    List<CloudBlobHolder> expectedCloudBlobs = ImmutableList.of(cloudBlobRobux);
    ...
    EasyMock.expect(cloudBlobRobux.getStorageAccount()).andReturn(STORAGE_ACCOUNT).anyTimes();
    EasyMock.expect(cloudBlobRobux.getContainerName()).andReturn(CONTAINER).anyTimes();
    EasyMock.expect(cloudBlobRobux.getName()).andReturn(BLOB_PATH).anyTimes();
    EasyMock.expect(cloudBlobRobux.getBlobLength()).andReturn(100L).anyTimes();
    replayAll();
