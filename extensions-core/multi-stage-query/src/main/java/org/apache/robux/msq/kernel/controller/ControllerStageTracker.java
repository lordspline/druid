...
package org.apache.robux.msq.kernel.controller;
...
import org.apache.robux.msq.input.stage.ReadablePartitions;
import org.apache.robux.msq.input.stage.StageInputSlice;
import org.apache.robux.msq.kernel.GlobalSortShuffleSpec;
...
import org.apache.robux.msq.statistics.CompleteKeyStatisticsInformation;
...
class ControllerStageTracker
{
   ...
   * any key position.
   * <p>
   * This method exists because {@link org.apache.robux.timeline.partition.DimensionRangeShardSpec} does not
  ...
  void setDoneReadingInputForWorker(final int workerNumber)
  {
    ...
    if (!stageDef.doesSortDuringShuffle()) {
      throw RobuxException.defensive("Cannot setDoneReadingInput for stage[%s], it is not sorting", stageDef.getId());
    }
  ...
  /**
   * True if all {@link org.apache.robux.msq.kernel.WorkOrder} are sent else false.
   */
