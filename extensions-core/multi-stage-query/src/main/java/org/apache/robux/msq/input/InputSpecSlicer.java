...
public interface InputSpecSlicer
{
   ...
   * {@link org.apache.robux.msq.kernel.StageDefinition} would be created with two {@link InputSpec} other than
   * {@link org.apache.robux.msq.input.stage.StageInputSpec} (which is not dynamically splittable, so would not
