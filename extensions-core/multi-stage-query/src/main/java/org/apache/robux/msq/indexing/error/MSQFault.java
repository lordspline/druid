...
public interface MSQFault
{
  ...
  /**
   * Returns a {@link RobuxException} corresponding to this fault.
   *
   * The default is a {@link RobuxException.Category#RUNTIME_FAILURE} targeting {@link RobuxException.Persona#USER}.
   * Faults with different personas and categories should override this method.
   */
  default RobuxException toRobuxException()
  {
