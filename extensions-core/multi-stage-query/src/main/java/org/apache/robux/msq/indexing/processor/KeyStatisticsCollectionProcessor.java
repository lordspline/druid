...
import org.apache.robux.frame.allocation.MemoryRange;
...
public class KeyStatisticsCollectionProcessor implements FrameProcessor<ClusterByStatisticsCollector>
{
   ...
   * {@link org.apache.robux.msq.util.MultiStageQueryContext#DEFAULT_ROWS_PER_SEGMENT}, and *some* redundancy between
