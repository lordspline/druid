...
import org.apache.robux.msq.logical.stages.AbstractFrameProcessorStage;
import org.apache.robux.msq.logical.stages.AbstractShuffleStage;
...
public class StageMaker
{
  ...
  private StageDefinitionBuilder buildStageInternal(LogicalStage stage)
  {
    ...
    throw RobuxException.defensive("Cannot build type [%s]", stage.getClass().getSimpleName());
  }
