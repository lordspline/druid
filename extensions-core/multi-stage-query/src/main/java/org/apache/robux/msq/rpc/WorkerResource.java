...
package org.apache.robux.msq.rpc;
...
import org.apache.robux.frame.file.FrameFileHttpResponseHandler;
...
import org.apache.robux.msq.statistics.serde.ClusterByStatisticsSnapshotSerde;
...
public class WorkerResource
{
   ...
   * <p>
   * See {@link org.apache.robux.msq.exec.WorkerClient#fetchChannelData} for the client-side code that calls this API.
   */
  @GET
  ...
  /**
   * See {@link org.apache.robux.msq.exec.WorkerClient#postWorkOrder} for the client-side code that calls this API.
   */
  @POST
  ...
  /**
   * See {@link org.apache.robux.msq.exec.WorkerClient#postResultPartitionBoundaries} for the client-side code that calls this API.
   */
  @POST
  @Consumes({MediaType.APPLICATION_JSON, SmileMediaTypes.APPLICATION_JACKSON_SMILE})
  ...
  /**
   * See {@link org.apache.robux.msq.exec.WorkerClient#postCleanupStage} for the client-side code that calls this API.
   */
  @POST
  ...
  /**
   * See {@link org.apache.robux.msq.exec.WorkerClient#postFinish} for the client-side code that calls this API.
   */
  @POST
  @Path("/finish")
  ...
  /**
   * See {@link org.apache.robux.msq.exec.WorkerClient#getCounters} for the client-side code that calls this API.
   */
  @GET
