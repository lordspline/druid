...
/**
 * Contains information on a set of segments, and the {@link RobuxServerMetadata} of a data server serving
...
public class DataServerRequestDescriptor
{
  ...
  public DataServerRequestDescriptor(
      @JsonProperty("serverMetadata") RobuxServerMetadata serverMetadata,
  ...
  public RobuxServerMetadata getServerMetadata()
  {
