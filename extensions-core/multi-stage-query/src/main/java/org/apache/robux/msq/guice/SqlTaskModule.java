...
import org.apache.robux.msq.sql.resources.SqlStatementResource;
import org.apache.robux.msq.sql.resources.SqlTaskResource;

/**
 * Module for adding the {@link SqlTaskResource} endpoint to the Broker.
 */
@LoadScope(roles = NodeRole.BROKER_JSON_NAME)
public class SqlTaskModule implements RobuxModule
{
  @Override
