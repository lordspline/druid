...
public class DartWorkerContext implements WorkerContext
{
  ...
  )
  {
    ...
    this.workerId = WorkerId.fromRobuxNode(selfNode, queryId);
  ...
  public boolean includeAllCounters()
  {
    ...
    // to Robux 31. Dart didn't exist prior to Robux 31, so there is no need for it here. Always emit all counters.
    return true;
  }
