...
public enum ShuffleKind
{
   ...
   * {@link org.apache.robux.msq.statistics.ClusterByStatisticsCollector}. The controller merges those statistics,
   * generating final {@link org.apache.robux.frame.key.ClusterByPartitions}. Then, workers fully sort and partition
