...
public class SqlTaskResource
{
   ...
   * {@link org.apache.robux.msq.indexing.MSQControllerTask}. The task ID is returned immediately to the caller,
  ...
  )
  {
    ...
    try {
      ...
      return buildNonOkResponse(
          "forbidden",
          RobuxException.forPersona(RobuxException.Persona.USER)
  ...
  private Response buildTaskResponse(Sequence<Object[]> sequence) throws IOException
  {
    ...
    if (taskId == null) {
      ...
      // user through a RobuxExcpetion that makes it out of this code and this code never actually gets executed.
  ...
  private Response buildNonOkResponse(String sqlQueryId, RobuxException exception)
  {
    return Response
