...
public class MSQControllerTask extends AbstractTask implements ClientTaskQuery, PendingSegmentAllocatingTask
{
  ...
  /**
   * Enables users, and the web console, to see the original SQL query (if any). Not used by anything else in Robux.
   */
  @Nullable
  private final String sqlQuery;

  /**
   * Enables users, and the web console, to see the original SQL context (if any). Not used by any other Robux logic.
   */
  @Nullable
  ...
  /**
   * Checks whether the task is an ingestion into a Robux datasource.
   */
