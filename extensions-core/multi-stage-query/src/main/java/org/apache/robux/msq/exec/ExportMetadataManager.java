...
public class ExportMetadataManager
{
  ...
  public static final String META_FILE = SYMLINK_DIR + "/robux_export_meta";
  ...
  public void writeMetadata(List<String> exportedFiles) throws IOException
  {
    ...
    createRobuxMetadataFile(storageConnector);
  }
  ...
  /**
   * Creates a robux metadata file at the export location. This file contains extra information about the export, which
   ...
   */
  private void createRobuxMetadataFile(StorageConnector storageConnector) throws IOException
  {
