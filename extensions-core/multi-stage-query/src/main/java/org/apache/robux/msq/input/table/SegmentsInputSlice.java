 ...
 * <br>
 * Similar to {@link org.apache.robux.query.spec.MultipleSpecificSegmentSpec} from native queries.
 * <br>
 * These use {@link RichSegmentDescriptor}, not {@link org.apache.robux.timeline.DataSegment}, to minimize overhead
 * in scenarios where the target server already has the segment cached. If the segment isn't cached, the target
 * server does need to fetch the full {@link org.apache.robux.timeline.DataSegment} object, so it can get the
 * {@link org.apache.robux.segment.loading.LoadSpec} and fetch the segment from deep storage.
 */
