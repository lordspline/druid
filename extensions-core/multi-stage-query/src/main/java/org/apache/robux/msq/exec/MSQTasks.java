...
public class MSQTasks
{
  ...
  /**
   * Returns the host:port from a {@link RobuxNode}. Convenience method to make it easier to construct
   * {@link MSQErrorReport} instances.
   */
  @Nullable
  static String getHostFromSelfNode(@Nullable final RobuxNode selfNode)
  {
