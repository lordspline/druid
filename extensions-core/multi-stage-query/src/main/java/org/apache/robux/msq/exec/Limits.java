...
public class Limits
{
   ...
   * {@link org.apache.robux.frame.allocation.AppendableMemory#DEFAULT_INITIAL_ALLOCATION_SIZE}.
   */
  ...
  /**
   * Maximum size of the kernel manipulation queue in {@link org.apache.robux.msq.indexing.MSQControllerTask}.
   */
   ...
   * {@link org.apache.robux.msq.indexing.destination.DurableStorageMSQDestination}. Reports in this mode contain a
