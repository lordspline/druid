...
public class DimensionSchemaUtils
{
  ...
  /**
   * Creates a dimension schema for creating {@link org.apache.robux.data.input.InputSourceReader}.
   */
   ...
   *
   * @throws org.apache.robux.error.RobuxException if there is some problem
   */
