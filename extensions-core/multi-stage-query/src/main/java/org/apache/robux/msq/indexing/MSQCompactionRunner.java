...
import org.apache.robux.indexing.common.task.CompactionRunner;
...
public class MSQCompactionRunner implements CompactionRunner
{
  ...
  )
  {
    ...
    Robuxs.ScanQueryBuilder scanQueryBuilder = new Robuxs.ScanQueryBuilder()
      ...
      throws JsonProcessingException
  {
    ...
    if (!isQueryGranularityEmptyOrNone(dataSchema)) {
      context.put(
          RobuxSqlInsert.SQL_INSERT_QUERY_GRANULARITY,
