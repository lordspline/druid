...
public class MemoryIntrospectorImpl implements MemoryIntrospector
{
   ...
   * @param numProcessingThreads size of processing thread pool, typically {@link RobuxProcessingConfig#getNumThreads()}
   ...
   * typical mode of operation, since by default robux.lookup.enableLookupSyncOnStartup = true.
   */
