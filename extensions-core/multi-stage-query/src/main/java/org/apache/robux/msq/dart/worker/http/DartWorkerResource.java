...
package org.apache.robux.msq.dart.worker.http;
...
import org.apache.robux.msq.rpc.MSQResourceUtils;
import org.apache.robux.msq.rpc.ResourcePermissionMapper;
import org.apache.robux.msq.rpc.WorkerResource;
import org.apache.robux.server.RobuxNode;
import org.apache.robux.server.initialization.jetty.ServiceUnavailableException;
 ...
 *
 * Note that this is not the same resource as used by {@link org.apache.robux.msq.indexing.MSQWorkerTask}.
 * For that, see {@link org.apache.robux.msq.indexing.client.WorkerChatHandler}.
 */
@LazySingleton
...
public class DartWorkerResource
{
   ...
   * Root of worker APIs.
   */
  public static final String PATH = "/robux/dart-worker";

  /**
   * Header containing the controller host:port, from {@link RobuxNode#getHostAndPortToUse()}.
   */
