...
public class SegmentLoadStatusFetcher implements AutoCloseable
{
   ...
   * evaluation.
   * <br>
   * See <a href="https://github.com/apache/robux/pull/14403">this</a> for more details about replication_factor
   */
  ...
  public enum State
  {
    ...
    FAILED,
    /**
     * The time spent waiting for segments to load exceeded org.apache.robux.msq.exec.SegmentLoadWaiter#TIMEOUT_DURATION_MILLIS.
