...
import org.apache.robux.msq.input.InputSpecs;
...
import org.apache.robux.msq.kernel.HashShuffleSpec;
import org.apache.robux.msq.kernel.QueryDefinition;
import org.apache.robux.msq.kernel.QueryDefinitionBuilder;
import org.apache.robux.msq.kernel.StageDefinition;
import org.apache.robux.msq.kernel.StageDefinitionBuilder;
...
import org.apache.robux.query.planning.JoinDataSourceAnalysis;
import org.apache.robux.query.planning.PreJoinableClause;
...
{
  /**
   * A map with {@link RobuxSqlInsert#SQL_INSERT_SEGMENT_GRANULARITY} set to null, so we can clear it from the context
   * of subqueries.
   */
  ...
  static {
    CONTEXT_MAP_NO_SEGMENT_GRANULARITY.put(RobuxSqlInsert.SQL_INSERT_SEGMENT_GRANULARITY, null);
  }
  ...
  )
  {
    ...
    // Plan the left input.
    // We're confident that we can cast dataSource.getLeft() to QueryDataSource, because RobuxJoinQueryRel creates
    ...
    // We're confident that we can cast dataSource.getRight() to QueryDataSource, because RobuxJoinQueryRel creates
    // subqueries when the join algorithm is sortMerge.
   ...
   * {@link org.apache.robux.sql.calcite.rel.RobuxQuery#canUseIntervalFiltering(DataSource)}.
   */
