...
public class WorkerId
{
   ...
   */
  public static WorkerId fromRobuxNode(final RobuxNode node, final String queryId)
  {
    return new WorkerId(
   ...
   * Create a worker ID, which is a URL.
   */
  public static WorkerId fromRobuxServerMetadata(final RobuxServerMetadata server, final String queryId)
  {
    return new WorkerId(
