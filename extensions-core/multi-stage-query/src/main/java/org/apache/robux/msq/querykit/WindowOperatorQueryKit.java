...
import org.apache.robux.msq.kernel.MixShuffleSpec;
...
import org.apache.robux.query.operator.AbstractPartitioningOperatorFactory;
import org.apache.robux.query.operator.AbstractSortOperatorFactory;
import org.apache.robux.query.operator.ColumnWithDirection;
import org.apache.robux.query.operator.GlueingPartitioningOperatorFactory;
import org.apache.robux.query.operator.OperatorFactory;
import org.apache.robux.query.operator.PartitionSortOperatorFactory;
...
public class WindowOperatorQueryKit implements QueryKit<WindowOperatorQuery>
{
  ...
  private static class WindowStages
  {
     ...
     * as they are handled as {@link org.apache.robux.query.scan.ScanQuery#orderBys}.
     */
