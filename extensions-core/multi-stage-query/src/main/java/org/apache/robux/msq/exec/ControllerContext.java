...
public interface ControllerContext
{
   ...
   * {@link org.apache.robux.msq.kernel.QueryDefinition#getQueryId}. Must be globally unique because this is used for
   * identifying workers, naming temporary files, etc.
   */
  String queryId();

  /**
   * Configuration for {@link org.apache.robux.msq.kernel.controller.ControllerQueryKernel}.
   */
   ...
   * {@link MSQSpec#getDestination()} is {@link org.apache.robux.msq.indexing.destination.DataSourceMSQDestination}.
   */
