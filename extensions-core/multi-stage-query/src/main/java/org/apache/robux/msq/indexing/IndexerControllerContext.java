...
public class IndexerControllerContext implements ControllerContext
{
  ...
  {
    return injector.getInstance(Key.get(RobuxNode.class, Self.class));
  }
  ...
  )
  {
    ...
    Map<String, Object> tags = (Map<String, Object>) controllerTaskContext.get(RobuxMetrics.TAGS);
    if (tags != null) {
      taskContextOverridesBuilder.put(RobuxMetrics.TAGS, tags);
    }
