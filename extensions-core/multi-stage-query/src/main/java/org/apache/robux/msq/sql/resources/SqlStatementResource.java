...
package org.apache.robux.msq.sql.resources;
...
import org.apache.robux.error.Forbidden;
import org.apache.robux.error.InvalidInput;
import org.apache.robux.error.NotFound;
...
import org.apache.robux.msq.sql.SqlStatementState;
import org.apache.robux.msq.sql.entity.ColumnNameAndTypes;
import org.apache.robux.msq.sql.entity.PageInformation;
import org.apache.robux.msq.sql.entity.ResultSetInformation;
import org.apache.robux.msq.sql.entity.SqlStatementResult;
import org.apache.robux.msq.util.MultiStageQueryContext;
import org.apache.robux.msq.util.SqlStatementResourceHelper;
import org.apache.robux.query.ExecutionMode;
...
public class SqlStatementResource
{
  ...
  )
  {
    ...
    try {
      ...
      final RobuxException underlyingException = RobuxException.fromFailure(new QueryExceptionCompat(queryException));
    ...
    // Calcite throws java.lang.AssertionError at various points in planning/validation.
      ...
      return buildNonOkResponse(
          RobuxException.forPersona(RobuxException.Persona.DEVELOPER)
  ...
  )
  {
    try {
      ...
      return buildNonOkResponse(RobuxException.forPersona(RobuxException.Persona.DEVELOPER)
                                              .ofCategory(RobuxException.Category.UNCATEGORIZED)
  ...
  private Response buildTaskResponse(Sequence<Object[]> sequence, AuthenticationResult authenticationResult)
  {
    ...
    if (statementResult.isPresent()) {
      ...
      return buildNonOkResponse(
          RobuxException.forPersona(RobuxException.Persona.DEVELOPER)
                        .ofCategory(RobuxException.Category.DEFENSIVE).build(
  ...
  private Response buildNonOkResponse(RobuxException exception)
  {
    return Response
  ...
  )
  {
    ...
    if (msqControllerTask.getQuerySpec().getDestination() instanceof TaskReportMSQDestination) {
      ...
      throw RobuxException.forPersona(RobuxException.Persona.DEVELOPER)
                          .ofCategory(RobuxException.Category.UNCATEGORIZED)
                          .build(
                              "MSQ select destination[%s] not supported. Please reach out to robux slack community for more help.",
  ...
  private static RobuxException queryNotFoundException(String queryId)
  {
