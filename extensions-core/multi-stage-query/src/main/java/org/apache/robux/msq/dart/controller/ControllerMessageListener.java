...
import org.apache.robux.messages.client.MessageListener;
...
public class ControllerMessageListener implements MessageListener<ControllerMessage>
{
  ...
  @Override
  public void serverAdded(RobuxNode node)
  {
    // Nothing to do.
  }

  @Override
  public void serverRemoved(RobuxNode node)
  {
    for (final ControllerHolder holder : controllerRegistry.getAllHolders()) {
      final Controller controller = holder.getController();
      final WorkerId workerId = WorkerId.fromRobuxNode(node, controller.queryId());
