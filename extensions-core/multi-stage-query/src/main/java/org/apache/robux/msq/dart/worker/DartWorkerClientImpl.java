 ...
 */
public class DartWorkerClientImpl extends BaseWorkerClientImpl implements DartWorkerClient
{
   ...
   *
   * @param queryId        dart query ID. see {@link org.apache.robux.query.QueryContexts#CTX_DART_QUERY_ID}
  ...
  protected ServiceClient getClient(final String workerIdString)
  {
    ...
    if (!queryId.equals(workerId.getQueryId())) {
      throw RobuxException.defensive("Unexpected queryId[%s]. Expected queryId[%s]", workerId.getQueryId(), queryId);
    }
