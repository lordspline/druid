...
import org.apache.robux.indexing.common.task.CompactionIntervalSpec;
...
import org.apache.robux.segment.NestedDataColumnSchema;
...
public class MSQCompactionRunnerTest
{
  ...
  public void testCompactionConfigWithoutMetricsSpecProducesCorrectSpec() throws JsonProcessingException
  {
    ...
    Assert.assertEquals(
        ...
        msqControllerTask.getContext().get(RobuxSqlInsert.SQL_INSERT_SEGMENT_GRANULARITY)
    );
    Assert.assertEquals(
        JSON_MAPPER.writeValueAsString(QUERY_GRANULARITY.toString()),
        msqControllerTask.getContext().get(RobuxSqlInsert.SQL_INSERT_QUERY_GRANULARITY)
    );
