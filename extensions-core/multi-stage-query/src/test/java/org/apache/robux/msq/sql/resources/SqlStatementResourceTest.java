...
import org.apache.robux.msq.indexing.report.MSQTaskReportTest;
...
public class SqlStatementResourceTest extends MSQTestBase
{
  ...
  private static final Query<?> QUERY = new Robuxs.ScanQueryBuilder().resultFormat(ScanQuery.ResultFormat.RESULT_FORMAT_COMPACTED_LIST)
  ...
  {
    assertThat(
        Assert.assertThrows(RobuxException.class, () -> SqlStatementResource.validateFilename(filename)),
        RobuxExceptionMatcher.invalidInput().expectMessageIs(errorMessage)
    );
  }
}
