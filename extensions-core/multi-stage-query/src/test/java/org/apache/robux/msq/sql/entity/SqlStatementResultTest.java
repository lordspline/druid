...
package org.apache.robux.msq.sql.entity;
...
import org.apache.robux.msq.sql.resources.SqlStatementResourceTest;
...
public class SqlStatementResultTest
{
  ...
  public static final String JSON_STRING = "{\"queryId\":\"q1\","
                                           ...
                                           + "\"errorDetails\":{\"error\":\"robuxException\",\"errorCode\":\"QueryNotSupported\",\"persona\":\"USER\",\"category\":\"UNCATEGORIZED\",\"errorMessage\":\"QueryNotSupported\",\"context\":{}}}";
  ...
  public static final SqlStatementResult SQL_STATEMENT_RESULT = new SqlStatementResult(
      ...
      RobuxException.fromFailure(new RobuxException.Failure(MSQ_EXCEPTION.getFault().getErrorCode())
      {
        @Override
        protected RobuxException makeException(RobuxException.RobuxExceptionBuilder bob)
        {
          return bob.forPersona(RobuxException.Persona.USER)
  ...
  public void sanityTest() throws JsonProcessingException
  {
    ...
    Assert.assertEquals(
        ...
        + " errorResponse={error=robuxException, errorCode=QueryNotSupported, persona=USER, category=UNCATEGORIZED, errorMessage=QueryNotSupported, context={}},"
        + " stages=null,"
        + " counters=null,"
        + " warnings=null}",
