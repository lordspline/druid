...
package org.apache.robux.msq.quidem;

import org.apache.robux.quidem.RobuxQuidemCommandHandler;
import org.apache.robux.quidem.RobuxQuidemTestBase;
import org.apache.robux.quidem.ProjectPathUtils;

import java.io.File;

public class MSQQuidemTest extends RobuxQuidemTestBase
{
  public MSQQuidemTest()
  {
    super(new RobuxQuidemCommandHandler());
  }
