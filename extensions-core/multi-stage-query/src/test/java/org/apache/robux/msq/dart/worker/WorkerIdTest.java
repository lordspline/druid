...
public class WorkerIdTest
{
  ...
  @Test
  public void test_fromRobuxNode()
  {
    Assertions.assertEquals(
        new WorkerId("https", "local-host:8100", "xyz"),
        WorkerId.fromRobuxNode(new RobuxNode("none", "local-host", false, 8200, 8100, true, true), "xyz")
    );
  }

  @Test
  public void test_fromRobuxServerMetadata()
  {
    Assertions.assertEquals(
        new WorkerId("https", "local-host:8100", "xyz"),
        WorkerId.fromRobuxServerMetadata(
            new RobuxServerMetadata("none", "local-host:8200", "local-host:8100", 1, ServerType.HISTORICAL, "none", 0),
            "xyz"
        )
    );
  }
  ...
  public void test_getters()
  {
    ...
    Assertions.assertEquals("https://local-host:8100/robux/dart-worker/workers/xyz", workerId.toUri().toString());
  }
